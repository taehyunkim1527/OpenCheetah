...
tmp19 = (( (int32_t)0 + (i0 *  (int32_t)512)) + (i1 *  (int32_t)1));
Arr1DIdxRowM(tmp16, (int32_t)25600,tmp19) = Arr2DIdxRowM(tmp4, (int32_t)50, (int32_t)512,i0,i1);
Arr1DIdxRowM(tmp17, (int32_t)25600,tmp19) = Arr2DIdxRowM(tmp3, (int32_t)1, (int32_t)512, (int32_t)0,i1);
}
}
...
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
tmp19 = (( (int32_t)0 + (i0 *  (int32_t)512)) + (i1 *  (int32_t)1));
Arr2DIdxRowM(tmp15, (int32_t)50, (int32_t)512,i0,i1) = Arr1DIdxRowM(tmp18, (int32_t)25600,tmp19);
}
}
...
Arr2DIdxRowM(tmp23, (int32_t)1, (int32_t)512,i3,i4) = Arr1DIdxRowM(tmp0, (int32_t)512,i2);
i2 = (i2 +  (int64_t)1);
}
}
...
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp23, tmp5, tmp25, 0);
...
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp28, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp25, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp6, (int32_t)1, (int32_t)512,i0,i1));
}
}
...
Relu2( (int32_t)1,  (int32_t)512, tmp28, tmp31,  (int32_t)12, 1);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp33, (int32_t)50, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp1, (int32_t)50, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp15, (int32_t)50, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp1);

uint64_t* tmp35 = make_array<uint64_t>( (int32_t)50,  (int32_t)512);
ScaleDown2( (int32_t)50,  (int32_t)512, tmp33,  (int32_t)12);
MatMul2D( (int32_t)50,  (int32_t)512,  (int32_t)512, tmp33, tmp7, tmp35, 0);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp38, (int32_t)50, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp35, (int32_t)50, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp8, (int32_t)1, (int32_t)512, (int32_t)0,i1));
}
}
...
Relu2( (int32_t)50,  (int32_t)512, tmp38, tmp41,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp38);

int32_t* tmp43 = make_array<int32_t>( (int32_t)4);
Arr1DIdxRowM(tmp43, (int32_t)4, (int64_t)0) =  (int32_t)512;
Arr1DIdxRowM(tmp43, (int32_t)4, (int64_t)1) =  (int32_t)1;
Arr1DIdxRowM(tmp43, (int32_t)4, (int64_t)2) =  (int32_t)50;
Arr1DIdxRowM(tmp43, (int32_t)4, (int64_t)3) =  (int32_t)1;

uint64_t* tmp44 = make_array<uint64_t>( (int32_t)512,  (int32_t)1,  (int32_t)50,  (int32_t)1);
...
Arr4DIdxRowM(tmp44, (int32_t)512, (int32_t)1, (int32_t)50, (int32_t)1,i7,i8,i9,i10) = Arr2DIdxRowM(tmp41, (int32_t)50, (int32_t)512,i5,i6);
i6 = (i6 +  (int64_t)1);
if ((i6 ==  (int64_t)512)) {
i6 =  (int64_t)0;
i5 = (i5 +  (int64_t)1);
...
uint64_t* tmp46 = make_array<uint64_t>( (int32_t)512,  (int32_t)1,  (int32_t)1,  (int32_t)1);
MaxPool( (int32_t)512,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)50,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1,  (int32_t)512,  (int32_t)1,  (int32_t)50,  (int32_t)1, tmp44, tmp46);
ClearMemSecret4( (int32_t)512,  (int32_t)1,  (int32_t)50,  (int32_t)1, tmp44);
...
Arr2DIdxRowM(tmp49, (int32_t)1, (int32_t)512,i15,i16) = Arr4DIdxRowM(tmp46, (int32_t)512, (int32_t)1, (int32_t)1, (int32_t)1,i11,i12,i13,i14);
i14 = (i14 +  (int64_t)1);
if ((i14 ==  (int64_t)1)) {
i14 =  (int64_t)0;
i13 = (i13 +  (int64_t)1);
...
ClearMemSecret4( (int32_t)512,  (int32_t)1,  (int32_t)1,  (int32_t)1, tmp46);

uint64_t* tmp51 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp51, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp49, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp31, (int32_t)1, (int32_t)512,i0,i1));
}
}
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp62, (int32_t)50, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp2, (int32_t)50, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp15, (int32_t)50, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp2);
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp15);

uint64_t* tmp65 = make_array<uint64_t>( (int32_t)50,  (int32_t)512);
ScaleDown2( (int32_t)50,  (int32_t)512, tmp62,  (int32_t)12);
MatMul2D( (int32_t)50,  (int32_t)512,  (int32_t)512, tmp62, tmp11, tmp65, 0);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp68, (int32_t)50, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp65, (int32_t)50, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp12, (int32_t)1, (int32_t)512, (int32_t)0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp12);
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp65);

uint64_t* tmp71 = make_array<uint64_t>( (int32_t)50,  (int32_t)512);
Relu2( (int32_t)50,  (int32_t)512, tmp68, tmp71,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp68);

int32_t* tmp73 = make_array<int32_t>( (int32_t)4);
Arr1DIdxRowM(tmp73, (int32_t)4, (int64_t)0) =  (int32_t)512;
Arr1DIdxRowM(tmp73, (int32_t)4, (int64_t)1) =  (int32_t)1;
Arr1DIdxRowM(tmp73, (int32_t)4, (int64_t)2) =  (int32_t)50;
Arr1DIdxRowM(tmp73, (int32_t)4, (int64_t)3) =  (int32_t)1;

uint64_t* tmp74 = make_array<uint64_t>( (int32_t)512,  (int32_t)1,  (int32_t)50,  (int32_t)1);
...
Arr4DIdxRowM(tmp74, (int32_t)512, (int32_t)1, (int32_t)50, (int32_t)1,i19,i20,i21,i22) = Arr2DIdxRowM(tmp71, (int32_t)50, (int32_t)512,i17,i18);
i18 = (i18 +  (int64_t)1);
if ((i18 ==  (int64_t)512)) {
i18 =  (int64_t)0;
i17 = (i17 +  (int64_t)1);
...
uint64_t* tmp76 = make_array<uint64_t>( (int32_t)512,  (int32_t)1,  (int32_t)1,  (int32_t)1);
MaxPool( (int32_t)512,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)50,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1,  (int32_t)512,  (int32_t)1,  (int32_t)50,  (int32_t)1, tmp74, tmp76);
ClearMemSecret4( (int32_t)512,  (int32_t)1,  (int32_t)50,  (int32_t)1, tmp74);

int32_t* tmp78 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp78, (int32_t)2, (int64_t)0) =  (int32_t)-1;
Arr1DIdxRowM(tmp78, (int32_t)2, (int64_t)1) =  (int32_t)512;
...
Arr2DIdxRowM(tmp79, (int32_t)1, (int32_t)512,i27,i28) = Arr4DIdxRowM(tmp76, (int32_t)512, (int32_t)1, (int32_t)1, (int32_t)1,i23,i24,i25,i26);
i26 = (i26 +  (int64_t)1);
if ((i26 ==  (int64_t)1)) {
i26 =  (int64_t)0;
i25 = (i25 +  (int64_t)1);
...
ClearMemSecret4( (int32_t)512,  (int32_t)1,  (int32_t)1,  (int32_t)1, tmp76);

uint64_t* tmp81 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp81, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp79, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp60, (int32_t)1, (int32_t)512,i0,i1));
}
}
...
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp81, tmp13, tmp84, 0);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp87, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp84, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp14, (int32_t)1, (int32_t)512,i0,i1));
}
}
...
Relu2( (int32_t)1,  (int32_t)512, tmp87, tmp90,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp87);
EndComputation();
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (uint32_t)0; i1 <  (int32_t)512; i1++){
cout << (funcReconstruct2PCCons(Arr2DIdxRowM(tmp90, (int32_t)1, (int32_t)512,i0,i1), 2)) << endl;
}
}
}
