...
uint64_t* tmp43 = make_array<uint64_t>( (int32_t)256);
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)256; i5++){
tmp42 = funcSSCons( (int64_t)0);
for (uint32_t i6 =  (int32_t)0; i6 <  (int32_t)50; i6++){
tmp42 = SecretAdd(tmp42, Arr2DIdxRowM(tmp39, (int32_t)50, (int32_t)256,i6,i5));
}
Arr1DIdxRowM(tmp43, (int32_t)256,i5) = tmp42;
}
...
Arr1DIdxRowM(tmp45, (int32_t)2, (int64_t)1) =  (int32_t)256;
...
Arr2DIdxRowM(tmp46, (int32_t)1, (int32_t)256,i8,i9) = Arr1DIdxRowM(tmp43, (int32_t)256,i7);
i7 = (i7 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)256, tmp43);
ScaleUp2( (int32_t)1,  (int32_t)256, tmp37,  (int32_t)12);

uint64_t* tmp48 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp48, (int32_t)1, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp46, (int32_t)1, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp37, (int32_t)1, (int32_t)256,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp46);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp37);
ScaleDown2( (int32_t)1,  (int32_t)256, tmp48,  (int32_t)12);

uint64_t* tmp51 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);

uint64_t* tmp52 = make_array<uint64_t>( (int32_t)256);

uint64_t* tmp53 = make_array<uint64_t>( (int32_t)256);
...
tmp55 = (( (int32_t)0 + (i10 *  (int32_t)256)) + (i11 *  (int32_t)1));
Arr1DIdxRowM(tmp52, (int32_t)256,tmp55) = Arr2DIdxRowM(tmp48, (int32_t)1, (int32_t)256,i10,i11);
Arr1DIdxRowM(tmp53, (int32_t)256,tmp55) = Arr2DIdxRowM(tmp9, (int32_t)1, (int32_t)1,i10, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)256, tmp52, tmp53, tmp54);
ClearMemSecret1( (int32_t)256, tmp52);
ClearMemSecret1( (int32_t)256, tmp53);
for (uint32_t i10 =  (int32_t)0; i10 <  (int32_t)1; i10++){
for (uint32_t i11 =  (int32_t)0; i11 <  (int32_t)256; i11++){
tmp55 = (( (int32_t)0 + (i10 *  (int32_t)256)) + (i11 *  (int32_t)1));
Arr2DIdxRowM(tmp51, (int32_t)1, (int32_t)256,i10,i11) = Arr1DIdxRowM(tmp54, (int32_t)256,tmp55);
}
}
ClearMemSecret1( (int32_t)256, tmp54);
ClearMemSecret2( (int32_t)1,  (int32_t)1, tmp9);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp48);

uint64_t* tmp58 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
ScaleDown2( (int32_t)1,  (int32_t)256, tmp51,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)256,  (int32_t)256, tmp51, tmp10, tmp58, 0);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp51);
...
uint64_t* tmp70 = make_array<uint64_t>( (int32_t)256);
for (uint32_t i12 =  (int32_t)0; i12 <  (int32_t)256; i12++){
tmp69 = funcSSCons( (int64_t)0);
for (uint32_t i13 =  (int32_t)0; i13 <  (int32_t)50; i13++){
tmp69 = SecretAdd(tmp69, Arr2DIdxRowM(tmp66, (int32_t)50, (int32_t)256,i13,i12));
}
Arr1DIdxRowM(tmp70, (int32_t)256,i12) = tmp69;
}
...
Arr1DIdxRowM(tmp72, (int32_t)2, (int64_t)1) =  (int32_t)256;
...
Arr2DIdxRowM(tmp73, (int32_t)1, (int32_t)256,i15,i16) = Arr1DIdxRowM(tmp70, (int32_t)256,i14);
i14 = (i14 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)256, tmp70);
ScaleUp2( (int32_t)1,  (int32_t)256, tmp64,  (int32_t)12);

uint64_t* tmp75 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp75, (int32_t)1, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp73, (int32_t)1, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp64, (int32_t)1, (int32_t)256,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp73);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp64);
ScaleDown2( (int32_t)1,  (int32_t)256, tmp75,  (int32_t)12);

uint64_t* tmp78 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);

uint64_t* tmp79 = make_array<uint64_t>( (int32_t)256);

uint64_t* tmp80 = make_array<uint64_t>( (int32_t)256);

uint64_t* tmp81 = make_array<uint64_t>( (int32_t)256);

int32_t tmp82;
for (uint32_t i17 =  (int32_t)0; i17 <  (int32_t)1; i17++){
for (uint32_t i18 =  (int32_t)0; i18 <  (int32_t)256; i18++){
tmp82 = (( (int32_t)0 + (i17 *  (int32_t)256)) + (i18 *  (int32_t)1));
Arr1DIdxRowM(tmp79, (int32_t)256,tmp82) = Arr2DIdxRowM(tmp75, (int32_t)1, (int32_t)256,i17,i18);
Arr1DIdxRowM(tmp80, (int32_t)256,tmp82) = Arr2DIdxRowM(tmp12, (int32_t)1, (int32_t)1,i17, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)256, tmp79, tmp80, tmp81);
ClearMemSecret1( (int32_t)256, tmp79);
ClearMemSecret1( (int32_t)256, tmp80);
for (uint32_t i17 =  (int32_t)0; i17 <  (int32_t)1; i17++){
for (uint32_t i18 =  (int32_t)0; i18 <  (int32_t)256; i18++){
tmp82 = (( (int32_t)0 + (i17 *  (int32_t)256)) + (i18 *  (int32_t)1));
Arr2DIdxRowM(tmp78, (int32_t)1, (int32_t)256,i17,i18) = Arr1DIdxRowM(tmp81, (int32_t)256,tmp82);
}
}
...
ScaleDown2( (int32_t)1,  (int32_t)256, tmp78,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)256,  (int32_t)256, tmp78, tmp13, tmp85, 0);
...
tmp96 = SecretAdd(tmp96, Arr2DIdxRowM(tmp93, (int32_t)50, (int32_t)256,i20,i19));
}
Arr1DIdxRowM(tmp97, (int32_t)256,i19) = tmp96;
}
...
Arr1DIdxRowM(tmp99, (int32_t)2, (int64_t)1) =  (int32_t)256;

uint64_t* tmp100 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
...
Arr2DIdxRowM(tmp100, (int32_t)1, (int32_t)256,i22,i23) = Arr1DIdxRowM(tmp97, (int32_t)256,i21);
i21 = (i21 +  (int64_t)1);
}
}
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp102, (int32_t)1, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp100, (int32_t)1, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp91, (int32_t)1, (int32_t)256,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp100);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp91);
ScaleDown2( (int32_t)1,  (int32_t)256, tmp102,  (int32_t)12);

uint64_t* tmp105 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);

uint64_t* tmp106 = make_array<uint64_t>( (int32_t)256);

uint64_t* tmp107 = make_array<uint64_t>( (int32_t)256);
...
tmp109 = (( (int32_t)0 + (i24 *  (int32_t)256)) + (i25 *  (int32_t)1));
Arr1DIdxRowM(tmp106, (int32_t)256,tmp109) = Arr2DIdxRowM(tmp102, (int32_t)1, (int32_t)256,i24,i25);
Arr1DIdxRowM(tmp107, (int32_t)256,tmp109) = Arr2DIdxRowM(tmp15, (int32_t)1, (int32_t)1,i24, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)256, tmp106, tmp107, tmp108);
ClearMemSecret1( (int32_t)256, tmp106);
ClearMemSecret1( (int32_t)256, tmp107);
for (uint32_t i24 =  (int32_t)0; i24 <  (int32_t)1; i24++){
for (uint32_t i25 =  (int32_t)0; i25 <  (int32_t)256; i25++){
tmp109 = (( (int32_t)0 + (i24 *  (int32_t)256)) + (i25 *  (int32_t)1));
Arr2DIdxRowM(tmp105, (int32_t)1, (int32_t)256,i24,i25) = Arr1DIdxRowM(tmp108, (int32_t)256,tmp109);
}
}
...
ScaleDown2( (int32_t)1,  (int32_t)256, tmp105,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)256,  (int32_t)256, tmp105, tmp16, tmp112, 0);
...
uint64_t* tmp125 = make_array<uint64_t>( (int32_t)256);
for (uint32_t i26 =  (int32_t)0; i26 <  (int32_t)256; i26++){
tmp124 = funcSSCons( (int64_t)0);
for (uint32_t i27 =  (int32_t)0; i27 <  (int32_t)50; i27++){
tmp124 = SecretAdd(tmp124, Arr2DIdxRowM(tmp120, (int32_t)50, (int32_t)256,i27,i26));
}
Arr1DIdxRowM(tmp125, (int32_t)256,i26) = tmp124;
}
...
Arr1DIdxRowM(tmp127, (int32_t)2, (int64_t)1) =  (int32_t)256;
...
Arr2DIdxRowM(tmp128, (int32_t)1, (int32_t)256,i29,i30) = Arr1DIdxRowM(tmp125, (int32_t)256,i28);
i28 = (i28 +  (int64_t)1);
}
}
...
uint64_t* tmp130 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp130, (int32_t)1, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp128, (int32_t)1, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp118, (int32_t)1, (int32_t)256,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp118);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp128);
ScaleDown2( (int32_t)1,  (int32_t)256, tmp130,  (int32_t)12);
...
tmp137 = (( (int32_t)0 + (i31 *  (int32_t)256)) + (i32 *  (int32_t)1));
Arr1DIdxRowM(tmp134, (int32_t)256,tmp137) = Arr2DIdxRowM(tmp130, (int32_t)1, (int32_t)256,i31,i32);
Arr1DIdxRowM(tmp135, (int32_t)256,tmp137) = Arr2DIdxRowM(tmp18, (int32_t)1, (int32_t)1,i31, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)256, tmp134, tmp135, tmp136);
ClearMemSecret1( (int32_t)256, tmp134);
ClearMemSecret1( (int32_t)256, tmp135);
for (uint32_t i31 =  (int32_t)0; i31 <  (int32_t)1; i31++){
for (uint32_t i32 =  (int32_t)0; i32 <  (int32_t)256; i32++){
tmp137 = (( (int32_t)0 + (i31 *  (int32_t)256)) + (i32 *  (int32_t)1));
Arr2DIdxRowM(tmp133, (int32_t)1, (int32_t)256,i31,i32) = Arr1DIdxRowM(tmp136, (int32_t)256,tmp137);
}
}
ClearMemSecret1( (int32_t)256, tmp136);
ClearMemSecret2( (int32_t)1,  (int32_t)1, tmp18);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp130);

uint64_t* tmp140 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
ScaleDown2( (int32_t)1,  (int32_t)256, tmp133,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)256,  (int32_t)256, tmp133, tmp19, tmp140, 0);
