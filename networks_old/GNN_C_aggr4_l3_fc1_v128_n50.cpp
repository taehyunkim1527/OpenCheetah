...
uint64_t* tmp11 = make_array<uint64_t>( (int32_t)6400);
...
Arr1DIdxRowM(tmp10, (int32_t)6400,tmp13) = Arr2DIdxRowM(tmp4, (int32_t)50, (int32_t)128,i0,i1);
Arr1DIdxRowM(tmp11, (int32_t)6400,tmp13) = Arr2DIdxRowM(tmp3, (int32_t)1, (int32_t)128, (int32_t)0,i1);
}
}
ElemWiseActModelVectorMult( (int32_t)6400, tmp10, tmp11, tmp12);
ClearMemSecret1( (int32_t)6400, tmp10);
ClearMemSecret1( (int32_t)6400, tmp11);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
tmp13 = (( (int32_t)0 + (i0 *  (int32_t)128)) + (i1 *  (int32_t)1));
Arr2DIdxRowM(tmp9, (int32_t)50, (int32_t)128,i0,i1) = Arr1DIdxRowM(tmp12, (int32_t)6400,tmp13);
}
}
...
uint64_t* tmp16 = make_array<uint64_t>( (int32_t)50,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp16, (int32_t)50, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp0, (int32_t)50, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp9, (int32_t)50, (int32_t)128,i0,i1));
}
}
ClearMemSecret2( (int32_t)50,  (int32_t)128, tmp0);
ScaleDown2( (int32_t)50,  (int32_t)128, tmp16,  (int32_t)12);
...
tmp22 = (( (int32_t)0 + (i2 *  (int32_t)128)) + (i3 *  (int32_t)1));
Arr1DIdxRowM(tmp19, (int32_t)6400,tmp22) = Arr2DIdxRowM(tmp16, (int32_t)50, (int32_t)128,i2,i3);
Arr1DIdxRowM(tmp20, (int32_t)6400,tmp22) = Arr2DIdxRowM(tmp6, (int32_t)50, (int32_t)1,i2, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)6400, tmp19, tmp20, tmp21);
ClearMemSecret1( (int32_t)6400, tmp19);
ClearMemSecret1( (int32_t)6400, tmp20);
for (uint32_t i2 =  (int32_t)0; i2 <  (int32_t)50; i2++){
for (uint32_t i3 =  (int32_t)0; i3 <  (int32_t)128; i3++){
tmp22 = (( (int32_t)0 + (i2 *  (int32_t)128)) + (i3 *  (int32_t)1));
Arr2DIdxRowM(tmp18, (int32_t)50, (int32_t)128,i2,i3) = Arr1DIdxRowM(tmp21, (int32_t)6400,tmp22);
}
}
ClearMemSecret1( (int32_t)6400, tmp21);
ClearMemSecret2( (int32_t)50,  (int32_t)1, tmp6);
ClearMemSecret2( (int32_t)50,  (int32_t)128, tmp16);
...
tmp26 = SecretAdd(tmp26, Arr2DIdxRowM(tmp18, (int32_t)50, (int32_t)128,i5,i4));
}
Arr1DIdxRowM(tmp27, (int32_t)128,i4) = tmp26;
}
ClearMemSecret2( (int32_t)50,  (int32_t)128, tmp18);
ScaleUp1( (int32_t)128, tmp5,  (int32_t)12);

uint64_t* tmp29 = make_array<uint64_t>( (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)128; i0++){
Arr1DIdxRowM(tmp29, (int32_t)128,i0) = SecretAdd(Arr1DIdxRowM(tmp27, (int32_t)128,i0), Arr1DIdxRowM(tmp5, (int32_t)128,i0));
}
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp31, (int32_t)50, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp1, (int32_t)50, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp9, (int32_t)50, (int32_t)128,i0,i1));
}
}
...
tmp37 = (( (int32_t)0 + (i6 *  (int32_t)128)) + (i7 *  (int32_t)1));
Arr1DIdxRowM(tmp34, (int32_t)6400,tmp37) = Arr2DIdxRowM(tmp31, (int32_t)50, (int32_t)128,i6,i7);
Arr1DIdxRowM(tmp35, (int32_t)6400,tmp37) = Arr2DIdxRowM(tmp7, (int32_t)50, (int32_t)1,i6, (int32_t)0);
}
}
...
for (uint32_t i7 =  (int32_t)0; i7 <  (int32_t)128; i7++){
tmp37 = (( (int32_t)0 + (i6 *  (int32_t)128)) + (i7 *  (int32_t)1));
Arr2DIdxRowM(tmp33, (int32_t)50, (int32_t)128,i6,i7) = Arr1DIdxRowM(tmp36, (int32_t)6400,tmp37);
}
}
...
tmp41 = SecretAdd(tmp41, Arr2DIdxRowM(tmp33, (int32_t)50, (int32_t)128,i9,i8));
}
Arr1DIdxRowM(tmp42, (int32_t)128,i8) = tmp41;
}
ClearMemSecret2( (int32_t)50,  (int32_t)128, tmp33);

uint64_t* tmp44 = make_array<uint64_t>( (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)128; i0++){
Arr1DIdxRowM(tmp44, (int32_t)128,i0) = SecretAdd(Arr1DIdxRowM(tmp42, (int32_t)128,i0), Arr1DIdxRowM(tmp5, (int32_t)128,i0));
}
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp46, (int32_t)50, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp2, (int32_t)50, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp9, (int32_t)50, (int32_t)128,i0,i1));
}
}
ClearMemSecret2( (int32_t)50,  (int32_t)128, tmp9);
ClearMemSecret2( (int32_t)50,  (int32_t)128, tmp2);
ScaleDown2( (int32_t)50,  (int32_t)128, tmp46,  (int32_t)12);
...
tmp53 = (( (int32_t)0 + (i10 *  (int32_t)128)) + (i11 *  (int32_t)1));
Arr1DIdxRowM(tmp50, (int32_t)6400,tmp53) = Arr2DIdxRowM(tmp46, (int32_t)50, (int32_t)128,i10,i11);
Arr1DIdxRowM(tmp51, (int32_t)6400,tmp53) = Arr2DIdxRowM(tmp8, (int32_t)50, (int32_t)1,i10, (int32_t)0);
}
}
...
for (uint32_t i11 =  (int32_t)0; i11 <  (int32_t)128; i11++){
tmp53 = (( (int32_t)0 + (i10 *  (int32_t)128)) + (i11 *  (int32_t)1));
Arr2DIdxRowM(tmp49, (int32_t)50, (int32_t)128,i10,i11) = Arr1DIdxRowM(tmp52, (int32_t)6400,tmp53);
}
}
...
tmp57 = SecretAdd(tmp57, Arr2DIdxRowM(tmp49, (int32_t)50, (int32_t)128,i13,i12));
}
Arr1DIdxRowM(tmp58, (int32_t)128,i12) = tmp57;
}
ClearMemSecret2( (int32_t)50,  (int32_t)128, tmp49);

uint64_t* tmp60 = make_array<uint64_t>( (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)128; i0++){
Arr1DIdxRowM(tmp60, (int32_t)128,i0) = SecretAdd(Arr1DIdxRowM(tmp58, (int32_t)128,i0), Arr1DIdxRowM(tmp5, (int32_t)128,i0));
}
ClearMemSecret1( (int32_t)128, tmp5);
ClearMemSecret1( (int32_t)128, tmp58);
ScaleDown1( (int32_t)128, tmp60,  (int32_t)12);
EndComputation();
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)128; i0++){
cout << (funcReconstruct2PCCons(Arr1DIdxRowM(tmp60, (int32_t)128,i0), 2)) << endl;
}
}
