...
uint64_t* tmp8 = make_array<uint64_t>( (int32_t)30,  (int32_t)128);
...
Arr2DIdxRowM(tmp8, (int32_t)30, (int32_t)128,i0,i1) = (party == SERVER) ? __tmp_in_tmp8 : 0;
}
}
...
uint64_t* tmp13 = make_array<uint64_t>( (int32_t)30,  (int32_t)128);
...
Arr2DIdxRowM(tmp13, (int32_t)30, (int32_t)128,i0,i1) = (party == SERVER) ? __tmp_in_tmp13 : 0;
}
}
...
uint64_t* tmp23 = make_array<uint64_t>( (int32_t)30,  (int32_t)128);

uint64_t* tmp24 = make_array<uint64_t>( (int32_t)3840);

uint64_t* tmp25 = make_array<uint64_t>( (int32_t)3840);
...
Arr1DIdxRowM(tmp24, (int32_t)3840,tmp27) = Arr2DIdxRowM(tmp5, (int32_t)30, (int32_t)128,i0,i1);
Arr1DIdxRowM(tmp25, (int32_t)3840,tmp27) = Arr2DIdxRowM(tmp4, (int32_t)1, (int32_t)128, (int32_t)0,i1);
}
}
ElemWiseActModelVectorMult( (int32_t)3840, tmp24, tmp25, tmp26);
ClearMemSecret1( (int32_t)3840, tmp24);
ClearMemSecret1( (int32_t)3840, tmp25);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)30; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
tmp27 = (( (int32_t)0 + (i0 *  (int32_t)128)) + (i1 *  (int32_t)1));
Arr2DIdxRowM(tmp23, (int32_t)30, (int32_t)128,i0,i1) = Arr1DIdxRowM(tmp26, (int32_t)3840,tmp27);
}
}
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)30; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp41, (int32_t)30, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp1, (int32_t)30, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp23, (int32_t)30, (int32_t)128,i0,i1));
}
}
ClearMemSecret2( (int32_t)30,  (int32_t)128, tmp1);
ScaleDown2( (int32_t)30,  (int32_t)128, tmp41,  (int32_t)12);

uint64_t* tmp43 = make_array<uint64_t>( (int32_t)30,  (int32_t)128);

uint64_t* tmp44 = make_array<uint64_t>( (int32_t)3840);

uint64_t* tmp45 = make_array<uint64_t>( (int32_t)3840);

uint64_t* tmp46 = make_array<uint64_t>( (int32_t)3840);
...
Arr1DIdxRowM(tmp44, (int32_t)3840,tmp47) = Arr2DIdxRowM(tmp41, (int32_t)30, (int32_t)128,i5,i6);
Arr1DIdxRowM(tmp45, (int32_t)3840,tmp47) = Arr2DIdxRowM(tmp8, (int32_t)30, (int32_t)128,i5,i6);
}
}
ElemWiseActModelVectorMult( (int32_t)3840, tmp44, tmp45, tmp46);
ClearMemSecret1( (int32_t)3840, tmp44);
ClearMemSecret1( (int32_t)3840, tmp45);
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)30; i5++){
for (uint32_t i6 =  (int32_t)0; i6 <  (int32_t)128; i6++){
tmp47 = (( (int32_t)0 + (i5 *  (int32_t)128)) + (i6 *  (int32_t)1));
Arr2DIdxRowM(tmp43, (int32_t)30, (int32_t)128,i5,i6) = Arr1DIdxRowM(tmp46, (int32_t)3840,tmp47);
}
}
ClearMemSecret1( (int32_t)3840, tmp46);
ClearMemSecret2( (int32_t)30,  (int32_t)128, tmp8);
...
tmp51 = SecretAdd(tmp51, Arr2DIdxRowM(tmp43, (int32_t)30, (int32_t)128,i8,i7));
}
...
uint64_t* tmp76 = make_array<uint64_t>( (int32_t)30,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)30; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp76, (int32_t)30, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp2, (int32_t)30, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp23, (int32_t)30, (int32_t)128,i0,i1));
}
}
ClearMemSecret2( (int32_t)30,  (int32_t)128, tmp2);
ScaleDown2( (int32_t)30,  (int32_t)128, tmp76,  (int32_t)12);

uint64_t* tmp78 = make_array<uint64_t>( (int32_t)30,  (int32_t)128);

uint64_t* tmp79 = make_array<uint64_t>( (int32_t)3840);

uint64_t* tmp80 = make_array<uint64_t>( (int32_t)3840);

uint64_t* tmp81 = make_array<uint64_t>( (int32_t)3840);
...
Arr1DIdxRowM(tmp79, (int32_t)3840,tmp82) = Arr2DIdxRowM(tmp76, (int32_t)30, (int32_t)128,i12,i13);
Arr1DIdxRowM(tmp80, (int32_t)3840,tmp82) = Arr2DIdxRowM(tmp13, (int32_t)30, (int32_t)128,i12,i13);
}
}
ElemWiseActModelVectorMult( (int32_t)3840, tmp79, tmp80, tmp81);
ClearMemSecret1( (int32_t)3840, tmp79);
ClearMemSecret1( (int32_t)3840, tmp80);
for (uint32_t i12 =  (int32_t)0; i12 <  (int32_t)30; i12++){
for (uint32_t i13 =  (int32_t)0; i13 <  (int32_t)128; i13++){
tmp82 = (( (int32_t)0 + (i12 *  (int32_t)128)) + (i13 *  (int32_t)1));
Arr2DIdxRowM(tmp78, (int32_t)30, (int32_t)128,i12,i13) = Arr1DIdxRowM(tmp81, (int32_t)3840,tmp82);
}
}
ClearMemSecret1( (int32_t)3840, tmp81);
ClearMemSecret2( (int32_t)30,  (int32_t)128, tmp76);
ClearMemSecret2( (int32_t)30,  (int32_t)128, tmp13);
...
tmp86 = SecretAdd(tmp86, Arr2DIdxRowM(tmp78, (int32_t)30, (int32_t)128,i15,i14));
}
Arr1DIdxRowM(tmp87, (int32_t)128,i14) = tmp86;
}
ClearMemSecret2( (int32_t)30,  (int32_t)128, tmp78);
...
uint64_t* tmp111 = make_array<uint64_t>( (int32_t)30,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)30; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp111, (int32_t)30, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp3, (int32_t)30, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp23, (int32_t)30, (int32_t)128,i0,i1));
}
}
ClearMemSecret2( (int32_t)30,  (int32_t)128, tmp23);
ClearMemSecret2( (int32_t)30,  (int32_t)128, tmp3);
ScaleDown2( (int32_t)30,  (int32_t)128, tmp111,  (int32_t)12);

uint64_t* tmp114 = make_array<uint64_t>( (int32_t)30,  (int32_t)128);

uint64_t* tmp115 = make_array<uint64_t>( (int32_t)3840);

uint64_t* tmp116 = make_array<uint64_t>( (int32_t)3840);

uint64_t* tmp117 = make_array<uint64_t>( (int32_t)3840);
...
Arr1DIdxRowM(tmp115, (int32_t)3840,tmp118) = Arr2DIdxRowM(tmp111, (int32_t)30, (int32_t)128,i19,i20);
Arr1DIdxRowM(tmp116, (int32_t)3840,tmp118) = Arr2DIdxRowM(tmp18, (int32_t)30, (int32_t)128,i19,i20);
}
}
ElemWiseActModelVectorMult( (int32_t)3840, tmp115, tmp116, tmp117);
ClearMemSecret1( (int32_t)3840, tmp115);
ClearMemSecret1( (int32_t)3840, tmp116);
for (uint32_t i19 =  (int32_t)0; i19 <  (int32_t)30; i19++){
for (uint32_t i20 =  (int32_t)0; i20 <  (int32_t)128; i20++){
tmp118 = (( (int32_t)0 + (i19 *  (int32_t)128)) + (i20 *  (int32_t)1));
Arr2DIdxRowM(tmp114, (int32_t)30, (int32_t)128,i19,i20) = Arr1DIdxRowM(tmp117, (int32_t)3840,tmp118);
}
}
ClearMemSecret1( (int32_t)3840, tmp117);
ClearMemSecret2( (int32_t)30,  (int32_t)128, tmp18);
ClearMemSecret2( (int32_t)30,  (int32_t)128, tmp111);
...
tmp122 = SecretAdd(tmp122, Arr2DIdxRowM(tmp114, (int32_t)30, (int32_t)128,i22,i21));
}
Arr1DIdxRowM(tmp123, (int32_t)128,i21) = tmp122;
}
ClearMemSecret2( (int32_t)30,  (int32_t)128, tmp114);
