...
uint64_t* tmp2 = make_array<uint64_t>( (int32_t)20,  (int32_t)128);
...
Arr2DIdxRowM(tmp2, (int32_t)20, (int32_t)128,i0,i1) = (party == SERVER) ? __tmp_in_tmp2 : 0;
}
}
...
uint64_t* tmp4 = make_array<uint64_t>( (int32_t)20,  (int32_t)1);
/* Variable to read the clear value corresponding to the input variable tmp4 at (9039,1-9039,37) */
...
Arr2DIdxRowM(tmp4, (int32_t)20, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp4 : 0;
}
}

uint64_t* tmp5 = make_array<uint64_t>( (int32_t)20,  (int32_t)1);
...
Arr2DIdxRowM(tmp5, (int32_t)20, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp5 : 0;
}
}
StartComputation();

uint64_t* tmp6 = make_array<uint64_t>( (int32_t)20,  (int32_t)128);
...
Arr1DIdxRowM(tmp7, (int32_t)2560,tmp10) = Arr2DIdxRowM(tmp2, (int32_t)20, (int32_t)128,i0,i1);
Arr1DIdxRowM(tmp8, (int32_t)2560,tmp10) = Arr2DIdxRowM(tmp1, (int32_t)1, (int32_t)128, (int32_t)0,i1);
}
}
...
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
tmp10 = (( (int32_t)0 + (i0 *  (int32_t)128)) + (i1 *  (int32_t)1));
Arr2DIdxRowM(tmp6, (int32_t)20, (int32_t)128,i0,i1) = Arr1DIdxRowM(tmp9, (int32_t)2560,tmp10);
}
}
ClearMemSecret1( (int32_t)2560, tmp9);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp1);
ClearMemSecret2( (int32_t)20,  (int32_t)128, tmp2);
ScaleUp2( (int32_t)20,  (int32_t)128, tmp0,  (int32_t)12);

uint64_t* tmp13 = make_array<uint64_t>( (int32_t)20,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)20; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp13, (int32_t)20, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp0, (int32_t)20, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp6, (int32_t)20, (int32_t)128,i0,i1));
}
}
ClearMemSecret2( (int32_t)20,  (int32_t)128, tmp0);
ClearMemSecret2( (int32_t)20,  (int32_t)128, tmp6);

uint64_t* tmp16 = make_array<uint64_t>( (int32_t)20,  (int32_t)1);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)20; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)1; i1++){
Arr2DIdxRowM(tmp16, (int32_t)20, (int32_t)1,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp4, (int32_t)20, (int32_t)1,i0,i1), Arr2DIdxRowM(tmp5, (int32_t)20, (int32_t)1,i0,i1));
}
}
ClearMemSecret2( (int32_t)20,  (int32_t)1, tmp4);
ClearMemSecret2( (int32_t)20,  (int32_t)1, tmp5);

uint64_t* tmp19 = make_array<uint64_t>( (int32_t)20,  (int32_t)1);
Relu2( (int32_t)20,  (int32_t)1, tmp16, tmp19,  (int32_t)0, 0);
ClearMemSecret2( (int32_t)20,  (int32_t)1, tmp16);

int32_t* tmp21 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp21, (int32_t)2, (int64_t)0) =  (int32_t)0;
Arr1DIdxRowM(tmp21, (int32_t)2, (int64_t)1) =  (int32_t)1;

uint64_t tmp22;

uint64_t* tmp23 = make_array<uint64_t>( (int32_t)1);
tmp22 = funcSSCons( (int64_t)0);
for (uint32_t i2 =  (int32_t)0; i2 <  (int32_t)20; i2++){
for (uint32_t i3 =  (int32_t)0; i3 <  (int32_t)1; i3++){
tmp22 = SecretAdd(tmp22, Arr2DIdxRowM(tmp19, (int32_t)20, (int32_t)1,i2,i3));
}
}
Arr1DIdxRowM(tmp23, (int32_t)1, (int32_t)0) = tmp22;
ScaleDown2( (int32_t)20,  (int32_t)128, tmp13,  (int32_t)12);

uint64_t* tmp24 = make_array<uint64_t>( (int32_t)20,  (int32_t)128);
...
tmp28 = (( (int32_t)0 + (i4 *  (int32_t)128)) + (i5 *  (int32_t)1));
Arr1DIdxRowM(tmp25, (int32_t)2560,tmp28) = Arr2DIdxRowM(tmp13, (int32_t)20, (int32_t)128,i4,i5);
Arr1DIdxRowM(tmp26, (int32_t)2560,tmp28) = Arr2DIdxRowM(tmp19, (int32_t)20, (int32_t)1,i4, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)2560, tmp25, tmp26, tmp27);
ClearMemSecret1( (int32_t)2560, tmp25);
ClearMemSecret1( (int32_t)2560, tmp26);
for (uint32_t i4 =  (int32_t)0; i4 <  (int32_t)20; i4++){
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)128; i5++){
tmp28 = (( (int32_t)0 + (i4 *  (int32_t)128)) + (i5 *  (int32_t)1));
Arr2DIdxRowM(tmp24, (int32_t)20, (int32_t)128,i4,i5) = Arr1DIdxRowM(tmp27, (int32_t)2560,tmp28);
}
}
ClearMemSecret1( (int32_t)2560, tmp27);
ClearMemSecret2( (int32_t)20,  (int32_t)128, tmp13);
ClearMemSecret2( (int32_t)20,  (int32_t)1, tmp19);
...
tmp32 = SecretAdd(tmp32, Arr2DIdxRowM(tmp24, (int32_t)20, (int32_t)128,i7,i6));
}
Arr1DIdxRowM(tmp33, (int32_t)128,i6) = tmp32;
}
ClearMemSecret2( (int32_t)20,  (int32_t)128, tmp24);
ScaleUp1( (int32_t)128, tmp3,  (int32_t)12);

uint64_t* tmp35 = make_array<uint64_t>( (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)128; i0++){
Arr1DIdxRowM(tmp35, (int32_t)128,i0) = SecretAdd(Arr1DIdxRowM(tmp33, (int32_t)128,i0), Arr1DIdxRowM(tmp3, (int32_t)128,i0));
}
ClearMemSecret1( (int32_t)128, tmp3);
ClearMemSecret1( (int32_t)128, tmp33);
ScaleDown1( (int32_t)128, tmp35,  (int32_t)12);
EndComputation();
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)128; i0++){
cout << (funcReconstruct2PCCons(Arr1DIdxRowM(tmp35, (int32_t)128,i0), 2)) << endl;
}
}
