...
uint64_t* tmp9 = make_array<uint64_t>( (int32_t)50,  (int32_t)1);
/* Variable to read the clear value corresponding to the input variable tmp9 at (9054,1-9054,37) */
...
Arr2DIdxRowM(tmp9, (int32_t)50, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp9 : 0;
}
}
...
uint64_t* tmp14 = make_array<uint64_t>( (int32_t)50,  (int32_t)1);
/* Variable to read the clear value corresponding to the input variable tmp14 at (9069,1-9069,38) */
...
Arr2DIdxRowM(tmp14, (int32_t)50, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp14 : 0;
}
}
...
uint64_t* tmp19 = make_array<uint64_t>( (int32_t)50,  (int32_t)1);
/* Variable to read the clear value corresponding to the input variable tmp19 at (9084,1-9084,38) */
...
Arr2DIdxRowM(tmp19, (int32_t)50, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp19 : 0;
}
}
...
uint64_t* tmp24 = make_array<uint64_t>( (int32_t)50,  (int32_t)1);
/* Variable to read the clear value corresponding to the input variable tmp24 at (9099,1-9099,38) */
...
Arr2DIdxRowM(tmp24, (int32_t)50, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp24 : 0;
}
}
...
Arr1DIdxRowM(tmp51, (int32_t)25600,tmp53) = Arr2DIdxRowM(tmp9, (int32_t)50, (int32_t)1,i5, (int32_t)0);
}
}
...
ClearMemSecret2( (int32_t)50,  (int32_t)1, tmp9);
...
Arr1DIdxRowM(tmp86, (int32_t)25600,tmp88) = Arr2DIdxRowM(tmp14, (int32_t)50, (int32_t)1,i12, (int32_t)0);
}
}
...
ClearMemSecret2( (int32_t)50,  (int32_t)1, tmp14);
...
Arr1DIdxRowM(tmp121, (int32_t)25600,tmp123) = Arr2DIdxRowM(tmp19, (int32_t)50, (int32_t)1,i19, (int32_t)0);
}
}
...
ClearMemSecret2( (int32_t)50,  (int32_t)1, tmp19);
...
Arr1DIdxRowM(tmp157, (int32_t)25600,tmp159) = Arr2DIdxRowM(tmp24, (int32_t)50, (int32_t)1,i26, (int32_t)0);
}
}
...
ClearMemSecret2( (int32_t)50,  (int32_t)1, tmp24);
