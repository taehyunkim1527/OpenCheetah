...
tmp5 = SecretAdd(tmp5, Arr2DIdxRowM(tmp0, (int32_t)50, (int32_t)256,i1,i0));
}
Arr1DIdxRowM(tmp6, (int32_t)256,i0) = tmp5;
}
...
tmp9 = SecretAdd(tmp9, Arr2DIdxRowM(tmp1, (int32_t)50, (int32_t)256,i3,i2));
}
Arr1DIdxRowM(tmp10, (int32_t)256,i2) = tmp9;
}
...
tmp13 = SecretAdd(tmp13, Arr2DIdxRowM(tmp2, (int32_t)50, (int32_t)256,i5,i4));
}
Arr1DIdxRowM(tmp14, (int32_t)256,i4) = tmp13;
}
...
tmp17 = SecretAdd(tmp17, Arr2DIdxRowM(tmp3, (int32_t)50, (int32_t)256,i7,i6));
}
Arr1DIdxRowM(tmp18, (int32_t)256,i6) = tmp17;
}
ClearMemSecret2( (int32_t)50,  (int32_t)256, tmp3);
EndComputation();
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)256; i0++){
cout << (funcReconstruct2PCCons(Arr1DIdxRowM(tmp18, (int32_t)256,i0), 2)) << endl;
}
}
