...
uint64_t* tmp10 = make_array<uint64_t>( (int32_t)1,  (int32_t)1);
...
Arr2DIdxRowM(tmp10, (int32_t)1, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp10 : 0;
}
}
...
int32_t tmp33 =  (int32_t)0;

uint64_t tmp34;

uint64_t* tmp35 = make_array<uint64_t>( (int32_t)512);
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)512; i5++){
tmp34 = funcSSCons( (int64_t)0);
for (uint32_t i6 =  (int32_t)0; i6 <  (int32_t)50; i6++){
tmp34 = SecretAdd(tmp34, Arr2DIdxRowM(tmp31, (int32_t)50, (int32_t)512,i6,i5));
}
Arr1DIdxRowM(tmp35, (int32_t)512,i5) = tmp34;
}
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp31);

int32_t* tmp37 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp37, (int32_t)2, (int64_t)0) =  (int32_t)-1;
Arr1DIdxRowM(tmp37, (int32_t)2, (int64_t)1) =  (int32_t)512;
...
Arr2DIdxRowM(tmp38, (int32_t)1, (int32_t)512,i8,i9) = Arr1DIdxRowM(tmp35, (int32_t)512,i7);
i7 = (i7 +  (int64_t)1);
}
}
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp40, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp38, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp29, (int32_t)1, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp38);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp29);
ScaleDown2( (int32_t)1,  (int32_t)512, tmp40,  (int32_t)12);
...
tmp47 = (( (int32_t)0 + (i10 *  (int32_t)512)) + (i11 *  (int32_t)1));
Arr1DIdxRowM(tmp44, (int32_t)512,tmp47) = Arr2DIdxRowM(tmp40, (int32_t)1, (int32_t)512,i10,i11);
Arr1DIdxRowM(tmp45, (int32_t)512,tmp47) = Arr2DIdxRowM(tmp7, (int32_t)1, (int32_t)1,i10, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)512, tmp44, tmp45, tmp46);
ClearMemSecret1( (int32_t)512, tmp44);
ClearMemSecret1( (int32_t)512, tmp45);
for (uint32_t i10 =  (int32_t)0; i10 <  (int32_t)1; i10++){
for (uint32_t i11 =  (int32_t)0; i11 <  (int32_t)512; i11++){
tmp47 = (( (int32_t)0 + (i10 *  (int32_t)512)) + (i11 *  (int32_t)1));
Arr2DIdxRowM(tmp43, (int32_t)1, (int32_t)512,i10,i11) = Arr1DIdxRowM(tmp46, (int32_t)512,tmp47);
}
}
...
ScaleDown2( (int32_t)1,  (int32_t)512, tmp43,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp43, tmp8, tmp50, 0);
...
uint64_t* tmp63 = make_array<uint64_t>( (int32_t)512);
for (uint32_t i12 =  (int32_t)0; i12 <  (int32_t)512; i12++){
tmp62 = funcSSCons( (int64_t)0);
for (uint32_t i13 =  (int32_t)0; i13 <  (int32_t)50; i13++){
tmp62 = SecretAdd(tmp62, Arr2DIdxRowM(tmp58, (int32_t)50, (int32_t)512,i13,i12));
}
Arr1DIdxRowM(tmp63, (int32_t)512,i12) = tmp62;
}
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp58);

int32_t* tmp65 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp65, (int32_t)2, (int64_t)0) =  (int32_t)-1;
Arr1DIdxRowM(tmp65, (int32_t)2, (int64_t)1) =  (int32_t)512;
...
Arr2DIdxRowM(tmp66, (int32_t)1, (int32_t)512,i15,i16) = Arr1DIdxRowM(tmp63, (int32_t)512,i14);
i14 = (i14 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)512, tmp63);
ScaleUp2( (int32_t)1,  (int32_t)512, tmp56,  (int32_t)12);

uint64_t* tmp68 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp68, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp66, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp56, (int32_t)1, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp66);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp56);
ScaleDown2( (int32_t)1,  (int32_t)512, tmp68,  (int32_t)12);

uint64_t* tmp71 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);

uint64_t* tmp72 = make_array<uint64_t>( (int32_t)512);

uint64_t* tmp73 = make_array<uint64_t>( (int32_t)512);

uint64_t* tmp74 = make_array<uint64_t>( (int32_t)512);

int32_t tmp75;
for (uint32_t i17 =  (int32_t)0; i17 <  (int32_t)1; i17++){
for (uint32_t i18 =  (int32_t)0; i18 <  (int32_t)512; i18++){
tmp75 = (( (int32_t)0 + (i17 *  (int32_t)512)) + (i18 *  (int32_t)1));
Arr1DIdxRowM(tmp72, (int32_t)512,tmp75) = Arr2DIdxRowM(tmp68, (int32_t)1, (int32_t)512,i17,i18);
Arr1DIdxRowM(tmp73, (int32_t)512,tmp75) = Arr2DIdxRowM(tmp10, (int32_t)1, (int32_t)1,i17, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)512, tmp72, tmp73, tmp74);
ClearMemSecret1( (int32_t)512, tmp72);
ClearMemSecret1( (int32_t)512, tmp73);
for (uint32_t i17 =  (int32_t)0; i17 <  (int32_t)1; i17++){
for (uint32_t i18 =  (int32_t)0; i18 <  (int32_t)512; i18++){
tmp75 = (( (int32_t)0 + (i17 *  (int32_t)512)) + (i18 *  (int32_t)1));
Arr2DIdxRowM(tmp71, (int32_t)1, (int32_t)512,i17,i18) = Arr1DIdxRowM(tmp74, (int32_t)512,tmp75);
}
}
ClearMemSecret1( (int32_t)512, tmp74);
ClearMemSecret2( (int32_t)1,  (int32_t)1, tmp10);
...
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp71, tmp11, tmp78, 0);
