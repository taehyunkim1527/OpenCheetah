...
uint64_t* tmp15 = make_array<uint64_t>( (int32_t)2560);
...
Arr1DIdxRowM(tmp15, (int32_t)2560,tmp18) = Arr2DIdxRowM(tmp5, (int32_t)5, (int32_t)512,i0,i1);
Arr1DIdxRowM(tmp16, (int32_t)2560,tmp18) = Arr2DIdxRowM(tmp4, (int32_t)1, (int32_t)512, (int32_t)0,i1);
}
}
ElemWiseActModelVectorMult( (int32_t)2560, tmp15, tmp16, tmp17);
ClearMemSecret1( (int32_t)2560, tmp15);
ClearMemSecret1( (int32_t)2560, tmp16);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)5; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
tmp18 = (( (int32_t)0 + (i0 *  (int32_t)512)) + (i1 *  (int32_t)1));
Arr2DIdxRowM(tmp14, (int32_t)5, (int32_t)512,i0,i1) = Arr1DIdxRowM(tmp17, (int32_t)2560,tmp18);
}
}
...
uint64_t* tmp32 = make_array<uint64_t>( (int32_t)5,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)5; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp32, (int32_t)5, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp1, (int32_t)5, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp14, (int32_t)5, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)5,  (int32_t)512, tmp1);

int32_t tmp34 =  (int32_t)0;

uint64_t tmp35;

uint64_t* tmp36 = make_array<uint64_t>( (int32_t)512);
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)512; i5++){
tmp35 = funcSSCons( (int64_t)0);
for (uint32_t i6 =  (int32_t)0; i6 <  (int32_t)5; i6++){
tmp35 = SecretAdd(tmp35, Arr2DIdxRowM(tmp32, (int32_t)5, (int32_t)512,i6,i5));
}
Arr1DIdxRowM(tmp36, (int32_t)512,i5) = tmp35;
}
ClearMemSecret2( (int32_t)5,  (int32_t)512, tmp32);

int32_t* tmp38 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp38, (int32_t)2, (int64_t)0) =  (int32_t)-1;
Arr1DIdxRowM(tmp38, (int32_t)2, (int64_t)1) =  (int32_t)512;
...
Arr2DIdxRowM(tmp39, (int32_t)1, (int32_t)512,i8,i9) = Arr1DIdxRowM(tmp36, (int32_t)512,i7);
i7 = (i7 +  (int64_t)1);
}
}
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp41, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp39, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp30, (int32_t)1, (int32_t)512,i0,i1));
}
}
...
ScaleDown2( (int32_t)1,  (int32_t)512, tmp41,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp41, tmp8, tmp44, 0);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp47, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp44, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp9, (int32_t)1, (int32_t)512,i0,i1));
}
}
...
Relu2( (int32_t)1,  (int32_t)512, tmp47, tmp50,  (int32_t)12, 1);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)5; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp52, (int32_t)5, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp2, (int32_t)5, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp14, (int32_t)5, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)5,  (int32_t)512, tmp2);

int32_t tmp54 =  (int32_t)0;

uint64_t tmp55;

uint64_t* tmp56 = make_array<uint64_t>( (int32_t)512);
for (uint32_t i10 =  (int32_t)0; i10 <  (int32_t)512; i10++){
tmp55 = funcSSCons( (int64_t)0);
for (uint32_t i11 =  (int32_t)0; i11 <  (int32_t)5; i11++){
tmp55 = SecretAdd(tmp55, Arr2DIdxRowM(tmp52, (int32_t)5, (int32_t)512,i11,i10));
}
Arr1DIdxRowM(tmp56, (int32_t)512,i10) = tmp55;
}
...
Arr2DIdxRowM(tmp59, (int32_t)1, (int32_t)512,i13,i14) = Arr1DIdxRowM(tmp56, (int32_t)512,i12);
i12 = (i12 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)512, tmp56);
ScaleUp2( (int32_t)1,  (int32_t)512, tmp50,  (int32_t)12);

uint64_t* tmp61 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp61, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp59, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp50, (int32_t)1, (int32_t)512,i0,i1));
}
}
...
ScaleDown2( (int32_t)1,  (int32_t)512, tmp61,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp61, tmp10, tmp64, 0);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp67, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp64, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp11, (int32_t)1, (int32_t)512,i0,i1));
}
}
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)5; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp72, (int32_t)5, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp3, (int32_t)5, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp14, (int32_t)5, (int32_t)512,i0,i1));
}
}
...
tmp76 = SecretAdd(tmp76, Arr2DIdxRowM(tmp72, (int32_t)5, (int32_t)512,i16,i15));
}
Arr1DIdxRowM(tmp77, (int32_t)512,i15) = tmp76;
}
...
Arr2DIdxRowM(tmp80, (int32_t)1, (int32_t)512,i18,i19) = Arr1DIdxRowM(tmp77, (int32_t)512,i17);
i17 = (i17 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)512, tmp77);
ScaleUp2( (int32_t)1,  (int32_t)512, tmp70,  (int32_t)12);

uint64_t* tmp82 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp82, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp80, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp70, (int32_t)1, (int32_t)512,i0,i1));
}
}
...
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp82, tmp12, tmp85, 0);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp88, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp85, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp13, (int32_t)1, (int32_t)512,i0,i1));
}
}
...
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (uint32_t)0; i1 <  (int32_t)512; i1++){
cout << (funcReconstruct2PCCons(Arr2DIdxRowM(tmp91, (int32_t)1, (int32_t)512,i0,i1), 2)) << endl;
}
}
}
