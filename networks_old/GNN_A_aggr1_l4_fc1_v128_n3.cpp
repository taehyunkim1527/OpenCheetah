...
Arr1DIdxRowM(tmp18, (int32_t)384,tmp21) = Arr2DIdxRowM(tmp6, (int32_t)3, (int32_t)128,i0,i1);
Arr1DIdxRowM(tmp19, (int32_t)384,tmp21) = Arr2DIdxRowM(tmp5, (int32_t)1, (int32_t)128, (int32_t)0,i1);
}
}
...
tmp38 = SecretAdd(tmp38, Arr2DIdxRowM(tmp35, (int32_t)3, (int32_t)128,i6,i5));
}
...
uint64_t* tmp55 = make_array<uint64_t>( (int32_t)3,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)3; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp55, (int32_t)3, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp2, (int32_t)3, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp17, (int32_t)3, (int32_t)128,i0,i1));
}
}
...
tmp58 = SecretAdd(tmp58, Arr2DIdxRowM(tmp55, (int32_t)3, (int32_t)128,i11,i10));
}
Arr1DIdxRowM(tmp59, (int32_t)128,i10) = tmp58;
}
ClearMemSecret2( (int32_t)3,  (int32_t)128, tmp55);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)3; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp75, (int32_t)3, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp3, (int32_t)3, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp17, (int32_t)3, (int32_t)128,i0,i1));
}
}
...
tmp78 = SecretAdd(tmp78, Arr2DIdxRowM(tmp75, (int32_t)3, (int32_t)128,i16,i15));
}
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)3; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp95, (int32_t)3, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp4, (int32_t)3, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp17, (int32_t)3, (int32_t)128,i0,i1));
}
}
...
tmp99 = SecretAdd(tmp99, Arr2DIdxRowM(tmp95, (int32_t)3, (int32_t)128,i21,i20));
}
