...
uint64_t* tmp0 = make_array<uint64_t>( (int32_t)200,  (int32_t)512);
...
Arr2DIdxRowM(tmp0, (int32_t)200, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp0 : 0;
}
}
...
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)200; i1++){
tmp4 = SecretAdd(tmp4, Arr2DIdxRowM(tmp0, (int32_t)200, (int32_t)512,i1,i0));
}
Arr1DIdxRowM(tmp5, (int32_t)512,i0) = tmp4;
}
ClearMemSecret2( (int32_t)200,  (int32_t)512, tmp0);
...
tmp8 = SecretAdd(tmp8, Arr2DIdxRowM(tmp1, (int32_t)200, (int32_t)512,i3,i2));
}
...
tmp12 = SecretAdd(tmp12, Arr2DIdxRowM(tmp2, (int32_t)200, (int32_t)512,i5,i4));
}
