...
uint64_t* tmp1 = make_array<uint64_t>( (int32_t)256);
...
Arr1DIdxRowM(tmp1, (int32_t)256,i0) = (party == SERVER) ? __tmp_in_tmp1 : 0;
}
...
tmp6 = SecretAdd(tmp6, Arr2DIdxRowM(tmp2, (int32_t)50, (int32_t)256,i1,i0));
}
Arr1DIdxRowM(tmp7, (int32_t)256,i0) = tmp6;
}
...
Arr1DIdxRowM(tmp10, (int32_t)256,tmp13) = Arr1DIdxRowM(tmp7, (int32_t)256,i2);
Arr1DIdxRowM(tmp11, (int32_t)256,tmp13) = Arr1DIdxRowM(tmp1, (int32_t)256,i2);
}
ElemWiseActModelVectorMult( (int32_t)256, tmp10, tmp11, tmp12);
ClearMemSecret1( (int32_t)256, tmp10);
ClearMemSecret1( (int32_t)256, tmp11);
for (uint32_t i2 =  (int32_t)0; i2 <  (int32_t)256; i2++){
tmp13 = ( (int32_t)0 + (i2 *  (int32_t)1));
Arr1DIdxRowM(tmp9, (int32_t)256,i2) = Arr1DIdxRowM(tmp12, (int32_t)256,tmp13);
}
ClearMemSecret1( (int32_t)256, tmp12);
ClearMemSecret1( (int32_t)256, tmp7);
ClearMemSecret1( (int32_t)256, tmp1);
...
tmp17 = SecretAdd(tmp17, Arr2DIdxRowM(tmp0, (int32_t)50, (int32_t)256,i4,i3));
}
Arr1DIdxRowM(tmp18, (int32_t)256,i3) = tmp17;
}
ClearMemSecret2( (int32_t)50,  (int32_t)256, tmp0);
ScaleUp1( (int32_t)256, tmp18,  (int32_t)12);

uint64_t* tmp20 = make_array<uint64_t>( (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)256; i0++){
Arr1DIdxRowM(tmp20, (int32_t)256,i0) = SecretAdd(Arr1DIdxRowM(tmp18, (int32_t)256,i0), Arr1DIdxRowM(tmp9, (int32_t)256,i0));
}
ClearMemSecret1( (int32_t)256, tmp9);
ClearMemSecret1( (int32_t)256, tmp18);
ScaleDown1( (int32_t)256, tmp20,  (int32_t)12);
...
Arr1DIdxRowM(tmp24, (int32_t)256,tmp27) = Arr1DIdxRowM(tmp20, (int32_t)256,i5);
Arr1DIdxRowM(tmp25, (int32_t)256,tmp27) = Arr1DIdxRowM(tmp4, (int32_t)1, (int32_t)0);
}
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)256; i0++){
Arr1DIdxRowM(tmp30, (int32_t)256,i0) = SecretAdd(Arr1DIdxRowM(tmp23, (int32_t)256,i0), Arr1DIdxRowM(tmp3, (int32_t)256,i0));
}
ClearMemSecret1( (int32_t)256, tmp23);
ClearMemSecret1( (int32_t)256, tmp3);
ScaleDown1( (int32_t)256, tmp30,  (int32_t)12);
EndComputation();
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)256; i0++){
cout << (funcReconstruct2PCCons(Arr1DIdxRowM(tmp30, (int32_t)256,i0), 2)) << endl;
}
}
