...
Arr1DIdxRowM(tmp8, (int32_t)25600,tmp11) = Arr2DIdxRowM(tmp3, (int32_t)50, (int32_t)512,i0,i1);
Arr1DIdxRowM(tmp9, (int32_t)25600,tmp11) = Arr2DIdxRowM(tmp2, (int32_t)1, (int32_t)512, (int32_t)0,i1);
}
}
...
ScaleDown2( (int32_t)50,  (int32_t)512, tmp14,  (int32_t)12);
...
tmp20 = (( (int32_t)0 + (i2 *  (int32_t)512)) + (i3 *  (int32_t)1));
Arr1DIdxRowM(tmp17, (int32_t)25600,tmp20) = Arr2DIdxRowM(tmp14, (int32_t)50, (int32_t)512,i2,i3);
Arr1DIdxRowM(tmp18, (int32_t)25600,tmp20) = Arr2DIdxRowM(tmp5, (int32_t)50, (int32_t)1,i2, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)25600, tmp17, tmp18, tmp19);
ClearMemSecret1( (int32_t)25600, tmp17);
ClearMemSecret1( (int32_t)25600, tmp18);
for (uint32_t i2 =  (int32_t)0; i2 <  (int32_t)50; i2++){
for (uint32_t i3 =  (int32_t)0; i3 <  (int32_t)512; i3++){
tmp20 = (( (int32_t)0 + (i2 *  (int32_t)512)) + (i3 *  (int32_t)1));
Arr2DIdxRowM(tmp16, (int32_t)50, (int32_t)512,i2,i3) = Arr1DIdxRowM(tmp19, (int32_t)25600,tmp20);
}
}
...
tmp24 = SecretAdd(tmp24, Arr2DIdxRowM(tmp16, (int32_t)50, (int32_t)512,i5,i4));
}
Arr1DIdxRowM(tmp25, (int32_t)512,i4) = tmp24;
}
...
Arr1DIdxRowM(tmp27, (int32_t)512,i0) = SecretAdd(Arr1DIdxRowM(tmp25, (int32_t)512,i0), Arr1DIdxRowM(tmp4, (int32_t)512,i0));
}
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp29, (int32_t)50, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp1, (int32_t)50, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp7, (int32_t)50, (int32_t)512,i0,i1));
}
}
...
tmp36 = (( (int32_t)0 + (i6 *  (int32_t)512)) + (i7 *  (int32_t)1));
Arr1DIdxRowM(tmp33, (int32_t)25600,tmp36) = Arr2DIdxRowM(tmp29, (int32_t)50, (int32_t)512,i6,i7);
Arr1DIdxRowM(tmp34, (int32_t)25600,tmp36) = Arr2DIdxRowM(tmp6, (int32_t)50, (int32_t)1,i6, (int32_t)0);
}
}
...
for (uint32_t i7 =  (int32_t)0; i7 <  (int32_t)512; i7++){
tmp36 = (( (int32_t)0 + (i6 *  (int32_t)512)) + (i7 *  (int32_t)1));
Arr2DIdxRowM(tmp32, (int32_t)50, (int32_t)512,i6,i7) = Arr1DIdxRowM(tmp35, (int32_t)25600,tmp36);
}
}
...
tmp40 = SecretAdd(tmp40, Arr2DIdxRowM(tmp32, (int32_t)50, (int32_t)512,i9,i8));
}
Arr1DIdxRowM(tmp41, (int32_t)512,i8) = tmp40;
}
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp32);

uint64_t* tmp43 = make_array<uint64_t>( (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)512; i0++){
Arr1DIdxRowM(tmp43, (int32_t)512,i0) = SecretAdd(Arr1DIdxRowM(tmp41, (int32_t)512,i0), Arr1DIdxRowM(tmp4, (int32_t)512,i0));
}
ClearMemSecret1( (int32_t)512, tmp41);
ClearMemSecret1( (int32_t)512, tmp4);
ScaleDown1( (int32_t)512, tmp43,  (int32_t)12);
EndComputation();
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)512; i0++){
cout << (funcReconstruct2PCCons(Arr1DIdxRowM(tmp43, (int32_t)512,i0), 2)) << endl;
}
}
