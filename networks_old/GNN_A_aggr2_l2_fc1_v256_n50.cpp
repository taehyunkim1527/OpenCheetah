...
tmp34 = SecretAdd(tmp34, Arr2DIdxRowM(tmp31, (int32_t)50, (int32_t)256,i6,i5));
}
Arr1DIdxRowM(tmp35, (int32_t)256,i5) = tmp34;
}
...
Arr1DIdxRowM(tmp37, (int32_t)2, (int64_t)1) =  (int32_t)256;
...
Arr2DIdxRowM(tmp38, (int32_t)1, (int32_t)256,i8,i9) = Arr1DIdxRowM(tmp35, (int32_t)256,i7);
i7 = (i7 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)256, tmp35);
ScaleUp2( (int32_t)1,  (int32_t)256, tmp29,  (int32_t)12);

uint64_t* tmp40 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp40, (int32_t)1, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp38, (int32_t)1, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp29, (int32_t)1, (int32_t)256,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp38);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp29);
ScaleDown2( (int32_t)1,  (int32_t)256, tmp40,  (int32_t)12);
...
tmp47 = (( (int32_t)0 + (i10 *  (int32_t)256)) + (i11 *  (int32_t)1));
Arr1DIdxRowM(tmp44, (int32_t)256,tmp47) = Arr2DIdxRowM(tmp40, (int32_t)1, (int32_t)256,i10,i11);
Arr1DIdxRowM(tmp45, (int32_t)256,tmp47) = Arr2DIdxRowM(tmp7, (int32_t)1, (int32_t)1,i10, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)256, tmp44, tmp45, tmp46);
ClearMemSecret1( (int32_t)256, tmp44);
ClearMemSecret1( (int32_t)256, tmp45);
for (uint32_t i10 =  (int32_t)0; i10 <  (int32_t)1; i10++){
for (uint32_t i11 =  (int32_t)0; i11 <  (int32_t)256; i11++){
tmp47 = (( (int32_t)0 + (i10 *  (int32_t)256)) + (i11 *  (int32_t)1));
Arr2DIdxRowM(tmp43, (int32_t)1, (int32_t)256,i10,i11) = Arr1DIdxRowM(tmp46, (int32_t)256,tmp47);
}
}
...
ScaleDown2( (int32_t)1,  (int32_t)256, tmp43,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)256,  (int32_t)256, tmp43, tmp8, tmp50, 0);
...
tmp62 = SecretAdd(tmp62, Arr2DIdxRowM(tmp58, (int32_t)50, (int32_t)256,i13,i12));
}
Arr1DIdxRowM(tmp63, (int32_t)256,i12) = tmp62;
}
...
Arr1DIdxRowM(tmp65, (int32_t)2, (int64_t)1) =  (int32_t)256;
...
Arr2DIdxRowM(tmp66, (int32_t)1, (int32_t)256,i15,i16) = Arr1DIdxRowM(tmp63, (int32_t)256,i14);
i14 = (i14 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)256, tmp63);
ScaleUp2( (int32_t)1,  (int32_t)256, tmp56,  (int32_t)12);

uint64_t* tmp68 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp68, (int32_t)1, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp66, (int32_t)1, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp56, (int32_t)1, (int32_t)256,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp66);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp56);
ScaleDown2( (int32_t)1,  (int32_t)256, tmp68,  (int32_t)12);
...
tmp75 = (( (int32_t)0 + (i17 *  (int32_t)256)) + (i18 *  (int32_t)1));
Arr1DIdxRowM(tmp72, (int32_t)256,tmp75) = Arr2DIdxRowM(tmp68, (int32_t)1, (int32_t)256,i17,i18);
Arr1DIdxRowM(tmp73, (int32_t)256,tmp75) = Arr2DIdxRowM(tmp10, (int32_t)1, (int32_t)1,i17, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)256, tmp72, tmp73, tmp74);
ClearMemSecret1( (int32_t)256, tmp72);
ClearMemSecret1( (int32_t)256, tmp73);
for (uint32_t i17 =  (int32_t)0; i17 <  (int32_t)1; i17++){
for (uint32_t i18 =  (int32_t)0; i18 <  (int32_t)256; i18++){
tmp75 = (( (int32_t)0 + (i17 *  (int32_t)256)) + (i18 *  (int32_t)1));
Arr2DIdxRowM(tmp71, (int32_t)1, (int32_t)256,i17,i18) = Arr1DIdxRowM(tmp74, (int32_t)256,tmp75);
}
}
...
MatMul2D( (int32_t)1,  (int32_t)256,  (int32_t)256, tmp71, tmp11, tmp78, 0);
