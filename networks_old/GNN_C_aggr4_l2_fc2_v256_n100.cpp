...
uint64_t* tmp5 = make_array<uint64_t>( (int32_t)100,  (int32_t)1);
...
Arr2DIdxRowM(tmp5, (int32_t)100, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp5 : 0;
}
}
...
Arr1DIdxRowM(tmp8, (int32_t)25600,tmp11) = Arr2DIdxRowM(tmp3, (int32_t)100, (int32_t)256,i0,i1);
Arr1DIdxRowM(tmp9, (int32_t)25600,tmp11) = Arr2DIdxRowM(tmp2, (int32_t)1, (int32_t)256, (int32_t)0,i1);
}
}
...
ScaleDown2( (int32_t)100,  (int32_t)256, tmp14,  (int32_t)12);
...
Arr1DIdxRowM(tmp17, (int32_t)25600,tmp20) = Arr2DIdxRowM(tmp14, (int32_t)100, (int32_t)256,i2,i3);
Arr1DIdxRowM(tmp18, (int32_t)25600,tmp20) = Arr2DIdxRowM(tmp5, (int32_t)100, (int32_t)1,i2, (int32_t)0);
}
}
...
for (uint32_t i3 =  (int32_t)0; i3 <  (int32_t)256; i3++){
tmp20 = (( (int32_t)0 + (i2 *  (int32_t)256)) + (i3 *  (int32_t)1));
Arr2DIdxRowM(tmp16, (int32_t)100, (int32_t)256,i2,i3) = Arr1DIdxRowM(tmp19, (int32_t)25600,tmp20);
}
}
ClearMemSecret1( (int32_t)25600, tmp19);
ClearMemSecret2( (int32_t)100,  (int32_t)256, tmp14);
ClearMemSecret2( (int32_t)100,  (int32_t)1, tmp5);
...
tmp24 = SecretAdd(tmp24, Arr2DIdxRowM(tmp16, (int32_t)100, (int32_t)256,i5,i4));
}
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)100; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp29, (int32_t)100, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp1, (int32_t)100, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp7, (int32_t)100, (int32_t)256,i0,i1));
}
}
...
Arr1DIdxRowM(tmp33, (int32_t)25600,tmp36) = Arr2DIdxRowM(tmp29, (int32_t)100, (int32_t)256,i6,i7);
Arr1DIdxRowM(tmp34, (int32_t)25600,tmp36) = Arr2DIdxRowM(tmp6, (int32_t)100, (int32_t)1,i6, (int32_t)0);
}
}
...
for (uint32_t i7 =  (int32_t)0; i7 <  (int32_t)256; i7++){
tmp36 = (( (int32_t)0 + (i6 *  (int32_t)256)) + (i7 *  (int32_t)1));
Arr2DIdxRowM(tmp32, (int32_t)100, (int32_t)256,i6,i7) = Arr1DIdxRowM(tmp35, (int32_t)25600,tmp36);
}
}
...
tmp40 = SecretAdd(tmp40, Arr2DIdxRowM(tmp32, (int32_t)100, (int32_t)256,i9,i8));
}
