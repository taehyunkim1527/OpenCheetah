...
uint64_t* tmp3 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
...
Arr2DIdxRowM(tmp3, (int32_t)1, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp3 : 0;
}
}
...
uint64_t* tmp5 = make_array<uint64_t>( (int32_t)512,  (int32_t)512);
...
Arr2DIdxRowM(tmp5, (int32_t)512, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp5 : 0;
}
}

uint64_t* tmp6 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
...
Arr2DIdxRowM(tmp6, (int32_t)1, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp6 : 0;
}
}
...
tmp23 = (( (int32_t)0 + (i0 *  (int32_t)512)) + (i1 *  (int32_t)1));
Arr1DIdxRowM(tmp20, (int32_t)25600,tmp23) = Arr2DIdxRowM(tmp4, (int32_t)50, (int32_t)512,i0,i1);
Arr1DIdxRowM(tmp21, (int32_t)25600,tmp23) = Arr2DIdxRowM(tmp3, (int32_t)1, (int32_t)512, (int32_t)0,i1);
}
}
ElemWiseActModelVectorMult( (int32_t)25600, tmp20, tmp21, tmp22);
ClearMemSecret1( (int32_t)25600, tmp20);
ClearMemSecret1( (int32_t)25600, tmp21);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
tmp23 = (( (int32_t)0 + (i0 *  (int32_t)512)) + (i1 *  (int32_t)1));
Arr2DIdxRowM(tmp19, (int32_t)50, (int32_t)512,i0,i1) = Arr1DIdxRowM(tmp22, (int32_t)25600,tmp23);
}
}
ClearMemSecret1( (int32_t)25600, tmp22);
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp4);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp3);

int32_t* tmp26 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp26, (int32_t)2, (int64_t)0) =  (int32_t)-1;
Arr1DIdxRowM(tmp26, (int32_t)2, (int64_t)1) =  (int32_t)512;
...
Arr2DIdxRowM(tmp27, (int32_t)1, (int32_t)512,i3,i4) = Arr1DIdxRowM(tmp0, (int32_t)512,i2);
i2 = (i2 +  (int64_t)1);
}
}
...
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp27, tmp5, tmp29, 0);
ClearMemSecret2( (int32_t)512,  (int32_t)512, tmp5);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp27);
ScaleUp2( (int32_t)1,  (int32_t)512, tmp6,  (int32_t)12);

uint64_t* tmp32 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp32, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp29, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp6, (int32_t)1, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp29);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp6);

uint64_t* tmp35 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
Relu2( (int32_t)1,  (int32_t)512, tmp32, tmp35,  (int32_t)12, 1);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp37, (int32_t)50, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp1, (int32_t)50, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp19, (int32_t)50, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp1);

uint64_t* tmp39 = make_array<uint64_t>( (int32_t)50,  (int32_t)512);
ScaleDown2( (int32_t)50,  (int32_t)512, tmp37,  (int32_t)12);
MatMul2D( (int32_t)50,  (int32_t)512,  (int32_t)512, tmp37, tmp7, tmp39, 0);
...
uint64_t* tmp42 = make_array<uint64_t>( (int32_t)50,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp42, (int32_t)50, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp39, (int32_t)50, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp8, (int32_t)1, (int32_t)512, (int32_t)0,i1));
}
}
...
Relu2( (int32_t)50,  (int32_t)512, tmp42, tmp45,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp42);

int32_t* tmp47 = make_array<int32_t>( (int32_t)4);
Arr1DIdxRowM(tmp47, (int32_t)4, (int64_t)0) =  (int32_t)512;
Arr1DIdxRowM(tmp47, (int32_t)4, (int64_t)1) =  (int32_t)1;
Arr1DIdxRowM(tmp47, (int32_t)4, (int64_t)2) =  (int32_t)50;
Arr1DIdxRowM(tmp47, (int32_t)4, (int64_t)3) =  (int32_t)1;

uint64_t* tmp48 = make_array<uint64_t>( (int32_t)512,  (int32_t)1,  (int32_t)50,  (int32_t)1);
...
Arr4DIdxRowM(tmp48, (int32_t)512, (int32_t)1, (int32_t)50, (int32_t)1,i7,i8,i9,i10) = Arr2DIdxRowM(tmp45, (int32_t)50, (int32_t)512,i5,i6);
i6 = (i6 +  (int64_t)1);
if ((i6 ==  (int64_t)512)) {
i6 =  (int64_t)0;
i5 = (i5 +  (int64_t)1);
...
uint64_t* tmp50 = make_array<uint64_t>( (int32_t)512,  (int32_t)1,  (int32_t)1,  (int32_t)1);
MaxPool( (int32_t)512,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)50,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1,  (int32_t)512,  (int32_t)1,  (int32_t)50,  (int32_t)1, tmp48, tmp50);
ClearMemSecret4( (int32_t)512,  (int32_t)1,  (int32_t)50,  (int32_t)1, tmp48);
...
Arr2DIdxRowM(tmp53, (int32_t)1, (int32_t)512,i15,i16) = Arr4DIdxRowM(tmp50, (int32_t)512, (int32_t)1, (int32_t)1, (int32_t)1,i11,i12,i13,i14);
i14 = (i14 +  (int64_t)1);
if ((i14 ==  (int64_t)1)) {
i14 =  (int64_t)0;
i13 = (i13 +  (int64_t)1);
...
ClearMemSecret4( (int32_t)512,  (int32_t)1,  (int32_t)1,  (int32_t)1, tmp50);

uint64_t* tmp55 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp55, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp53, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp35, (int32_t)1, (int32_t)512,i0,i1));
}
}
...
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp55, tmp9, tmp58, 0);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp61, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp58, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp10, (int32_t)1, (int32_t)512,i0,i1));
}
}
...
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp64, tmp11, tmp66, 0);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp69, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp66, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp12, (int32_t)1, (int32_t)512,i0,i1));
}
}
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp74, (int32_t)50, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp2, (int32_t)50, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp19, (int32_t)50, (int32_t)512,i0,i1));
}
}
...
ScaleDown2( (int32_t)50,  (int32_t)512, tmp74,  (int32_t)12);
MatMul2D( (int32_t)50,  (int32_t)512,  (int32_t)512, tmp74, tmp13, tmp77, 0);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp80, (int32_t)50, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp77, (int32_t)50, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp14, (int32_t)1, (int32_t)512, (int32_t)0,i1));
}
}
...
Relu2( (int32_t)50,  (int32_t)512, tmp80, tmp83,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp80);

int32_t* tmp85 = make_array<int32_t>( (int32_t)4);
Arr1DIdxRowM(tmp85, (int32_t)4, (int64_t)0) =  (int32_t)512;
Arr1DIdxRowM(tmp85, (int32_t)4, (int64_t)1) =  (int32_t)1;
Arr1DIdxRowM(tmp85, (int32_t)4, (int64_t)2) =  (int32_t)50;
Arr1DIdxRowM(tmp85, (int32_t)4, (int64_t)3) =  (int32_t)1;

uint64_t* tmp86 = make_array<uint64_t>( (int32_t)512,  (int32_t)1,  (int32_t)50,  (int32_t)1);
...
Arr4DIdxRowM(tmp86, (int32_t)512, (int32_t)1, (int32_t)50, (int32_t)1,i19,i20,i21,i22) = Arr2DIdxRowM(tmp83, (int32_t)50, (int32_t)512,i17,i18);
i18 = (i18 +  (int64_t)1);
if ((i18 ==  (int64_t)512)) {
i18 =  (int64_t)0;
i17 = (i17 +  (int64_t)1);
...
uint64_t* tmp88 = make_array<uint64_t>( (int32_t)512,  (int32_t)1,  (int32_t)1,  (int32_t)1);
MaxPool( (int32_t)512,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)50,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1,  (int32_t)512,  (int32_t)1,  (int32_t)50,  (int32_t)1, tmp86, tmp88);
ClearMemSecret4( (int32_t)512,  (int32_t)1,  (int32_t)50,  (int32_t)1, tmp86);

int32_t* tmp90 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp90, (int32_t)2, (int64_t)0) =  (int32_t)-1;
Arr1DIdxRowM(tmp90, (int32_t)2, (int64_t)1) =  (int32_t)512;
...
Arr2DIdxRowM(tmp91, (int32_t)1, (int32_t)512,i27,i28) = Arr4DIdxRowM(tmp88, (int32_t)512, (int32_t)1, (int32_t)1, (int32_t)1,i23,i24,i25,i26);
i26 = (i26 +  (int64_t)1);
if ((i26 ==  (int64_t)1)) {
i26 =  (int64_t)0;
i25 = (i25 +  (int64_t)1);
...
ClearMemSecret4( (int32_t)512,  (int32_t)1,  (int32_t)1,  (int32_t)1, tmp88);

uint64_t* tmp93 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp93, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp91, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp72, (int32_t)1, (int32_t)512,i0,i1));
}
}
...
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp93, tmp15, tmp96, 0);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp99, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp96, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp16, (int32_t)1, (int32_t)512,i0,i1));
}
}
...
Relu2( (int32_t)1,  (int32_t)512, tmp99, tmp102,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp99);

uint64_t* tmp104 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp102, tmp17, tmp104, 0);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp107, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp104, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp18, (int32_t)1, (int32_t)512,i0,i1));
}
}
...
Relu2( (int32_t)1,  (int32_t)512, tmp107, tmp110,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp107);
EndComputation();
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (uint32_t)0; i1 <  (int32_t)512; i1++){
cout << (funcReconstruct2PCCons(Arr2DIdxRowM(tmp110, (int32_t)1, (int32_t)512,i0,i1), 2)) << endl;
}
}
}
