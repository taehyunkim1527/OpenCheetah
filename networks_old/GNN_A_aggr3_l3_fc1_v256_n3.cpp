...
uint64_t* tmp20 = make_array<uint64_t>( (int32_t)3,  (int32_t)256);

uint64_t* tmp21 = make_array<uint64_t>( (int32_t)768);
...
Arr1DIdxRowM(tmp21, (int32_t)768,tmp24) = Arr2DIdxRowM(tmp5, (int32_t)3, (int32_t)256,i0,i1);
Arr1DIdxRowM(tmp22, (int32_t)768,tmp24) = Arr2DIdxRowM(tmp4, (int32_t)1, (int32_t)256, (int32_t)0,i1);
}
}
ElemWiseActModelVectorMult( (int32_t)768, tmp21, tmp22, tmp23);
ClearMemSecret1( (int32_t)768, tmp21);
ClearMemSecret1( (int32_t)768, tmp22);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)3; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
tmp24 = (( (int32_t)0 + (i0 *  (int32_t)256)) + (i1 *  (int32_t)1));
Arr2DIdxRowM(tmp20, (int32_t)3, (int32_t)256,i0,i1) = Arr1DIdxRowM(tmp23, (int32_t)768,tmp24);
}
}
...
uint64_t* tmp38 = make_array<uint64_t>( (int32_t)3,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)3; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp38, (int32_t)3, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp1, (int32_t)3, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp20, (int32_t)3, (int32_t)256,i0,i1));
}
}
ClearMemSecret2( (int32_t)3,  (int32_t)256, tmp1);

uint64_t* tmp40 = make_array<uint64_t>( (int32_t)3,  (int32_t)256);
ScaleDown2( (int32_t)3,  (int32_t)256, tmp38,  (int32_t)12);
MatMul2D( (int32_t)3,  (int32_t)256,  (int32_t)256, tmp38, tmp8, tmp40, 0);
ClearMemSecret2( (int32_t)256,  (int32_t)256, tmp8);
ClearMemSecret2( (int32_t)3,  (int32_t)256, tmp38);
ScaleUp2( (int32_t)1,  (int32_t)256, tmp9,  (int32_t)12);

uint64_t* tmp43 = make_array<uint64_t>( (int32_t)3,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)3; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp43, (int32_t)3, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp40, (int32_t)3, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp9, (int32_t)1, (int32_t)256, (int32_t)0,i1));
}
}
ClearMemSecret2( (int32_t)3,  (int32_t)256, tmp40);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp9);

uint64_t* tmp46 = make_array<uint64_t>( (int32_t)3,  (int32_t)256);
Relu2( (int32_t)3,  (int32_t)256, tmp43, tmp46,  (int32_t)12, 1);
...
uint64_t* tmp49 = make_array<uint64_t>( (int32_t)256,  (int32_t)1,  (int32_t)3,  (int32_t)1);
...
Arr4DIdxRowM(tmp49, (int32_t)256, (int32_t)1, (int32_t)3, (int32_t)1,i7,i8,i9,i10) = Arr2DIdxRowM(tmp46, (int32_t)3, (int32_t)256,i5,i6);
i6 = (i6 +  (int64_t)1);
if ((i6 ==  (int64_t)256)) {
i6 =  (int64_t)0;
i5 = (i5 +  (int64_t)1);
...
MaxPool( (int32_t)256,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)3,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1,  (int32_t)256,  (int32_t)1,  (int32_t)3,  (int32_t)1, tmp49, tmp51);
ClearMemSecret4( (int32_t)256,  (int32_t)1,  (int32_t)3,  (int32_t)1, tmp49);
...
uint64_t* tmp67 = make_array<uint64_t>( (int32_t)3,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)3; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp67, (int32_t)3, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp2, (int32_t)3, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp20, (int32_t)3, (int32_t)256,i0,i1));
}
}
ClearMemSecret2( (int32_t)3,  (int32_t)256, tmp2);

uint64_t* tmp69 = make_array<uint64_t>( (int32_t)3,  (int32_t)256);
ScaleDown2( (int32_t)3,  (int32_t)256, tmp67,  (int32_t)12);
MatMul2D( (int32_t)3,  (int32_t)256,  (int32_t)256, tmp67, tmp12, tmp69, 0);
ClearMemSecret2( (int32_t)3,  (int32_t)256, tmp67);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)3; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp72, (int32_t)3, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp69, (int32_t)3, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp13, (int32_t)1, (int32_t)256, (int32_t)0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp13);
ClearMemSecret2( (int32_t)3,  (int32_t)256, tmp69);

uint64_t* tmp75 = make_array<uint64_t>( (int32_t)3,  (int32_t)256);
Relu2( (int32_t)3,  (int32_t)256, tmp72, tmp75,  (int32_t)12, 1);
...
uint64_t* tmp78 = make_array<uint64_t>( (int32_t)256,  (int32_t)1,  (int32_t)3,  (int32_t)1);
...
Arr4DIdxRowM(tmp78, (int32_t)256, (int32_t)1, (int32_t)3, (int32_t)1,i19,i20,i21,i22) = Arr2DIdxRowM(tmp75, (int32_t)3, (int32_t)256,i17,i18);
i18 = (i18 +  (int64_t)1);
if ((i18 ==  (int64_t)256)) {
i18 =  (int64_t)0;
i17 = (i17 +  (int64_t)1);
...
ClearMemSecret2( (int32_t)3,  (int32_t)256, tmp75);

uint64_t* tmp80 = make_array<uint64_t>( (int32_t)256,  (int32_t)1,  (int32_t)1,  (int32_t)1);
MaxPool( (int32_t)256,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)3,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1,  (int32_t)256,  (int32_t)1,  (int32_t)3,  (int32_t)1, tmp78, tmp80);
ClearMemSecret4( (int32_t)256,  (int32_t)1,  (int32_t)3,  (int32_t)1, tmp78);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)3; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp96, (int32_t)3, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp3, (int32_t)3, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp20, (int32_t)3, (int32_t)256,i0,i1));
}
}
ClearMemSecret2( (int32_t)3,  (int32_t)256, tmp3);
ClearMemSecret2( (int32_t)3,  (int32_t)256, tmp20);

uint64_t* tmp99 = make_array<uint64_t>( (int32_t)3,  (int32_t)256);
ScaleDown2( (int32_t)3,  (int32_t)256, tmp96,  (int32_t)12);
MatMul2D( (int32_t)3,  (int32_t)256,  (int32_t)256, tmp96, tmp16, tmp99, 0);
...
uint64_t* tmp102 = make_array<uint64_t>( (int32_t)3,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)3; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp102, (int32_t)3, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp99, (int32_t)3, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp17, (int32_t)1, (int32_t)256, (int32_t)0,i1));
}
}
ClearMemSecret2( (int32_t)3,  (int32_t)256, tmp99);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp17);

uint64_t* tmp105 = make_array<uint64_t>( (int32_t)3,  (int32_t)256);
Relu2( (int32_t)3,  (int32_t)256, tmp102, tmp105,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)3,  (int32_t)256, tmp102);
...
uint64_t* tmp108 = make_array<uint64_t>( (int32_t)256,  (int32_t)1,  (int32_t)3,  (int32_t)1);
...
Arr4DIdxRowM(tmp108, (int32_t)256, (int32_t)1, (int32_t)3, (int32_t)1,i31,i32,i33,i34) = Arr2DIdxRowM(tmp105, (int32_t)3, (int32_t)256,i29,i30);
i30 = (i30 +  (int64_t)1);
if ((i30 ==  (int64_t)256)) {
i30 =  (int64_t)0;
i29 = (i29 +  (int64_t)1);
...
ClearMemSecret2( (int32_t)3,  (int32_t)256, tmp105);

uint64_t* tmp110 = make_array<uint64_t>( (int32_t)256,  (int32_t)1,  (int32_t)1,  (int32_t)1);
MaxPool( (int32_t)256,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)3,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1,  (int32_t)256,  (int32_t)1,  (int32_t)3,  (int32_t)1, tmp108, tmp110);
ClearMemSecret4( (int32_t)256,  (int32_t)1,  (int32_t)3,  (int32_t)1, tmp108);
