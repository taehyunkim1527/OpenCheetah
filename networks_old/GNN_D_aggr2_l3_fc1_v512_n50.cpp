...
uint64_t* tmp3 = make_array<uint64_t>( (int32_t)512);
/* Variable to read the clear value corresponding to the input variable tmp3 at (9036,1-9036,35) */
uint64_t __tmp_in_tmp3;
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)512; i0++){
if ((party == SERVER)) {
__tmp_in_tmp3 = 2;
}
Arr1DIdxRowM(tmp3, (int32_t)512,i0) = (party == SERVER) ? __tmp_in_tmp3 : 0;
}
...
uint64_t* tmp6 = make_array<uint64_t>( (int32_t)1);
...
Arr1DIdxRowM(tmp6, (int32_t)1,i0) = (party == SERVER) ? __tmp_in_tmp6 : 0;
}
StartComputation();
...
uint64_t* tmp9 = make_array<uint64_t>( (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)512; i0++){
tmp8 = funcSSCons( (int64_t)0);
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)50; i1++){
tmp8 = SecretAdd(tmp8, Arr2DIdxRowM(tmp4, (int32_t)50, (int32_t)512,i1,i0));
}
Arr1DIdxRowM(tmp9, (int32_t)512,i0) = tmp8;
}
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp4);

uint64_t* tmp11 = make_array<uint64_t>( (int32_t)512);
...
tmp15 = ( (int32_t)0 + (i2 *  (int32_t)1));
Arr1DIdxRowM(tmp12, (int32_t)512,tmp15) = Arr1DIdxRowM(tmp9, (int32_t)512,i2);
Arr1DIdxRowM(tmp13, (int32_t)512,tmp15) = Arr1DIdxRowM(tmp3, (int32_t)512,i2);
}
ElemWiseActModelVectorMult( (int32_t)512, tmp12, tmp13, tmp14);
ClearMemSecret1( (int32_t)512, tmp12);
ClearMemSecret1( (int32_t)512, tmp13);
for (uint32_t i2 =  (int32_t)0; i2 <  (int32_t)512; i2++){
tmp15 = ( (int32_t)0 + (i2 *  (int32_t)1));
Arr1DIdxRowM(tmp11, (int32_t)512,i2) = Arr1DIdxRowM(tmp14, (int32_t)512,tmp15);
}
ClearMemSecret1( (int32_t)512, tmp14);
ClearMemSecret1( (int32_t)512, tmp3);
ClearMemSecret1( (int32_t)512, tmp9);

int32_t tmp18 =  (int32_t)0;

uint64_t tmp19;

uint64_t* tmp20 = make_array<uint64_t>( (int32_t)512);
for (uint32_t i3 =  (int32_t)0; i3 <  (int32_t)512; i3++){
tmp19 = funcSSCons( (int64_t)0);
for (uint32_t i4 =  (int32_t)0; i4 <  (int32_t)50; i4++){
tmp19 = SecretAdd(tmp19, Arr2DIdxRowM(tmp0, (int32_t)50, (int32_t)512,i4,i3));
}
Arr1DIdxRowM(tmp20, (int32_t)512,i3) = tmp19;
}
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp0);
ScaleUp1( (int32_t)512, tmp20,  (int32_t)12);

uint64_t* tmp22 = make_array<uint64_t>( (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)512; i0++){
Arr1DIdxRowM(tmp22, (int32_t)512,i0) = SecretAdd(Arr1DIdxRowM(tmp20, (int32_t)512,i0), Arr1DIdxRowM(tmp11, (int32_t)512,i0));
}
ClearMemSecret1( (int32_t)512, tmp20);
ScaleDown1( (int32_t)512, tmp22,  (int32_t)12);

uint64_t* tmp24 = make_array<uint64_t>( (int32_t)512);
...
tmp28 = ( (int32_t)0 + (i5 *  (int32_t)1));
Arr1DIdxRowM(tmp25, (int32_t)512,tmp28) = Arr1DIdxRowM(tmp22, (int32_t)512,i5);
Arr1DIdxRowM(tmp26, (int32_t)512,tmp28) = Arr1DIdxRowM(tmp6, (int32_t)1, (int32_t)0);
}
ElemWiseActModelVectorMult( (int32_t)512, tmp25, tmp26, tmp27);
ClearMemSecret1( (int32_t)512, tmp25);
ClearMemSecret1( (int32_t)512, tmp26);
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)512; i5++){
tmp28 = ( (int32_t)0 + (i5 *  (int32_t)1));
Arr1DIdxRowM(tmp24, (int32_t)512,i5) = Arr1DIdxRowM(tmp27, (int32_t)512,tmp28);
}
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)512; i0++){
Arr1DIdxRowM(tmp30, (int32_t)512,i0) = SecretAdd(Arr1DIdxRowM(tmp24, (int32_t)512,i0), Arr1DIdxRowM(tmp5, (int32_t)512,i0));
}
ClearMemSecret1( (int32_t)512, tmp24);
...
tmp33 = SecretAdd(tmp33, Arr2DIdxRowM(tmp1, (int32_t)50, (int32_t)512,i7,i6));
}
Arr1DIdxRowM(tmp34, (int32_t)512,i6) = tmp33;
}
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp1);
ScaleUp1( (int32_t)512, tmp34,  (int32_t)12);

uint64_t* tmp36 = make_array<uint64_t>( (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)512; i0++){
Arr1DIdxRowM(tmp36, (int32_t)512,i0) = SecretAdd(Arr1DIdxRowM(tmp34, (int32_t)512,i0), Arr1DIdxRowM(tmp11, (int32_t)512,i0));
}
ClearMemSecret1( (int32_t)512, tmp34);
ScaleDown1( (int32_t)512, tmp36,  (int32_t)12);
...
tmp42 = ( (int32_t)0 + (i8 *  (int32_t)1));
Arr1DIdxRowM(tmp39, (int32_t)512,tmp42) = Arr1DIdxRowM(tmp36, (int32_t)512,i8);
Arr1DIdxRowM(tmp40, (int32_t)512,tmp42) = Arr1DIdxRowM(tmp6, (int32_t)1, (int32_t)0);
}
ElemWiseActModelVectorMult( (int32_t)512, tmp39, tmp40, tmp41);
ClearMemSecret1( (int32_t)512, tmp39);
ClearMemSecret1( (int32_t)512, tmp40);
for (uint32_t i8 =  (int32_t)0; i8 <  (int32_t)512; i8++){
tmp42 = ( (int32_t)0 + (i8 *  (int32_t)1));
Arr1DIdxRowM(tmp38, (int32_t)512,i8) = Arr1DIdxRowM(tmp41, (int32_t)512,tmp42);
}
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)512; i0++){
Arr1DIdxRowM(tmp44, (int32_t)512,i0) = SecretAdd(Arr1DIdxRowM(tmp38, (int32_t)512,i0), Arr1DIdxRowM(tmp5, (int32_t)512,i0));
}
...
tmp47 = SecretAdd(tmp47, Arr2DIdxRowM(tmp2, (int32_t)50, (int32_t)512,i10,i9));
}
Arr1DIdxRowM(tmp48, (int32_t)512,i9) = tmp47;
}
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)512; i0++){
Arr1DIdxRowM(tmp50, (int32_t)512,i0) = SecretAdd(Arr1DIdxRowM(tmp48, (int32_t)512,i0), Arr1DIdxRowM(tmp11, (int32_t)512,i0));
}
ClearMemSecret1( (int32_t)512, tmp11);
ClearMemSecret1( (int32_t)512, tmp48);
ScaleDown1( (int32_t)512, tmp50,  (int32_t)12);
...
Arr1DIdxRowM(tmp54, (int32_t)512,tmp57) = Arr1DIdxRowM(tmp50, (int32_t)512,i11);
Arr1DIdxRowM(tmp55, (int32_t)512,tmp57) = Arr1DIdxRowM(tmp6, (int32_t)1, (int32_t)0);
}
...
ClearMemSecret1( (int32_t)1, tmp6);
ClearMemSecret1( (int32_t)512, tmp50);

uint64_t* tmp60 = make_array<uint64_t>( (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)512; i0++){
Arr1DIdxRowM(tmp60, (int32_t)512,i0) = SecretAdd(Arr1DIdxRowM(tmp53, (int32_t)512,i0), Arr1DIdxRowM(tmp5, (int32_t)512,i0));
}
