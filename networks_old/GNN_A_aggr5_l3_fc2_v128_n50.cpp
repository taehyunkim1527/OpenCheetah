...
uint64_t* tmp8 = make_array<uint64_t>( (int32_t)50,  (int32_t)128);
...
Arr2DIdxRowM(tmp8, (int32_t)50, (int32_t)128,i0,i1) = (party == SERVER) ? __tmp_in_tmp8 : 0;
}
}
...
uint64_t* tmp13 = make_array<uint64_t>( (int32_t)50,  (int32_t)128);
...
Arr2DIdxRowM(tmp13, (int32_t)50, (int32_t)128,i0,i1) = (party == SERVER) ? __tmp_in_tmp13 : 0;
}
}
...
uint64_t* tmp23 = make_array<uint64_t>( (int32_t)50,  (int32_t)128);

uint64_t* tmp24 = make_array<uint64_t>( (int32_t)6400);

uint64_t* tmp25 = make_array<uint64_t>( (int32_t)6400);
...
tmp27 = (( (int32_t)0 + (i0 *  (int32_t)128)) + (i1 *  (int32_t)1));
Arr1DIdxRowM(tmp24, (int32_t)6400,tmp27) = Arr2DIdxRowM(tmp5, (int32_t)50, (int32_t)128,i0,i1);
Arr1DIdxRowM(tmp25, (int32_t)6400,tmp27) = Arr2DIdxRowM(tmp4, (int32_t)1, (int32_t)128, (int32_t)0,i1);
}
}
ElemWiseActModelVectorMult( (int32_t)6400, tmp24, tmp25, tmp26);
ClearMemSecret1( (int32_t)6400, tmp24);
ClearMemSecret1( (int32_t)6400, tmp25);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
tmp27 = (( (int32_t)0 + (i0 *  (int32_t)128)) + (i1 *  (int32_t)1));
Arr2DIdxRowM(tmp23, (int32_t)50, (int32_t)128,i0,i1) = Arr1DIdxRowM(tmp26, (int32_t)6400,tmp27);
}
}
...
Arr1DIdxRowM(tmp30, (int32_t)2, (int64_t)1) =  (int32_t)128;
...
Arr2DIdxRowM(tmp31, (int32_t)1, (int32_t)128,i3,i4) = Arr1DIdxRowM(tmp0, (int32_t)128,i2);
i2 = (i2 +  (int64_t)1);
}
}
...
MatMul2D( (int32_t)1,  (int32_t)128,  (int32_t)128, tmp31, tmp6, tmp33, 0);
...
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp36, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp33, (int32_t)1, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp7, (int32_t)1, (int32_t)128,i0,i1));
}
}
...
Relu2( (int32_t)1,  (int32_t)128, tmp36, tmp39,  (int32_t)12, 1);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp41, (int32_t)50, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp1, (int32_t)50, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp23, (int32_t)50, (int32_t)128,i0,i1));
}
}
ClearMemSecret2( (int32_t)50,  (int32_t)128, tmp1);
ScaleDown2( (int32_t)50,  (int32_t)128, tmp41,  (int32_t)12);

uint64_t* tmp43 = make_array<uint64_t>( (int32_t)50,  (int32_t)128);

uint64_t* tmp44 = make_array<uint64_t>( (int32_t)6400);

uint64_t* tmp45 = make_array<uint64_t>( (int32_t)6400);

uint64_t* tmp46 = make_array<uint64_t>( (int32_t)6400);

int32_t tmp47;
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)50; i5++){
for (uint32_t i6 =  (int32_t)0; i6 <  (int32_t)128; i6++){
tmp47 = (( (int32_t)0 + (i5 *  (int32_t)128)) + (i6 *  (int32_t)1));
Arr1DIdxRowM(tmp44, (int32_t)6400,tmp47) = Arr2DIdxRowM(tmp41, (int32_t)50, (int32_t)128,i5,i6);
Arr1DIdxRowM(tmp45, (int32_t)6400,tmp47) = Arr2DIdxRowM(tmp8, (int32_t)50, (int32_t)128,i5,i6);
}
}
ElemWiseActModelVectorMult( (int32_t)6400, tmp44, tmp45, tmp46);
ClearMemSecret1( (int32_t)6400, tmp44);
ClearMemSecret1( (int32_t)6400, tmp45);
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)50; i5++){
for (uint32_t i6 =  (int32_t)0; i6 <  (int32_t)128; i6++){
tmp47 = (( (int32_t)0 + (i5 *  (int32_t)128)) + (i6 *  (int32_t)1));
Arr2DIdxRowM(tmp43, (int32_t)50, (int32_t)128,i5,i6) = Arr1DIdxRowM(tmp46, (int32_t)6400,tmp47);
}
}
ClearMemSecret1( (int32_t)6400, tmp46);
ClearMemSecret2( (int32_t)50,  (int32_t)128, tmp41);
ClearMemSecret2( (int32_t)50,  (int32_t)128, tmp8);
...
tmp51 = SecretAdd(tmp51, Arr2DIdxRowM(tmp43, (int32_t)50, (int32_t)128,i8,i7));
}
Arr1DIdxRowM(tmp52, (int32_t)128,i7) = tmp51;
}
...
Arr1DIdxRowM(tmp54, (int32_t)2, (int64_t)1) =  (int32_t)128;
...
Arr2DIdxRowM(tmp55, (int32_t)1, (int32_t)128,i10,i11) = Arr1DIdxRowM(tmp52, (int32_t)128,i9);
i9 = (i9 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)128, tmp52);
ScaleUp2( (int32_t)1,  (int32_t)128, tmp39,  (int32_t)12);

uint64_t* tmp57 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp57, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp55, (int32_t)1, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp39, (int32_t)1, (int32_t)128,i0,i1));
}
}
...
ScaleDown2( (int32_t)1,  (int32_t)128, tmp57,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)128,  (int32_t)128, tmp57, tmp9, tmp60, 0);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp57);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp63, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp60, (int32_t)1, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp10, (int32_t)1, (int32_t)128,i0,i1));
}
}
...
Relu2( (int32_t)1,  (int32_t)128, tmp63, tmp66,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp63);

uint64_t* tmp68 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);
MatMul2D( (int32_t)1,  (int32_t)128,  (int32_t)128, tmp66, tmp11, tmp68, 0);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp71, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp68, (int32_t)1, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp12, (int32_t)1, (int32_t)128,i0,i1));
}
}
...
Relu2( (int32_t)1,  (int32_t)128, tmp71, tmp74,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp71);
ScaleUp2( (int32_t)50,  (int32_t)128, tmp2,  (int32_t)12);

uint64_t* tmp76 = make_array<uint64_t>( (int32_t)50,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp76, (int32_t)50, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp2, (int32_t)50, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp23, (int32_t)50, (int32_t)128,i0,i1));
}
}
ClearMemSecret2( (int32_t)50,  (int32_t)128, tmp2);
ScaleDown2( (int32_t)50,  (int32_t)128, tmp76,  (int32_t)12);

uint64_t* tmp78 = make_array<uint64_t>( (int32_t)50,  (int32_t)128);

uint64_t* tmp79 = make_array<uint64_t>( (int32_t)6400);

uint64_t* tmp80 = make_array<uint64_t>( (int32_t)6400);

uint64_t* tmp81 = make_array<uint64_t>( (int32_t)6400);

int32_t tmp82;
for (uint32_t i12 =  (int32_t)0; i12 <  (int32_t)50; i12++){
for (uint32_t i13 =  (int32_t)0; i13 <  (int32_t)128; i13++){
tmp82 = (( (int32_t)0 + (i12 *  (int32_t)128)) + (i13 *  (int32_t)1));
Arr1DIdxRowM(tmp79, (int32_t)6400,tmp82) = Arr2DIdxRowM(tmp76, (int32_t)50, (int32_t)128,i12,i13);
Arr1DIdxRowM(tmp80, (int32_t)6400,tmp82) = Arr2DIdxRowM(tmp13, (int32_t)50, (int32_t)128,i12,i13);
}
}
ElemWiseActModelVectorMult( (int32_t)6400, tmp79, tmp80, tmp81);
ClearMemSecret1( (int32_t)6400, tmp79);
ClearMemSecret1( (int32_t)6400, tmp80);
for (uint32_t i12 =  (int32_t)0; i12 <  (int32_t)50; i12++){
for (uint32_t i13 =  (int32_t)0; i13 <  (int32_t)128; i13++){
tmp82 = (( (int32_t)0 + (i12 *  (int32_t)128)) + (i13 *  (int32_t)1));
Arr2DIdxRowM(tmp78, (int32_t)50, (int32_t)128,i12,i13) = Arr1DIdxRowM(tmp81, (int32_t)6400,tmp82);
}
}
ClearMemSecret1( (int32_t)6400, tmp81);
ClearMemSecret2( (int32_t)50,  (int32_t)128, tmp13);
ClearMemSecret2( (int32_t)50,  (int32_t)128, tmp76);
...
tmp86 = SecretAdd(tmp86, Arr2DIdxRowM(tmp78, (int32_t)50, (int32_t)128,i15,i14));
}
Arr1DIdxRowM(tmp87, (int32_t)128,i14) = tmp86;
}
ClearMemSecret2( (int32_t)50,  (int32_t)128, tmp78);

int32_t* tmp89 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp89, (int32_t)2, (int64_t)0) =  (int32_t)-1;
Arr1DIdxRowM(tmp89, (int32_t)2, (int64_t)1) =  (int32_t)128;
...
Arr2DIdxRowM(tmp90, (int32_t)1, (int32_t)128,i17,i18) = Arr1DIdxRowM(tmp87, (int32_t)128,i16);
i16 = (i16 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)128, tmp87);
ScaleUp2( (int32_t)1,  (int32_t)128, tmp74,  (int32_t)12);

uint64_t* tmp92 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp92, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp90, (int32_t)1, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp74, (int32_t)1, (int32_t)128,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp74);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp90);

uint64_t* tmp95 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);
ScaleDown2( (int32_t)1,  (int32_t)128, tmp92,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)128,  (int32_t)128, tmp92, tmp14, tmp95, 0);
ClearMemSecret2( (int32_t)128,  (int32_t)128, tmp14);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp92);
ScaleUp2( (int32_t)1,  (int32_t)128, tmp15,  (int32_t)12);

uint64_t* tmp98 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp98, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp95, (int32_t)1, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp15, (int32_t)1, (int32_t)128,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp15);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp95);

uint64_t* tmp101 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);
Relu2( (int32_t)1,  (int32_t)128, tmp98, tmp101,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp98);

uint64_t* tmp103 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);
MatMul2D( (int32_t)1,  (int32_t)128,  (int32_t)128, tmp101, tmp16, tmp103, 0);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp106, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp103, (int32_t)1, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp17, (int32_t)1, (int32_t)128,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp17);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp103);

uint64_t* tmp109 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);
Relu2( (int32_t)1,  (int32_t)128, tmp106, tmp109,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp106);
ScaleUp2( (int32_t)50,  (int32_t)128, tmp3,  (int32_t)12);

uint64_t* tmp111 = make_array<uint64_t>( (int32_t)50,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp111, (int32_t)50, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp3, (int32_t)50, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp23, (int32_t)50, (int32_t)128,i0,i1));
}
}
ClearMemSecret2( (int32_t)50,  (int32_t)128, tmp23);
ClearMemSecret2( (int32_t)50,  (int32_t)128, tmp3);
ScaleDown2( (int32_t)50,  (int32_t)128, tmp111,  (int32_t)12);

uint64_t* tmp114 = make_array<uint64_t>( (int32_t)50,  (int32_t)128);

uint64_t* tmp115 = make_array<uint64_t>( (int32_t)6400);

uint64_t* tmp116 = make_array<uint64_t>( (int32_t)6400);

uint64_t* tmp117 = make_array<uint64_t>( (int32_t)6400);

int32_t tmp118;
for (uint32_t i19 =  (int32_t)0; i19 <  (int32_t)50; i19++){
for (uint32_t i20 =  (int32_t)0; i20 <  (int32_t)128; i20++){
tmp118 = (( (int32_t)0 + (i19 *  (int32_t)128)) + (i20 *  (int32_t)1));
Arr1DIdxRowM(tmp115, (int32_t)6400,tmp118) = Arr2DIdxRowM(tmp111, (int32_t)50, (int32_t)128,i19,i20);
Arr1DIdxRowM(tmp116, (int32_t)6400,tmp118) = Arr2DIdxRowM(tmp18, (int32_t)50, (int32_t)128,i19,i20);
}
}
ElemWiseActModelVectorMult( (int32_t)6400, tmp115, tmp116, tmp117);
ClearMemSecret1( (int32_t)6400, tmp115);
ClearMemSecret1( (int32_t)6400, tmp116);
for (uint32_t i19 =  (int32_t)0; i19 <  (int32_t)50; i19++){
for (uint32_t i20 =  (int32_t)0; i20 <  (int32_t)128; i20++){
tmp118 = (( (int32_t)0 + (i19 *  (int32_t)128)) + (i20 *  (int32_t)1));
Arr2DIdxRowM(tmp114, (int32_t)50, (int32_t)128,i19,i20) = Arr1DIdxRowM(tmp117, (int32_t)6400,tmp118);
}
}
ClearMemSecret1( (int32_t)6400, tmp117);
ClearMemSecret2( (int32_t)50,  (int32_t)128, tmp18);
ClearMemSecret2( (int32_t)50,  (int32_t)128, tmp111);

int32_t tmp121 =  (int32_t)0;

uint64_t tmp122;

uint64_t* tmp123 = make_array<uint64_t>( (int32_t)128);
for (uint32_t i21 =  (int32_t)0; i21 <  (int32_t)128; i21++){
tmp122 = funcSSCons( (int64_t)0);
for (uint32_t i22 =  (int32_t)0; i22 <  (int32_t)50; i22++){
tmp122 = SecretAdd(tmp122, Arr2DIdxRowM(tmp114, (int32_t)50, (int32_t)128,i22,i21));
}
Arr1DIdxRowM(tmp123, (int32_t)128,i21) = tmp122;
}
ClearMemSecret2( (int32_t)50,  (int32_t)128, tmp114);

int32_t* tmp125 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp125, (int32_t)2, (int64_t)0) =  (int32_t)-1;
Arr1DIdxRowM(tmp125, (int32_t)2, (int64_t)1) =  (int32_t)128;
...
Arr2DIdxRowM(tmp126, (int32_t)1, (int32_t)128,i24,i25) = Arr1DIdxRowM(tmp123, (int32_t)128,i23);
i23 = (i23 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)128, tmp123);
ScaleUp2( (int32_t)1,  (int32_t)128, tmp109,  (int32_t)12);

uint64_t* tmp128 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp128, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp126, (int32_t)1, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp109, (int32_t)1, (int32_t)128,i0,i1));
}
}
...
ScaleDown2( (int32_t)1,  (int32_t)128, tmp128,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)128,  (int32_t)128, tmp128, tmp19, tmp131, 0);
...
uint64_t* tmp134 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp134, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp131, (int32_t)1, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp20, (int32_t)1, (int32_t)128,i0,i1));
}
}
...
Relu2( (int32_t)1,  (int32_t)128, tmp134, tmp137,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp134);

uint64_t* tmp139 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);
MatMul2D( (int32_t)1,  (int32_t)128,  (int32_t)128, tmp137, tmp21, tmp139, 0);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp142, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp139, (int32_t)1, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp22, (int32_t)1, (int32_t)128,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp139);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp22);

uint64_t* tmp145 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);
Relu2( (int32_t)1,  (int32_t)128, tmp142, tmp145,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp142);
EndComputation();
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (uint32_t)0; i1 <  (int32_t)128; i1++){
cout << (funcReconstruct2PCCons(Arr2DIdxRowM(tmp145, (int32_t)1, (int32_t)128,i0,i1), 2)) << endl;
}
}
}
