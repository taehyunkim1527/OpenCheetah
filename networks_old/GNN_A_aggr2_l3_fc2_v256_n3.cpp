...
tmp44 = SecretAdd(tmp44, Arr2DIdxRowM(tmp41, (int32_t)3, (int32_t)256,i6,i5));
}
...
tmp79 = SecretAdd(tmp79, Arr2DIdxRowM(tmp76, (int32_t)3, (int32_t)256,i13,i12));
}
...
tmp115 = SecretAdd(tmp115, Arr2DIdxRowM(tmp111, (int32_t)3, (int32_t)256,i20,i19));
}
