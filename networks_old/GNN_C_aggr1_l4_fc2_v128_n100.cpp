...
tmp5 = SecretAdd(tmp5, Arr2DIdxRowM(tmp0, (int32_t)100, (int32_t)128,i1,i0));
}
...
tmp9 = SecretAdd(tmp9, Arr2DIdxRowM(tmp1, (int32_t)100, (int32_t)128,i3,i2));
}
...
tmp13 = SecretAdd(tmp13, Arr2DIdxRowM(tmp2, (int32_t)100, (int32_t)128,i5,i4));
}
...
tmp17 = SecretAdd(tmp17, Arr2DIdxRowM(tmp3, (int32_t)100, (int32_t)128,i7,i6));
}
