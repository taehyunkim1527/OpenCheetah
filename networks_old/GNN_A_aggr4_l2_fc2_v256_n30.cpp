...
Arr1DIdxRowM(tmp18, (int32_t)7680,tmp21) = Arr2DIdxRowM(tmp4, (int32_t)30, (int32_t)256,i0,i1);
Arr1DIdxRowM(tmp19, (int32_t)7680,tmp21) = Arr2DIdxRowM(tmp3, (int32_t)1, (int32_t)256, (int32_t)0,i1);
}
}
...
Arr1DIdxRowM(tmp39, (int32_t)7680,tmp41) = Arr2DIdxRowM(tmp7, (int32_t)30, (int32_t)1,i5, (int32_t)0);
}
}
...
uint64_t* tmp70 = make_array<uint64_t>( (int32_t)30,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)30; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp70, (int32_t)30, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp2, (int32_t)30, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp17, (int32_t)30, (int32_t)256,i0,i1));
}
}
ClearMemSecret2( (int32_t)30,  (int32_t)256, tmp2);
ClearMemSecret2( (int32_t)30,  (int32_t)256, tmp17);
ScaleDown2( (int32_t)30,  (int32_t)256, tmp70,  (int32_t)12);

uint64_t* tmp73 = make_array<uint64_t>( (int32_t)30,  (int32_t)256);

uint64_t* tmp74 = make_array<uint64_t>( (int32_t)7680);

uint64_t* tmp75 = make_array<uint64_t>( (int32_t)7680);

uint64_t* tmp76 = make_array<uint64_t>( (int32_t)7680);
...
Arr1DIdxRowM(tmp74, (int32_t)7680,tmp77) = Arr2DIdxRowM(tmp70, (int32_t)30, (int32_t)256,i12,i13);
Arr1DIdxRowM(tmp75, (int32_t)7680,tmp77) = Arr2DIdxRowM(tmp12, (int32_t)30, (int32_t)1,i12, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)7680, tmp74, tmp75, tmp76);
ClearMemSecret1( (int32_t)7680, tmp74);
ClearMemSecret1( (int32_t)7680, tmp75);
for (uint32_t i12 =  (int32_t)0; i12 <  (int32_t)30; i12++){
for (uint32_t i13 =  (int32_t)0; i13 <  (int32_t)256; i13++){
tmp77 = (( (int32_t)0 + (i12 *  (int32_t)256)) + (i13 *  (int32_t)1));
Arr2DIdxRowM(tmp73, (int32_t)30, (int32_t)256,i12,i13) = Arr1DIdxRowM(tmp76, (int32_t)7680,tmp77);
}
}
ClearMemSecret1( (int32_t)7680, tmp76);
ClearMemSecret2( (int32_t)30,  (int32_t)1, tmp12);
ClearMemSecret2( (int32_t)30,  (int32_t)256, tmp70);
...
tmp81 = SecretAdd(tmp81, Arr2DIdxRowM(tmp73, (int32_t)30, (int32_t)256,i15,i14));
}
Arr1DIdxRowM(tmp82, (int32_t)256,i14) = tmp81;
}
ClearMemSecret2( (int32_t)30,  (int32_t)256, tmp73);
