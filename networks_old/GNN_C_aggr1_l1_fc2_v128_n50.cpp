...
tmp2 = SecretAdd(tmp2, Arr2DIdxRowM(tmp0, (int32_t)50, (int32_t)128,i1,i0));
}
Arr1DIdxRowM(tmp3, (int32_t)128,i0) = tmp2;
}
ClearMemSecret2( (int32_t)50,  (int32_t)128, tmp0);
EndComputation();
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)128; i0++){
cout << (funcReconstruct2PCCons(Arr1DIdxRowM(tmp3, (int32_t)128,i0), 2)) << endl;
}
}
