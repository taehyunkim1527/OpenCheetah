...
Arr1DIdxRowM(tmp9, (int32_t)1280,tmp12) = Arr2DIdxRowM(tmp3, (int32_t)5, (int32_t)256,i0,i1);
Arr1DIdxRowM(tmp10, (int32_t)1280,tmp12) = Arr2DIdxRowM(tmp2, (int32_t)1, (int32_t)256, (int32_t)0,i1);
}
}
ElemWiseActModelVectorMult( (int32_t)1280, tmp9, tmp10, tmp11);
ClearMemSecret1( (int32_t)1280, tmp9);
ClearMemSecret1( (int32_t)1280, tmp10);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)5; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
tmp12 = (( (int32_t)0 + (i0 *  (int32_t)256)) + (i1 *  (int32_t)1));
Arr2DIdxRowM(tmp8, (int32_t)5, (int32_t)256,i0,i1) = Arr1DIdxRowM(tmp11, (int32_t)1280,tmp12);
}
}
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)5; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp26, (int32_t)5, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp1, (int32_t)5, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp8, (int32_t)5, (int32_t)256,i0,i1));
}
}
...
tmp30 = SecretAdd(tmp30, Arr2DIdxRowM(tmp26, (int32_t)5, (int32_t)256,i6,i5));
}
Arr1DIdxRowM(tmp31, (int32_t)256,i5) = tmp30;
}
...
Arr2DIdxRowM(tmp34, (int32_t)1, (int32_t)256,i8,i9) = Arr1DIdxRowM(tmp31, (int32_t)256,i7);
i7 = (i7 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)256, tmp31);
ScaleUp2( (int32_t)1,  (int32_t)256, tmp24,  (int32_t)12);

uint64_t* tmp36 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp36, (int32_t)1, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp34, (int32_t)1, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp24, (int32_t)1, (int32_t)256,i0,i1));
}
}
...
ScaleDown2( (int32_t)1,  (int32_t)256, tmp36,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)256,  (int32_t)256, tmp36, tmp6, tmp39, 0);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp42, (int32_t)1, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp39, (int32_t)1, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp7, (int32_t)1, (int32_t)256,i0,i1));
}
}
...
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (uint32_t)0; i1 <  (int32_t)256; i1++){
cout << (funcReconstruct2PCCons(Arr2DIdxRowM(tmp45, (int32_t)1, (int32_t)256,i0,i1), 2)) << endl;
}
}
}
