...
uint64_t* tmp5 = make_array<uint64_t>( (int32_t)3,  (int32_t)128);
...
Arr2DIdxRowM(tmp5, (int32_t)3, (int32_t)128,i0,i1) = (party == SERVER) ? __tmp_in_tmp5 : 0;
}
}
...
uint64_t* tmp26 = make_array<uint64_t>( (int32_t)3,  (int32_t)128);

uint64_t* tmp27 = make_array<uint64_t>( (int32_t)384);

uint64_t* tmp28 = make_array<uint64_t>( (int32_t)384);

uint64_t* tmp29 = make_array<uint64_t>( (int32_t)384);
...
Arr1DIdxRowM(tmp27, (int32_t)384,tmp30) = Arr2DIdxRowM(tmp5, (int32_t)3, (int32_t)128,i0,i1);
Arr1DIdxRowM(tmp28, (int32_t)384,tmp30) = Arr2DIdxRowM(tmp4, (int32_t)1, (int32_t)128, (int32_t)0,i1);
}
}
ElemWiseActModelVectorMult( (int32_t)384, tmp27, tmp28, tmp29);
ClearMemSecret1( (int32_t)384, tmp27);
ClearMemSecret1( (int32_t)384, tmp28);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)3; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
tmp30 = (( (int32_t)0 + (i0 *  (int32_t)128)) + (i1 *  (int32_t)1));
Arr2DIdxRowM(tmp26, (int32_t)3, (int32_t)128,i0,i1) = Arr1DIdxRowM(tmp29, (int32_t)384,tmp30);
}
}
ClearMemSecret1( (int32_t)384, tmp29);
ClearMemSecret2( (int32_t)3,  (int32_t)128, tmp5);
...
uint64_t* tmp44 = make_array<uint64_t>( (int32_t)3,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)3; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp44, (int32_t)3, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp1, (int32_t)3, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp26, (int32_t)3, (int32_t)128,i0,i1));
}
}
ClearMemSecret2( (int32_t)3,  (int32_t)128, tmp1);

uint64_t* tmp46 = make_array<uint64_t>( (int32_t)3,  (int32_t)128);
ScaleDown2( (int32_t)3,  (int32_t)128, tmp44,  (int32_t)12);
MatMul2D( (int32_t)3,  (int32_t)128,  (int32_t)128, tmp44, tmp8, tmp46, 0);
ClearMemSecret2( (int32_t)128,  (int32_t)128, tmp8);
ClearMemSecret2( (int32_t)3,  (int32_t)128, tmp44);
ScaleUp2( (int32_t)1,  (int32_t)128, tmp9,  (int32_t)12);

uint64_t* tmp49 = make_array<uint64_t>( (int32_t)3,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)3; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp49, (int32_t)3, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp46, (int32_t)3, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp9, (int32_t)1, (int32_t)128, (int32_t)0,i1));
}
}
ClearMemSecret2( (int32_t)3,  (int32_t)128, tmp46);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp9);

uint64_t* tmp52 = make_array<uint64_t>( (int32_t)3,  (int32_t)128);
Relu2( (int32_t)3,  (int32_t)128, tmp49, tmp52,  (int32_t)12, 1);
...
uint64_t* tmp55 = make_array<uint64_t>( (int32_t)128,  (int32_t)1,  (int32_t)3,  (int32_t)1);
...
Arr4DIdxRowM(tmp55, (int32_t)128, (int32_t)1, (int32_t)3, (int32_t)1,i7,i8,i9,i10) = Arr2DIdxRowM(tmp52, (int32_t)3, (int32_t)128,i5,i6);
i6 = (i6 +  (int64_t)1);
if ((i6 ==  (int64_t)128)) {
i6 =  (int64_t)0;
i5 = (i5 +  (int64_t)1);
...
ClearMemSecret2( (int32_t)3,  (int32_t)128, tmp52);

uint64_t* tmp57 = make_array<uint64_t>( (int32_t)128,  (int32_t)1,  (int32_t)1,  (int32_t)1);
MaxPool( (int32_t)128,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)3,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1,  (int32_t)128,  (int32_t)1,  (int32_t)3,  (int32_t)1, tmp55, tmp57);
ClearMemSecret4( (int32_t)128,  (int32_t)1,  (int32_t)3,  (int32_t)1, tmp55);
...
uint64_t* tmp81 = make_array<uint64_t>( (int32_t)3,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)3; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp81, (int32_t)3, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp2, (int32_t)3, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp26, (int32_t)3, (int32_t)128,i0,i1));
}
}
ClearMemSecret2( (int32_t)3,  (int32_t)128, tmp2);

uint64_t* tmp83 = make_array<uint64_t>( (int32_t)3,  (int32_t)128);
ScaleDown2( (int32_t)3,  (int32_t)128, tmp81,  (int32_t)12);
MatMul2D( (int32_t)3,  (int32_t)128,  (int32_t)128, tmp81, tmp14, tmp83, 0);
ClearMemSecret2( (int32_t)3,  (int32_t)128, tmp81);
ClearMemSecret2( (int32_t)128,  (int32_t)128, tmp14);
ScaleUp2( (int32_t)1,  (int32_t)128, tmp15,  (int32_t)12);

uint64_t* tmp86 = make_array<uint64_t>( (int32_t)3,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)3; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp86, (int32_t)3, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp83, (int32_t)3, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp15, (int32_t)1, (int32_t)128, (int32_t)0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp15);
ClearMemSecret2( (int32_t)3,  (int32_t)128, tmp83);

uint64_t* tmp89 = make_array<uint64_t>( (int32_t)3,  (int32_t)128);
Relu2( (int32_t)3,  (int32_t)128, tmp86, tmp89,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)3,  (int32_t)128, tmp86);
...
uint64_t* tmp92 = make_array<uint64_t>( (int32_t)128,  (int32_t)1,  (int32_t)3,  (int32_t)1);
...
Arr4DIdxRowM(tmp92, (int32_t)128, (int32_t)1, (int32_t)3, (int32_t)1,i19,i20,i21,i22) = Arr2DIdxRowM(tmp89, (int32_t)3, (int32_t)128,i17,i18);
i18 = (i18 +  (int64_t)1);
if ((i18 ==  (int64_t)128)) {
i18 =  (int64_t)0;
i17 = (i17 +  (int64_t)1);
...
ClearMemSecret2( (int32_t)3,  (int32_t)128, tmp89);

uint64_t* tmp94 = make_array<uint64_t>( (int32_t)128,  (int32_t)1,  (int32_t)1,  (int32_t)1);
MaxPool( (int32_t)128,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)3,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1,  (int32_t)128,  (int32_t)1,  (int32_t)3,  (int32_t)1, tmp92, tmp94);
ClearMemSecret4( (int32_t)128,  (int32_t)1,  (int32_t)3,  (int32_t)1, tmp92);
...
uint64_t* tmp118 = make_array<uint64_t>( (int32_t)3,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)3; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp118, (int32_t)3, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp3, (int32_t)3, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp26, (int32_t)3, (int32_t)128,i0,i1));
}
}
ClearMemSecret2( (int32_t)3,  (int32_t)128, tmp3);
ClearMemSecret2( (int32_t)3,  (int32_t)128, tmp26);

uint64_t* tmp121 = make_array<uint64_t>( (int32_t)3,  (int32_t)128);
ScaleDown2( (int32_t)3,  (int32_t)128, tmp118,  (int32_t)12);
MatMul2D( (int32_t)3,  (int32_t)128,  (int32_t)128, tmp118, tmp20, tmp121, 0);
ClearMemSecret2( (int32_t)128,  (int32_t)128, tmp20);
ClearMemSecret2( (int32_t)3,  (int32_t)128, tmp118);
ScaleUp2( (int32_t)1,  (int32_t)128, tmp21,  (int32_t)12);

uint64_t* tmp124 = make_array<uint64_t>( (int32_t)3,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)3; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp124, (int32_t)3, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp121, (int32_t)3, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp21, (int32_t)1, (int32_t)128, (int32_t)0,i1));
}
}
ClearMemSecret2( (int32_t)3,  (int32_t)128, tmp121);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp21);

uint64_t* tmp127 = make_array<uint64_t>( (int32_t)3,  (int32_t)128);
Relu2( (int32_t)3,  (int32_t)128, tmp124, tmp127,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)3,  (int32_t)128, tmp124);
...
uint64_t* tmp130 = make_array<uint64_t>( (int32_t)128,  (int32_t)1,  (int32_t)3,  (int32_t)1);
...
Arr4DIdxRowM(tmp130, (int32_t)128, (int32_t)1, (int32_t)3, (int32_t)1,i31,i32,i33,i34) = Arr2DIdxRowM(tmp127, (int32_t)3, (int32_t)128,i29,i30);
i30 = (i30 +  (int64_t)1);
if ((i30 ==  (int64_t)128)) {
i30 =  (int64_t)0;
i29 = (i29 +  (int64_t)1);
...
MaxPool( (int32_t)128,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)3,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1,  (int32_t)128,  (int32_t)1,  (int32_t)3,  (int32_t)1, tmp130, tmp132);
ClearMemSecret4( (int32_t)128,  (int32_t)1,  (int32_t)3,  (int32_t)1, tmp130);
