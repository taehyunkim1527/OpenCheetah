...
Arr1DIdxRowM(tmp10, (int32_t)1280,tmp13) = Arr2DIdxRowM(tmp3, (int32_t)5, (int32_t)256,i0,i1);
Arr1DIdxRowM(tmp11, (int32_t)1280,tmp13) = Arr2DIdxRowM(tmp2, (int32_t)1, (int32_t)256, (int32_t)0,i1);
}
}
...
uint64_t* tmp27 = make_array<uint64_t>( (int32_t)5,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)5; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp27, (int32_t)5, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp1, (int32_t)5, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp9, (int32_t)5, (int32_t)256,i0,i1));
}
}
ClearMemSecret2( (int32_t)5,  (int32_t)256, tmp1);
ClearMemSecret2( (int32_t)5,  (int32_t)256, tmp9);
ScaleDown2( (int32_t)5,  (int32_t)256, tmp27,  (int32_t)12);
...
Arr1DIdxRowM(tmp31, (int32_t)1280,tmp34) = Arr2DIdxRowM(tmp27, (int32_t)5, (int32_t)256,i5,i6);
Arr1DIdxRowM(tmp32, (int32_t)1280,tmp34) = Arr2DIdxRowM(tmp6, (int32_t)5, (int32_t)256,i5,i6);
}
}
...
for (uint32_t i6 =  (int32_t)0; i6 <  (int32_t)256; i6++){
tmp34 = (( (int32_t)0 + (i5 *  (int32_t)256)) + (i6 *  (int32_t)1));
Arr2DIdxRowM(tmp30, (int32_t)5, (int32_t)256,i5,i6) = Arr1DIdxRowM(tmp33, (int32_t)1280,tmp34);
}
}
ClearMemSecret1( (int32_t)1280, tmp33);
ClearMemSecret2( (int32_t)5,  (int32_t)256, tmp27);
...
tmp38 = SecretAdd(tmp38, Arr2DIdxRowM(tmp30, (int32_t)5, (int32_t)256,i8,i7));
}
