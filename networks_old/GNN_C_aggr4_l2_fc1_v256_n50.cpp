...
uint64_t* tmp5 = make_array<uint64_t>( (int32_t)50,  (int32_t)1);
/* Variable to read the clear value corresponding to the input variable tmp5 at (9042,1-9042,37) */
...
Arr2DIdxRowM(tmp5, (int32_t)50, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp5 : 0;
}
}
...
Arr1DIdxRowM(tmp8, (int32_t)12800,tmp11) = Arr2DIdxRowM(tmp3, (int32_t)50, (int32_t)256,i0,i1);
Arr1DIdxRowM(tmp9, (int32_t)12800,tmp11) = Arr2DIdxRowM(tmp2, (int32_t)1, (int32_t)256, (int32_t)0,i1);
}
}
...
ScaleDown2( (int32_t)50,  (int32_t)256, tmp14,  (int32_t)12);
...
tmp20 = (( (int32_t)0 + (i2 *  (int32_t)256)) + (i3 *  (int32_t)1));
Arr1DIdxRowM(tmp17, (int32_t)12800,tmp20) = Arr2DIdxRowM(tmp14, (int32_t)50, (int32_t)256,i2,i3);
Arr1DIdxRowM(tmp18, (int32_t)12800,tmp20) = Arr2DIdxRowM(tmp5, (int32_t)50, (int32_t)1,i2, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)12800, tmp17, tmp18, tmp19);
ClearMemSecret1( (int32_t)12800, tmp17);
ClearMemSecret1( (int32_t)12800, tmp18);
for (uint32_t i2 =  (int32_t)0; i2 <  (int32_t)50; i2++){
for (uint32_t i3 =  (int32_t)0; i3 <  (int32_t)256; i3++){
tmp20 = (( (int32_t)0 + (i2 *  (int32_t)256)) + (i3 *  (int32_t)1));
Arr2DIdxRowM(tmp16, (int32_t)50, (int32_t)256,i2,i3) = Arr1DIdxRowM(tmp19, (int32_t)12800,tmp20);
}
}
ClearMemSecret1( (int32_t)12800, tmp19);
ClearMemSecret2( (int32_t)50,  (int32_t)256, tmp14);
ClearMemSecret2( (int32_t)50,  (int32_t)1, tmp5);

int32_t tmp23 =  (int32_t)0;
...
tmp24 = SecretAdd(tmp24, Arr2DIdxRowM(tmp16, (int32_t)50, (int32_t)256,i5,i4));
}
Arr1DIdxRowM(tmp25, (int32_t)256,i4) = tmp24;
}
ClearMemSecret2( (int32_t)50,  (int32_t)256, tmp16);
ScaleUp1( (int32_t)256, tmp4,  (int32_t)12);

uint64_t* tmp27 = make_array<uint64_t>( (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)256; i0++){
Arr1DIdxRowM(tmp27, (int32_t)256,i0) = SecretAdd(Arr1DIdxRowM(tmp25, (int32_t)256,i0), Arr1DIdxRowM(tmp4, (int32_t)256,i0));
}
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp29, (int32_t)50, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp1, (int32_t)50, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp7, (int32_t)50, (int32_t)256,i0,i1));
}
}
...
tmp36 = (( (int32_t)0 + (i6 *  (int32_t)256)) + (i7 *  (int32_t)1));
Arr1DIdxRowM(tmp33, (int32_t)12800,tmp36) = Arr2DIdxRowM(tmp29, (int32_t)50, (int32_t)256,i6,i7);
Arr1DIdxRowM(tmp34, (int32_t)12800,tmp36) = Arr2DIdxRowM(tmp6, (int32_t)50, (int32_t)1,i6, (int32_t)0);
}
}
...
for (uint32_t i7 =  (int32_t)0; i7 <  (int32_t)256; i7++){
tmp36 = (( (int32_t)0 + (i6 *  (int32_t)256)) + (i7 *  (int32_t)1));
Arr2DIdxRowM(tmp32, (int32_t)50, (int32_t)256,i6,i7) = Arr1DIdxRowM(tmp35, (int32_t)12800,tmp36);
}
}
...
tmp40 = SecretAdd(tmp40, Arr2DIdxRowM(tmp32, (int32_t)50, (int32_t)256,i9,i8));
}
Arr1DIdxRowM(tmp41, (int32_t)256,i8) = tmp40;
}
ClearMemSecret2( (int32_t)50,  (int32_t)256, tmp32);

uint64_t* tmp43 = make_array<uint64_t>( (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)256; i0++){
Arr1DIdxRowM(tmp43, (int32_t)256,i0) = SecretAdd(Arr1DIdxRowM(tmp41, (int32_t)256,i0), Arr1DIdxRowM(tmp4, (int32_t)256,i0));
}
ClearMemSecret1( (int32_t)256, tmp41);
ClearMemSecret1( (int32_t)256, tmp4);
ScaleDown1( (int32_t)256, tmp43,  (int32_t)12);
EndComputation();
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)256; i0++){
cout << (funcReconstruct2PCCons(Arr1DIdxRowM(tmp43, (int32_t)256,i0), 2)) << endl;
}
}
