...
uint64_t* tmp10 = make_array<uint64_t>( (int32_t)3,  (int32_t)1);
...
Arr2DIdxRowM(tmp10, (int32_t)3, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp10 : 0;
}
}
...
Arr1DIdxRowM(tmp35, (int32_t)1536,tmp37) = Arr2DIdxRowM(tmp7, (int32_t)3, (int32_t)1,i5, (int32_t)0);
}
}
...
Arr1DIdxRowM(tmp63, (int32_t)1536,tmp65) = Arr2DIdxRowM(tmp10, (int32_t)3, (int32_t)1,i12, (int32_t)0);
}
}
...
ClearMemSecret2( (int32_t)3,  (int32_t)1, tmp10);
