...
uint64_t* tmp49 = make_array<uint64_t>( (int32_t)128);
...
tmp51 = (( (int32_t)0 + (i10 *  (int32_t)128)) + (i11 *  (int32_t)1));
Arr1DIdxRowM(tmp48, (int32_t)128,tmp51) = Arr2DIdxRowM(tmp44, (int32_t)1, (int32_t)128,i10,i11);
Arr1DIdxRowM(tmp49, (int32_t)128,tmp51) = Arr2DIdxRowM(tmp8, (int32_t)1, (int32_t)1,i10, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)128, tmp48, tmp49, tmp50);
ClearMemSecret1( (int32_t)128, tmp48);
ClearMemSecret1( (int32_t)128, tmp49);
for (uint32_t i10 =  (int32_t)0; i10 <  (int32_t)1; i10++){
for (uint32_t i11 =  (int32_t)0; i11 <  (int32_t)128; i11++){
tmp51 = (( (int32_t)0 + (i10 *  (int32_t)128)) + (i11 *  (int32_t)1));
Arr2DIdxRowM(tmp47, (int32_t)1, (int32_t)128,i10,i11) = Arr1DIdxRowM(tmp50, (int32_t)128,tmp51);
}
}
...
MatMul2D( (int32_t)1,  (int32_t)128,  (int32_t)128, tmp47, tmp9, tmp54, 0);
...
uint64_t* tmp66 = make_array<uint64_t>( (int32_t)128);
for (uint32_t i12 =  (int32_t)0; i12 <  (int32_t)128; i12++){
tmp65 = funcSSCons( (int64_t)0);
for (uint32_t i13 =  (int32_t)0; i13 <  (int32_t)5; i13++){
tmp65 = SecretAdd(tmp65, Arr2DIdxRowM(tmp62, (int32_t)5, (int32_t)128,i13,i12));
}
Arr1DIdxRowM(tmp66, (int32_t)128,i12) = tmp65;
}
...
Arr1DIdxRowM(tmp68, (int32_t)2, (int64_t)1) =  (int32_t)128;
...
Arr2DIdxRowM(tmp69, (int32_t)1, (int32_t)128,i15,i16) = Arr1DIdxRowM(tmp66, (int32_t)128,i14);
i14 = (i14 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)128, tmp66);
ScaleUp2( (int32_t)1,  (int32_t)128, tmp60,  (int32_t)12);

uint64_t* tmp71 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp71, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp69, (int32_t)1, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp60, (int32_t)1, (int32_t)128,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp60);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp69);
ScaleDown2( (int32_t)1,  (int32_t)128, tmp71,  (int32_t)12);
...
tmp78 = (( (int32_t)0 + (i17 *  (int32_t)128)) + (i18 *  (int32_t)1));
Arr1DIdxRowM(tmp75, (int32_t)128,tmp78) = Arr2DIdxRowM(tmp71, (int32_t)1, (int32_t)128,i17,i18);
Arr1DIdxRowM(tmp76, (int32_t)128,tmp78) = Arr2DIdxRowM(tmp11, (int32_t)1, (int32_t)1,i17, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)128, tmp75, tmp76, tmp77);
ClearMemSecret1( (int32_t)128, tmp75);
ClearMemSecret1( (int32_t)128, tmp76);
for (uint32_t i17 =  (int32_t)0; i17 <  (int32_t)1; i17++){
for (uint32_t i18 =  (int32_t)0; i18 <  (int32_t)128; i18++){
tmp78 = (( (int32_t)0 + (i17 *  (int32_t)128)) + (i18 *  (int32_t)1));
Arr2DIdxRowM(tmp74, (int32_t)1, (int32_t)128,i17,i18) = Arr1DIdxRowM(tmp77, (int32_t)128,tmp78);
}
}
...
ScaleDown2( (int32_t)1,  (int32_t)128, tmp74,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)128,  (int32_t)128, tmp74, tmp12, tmp81, 0);
...
uint64_t* tmp94 = make_array<uint64_t>( (int32_t)128);
for (uint32_t i19 =  (int32_t)0; i19 <  (int32_t)128; i19++){
tmp93 = funcSSCons( (int64_t)0);
for (uint32_t i20 =  (int32_t)0; i20 <  (int32_t)5; i20++){
tmp93 = SecretAdd(tmp93, Arr2DIdxRowM(tmp89, (int32_t)5, (int32_t)128,i20,i19));
}
Arr1DIdxRowM(tmp94, (int32_t)128,i19) = tmp93;
}
...
Arr2DIdxRowM(tmp97, (int32_t)1, (int32_t)128,i22,i23) = Arr1DIdxRowM(tmp94, (int32_t)128,i21);
i21 = (i21 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)128, tmp94);
ScaleUp2( (int32_t)1,  (int32_t)128, tmp87,  (int32_t)12);

uint64_t* tmp99 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp99, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp97, (int32_t)1, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp87, (int32_t)1, (int32_t)128,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp97);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp87);
ScaleDown2( (int32_t)1,  (int32_t)128, tmp99,  (int32_t)12);
...
tmp106 = (( (int32_t)0 + (i24 *  (int32_t)128)) + (i25 *  (int32_t)1));
Arr1DIdxRowM(tmp103, (int32_t)128,tmp106) = Arr2DIdxRowM(tmp99, (int32_t)1, (int32_t)128,i24,i25);
Arr1DIdxRowM(tmp104, (int32_t)128,tmp106) = Arr2DIdxRowM(tmp14, (int32_t)1, (int32_t)1,i24, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)128, tmp103, tmp104, tmp105);
ClearMemSecret1( (int32_t)128, tmp103);
ClearMemSecret1( (int32_t)128, tmp104);
for (uint32_t i24 =  (int32_t)0; i24 <  (int32_t)1; i24++){
for (uint32_t i25 =  (int32_t)0; i25 <  (int32_t)128; i25++){
tmp106 = (( (int32_t)0 + (i24 *  (int32_t)128)) + (i25 *  (int32_t)1));
Arr2DIdxRowM(tmp102, (int32_t)1, (int32_t)128,i24,i25) = Arr1DIdxRowM(tmp105, (int32_t)128,tmp106);
}
}
...
MatMul2D( (int32_t)1,  (int32_t)128,  (int32_t)128, tmp102, tmp15, tmp109, 0);
