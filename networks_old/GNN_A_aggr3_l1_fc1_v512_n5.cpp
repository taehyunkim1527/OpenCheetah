...
tmp14 = (( (int32_t)0 + (i0 *  (int32_t)512)) + (i1 *  (int32_t)1));
Arr1DIdxRowM(tmp11, (int32_t)2560,tmp14) = Arr2DIdxRowM(tmp3, (int32_t)5, (int32_t)512,i0,i1);
Arr1DIdxRowM(tmp12, (int32_t)2560,tmp14) = Arr2DIdxRowM(tmp2, (int32_t)1, (int32_t)512, (int32_t)0,i1);
}
}
ElemWiseActModelVectorMult( (int32_t)2560, tmp11, tmp12, tmp13);
ClearMemSecret1( (int32_t)2560, tmp11);
ClearMemSecret1( (int32_t)2560, tmp12);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)5; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
tmp14 = (( (int32_t)0 + (i0 *  (int32_t)512)) + (i1 *  (int32_t)1));
Arr2DIdxRowM(tmp10, (int32_t)5, (int32_t)512,i0,i1) = Arr1DIdxRowM(tmp13, (int32_t)2560,tmp14);
}
}
...
Arr2DIdxRowM(tmp18, (int32_t)1, (int32_t)512,i3,i4) = Arr1DIdxRowM(tmp0, (int32_t)512,i2);
i2 = (i2 +  (int64_t)1);
}
}
...
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp18, tmp4, tmp20, 0);
...
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp23, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp20, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp5, (int32_t)1, (int32_t)512,i0,i1));
}
}
...
Relu2( (int32_t)1,  (int32_t)512, tmp23, tmp26,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp23);
ScaleUp2( (int32_t)5,  (int32_t)512, tmp1,  (int32_t)12);

uint64_t* tmp28 = make_array<uint64_t>( (int32_t)5,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)5; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp28, (int32_t)5, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp1, (int32_t)5, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp10, (int32_t)5, (int32_t)512,i0,i1));
}
}
...
ScaleDown2( (int32_t)5,  (int32_t)512, tmp28,  (int32_t)12);
MatMul2D( (int32_t)5,  (int32_t)512,  (int32_t)512, tmp28, tmp6, tmp31, 0);
ClearMemSecret2( (int32_t)512,  (int32_t)512, tmp6);
ClearMemSecret2( (int32_t)5,  (int32_t)512, tmp28);
ScaleUp2( (int32_t)1,  (int32_t)512, tmp7,  (int32_t)12);

uint64_t* tmp34 = make_array<uint64_t>( (int32_t)5,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)5; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp34, (int32_t)5, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp31, (int32_t)5, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp7, (int32_t)1, (int32_t)512, (int32_t)0,i1));
}
}
...
Relu2( (int32_t)5,  (int32_t)512, tmp34, tmp37,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)5,  (int32_t)512, tmp34);

int32_t* tmp39 = make_array<int32_t>( (int32_t)4);
Arr1DIdxRowM(tmp39, (int32_t)4, (int64_t)0) =  (int32_t)512;
Arr1DIdxRowM(tmp39, (int32_t)4, (int64_t)1) =  (int32_t)1;
Arr1DIdxRowM(tmp39, (int32_t)4, (int64_t)2) =  (int32_t)5;
Arr1DIdxRowM(tmp39, (int32_t)4, (int64_t)3) =  (int32_t)1;

uint64_t* tmp40 = make_array<uint64_t>( (int32_t)512,  (int32_t)1,  (int32_t)5,  (int32_t)1);
...
Arr4DIdxRowM(tmp40, (int32_t)512, (int32_t)1, (int32_t)5, (int32_t)1,i7,i8,i9,i10) = Arr2DIdxRowM(tmp37, (int32_t)5, (int32_t)512,i5,i6);
i6 = (i6 +  (int64_t)1);
if ((i6 ==  (int64_t)512)) {
i6 =  (int64_t)0;
i5 = (i5 +  (int64_t)1);
...
uint64_t* tmp42 = make_array<uint64_t>( (int32_t)512,  (int32_t)1,  (int32_t)1,  (int32_t)1);
MaxPool( (int32_t)512,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)5,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1,  (int32_t)512,  (int32_t)1,  (int32_t)5,  (int32_t)1, tmp40, tmp42);
ClearMemSecret4( (int32_t)512,  (int32_t)1,  (int32_t)5,  (int32_t)1, tmp40);
...
Arr2DIdxRowM(tmp45, (int32_t)1, (int32_t)512,i15,i16) = Arr4DIdxRowM(tmp42, (int32_t)512, (int32_t)1, (int32_t)1, (int32_t)1,i11,i12,i13,i14);
i14 = (i14 +  (int64_t)1);
if ((i14 ==  (int64_t)1)) {
i14 =  (int64_t)0;
i13 = (i13 +  (int64_t)1);
...
ClearMemSecret4( (int32_t)512,  (int32_t)1,  (int32_t)1,  (int32_t)1, tmp42);

uint64_t* tmp47 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp47, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp45, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp26, (int32_t)1, (int32_t)512,i0,i1));
}
}
...
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (uint32_t)0; i1 <  (int32_t)512; i1++){
cout << (funcReconstruct2PCCons(Arr2DIdxRowM(tmp56, (int32_t)1, (int32_t)512,i0,i1), 2)) << endl;
}
}
}
