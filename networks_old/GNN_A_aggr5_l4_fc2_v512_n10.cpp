...
uint64_t* tmp9 = make_array<uint64_t>( (int32_t)10,  (int32_t)512);
...
Arr2DIdxRowM(tmp9, (int32_t)10, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp9 : 0;
}
}
...
uint64_t* tmp14 = make_array<uint64_t>( (int32_t)10,  (int32_t)512);
...
Arr2DIdxRowM(tmp14, (int32_t)10, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp14 : 0;
}
}
...
uint64_t* tmp19 = make_array<uint64_t>( (int32_t)10,  (int32_t)512);
...
Arr2DIdxRowM(tmp19, (int32_t)10, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp19 : 0;
}
}
...
uint64_t* tmp24 = make_array<uint64_t>( (int32_t)10,  (int32_t)512);
...
Arr2DIdxRowM(tmp24, (int32_t)10, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp24 : 0;
}
}
...
uint64_t* tmp29 = make_array<uint64_t>( (int32_t)10,  (int32_t)512);

uint64_t* tmp30 = make_array<uint64_t>( (int32_t)5120);

uint64_t* tmp31 = make_array<uint64_t>( (int32_t)5120);

uint64_t* tmp32 = make_array<uint64_t>( (int32_t)5120);
...
Arr1DIdxRowM(tmp30, (int32_t)5120,tmp33) = Arr2DIdxRowM(tmp6, (int32_t)10, (int32_t)512,i0,i1);
Arr1DIdxRowM(tmp31, (int32_t)5120,tmp33) = Arr2DIdxRowM(tmp5, (int32_t)1, (int32_t)512, (int32_t)0,i1);
}
}
ElemWiseActModelVectorMult( (int32_t)5120, tmp30, tmp31, tmp32);
ClearMemSecret1( (int32_t)5120, tmp30);
ClearMemSecret1( (int32_t)5120, tmp31);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)10; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
tmp33 = (( (int32_t)0 + (i0 *  (int32_t)512)) + (i1 *  (int32_t)1));
Arr2DIdxRowM(tmp29, (int32_t)10, (int32_t)512,i0,i1) = Arr1DIdxRowM(tmp32, (int32_t)5120,tmp33);
}
}
ClearMemSecret1( (int32_t)5120, tmp32);
...
uint64_t* tmp47 = make_array<uint64_t>( (int32_t)10,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)10; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp47, (int32_t)10, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp1, (int32_t)10, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp29, (int32_t)10, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)10,  (int32_t)512, tmp1);
ScaleDown2( (int32_t)10,  (int32_t)512, tmp47,  (int32_t)12);

uint64_t* tmp49 = make_array<uint64_t>( (int32_t)10,  (int32_t)512);

uint64_t* tmp50 = make_array<uint64_t>( (int32_t)5120);

uint64_t* tmp51 = make_array<uint64_t>( (int32_t)5120);

uint64_t* tmp52 = make_array<uint64_t>( (int32_t)5120);
...
Arr1DIdxRowM(tmp50, (int32_t)5120,tmp53) = Arr2DIdxRowM(tmp47, (int32_t)10, (int32_t)512,i5,i6);
Arr1DIdxRowM(tmp51, (int32_t)5120,tmp53) = Arr2DIdxRowM(tmp9, (int32_t)10, (int32_t)512,i5,i6);
}
}
ElemWiseActModelVectorMult( (int32_t)5120, tmp50, tmp51, tmp52);
ClearMemSecret1( (int32_t)5120, tmp50);
ClearMemSecret1( (int32_t)5120, tmp51);
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)10; i5++){
for (uint32_t i6 =  (int32_t)0; i6 <  (int32_t)512; i6++){
tmp53 = (( (int32_t)0 + (i5 *  (int32_t)512)) + (i6 *  (int32_t)1));
Arr2DIdxRowM(tmp49, (int32_t)10, (int32_t)512,i5,i6) = Arr1DIdxRowM(tmp52, (int32_t)5120,tmp53);
}
}
ClearMemSecret1( (int32_t)5120, tmp52);
ClearMemSecret2( (int32_t)10,  (int32_t)512, tmp47);
ClearMemSecret2( (int32_t)10,  (int32_t)512, tmp9);
...
for (uint32_t i8 =  (int32_t)0; i8 <  (int32_t)10; i8++){
tmp57 = SecretAdd(tmp57, Arr2DIdxRowM(tmp49, (int32_t)10, (int32_t)512,i8,i7));
}
Arr1DIdxRowM(tmp58, (int32_t)512,i7) = tmp57;
}
ClearMemSecret2( (int32_t)10,  (int32_t)512, tmp49);
...
uint64_t* tmp82 = make_array<uint64_t>( (int32_t)10,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)10; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp82, (int32_t)10, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp2, (int32_t)10, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp29, (int32_t)10, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)10,  (int32_t)512, tmp2);
ScaleDown2( (int32_t)10,  (int32_t)512, tmp82,  (int32_t)12);

uint64_t* tmp84 = make_array<uint64_t>( (int32_t)10,  (int32_t)512);

uint64_t* tmp85 = make_array<uint64_t>( (int32_t)5120);

uint64_t* tmp86 = make_array<uint64_t>( (int32_t)5120);

uint64_t* tmp87 = make_array<uint64_t>( (int32_t)5120);

int32_t tmp88;
for (uint32_t i12 =  (int32_t)0; i12 <  (int32_t)10; i12++){
for (uint32_t i13 =  (int32_t)0; i13 <  (int32_t)512; i13++){
tmp88 = (( (int32_t)0 + (i12 *  (int32_t)512)) + (i13 *  (int32_t)1));
Arr1DIdxRowM(tmp85, (int32_t)5120,tmp88) = Arr2DIdxRowM(tmp82, (int32_t)10, (int32_t)512,i12,i13);
Arr1DIdxRowM(tmp86, (int32_t)5120,tmp88) = Arr2DIdxRowM(tmp14, (int32_t)10, (int32_t)512,i12,i13);
}
}
ElemWiseActModelVectorMult( (int32_t)5120, tmp85, tmp86, tmp87);
ClearMemSecret1( (int32_t)5120, tmp85);
ClearMemSecret1( (int32_t)5120, tmp86);
for (uint32_t i12 =  (int32_t)0; i12 <  (int32_t)10; i12++){
for (uint32_t i13 =  (int32_t)0; i13 <  (int32_t)512; i13++){
tmp88 = (( (int32_t)0 + (i12 *  (int32_t)512)) + (i13 *  (int32_t)1));
Arr2DIdxRowM(tmp84, (int32_t)10, (int32_t)512,i12,i13) = Arr1DIdxRowM(tmp87, (int32_t)5120,tmp88);
}
}
ClearMemSecret1( (int32_t)5120, tmp87);
ClearMemSecret2( (int32_t)10,  (int32_t)512, tmp14);
ClearMemSecret2( (int32_t)10,  (int32_t)512, tmp82);
...
for (uint32_t i15 =  (int32_t)0; i15 <  (int32_t)10; i15++){
tmp92 = SecretAdd(tmp92, Arr2DIdxRowM(tmp84, (int32_t)10, (int32_t)512,i15,i14));
}
Arr1DIdxRowM(tmp93, (int32_t)512,i14) = tmp92;
}
ClearMemSecret2( (int32_t)10,  (int32_t)512, tmp84);
...
uint64_t* tmp117 = make_array<uint64_t>( (int32_t)10,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)10; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp117, (int32_t)10, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp3, (int32_t)10, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp29, (int32_t)10, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)10,  (int32_t)512, tmp3);
ScaleDown2( (int32_t)10,  (int32_t)512, tmp117,  (int32_t)12);

uint64_t* tmp119 = make_array<uint64_t>( (int32_t)10,  (int32_t)512);

uint64_t* tmp120 = make_array<uint64_t>( (int32_t)5120);

uint64_t* tmp121 = make_array<uint64_t>( (int32_t)5120);

uint64_t* tmp122 = make_array<uint64_t>( (int32_t)5120);

int32_t tmp123;
for (uint32_t i19 =  (int32_t)0; i19 <  (int32_t)10; i19++){
for (uint32_t i20 =  (int32_t)0; i20 <  (int32_t)512; i20++){
tmp123 = (( (int32_t)0 + (i19 *  (int32_t)512)) + (i20 *  (int32_t)1));
Arr1DIdxRowM(tmp120, (int32_t)5120,tmp123) = Arr2DIdxRowM(tmp117, (int32_t)10, (int32_t)512,i19,i20);
Arr1DIdxRowM(tmp121, (int32_t)5120,tmp123) = Arr2DIdxRowM(tmp19, (int32_t)10, (int32_t)512,i19,i20);
}
}
ElemWiseActModelVectorMult( (int32_t)5120, tmp120, tmp121, tmp122);
ClearMemSecret1( (int32_t)5120, tmp120);
ClearMemSecret1( (int32_t)5120, tmp121);
for (uint32_t i19 =  (int32_t)0; i19 <  (int32_t)10; i19++){
for (uint32_t i20 =  (int32_t)0; i20 <  (int32_t)512; i20++){
tmp123 = (( (int32_t)0 + (i19 *  (int32_t)512)) + (i20 *  (int32_t)1));
Arr2DIdxRowM(tmp119, (int32_t)10, (int32_t)512,i19,i20) = Arr1DIdxRowM(tmp122, (int32_t)5120,tmp123);
}
}
ClearMemSecret1( (int32_t)5120, tmp122);
ClearMemSecret2( (int32_t)10,  (int32_t)512, tmp19);
ClearMemSecret2( (int32_t)10,  (int32_t)512, tmp117);
...
for (uint32_t i22 =  (int32_t)0; i22 <  (int32_t)10; i22++){
tmp127 = SecretAdd(tmp127, Arr2DIdxRowM(tmp119, (int32_t)10, (int32_t)512,i22,i21));
}
Arr1DIdxRowM(tmp128, (int32_t)512,i21) = tmp127;
}
ClearMemSecret2( (int32_t)10,  (int32_t)512, tmp119);
...
uint64_t* tmp152 = make_array<uint64_t>( (int32_t)10,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)10; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp152, (int32_t)10, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp4, (int32_t)10, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp29, (int32_t)10, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)10,  (int32_t)512, tmp4);
ClearMemSecret2( (int32_t)10,  (int32_t)512, tmp29);
ScaleDown2( (int32_t)10,  (int32_t)512, tmp152,  (int32_t)12);

uint64_t* tmp155 = make_array<uint64_t>( (int32_t)10,  (int32_t)512);

uint64_t* tmp156 = make_array<uint64_t>( (int32_t)5120);

uint64_t* tmp157 = make_array<uint64_t>( (int32_t)5120);

uint64_t* tmp158 = make_array<uint64_t>( (int32_t)5120);

int32_t tmp159;
for (uint32_t i26 =  (int32_t)0; i26 <  (int32_t)10; i26++){
for (uint32_t i27 =  (int32_t)0; i27 <  (int32_t)512; i27++){
tmp159 = (( (int32_t)0 + (i26 *  (int32_t)512)) + (i27 *  (int32_t)1));
Arr1DIdxRowM(tmp156, (int32_t)5120,tmp159) = Arr2DIdxRowM(tmp152, (int32_t)10, (int32_t)512,i26,i27);
Arr1DIdxRowM(tmp157, (int32_t)5120,tmp159) = Arr2DIdxRowM(tmp24, (int32_t)10, (int32_t)512,i26,i27);
}
}
ElemWiseActModelVectorMult( (int32_t)5120, tmp156, tmp157, tmp158);
ClearMemSecret1( (int32_t)5120, tmp156);
ClearMemSecret1( (int32_t)5120, tmp157);
for (uint32_t i26 =  (int32_t)0; i26 <  (int32_t)10; i26++){
for (uint32_t i27 =  (int32_t)0; i27 <  (int32_t)512; i27++){
tmp159 = (( (int32_t)0 + (i26 *  (int32_t)512)) + (i27 *  (int32_t)1));
Arr2DIdxRowM(tmp155, (int32_t)10, (int32_t)512,i26,i27) = Arr1DIdxRowM(tmp158, (int32_t)5120,tmp159);
}
}
ClearMemSecret1( (int32_t)5120, tmp158);
ClearMemSecret2( (int32_t)10,  (int32_t)512, tmp152);
ClearMemSecret2( (int32_t)10,  (int32_t)512, tmp24);
...
for (uint32_t i29 =  (int32_t)0; i29 <  (int32_t)10; i29++){
tmp163 = SecretAdd(tmp163, Arr2DIdxRowM(tmp155, (int32_t)10, (int32_t)512,i29,i28));
}
Arr1DIdxRowM(tmp164, (int32_t)512,i28) = tmp163;
}
ClearMemSecret2( (int32_t)10,  (int32_t)512, tmp155);
