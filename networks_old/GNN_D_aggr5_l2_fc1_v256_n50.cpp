...
tmp3 = SecretAdd(tmp3, Arr2DIdxRowM(tmp0, (int32_t)50, (int32_t)256,i1,i0));
}
Arr1DIdxRowM(tmp4, (int32_t)256,i0) = tmp3;
}
...
tmp7 = SecretAdd(tmp7, Arr2DIdxRowM(tmp1, (int32_t)50, (int32_t)256,i3,i2));
}
Arr1DIdxRowM(tmp8, (int32_t)256,i2) = tmp7;
}
ClearMemSecret2( (int32_t)50,  (int32_t)256, tmp1);
EndComputation();
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)256; i0++){
cout << (funcReconstruct2PCCons(Arr1DIdxRowM(tmp8, (int32_t)256,i0), 2)) << endl;
}
}
