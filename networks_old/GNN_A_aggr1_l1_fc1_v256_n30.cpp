...
Arr1DIdxRowM(tmp9, (int32_t)7680,tmp12) = Arr2DIdxRowM(tmp3, (int32_t)30, (int32_t)256,i0,i1);
Arr1DIdxRowM(tmp10, (int32_t)7680,tmp12) = Arr2DIdxRowM(tmp2, (int32_t)1, (int32_t)256, (int32_t)0,i1);
}
}
ElemWiseActModelVectorMult( (int32_t)7680, tmp9, tmp10, tmp11);
ClearMemSecret1( (int32_t)7680, tmp9);
ClearMemSecret1( (int32_t)7680, tmp10);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)30; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
tmp12 = (( (int32_t)0 + (i0 *  (int32_t)256)) + (i1 *  (int32_t)1));
Arr2DIdxRowM(tmp8, (int32_t)30, (int32_t)256,i0,i1) = Arr1DIdxRowM(tmp11, (int32_t)7680,tmp12);
}
}
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)30; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp26, (int32_t)30, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp1, (int32_t)30, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp8, (int32_t)30, (int32_t)256,i0,i1));
}
}
...
tmp30 = SecretAdd(tmp30, Arr2DIdxRowM(tmp26, (int32_t)30, (int32_t)256,i6,i5));
}
