...
uint64_t* tmp6 = make_array<uint64_t>( (int32_t)12800);
...
tmp9 = (( (int32_t)0 + (i0 *  (int32_t)256)) + (i1 *  (int32_t)1));
Arr1DIdxRowM(tmp6, (int32_t)12800,tmp9) = Arr2DIdxRowM(tmp3, (int32_t)50, (int32_t)256,i0,i1);
Arr1DIdxRowM(tmp7, (int32_t)12800,tmp9) = Arr2DIdxRowM(tmp2, (int32_t)1, (int32_t)256, (int32_t)0,i1);
}
}
ElemWiseActModelVectorMult( (int32_t)12800, tmp6, tmp7, tmp8);
ClearMemSecret1( (int32_t)12800, tmp6);
ClearMemSecret1( (int32_t)12800, tmp7);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
tmp9 = (( (int32_t)0 + (i0 *  (int32_t)256)) + (i1 *  (int32_t)1));
Arr2DIdxRowM(tmp5, (int32_t)50, (int32_t)256,i0,i1) = Arr1DIdxRowM(tmp8, (int32_t)12800,tmp9);
}
}
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp12, (int32_t)50, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp0, (int32_t)50, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp5, (int32_t)50, (int32_t)256,i0,i1));
}
}
ClearMemSecret2( (int32_t)50,  (int32_t)256, tmp0);

int32_t* tmp14 = make_array<int32_t>( (int32_t)4);
Arr1DIdxRowM(tmp14, (int32_t)4, (int64_t)0) =  (int32_t)256;
Arr1DIdxRowM(tmp14, (int32_t)4, (int64_t)1) =  (int32_t)1;
Arr1DIdxRowM(tmp14, (int32_t)4, (int64_t)2) =  (int32_t)50;
Arr1DIdxRowM(tmp14, (int32_t)4, (int64_t)3) =  (int32_t)1;

uint64_t* tmp15 = make_array<uint64_t>( (int32_t)256,  (int32_t)1,  (int32_t)50,  (int32_t)1);
...
Arr4DIdxRowM(tmp15, (int32_t)256, (int32_t)1, (int32_t)50, (int32_t)1,i4,i5,i6,i7) = Arr2DIdxRowM(tmp12, (int32_t)50, (int32_t)256,i2,i3);
i3 = (i3 +  (int64_t)1);
if ((i3 ==  (int64_t)256)) {
i3 =  (int64_t)0;
i2 = (i2 +  (int64_t)1);
...
uint64_t* tmp17 = make_array<uint64_t>( (int32_t)256,  (int32_t)1,  (int32_t)1,  (int32_t)1);
MaxPool( (int32_t)256,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)50,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1,  (int32_t)256,  (int32_t)1,  (int32_t)50,  (int32_t)1, tmp15, tmp17);
ClearMemSecret4( (int32_t)256,  (int32_t)1,  (int32_t)50,  (int32_t)1, tmp15);
ScaleUp1( (int32_t)256, tmp4,  (int32_t)12);

uint64_t* tmp19 = make_array<uint64_t>( (int32_t)256,  (int32_t)1,  (int32_t)1,  (int32_t)256);
...
Arr4DIdxRowM(tmp19, (int32_t)256, (int32_t)1, (int32_t)1, (int32_t)256,i0,i1,i2,i3) = SecretAdd(Arr4DIdxRowM(tmp17, (int32_t)256, (int32_t)1, (int32_t)1, (int32_t)1,i0,i1,i2, (int32_t)0), Arr1DIdxRowM(tmp4, (int32_t)256,i3));
}
}
}
}
ClearMemSecret4( (int32_t)256,  (int32_t)1,  (int32_t)1,  (int32_t)1, tmp17);
ScaleUp2( (int32_t)50,  (int32_t)256, tmp1,  (int32_t)12);

uint64_t* tmp21 = make_array<uint64_t>( (int32_t)50,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp21, (int32_t)50, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp1, (int32_t)50, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp5, (int32_t)50, (int32_t)256,i0,i1));
}
}
...
Arr4DIdxRowM(tmp25, (int32_t)256, (int32_t)1, (int32_t)50, (int32_t)1,i10,i11,i12,i13) = Arr2DIdxRowM(tmp21, (int32_t)50, (int32_t)256,i8,i9);
i9 = (i9 +  (int64_t)1);
if ((i9 ==  (int64_t)256)) {
i9 =  (int64_t)0;
i8 = (i8 +  (int64_t)1);
...
for (uint32_t i2 =  (int32_t)0; i2 <  (int32_t)1; i2++){
for (uint32_t i3 =  (int32_t)0; i3 <  (int32_t)256; i3++){
Arr4DIdxRowM(tmp29, (int32_t)256, (int32_t)1, (int32_t)1, (int32_t)256,i0,i1,i2,i3) = SecretAdd(Arr4DIdxRowM(tmp27, (int32_t)256, (int32_t)1, (int32_t)1, (int32_t)1,i0,i1,i2, (int32_t)0), Arr1DIdxRowM(tmp4, (int32_t)256,i3));
}
}
}
}
...
ScaleDown4( (int32_t)256,  (int32_t)1,  (int32_t)1,  (int32_t)256, tmp29,  (int32_t)12);
EndComputation();
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)256; i0++){
...
cout << (funcReconstruct2PCCons(Arr4DIdxRowM(tmp29, (int32_t)256, (int32_t)1, (int32_t)1, (int32_t)256,i0,i1,i2,i3), 2)) << endl;
}
}
}
}
