...
Arr1DIdxRowM(tmp12, (int32_t)25600,tmp15) = Arr2DIdxRowM(tmp3, (int32_t)100, (int32_t)256,i0,i1);
Arr1DIdxRowM(tmp13, (int32_t)25600,tmp15) = Arr2DIdxRowM(tmp2, (int32_t)1, (int32_t)256, (int32_t)0,i1);
}
}
...
ScaleDown2( (int32_t)100,  (int32_t)256, tmp29,  (int32_t)12);
...
Arr1DIdxRowM(tmp33, (int32_t)25600,tmp36) = Arr2DIdxRowM(tmp29, (int32_t)100, (int32_t)256,i5,i6);
Arr1DIdxRowM(tmp34, (int32_t)25600,tmp36) = Arr2DIdxRowM(tmp6, (int32_t)100, (int32_t)256,i5,i6);
}
}
...
for (uint32_t i6 =  (int32_t)0; i6 <  (int32_t)256; i6++){
tmp36 = (( (int32_t)0 + (i5 *  (int32_t)256)) + (i6 *  (int32_t)1));
Arr2DIdxRowM(tmp32, (int32_t)100, (int32_t)256,i5,i6) = Arr1DIdxRowM(tmp35, (int32_t)25600,tmp36);
}
}
...
tmp40 = SecretAdd(tmp40, Arr2DIdxRowM(tmp32, (int32_t)100, (int32_t)256,i8,i7));
}
