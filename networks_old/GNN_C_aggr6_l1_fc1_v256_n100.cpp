...
Arr1DIdxRowM(tmp7, (int32_t)25600,tmp10) = Arr2DIdxRowM(tmp2, (int32_t)100, (int32_t)256,i0,i1);
Arr1DIdxRowM(tmp8, (int32_t)25600,tmp10) = Arr2DIdxRowM(tmp1, (int32_t)1, (int32_t)256, (int32_t)0,i1);
}
}
...
ScaleDown2( (int32_t)100,  (int32_t)256, tmp13,  (int32_t)12);
...
Arr1DIdxRowM(tmp25, (int32_t)25600,tmp28) = Arr2DIdxRowM(tmp13, (int32_t)100, (int32_t)256,i5,i6);
Arr1DIdxRowM(tmp26, (int32_t)25600,tmp28) = Arr2DIdxRowM(tmp22, (int32_t)1, (int32_t)256, (int32_t)0,i6);
}
}
...
for (uint32_t i6 =  (int32_t)0; i6 <  (int32_t)256; i6++){
tmp28 = (( (int32_t)0 + (i5 *  (int32_t)256)) + (i6 *  (int32_t)1));
Arr2DIdxRowM(tmp24, (int32_t)100, (int32_t)256,i5,i6) = Arr1DIdxRowM(tmp27, (int32_t)25600,tmp28);
}
}
...
tmp32 = SecretAdd(tmp32, Arr2DIdxRowM(tmp24, (int32_t)100, (int32_t)256,i8,i7));
}
