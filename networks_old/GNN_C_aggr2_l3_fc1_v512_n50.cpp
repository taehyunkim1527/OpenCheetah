...
tmp4 = SecretAdd(tmp4, Arr2DIdxRowM(tmp0, (int32_t)50, (int32_t)512,i1,i0));
}
Arr1DIdxRowM(tmp5, (int32_t)512,i0) = tmp4;
}
...
tmp8 = SecretAdd(tmp8, Arr2DIdxRowM(tmp1, (int32_t)50, (int32_t)512,i3,i2));
}
Arr1DIdxRowM(tmp9, (int32_t)512,i2) = tmp8;
}
...
tmp12 = SecretAdd(tmp12, Arr2DIdxRowM(tmp2, (int32_t)50, (int32_t)512,i5,i4));
}
Arr1DIdxRowM(tmp13, (int32_t)512,i4) = tmp12;
}
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp2);
EndComputation();
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)512; i0++){
cout << (funcReconstruct2PCCons(Arr1DIdxRowM(tmp13, (int32_t)512,i0), 2)) << endl;
}
}
