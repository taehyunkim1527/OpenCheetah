...
uint64_t* tmp11 = make_array<uint64_t>( (int32_t)50,  (int32_t)512);
/* Variable to read the clear value corresponding to the input variable tmp11 at (9060,1-9060,40) */
...
Arr2DIdxRowM(tmp11, (int32_t)50, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp11 : 0;
}
}
...
uint64_t* tmp17 = make_array<uint64_t>( (int32_t)50,  (int32_t)512);

uint64_t* tmp18 = make_array<uint64_t>( (int32_t)25600);

uint64_t* tmp19 = make_array<uint64_t>( (int32_t)25600);

uint64_t* tmp20 = make_array<uint64_t>( (int32_t)25600);

int32_t tmp21;
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
tmp21 = (( (int32_t)0 + (i0 *  (int32_t)512)) + (i1 *  (int32_t)1));
Arr1DIdxRowM(tmp18, (int32_t)25600,tmp21) = Arr2DIdxRowM(tmp5, (int32_t)50, (int32_t)512,i0,i1);
Arr1DIdxRowM(tmp19, (int32_t)25600,tmp21) = Arr2DIdxRowM(tmp4, (int32_t)1, (int32_t)512, (int32_t)0,i1);
}
}
ElemWiseActModelVectorMult( (int32_t)25600, tmp18, tmp19, tmp20);
ClearMemSecret1( (int32_t)25600, tmp18);
ClearMemSecret1( (int32_t)25600, tmp19);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
tmp21 = (( (int32_t)0 + (i0 *  (int32_t)512)) + (i1 *  (int32_t)1));
Arr2DIdxRowM(tmp17, (int32_t)50, (int32_t)512,i0,i1) = Arr1DIdxRowM(tmp20, (int32_t)25600,tmp21);
}
}
ClearMemSecret1( (int32_t)25600, tmp20);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp4);
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp5);

int32_t* tmp24 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp24, (int32_t)2, (int64_t)0) =  (int32_t)-1;
Arr1DIdxRowM(tmp24, (int32_t)2, (int64_t)1) =  (int32_t)512;
...
Arr2DIdxRowM(tmp25, (int32_t)1, (int32_t)512,i3,i4) = Arr1DIdxRowM(tmp0, (int32_t)512,i2);
i2 = (i2 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)512, tmp0);

uint64_t* tmp27 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp25, tmp6, tmp27, 0);
...
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp30, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp27, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp7, (int32_t)1, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp27);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp7);

uint64_t* tmp33 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
Relu2( (int32_t)1,  (int32_t)512, tmp30, tmp33,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp30);
ScaleUp2( (int32_t)50,  (int32_t)512, tmp1,  (int32_t)12);

uint64_t* tmp35 = make_array<uint64_t>( (int32_t)50,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp35, (int32_t)50, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp1, (int32_t)50, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp17, (int32_t)50, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp1);
ScaleDown2( (int32_t)50,  (int32_t)512, tmp35,  (int32_t)12);

uint64_t* tmp37 = make_array<uint64_t>( (int32_t)50,  (int32_t)512);

uint64_t* tmp38 = make_array<uint64_t>( (int32_t)25600);

uint64_t* tmp39 = make_array<uint64_t>( (int32_t)25600);

uint64_t* tmp40 = make_array<uint64_t>( (int32_t)25600);

int32_t tmp41;
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)50; i5++){
for (uint32_t i6 =  (int32_t)0; i6 <  (int32_t)512; i6++){
tmp41 = (( (int32_t)0 + (i5 *  (int32_t)512)) + (i6 *  (int32_t)1));
Arr1DIdxRowM(tmp38, (int32_t)25600,tmp41) = Arr2DIdxRowM(tmp35, (int32_t)50, (int32_t)512,i5,i6);
Arr1DIdxRowM(tmp39, (int32_t)25600,tmp41) = Arr2DIdxRowM(tmp8, (int32_t)50, (int32_t)512,i5,i6);
}
}
ElemWiseActModelVectorMult( (int32_t)25600, tmp38, tmp39, tmp40);
ClearMemSecret1( (int32_t)25600, tmp38);
ClearMemSecret1( (int32_t)25600, tmp39);
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)50; i5++){
for (uint32_t i6 =  (int32_t)0; i6 <  (int32_t)512; i6++){
tmp41 = (( (int32_t)0 + (i5 *  (int32_t)512)) + (i6 *  (int32_t)1));
Arr2DIdxRowM(tmp37, (int32_t)50, (int32_t)512,i5,i6) = Arr1DIdxRowM(tmp40, (int32_t)25600,tmp41);
}
}
ClearMemSecret1( (int32_t)25600, tmp40);
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp8);
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp35);

int32_t tmp44 =  (int32_t)0;

uint64_t tmp45;

uint64_t* tmp46 = make_array<uint64_t>( (int32_t)512);
for (uint32_t i7 =  (int32_t)0; i7 <  (int32_t)512; i7++){
tmp45 = funcSSCons( (int64_t)0);
for (uint32_t i8 =  (int32_t)0; i8 <  (int32_t)50; i8++){
tmp45 = SecretAdd(tmp45, Arr2DIdxRowM(tmp37, (int32_t)50, (int32_t)512,i8,i7));
}
Arr1DIdxRowM(tmp46, (int32_t)512,i7) = tmp45;
}
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp37);

int32_t* tmp48 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp48, (int32_t)2, (int64_t)0) =  (int32_t)-1;
Arr1DIdxRowM(tmp48, (int32_t)2, (int64_t)1) =  (int32_t)512;
...
Arr2DIdxRowM(tmp49, (int32_t)1, (int32_t)512,i10,i11) = Arr1DIdxRowM(tmp46, (int32_t)512,i9);
i9 = (i9 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)512, tmp46);
ScaleUp2( (int32_t)1,  (int32_t)512, tmp33,  (int32_t)12);

uint64_t* tmp51 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp51, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp49, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp33, (int32_t)1, (int32_t)512,i0,i1));
}
}
...
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp51, tmp9, tmp54, 0);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp57, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp54, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp10, (int32_t)1, (int32_t)512,i0,i1));
}
}
...
Relu2( (int32_t)1,  (int32_t)512, tmp57, tmp60,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp57);
ScaleUp2( (int32_t)50,  (int32_t)512, tmp2,  (int32_t)12);

uint64_t* tmp62 = make_array<uint64_t>( (int32_t)50,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp62, (int32_t)50, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp2, (int32_t)50, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp17, (int32_t)50, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp2);
ScaleDown2( (int32_t)50,  (int32_t)512, tmp62,  (int32_t)12);

uint64_t* tmp64 = make_array<uint64_t>( (int32_t)50,  (int32_t)512);

uint64_t* tmp65 = make_array<uint64_t>( (int32_t)25600);

uint64_t* tmp66 = make_array<uint64_t>( (int32_t)25600);

uint64_t* tmp67 = make_array<uint64_t>( (int32_t)25600);

int32_t tmp68;
for (uint32_t i12 =  (int32_t)0; i12 <  (int32_t)50; i12++){
for (uint32_t i13 =  (int32_t)0; i13 <  (int32_t)512; i13++){
tmp68 = (( (int32_t)0 + (i12 *  (int32_t)512)) + (i13 *  (int32_t)1));
Arr1DIdxRowM(tmp65, (int32_t)25600,tmp68) = Arr2DIdxRowM(tmp62, (int32_t)50, (int32_t)512,i12,i13);
Arr1DIdxRowM(tmp66, (int32_t)25600,tmp68) = Arr2DIdxRowM(tmp11, (int32_t)50, (int32_t)512,i12,i13);
}
}
ElemWiseActModelVectorMult( (int32_t)25600, tmp65, tmp66, tmp67);
ClearMemSecret1( (int32_t)25600, tmp65);
ClearMemSecret1( (int32_t)25600, tmp66);
for (uint32_t i12 =  (int32_t)0; i12 <  (int32_t)50; i12++){
for (uint32_t i13 =  (int32_t)0; i13 <  (int32_t)512; i13++){
tmp68 = (( (int32_t)0 + (i12 *  (int32_t)512)) + (i13 *  (int32_t)1));
Arr2DIdxRowM(tmp64, (int32_t)50, (int32_t)512,i12,i13) = Arr1DIdxRowM(tmp67, (int32_t)25600,tmp68);
}
}
ClearMemSecret1( (int32_t)25600, tmp67);
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp11);
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp62);

int32_t tmp71 =  (int32_t)0;

uint64_t tmp72;

uint64_t* tmp73 = make_array<uint64_t>( (int32_t)512);
for (uint32_t i14 =  (int32_t)0; i14 <  (int32_t)512; i14++){
tmp72 = funcSSCons( (int64_t)0);
for (uint32_t i15 =  (int32_t)0; i15 <  (int32_t)50; i15++){
tmp72 = SecretAdd(tmp72, Arr2DIdxRowM(tmp64, (int32_t)50, (int32_t)512,i15,i14));
}
Arr1DIdxRowM(tmp73, (int32_t)512,i14) = tmp72;
}
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp64);

int32_t* tmp75 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp75, (int32_t)2, (int64_t)0) =  (int32_t)-1;
Arr1DIdxRowM(tmp75, (int32_t)2, (int64_t)1) =  (int32_t)512;
...
Arr2DIdxRowM(tmp76, (int32_t)1, (int32_t)512,i17,i18) = Arr1DIdxRowM(tmp73, (int32_t)512,i16);
i16 = (i16 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)512, tmp73);
ScaleUp2( (int32_t)1,  (int32_t)512, tmp60,  (int32_t)12);

uint64_t* tmp78 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp78, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp76, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp60, (int32_t)1, (int32_t)512,i0,i1));
}
}
...
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp78, tmp12, tmp81, 0);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp84, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp81, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp13, (int32_t)1, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp81);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp13);

uint64_t* tmp87 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
Relu2( (int32_t)1,  (int32_t)512, tmp84, tmp87,  (int32_t)12, 1);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp89, (int32_t)50, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp3, (int32_t)50, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp17, (int32_t)50, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp17);
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp3);
ScaleDown2( (int32_t)50,  (int32_t)512, tmp89,  (int32_t)12);

uint64_t* tmp92 = make_array<uint64_t>( (int32_t)50,  (int32_t)512);

uint64_t* tmp93 = make_array<uint64_t>( (int32_t)25600);

uint64_t* tmp94 = make_array<uint64_t>( (int32_t)25600);

uint64_t* tmp95 = make_array<uint64_t>( (int32_t)25600);

int32_t tmp96;
for (uint32_t i19 =  (int32_t)0; i19 <  (int32_t)50; i19++){
for (uint32_t i20 =  (int32_t)0; i20 <  (int32_t)512; i20++){
tmp96 = (( (int32_t)0 + (i19 *  (int32_t)512)) + (i20 *  (int32_t)1));
Arr1DIdxRowM(tmp93, (int32_t)25600,tmp96) = Arr2DIdxRowM(tmp89, (int32_t)50, (int32_t)512,i19,i20);
Arr1DIdxRowM(tmp94, (int32_t)25600,tmp96) = Arr2DIdxRowM(tmp14, (int32_t)50, (int32_t)512,i19,i20);
}
}
ElemWiseActModelVectorMult( (int32_t)25600, tmp93, tmp94, tmp95);
ClearMemSecret1( (int32_t)25600, tmp93);
ClearMemSecret1( (int32_t)25600, tmp94);
for (uint32_t i19 =  (int32_t)0; i19 <  (int32_t)50; i19++){
for (uint32_t i20 =  (int32_t)0; i20 <  (int32_t)512; i20++){
tmp96 = (( (int32_t)0 + (i19 *  (int32_t)512)) + (i20 *  (int32_t)1));
Arr2DIdxRowM(tmp92, (int32_t)50, (int32_t)512,i19,i20) = Arr1DIdxRowM(tmp95, (int32_t)25600,tmp96);
}
}
ClearMemSecret1( (int32_t)25600, tmp95);
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp89);
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp14);

int32_t tmp99 =  (int32_t)0;

uint64_t tmp100;

uint64_t* tmp101 = make_array<uint64_t>( (int32_t)512);
for (uint32_t i21 =  (int32_t)0; i21 <  (int32_t)512; i21++){
tmp100 = funcSSCons( (int64_t)0);
for (uint32_t i22 =  (int32_t)0; i22 <  (int32_t)50; i22++){
tmp100 = SecretAdd(tmp100, Arr2DIdxRowM(tmp92, (int32_t)50, (int32_t)512,i22,i21));
}
Arr1DIdxRowM(tmp101, (int32_t)512,i21) = tmp100;
}
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp92);
...
Arr2DIdxRowM(tmp104, (int32_t)1, (int32_t)512,i24,i25) = Arr1DIdxRowM(tmp101, (int32_t)512,i23);
i23 = (i23 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)512, tmp101);
ScaleUp2( (int32_t)1,  (int32_t)512, tmp87,  (int32_t)12);

uint64_t* tmp106 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp106, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp104, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp87, (int32_t)1, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp104);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp87);

uint64_t* tmp109 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
ScaleDown2( (int32_t)1,  (int32_t)512, tmp106,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp106, tmp15, tmp109, 0);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp112, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp109, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp16, (int32_t)1, (int32_t)512,i0,i1));
}
}
...
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (uint32_t)0; i1 <  (int32_t)512; i1++){
cout << (funcReconstruct2PCCons(Arr2DIdxRowM(tmp115, (int32_t)1, (int32_t)512,i0,i1), 2)) << endl;
}
}
}
