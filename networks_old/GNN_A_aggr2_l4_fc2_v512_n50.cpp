...
uint64_t* tmp9 = make_array<uint64_t>( (int32_t)1,  (int32_t)1);
...
Arr2DIdxRowM(tmp9, (int32_t)1, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp9 : 0;
}
}
...
uint64_t* tmp14 = make_array<uint64_t>( (int32_t)1,  (int32_t)1);
...
Arr2DIdxRowM(tmp14, (int32_t)1, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp14 : 0;
}
}
...
uint64_t* tmp19 = make_array<uint64_t>( (int32_t)1,  (int32_t)1);
...
Arr2DIdxRowM(tmp19, (int32_t)1, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp19 : 0;
}
}
...
uint64_t* tmp24 = make_array<uint64_t>( (int32_t)1,  (int32_t)1);
...
Arr2DIdxRowM(tmp24, (int32_t)1, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp24 : 0;
}
}
...
int32_t tmp49 =  (int32_t)0;

uint64_t tmp50;

uint64_t* tmp51 = make_array<uint64_t>( (int32_t)512);
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)512; i5++){
tmp50 = funcSSCons( (int64_t)0);
for (uint32_t i6 =  (int32_t)0; i6 <  (int32_t)50; i6++){
tmp50 = SecretAdd(tmp50, Arr2DIdxRowM(tmp47, (int32_t)50, (int32_t)512,i6,i5));
}
Arr1DIdxRowM(tmp51, (int32_t)512,i5) = tmp50;
}
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp47);

int32_t* tmp53 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp53, (int32_t)2, (int64_t)0) =  (int32_t)-1;
Arr1DIdxRowM(tmp53, (int32_t)2, (int64_t)1) =  (int32_t)512;

uint64_t* tmp54 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
...
for (uint32_t i9 =  (int32_t)0; i9 <  (int32_t)512; i9++){
Arr2DIdxRowM(tmp54, (int32_t)1, (int32_t)512,i8,i9) = Arr1DIdxRowM(tmp51, (int32_t)512,i7);
i7 = (i7 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)512, tmp51);
ScaleUp2( (int32_t)1,  (int32_t)512, tmp45,  (int32_t)12);

uint64_t* tmp56 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp56, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp54, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp45, (int32_t)1, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp45);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp54);
ScaleDown2( (int32_t)1,  (int32_t)512, tmp56,  (int32_t)12);

uint64_t* tmp59 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);

uint64_t* tmp60 = make_array<uint64_t>( (int32_t)512);

uint64_t* tmp61 = make_array<uint64_t>( (int32_t)512);

uint64_t* tmp62 = make_array<uint64_t>( (int32_t)512);

int32_t tmp63;
for (uint32_t i10 =  (int32_t)0; i10 <  (int32_t)1; i10++){
for (uint32_t i11 =  (int32_t)0; i11 <  (int32_t)512; i11++){
tmp63 = (( (int32_t)0 + (i10 *  (int32_t)512)) + (i11 *  (int32_t)1));
Arr1DIdxRowM(tmp60, (int32_t)512,tmp63) = Arr2DIdxRowM(tmp56, (int32_t)1, (int32_t)512,i10,i11);
Arr1DIdxRowM(tmp61, (int32_t)512,tmp63) = Arr2DIdxRowM(tmp9, (int32_t)1, (int32_t)1,i10, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)512, tmp60, tmp61, tmp62);
ClearMemSecret1( (int32_t)512, tmp60);
ClearMemSecret1( (int32_t)512, tmp61);
for (uint32_t i10 =  (int32_t)0; i10 <  (int32_t)1; i10++){
for (uint32_t i11 =  (int32_t)0; i11 <  (int32_t)512; i11++){
tmp63 = (( (int32_t)0 + (i10 *  (int32_t)512)) + (i11 *  (int32_t)1));
Arr2DIdxRowM(tmp59, (int32_t)1, (int32_t)512,i10,i11) = Arr1DIdxRowM(tmp62, (int32_t)512,tmp63);
}
}
ClearMemSecret1( (int32_t)512, tmp62);
ClearMemSecret2( (int32_t)1,  (int32_t)1, tmp9);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp56);

uint64_t* tmp66 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
ScaleDown2( (int32_t)1,  (int32_t)512, tmp59,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp59, tmp10, tmp66, 0);
ClearMemSecret2( (int32_t)512,  (int32_t)512, tmp10);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp59);
...
int32_t tmp84 =  (int32_t)0;

uint64_t tmp85;

uint64_t* tmp86 = make_array<uint64_t>( (int32_t)512);
for (uint32_t i12 =  (int32_t)0; i12 <  (int32_t)512; i12++){
tmp85 = funcSSCons( (int64_t)0);
for (uint32_t i13 =  (int32_t)0; i13 <  (int32_t)50; i13++){
tmp85 = SecretAdd(tmp85, Arr2DIdxRowM(tmp82, (int32_t)50, (int32_t)512,i13,i12));
}
Arr1DIdxRowM(tmp86, (int32_t)512,i12) = tmp85;
}
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp82);

int32_t* tmp88 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp88, (int32_t)2, (int64_t)0) =  (int32_t)-1;
Arr1DIdxRowM(tmp88, (int32_t)2, (int64_t)1) =  (int32_t)512;

uint64_t* tmp89 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
...
Arr2DIdxRowM(tmp89, (int32_t)1, (int32_t)512,i15,i16) = Arr1DIdxRowM(tmp86, (int32_t)512,i14);
i14 = (i14 +  (int64_t)1);
}
}
...
uint64_t* tmp91 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp91, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp89, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp80, (int32_t)1, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp89);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp80);
ScaleDown2( (int32_t)1,  (int32_t)512, tmp91,  (int32_t)12);

uint64_t* tmp94 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
...
tmp98 = (( (int32_t)0 + (i17 *  (int32_t)512)) + (i18 *  (int32_t)1));
Arr1DIdxRowM(tmp95, (int32_t)512,tmp98) = Arr2DIdxRowM(tmp91, (int32_t)1, (int32_t)512,i17,i18);
Arr1DIdxRowM(tmp96, (int32_t)512,tmp98) = Arr2DIdxRowM(tmp14, (int32_t)1, (int32_t)1,i17, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)512, tmp95, tmp96, tmp97);
ClearMemSecret1( (int32_t)512, tmp95);
ClearMemSecret1( (int32_t)512, tmp96);
for (uint32_t i17 =  (int32_t)0; i17 <  (int32_t)1; i17++){
for (uint32_t i18 =  (int32_t)0; i18 <  (int32_t)512; i18++){
tmp98 = (( (int32_t)0 + (i17 *  (int32_t)512)) + (i18 *  (int32_t)1));
Arr2DIdxRowM(tmp94, (int32_t)1, (int32_t)512,i17,i18) = Arr1DIdxRowM(tmp97, (int32_t)512,tmp98);
}
}
ClearMemSecret1( (int32_t)512, tmp97);
ClearMemSecret2( (int32_t)1,  (int32_t)1, tmp14);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp91);

uint64_t* tmp101 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
ScaleDown2( (int32_t)1,  (int32_t)512, tmp94,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp94, tmp15, tmp101, 0);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp94);
...
int32_t tmp119 =  (int32_t)0;

uint64_t tmp120;

uint64_t* tmp121 = make_array<uint64_t>( (int32_t)512);
for (uint32_t i19 =  (int32_t)0; i19 <  (int32_t)512; i19++){
tmp120 = funcSSCons( (int64_t)0);
for (uint32_t i20 =  (int32_t)0; i20 <  (int32_t)50; i20++){
tmp120 = SecretAdd(tmp120, Arr2DIdxRowM(tmp117, (int32_t)50, (int32_t)512,i20,i19));
}
Arr1DIdxRowM(tmp121, (int32_t)512,i19) = tmp120;
}
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp117);

int32_t* tmp123 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp123, (int32_t)2, (int64_t)0) =  (int32_t)-1;
Arr1DIdxRowM(tmp123, (int32_t)2, (int64_t)1) =  (int32_t)512;

uint64_t* tmp124 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
...
for (uint32_t i23 =  (int32_t)0; i23 <  (int32_t)512; i23++){
Arr2DIdxRowM(tmp124, (int32_t)1, (int32_t)512,i22,i23) = Arr1DIdxRowM(tmp121, (int32_t)512,i21);
i21 = (i21 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)512, tmp121);
ScaleUp2( (int32_t)1,  (int32_t)512, tmp115,  (int32_t)12);

uint64_t* tmp126 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp126, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp124, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp115, (int32_t)1, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp124);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp115);
ScaleDown2( (int32_t)1,  (int32_t)512, tmp126,  (int32_t)12);

uint64_t* tmp129 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);

uint64_t* tmp130 = make_array<uint64_t>( (int32_t)512);

uint64_t* tmp131 = make_array<uint64_t>( (int32_t)512);

uint64_t* tmp132 = make_array<uint64_t>( (int32_t)512);

int32_t tmp133;
for (uint32_t i24 =  (int32_t)0; i24 <  (int32_t)1; i24++){
for (uint32_t i25 =  (int32_t)0; i25 <  (int32_t)512; i25++){
tmp133 = (( (int32_t)0 + (i24 *  (int32_t)512)) + (i25 *  (int32_t)1));
Arr1DIdxRowM(tmp130, (int32_t)512,tmp133) = Arr2DIdxRowM(tmp126, (int32_t)1, (int32_t)512,i24,i25);
Arr1DIdxRowM(tmp131, (int32_t)512,tmp133) = Arr2DIdxRowM(tmp19, (int32_t)1, (int32_t)1,i24, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)512, tmp130, tmp131, tmp132);
ClearMemSecret1( (int32_t)512, tmp130);
ClearMemSecret1( (int32_t)512, tmp131);
for (uint32_t i24 =  (int32_t)0; i24 <  (int32_t)1; i24++){
for (uint32_t i25 =  (int32_t)0; i25 <  (int32_t)512; i25++){
tmp133 = (( (int32_t)0 + (i24 *  (int32_t)512)) + (i25 *  (int32_t)1));
Arr2DIdxRowM(tmp129, (int32_t)1, (int32_t)512,i24,i25) = Arr1DIdxRowM(tmp132, (int32_t)512,tmp133);
}
}
ClearMemSecret1( (int32_t)512, tmp132);
ClearMemSecret2( (int32_t)1,  (int32_t)1, tmp19);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp126);

uint64_t* tmp136 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
ScaleDown2( (int32_t)1,  (int32_t)512, tmp129,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp129, tmp20, tmp136, 0);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp129);
...
int32_t tmp155 =  (int32_t)0;

uint64_t tmp156;

uint64_t* tmp157 = make_array<uint64_t>( (int32_t)512);
for (uint32_t i26 =  (int32_t)0; i26 <  (int32_t)512; i26++){
tmp156 = funcSSCons( (int64_t)0);
for (uint32_t i27 =  (int32_t)0; i27 <  (int32_t)50; i27++){
tmp156 = SecretAdd(tmp156, Arr2DIdxRowM(tmp152, (int32_t)50, (int32_t)512,i27,i26));
}
Arr1DIdxRowM(tmp157, (int32_t)512,i26) = tmp156;
}
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp152);

int32_t* tmp159 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp159, (int32_t)2, (int64_t)0) =  (int32_t)-1;
Arr1DIdxRowM(tmp159, (int32_t)2, (int64_t)1) =  (int32_t)512;
...
for (uint32_t i30 =  (int32_t)0; i30 <  (int32_t)512; i30++){
Arr2DIdxRowM(tmp160, (int32_t)1, (int32_t)512,i29,i30) = Arr1DIdxRowM(tmp157, (int32_t)512,i28);
i28 = (i28 +  (int64_t)1);
}
}
...
uint64_t* tmp162 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp162, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp160, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp150, (int32_t)1, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp160);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp150);
ScaleDown2( (int32_t)1,  (int32_t)512, tmp162,  (int32_t)12);

uint64_t* tmp165 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);

uint64_t* tmp166 = make_array<uint64_t>( (int32_t)512);

uint64_t* tmp167 = make_array<uint64_t>( (int32_t)512);

uint64_t* tmp168 = make_array<uint64_t>( (int32_t)512);

int32_t tmp169;
for (uint32_t i31 =  (int32_t)0; i31 <  (int32_t)1; i31++){
for (uint32_t i32 =  (int32_t)0; i32 <  (int32_t)512; i32++){
tmp169 = (( (int32_t)0 + (i31 *  (int32_t)512)) + (i32 *  (int32_t)1));
Arr1DIdxRowM(tmp166, (int32_t)512,tmp169) = Arr2DIdxRowM(tmp162, (int32_t)1, (int32_t)512,i31,i32);
Arr1DIdxRowM(tmp167, (int32_t)512,tmp169) = Arr2DIdxRowM(tmp24, (int32_t)1, (int32_t)1,i31, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)512, tmp166, tmp167, tmp168);
ClearMemSecret1( (int32_t)512, tmp166);
ClearMemSecret1( (int32_t)512, tmp167);
for (uint32_t i31 =  (int32_t)0; i31 <  (int32_t)1; i31++){
for (uint32_t i32 =  (int32_t)0; i32 <  (int32_t)512; i32++){
tmp169 = (( (int32_t)0 + (i31 *  (int32_t)512)) + (i32 *  (int32_t)1));
Arr2DIdxRowM(tmp165, (int32_t)1, (int32_t)512,i31,i32) = Arr1DIdxRowM(tmp168, (int32_t)512,tmp169);
}
}
ClearMemSecret1( (int32_t)512, tmp168);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp162);
ClearMemSecret2( (int32_t)1,  (int32_t)1, tmp24);

uint64_t* tmp172 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
ScaleDown2( (int32_t)1,  (int32_t)512, tmp165,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp165, tmp25, tmp172, 0);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp165);
