...
uint64_t* tmp5 = make_array<uint64_t>( (int32_t)5,  (int32_t)1);
/* Variable to read the clear value corresponding to the input variable tmp5 at (9042,1-9042,36) */
...
Arr2DIdxRowM(tmp5, (int32_t)5, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp5 : 0;
}
}
...
Arr1DIdxRowM(tmp18, (int32_t)1280,tmp20) = Arr2DIdxRowM(tmp5, (int32_t)5, (int32_t)1,i2, (int32_t)0);
}
}
...
ClearMemSecret2( (int32_t)5,  (int32_t)1, tmp5);
...
Arr1DIdxRowM(tmp34, (int32_t)1280,tmp36) = Arr2DIdxRowM(tmp6, (int32_t)5, (int32_t)1,i6, (int32_t)0);
}
}
