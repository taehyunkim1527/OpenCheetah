...
Arr1DIdxRowM(tmp11, (int32_t)15360,tmp14) = Arr2DIdxRowM(tmp3, (int32_t)30, (int32_t)512,i0,i1);
Arr1DIdxRowM(tmp12, (int32_t)15360,tmp14) = Arr2DIdxRowM(tmp2, (int32_t)1, (int32_t)512, (int32_t)0,i1);
}
}
ElemWiseActModelVectorMult( (int32_t)15360, tmp11, tmp12, tmp13);
ClearMemSecret1( (int32_t)15360, tmp11);
ClearMemSecret1( (int32_t)15360, tmp12);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)30; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
tmp14 = (( (int32_t)0 + (i0 *  (int32_t)512)) + (i1 *  (int32_t)1));
Arr2DIdxRowM(tmp10, (int32_t)30, (int32_t)512,i0,i1) = Arr1DIdxRowM(tmp13, (int32_t)15360,tmp14);
}
}
...
uint64_t* tmp28 = make_array<uint64_t>( (int32_t)30,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)30; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp28, (int32_t)30, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp1, (int32_t)30, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp10, (int32_t)30, (int32_t)512,i0,i1));
}
}
...
ScaleDown2( (int32_t)30,  (int32_t)512, tmp28,  (int32_t)12);
MatMul2D( (int32_t)30,  (int32_t)512,  (int32_t)512, tmp28, tmp6, tmp31, 0);
ClearMemSecret2( (int32_t)512,  (int32_t)512, tmp6);
ClearMemSecret2( (int32_t)30,  (int32_t)512, tmp28);
ScaleUp2( (int32_t)1,  (int32_t)512, tmp7,  (int32_t)12);

uint64_t* tmp34 = make_array<uint64_t>( (int32_t)30,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)30; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp34, (int32_t)30, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp31, (int32_t)30, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp7, (int32_t)1, (int32_t)512, (int32_t)0,i1));
}
}
...
Relu2( (int32_t)30,  (int32_t)512, tmp34, tmp37,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)30,  (int32_t)512, tmp34);
...
Arr1DIdxRowM(tmp39, (int32_t)4, (int64_t)2) =  (int32_t)30;
Arr1DIdxRowM(tmp39, (int32_t)4, (int64_t)3) =  (int32_t)1;

uint64_t* tmp40 = make_array<uint64_t>( (int32_t)512,  (int32_t)1,  (int32_t)30,  (int32_t)1);
...
Arr4DIdxRowM(tmp40, (int32_t)512, (int32_t)1, (int32_t)30, (int32_t)1,i7,i8,i9,i10) = Arr2DIdxRowM(tmp37, (int32_t)30, (int32_t)512,i5,i6);
i6 = (i6 +  (int64_t)1);
if ((i6 ==  (int64_t)512)) {
i6 =  (int64_t)0;
i5 = (i5 +  (int64_t)1);
...
MaxPool( (int32_t)512,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)30,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1,  (int32_t)512,  (int32_t)1,  (int32_t)30,  (int32_t)1, tmp40, tmp42);
ClearMemSecret4( (int32_t)512,  (int32_t)1,  (int32_t)30,  (int32_t)1, tmp40);
