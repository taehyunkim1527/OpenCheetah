...
tmp50 = SecretAdd(tmp50, Arr2DIdxRowM(tmp47, (int32_t)30, (int32_t)128,i6,i5));
}
...
tmp85 = SecretAdd(tmp85, Arr2DIdxRowM(tmp82, (int32_t)30, (int32_t)128,i13,i12));
}
...
tmp120 = SecretAdd(tmp120, Arr2DIdxRowM(tmp117, (int32_t)30, (int32_t)128,i20,i19));
}
...
tmp156 = SecretAdd(tmp156, Arr2DIdxRowM(tmp152, (int32_t)30, (int32_t)128,i27,i26));
}
