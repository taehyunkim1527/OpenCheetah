...
int32_t* tmp4 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp4, (int32_t)2, (int64_t)0) =  (int32_t)-1;
Arr1DIdxRowM(tmp4, (int32_t)2, (int64_t)1) =  (int32_t)256;
...
Arr2DIdxRowM(tmp5, (int32_t)1, (int32_t)256,i1,i2) = Arr1DIdxRowM(tmp0, (int32_t)256,i0);
i0 = (i0 +  (int64_t)1);
}
}
...
MatMul2D( (int32_t)1,  (int32_t)256,  (int32_t)256, tmp5, tmp1, tmp7, 0);
...
Arr2DIdxRowM(tmp10, (int32_t)1, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp7, (int32_t)1, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp2, (int32_t)1, (int32_t)256,i0,i1));
}
}
...
Relu2( (int32_t)1,  (int32_t)256, tmp10, tmp13,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp10);

uint64_t* tmp15 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp15, (int32_t)1, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp13, (int32_t)1, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp3, (int32_t)1, (int32_t)256,i0,i1));
}
}
...
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (uint32_t)0; i1 <  (int32_t)256; i1++){
cout << (funcReconstruct2PCCons(Arr2DIdxRowM(tmp15, (int32_t)1, (int32_t)256,i0,i1), 2)) << endl;
}
}
}
