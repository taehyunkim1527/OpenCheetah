...
uint64_t* tmp10 = make_array<uint64_t>( (int32_t)10,  (int32_t)512);
...
Arr2DIdxRowM(tmp10, (int32_t)10, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp10 : 0;
}
}
...
Arr1DIdxRowM(tmp35, (int32_t)5120,tmp37) = Arr2DIdxRowM(tmp7, (int32_t)10, (int32_t)512,i5,i6);
}
}
...
Arr1DIdxRowM(tmp63, (int32_t)5120,tmp65) = Arr2DIdxRowM(tmp10, (int32_t)10, (int32_t)512,i12,i13);
}
}
...
ClearMemSecret2( (int32_t)10,  (int32_t)512, tmp10);
