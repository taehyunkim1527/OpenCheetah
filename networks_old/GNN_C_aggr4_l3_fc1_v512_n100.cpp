...
uint64_t* tmp6 = make_array<uint64_t>( (int32_t)100,  (int32_t)1);
...
Arr2DIdxRowM(tmp6, (int32_t)100, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp6 : 0;
}
}
...
Arr1DIdxRowM(tmp20, (int32_t)51200,tmp22) = Arr2DIdxRowM(tmp6, (int32_t)100, (int32_t)1,i2, (int32_t)0);
}
}
...
ClearMemSecret2( (int32_t)100,  (int32_t)1, tmp6);
...
Arr1DIdxRowM(tmp35, (int32_t)51200,tmp37) = Arr2DIdxRowM(tmp7, (int32_t)100, (int32_t)1,i6, (int32_t)0);
}
}
...
Arr1DIdxRowM(tmp51, (int32_t)51200,tmp53) = Arr2DIdxRowM(tmp8, (int32_t)100, (int32_t)1,i10, (int32_t)0);
}
}
