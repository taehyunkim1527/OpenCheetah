...
uint64_t* tmp12 = make_array<uint64_t>( (int32_t)50,  (int32_t)128);
...
Arr2DIdxRowM(tmp12, (int32_t)50, (int32_t)128,i0,i1) = (party == SERVER) ? __tmp_in_tmp12 : 0;
}
}
...
uint64_t* tmp15 = make_array<uint64_t>( (int32_t)50,  (int32_t)128);
...
Arr2DIdxRowM(tmp15, (int32_t)50, (int32_t)128,i0,i1) = (party == SERVER) ? __tmp_in_tmp15 : 0;
}
}
...
uint64_t* tmp18 = make_array<uint64_t>( (int32_t)50,  (int32_t)128);
...
Arr2DIdxRowM(tmp18, (int32_t)50, (int32_t)128,i0,i1) = (party == SERVER) ? __tmp_in_tmp18 : 0;
}
}
...
uint64_t* tmp21 = make_array<uint64_t>( (int32_t)50,  (int32_t)128);

uint64_t* tmp22 = make_array<uint64_t>( (int32_t)6400);

uint64_t* tmp23 = make_array<uint64_t>( (int32_t)6400);

uint64_t* tmp24 = make_array<uint64_t>( (int32_t)6400);

int32_t tmp25;
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
tmp25 = (( (int32_t)0 + (i0 *  (int32_t)128)) + (i1 *  (int32_t)1));
Arr1DIdxRowM(tmp22, (int32_t)6400,tmp25) = Arr2DIdxRowM(tmp6, (int32_t)50, (int32_t)128,i0,i1);
Arr1DIdxRowM(tmp23, (int32_t)6400,tmp25) = Arr2DIdxRowM(tmp5, (int32_t)1, (int32_t)128, (int32_t)0,i1);
}
}
ElemWiseActModelVectorMult( (int32_t)6400, tmp22, tmp23, tmp24);
ClearMemSecret1( (int32_t)6400, tmp22);
ClearMemSecret1( (int32_t)6400, tmp23);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
tmp25 = (( (int32_t)0 + (i0 *  (int32_t)128)) + (i1 *  (int32_t)1));
Arr2DIdxRowM(tmp21, (int32_t)50, (int32_t)128,i0,i1) = Arr1DIdxRowM(tmp24, (int32_t)6400,tmp25);
}
}
ClearMemSecret1( (int32_t)6400, tmp24);
...
Arr1DIdxRowM(tmp28, (int32_t)2, (int64_t)1) =  (int32_t)128;

uint64_t* tmp29 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);
...
Arr2DIdxRowM(tmp29, (int32_t)1, (int32_t)128,i3,i4) = Arr1DIdxRowM(tmp0, (int32_t)128,i2);
i2 = (i2 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)128, tmp0);

uint64_t* tmp31 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);
MatMul2D( (int32_t)1,  (int32_t)128,  (int32_t)128, tmp29, tmp7, tmp31, 0);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp29);
...
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp34, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp31, (int32_t)1, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp8, (int32_t)1, (int32_t)128,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp8);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp31);

uint64_t* tmp37 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);
Relu2( (int32_t)1,  (int32_t)128, tmp34, tmp37,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp34);
ScaleUp2( (int32_t)50,  (int32_t)128, tmp1,  (int32_t)12);

uint64_t* tmp39 = make_array<uint64_t>( (int32_t)50,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp39, (int32_t)50, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp1, (int32_t)50, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp21, (int32_t)50, (int32_t)128,i0,i1));
}
}
ClearMemSecret2( (int32_t)50,  (int32_t)128, tmp1);
ScaleDown2( (int32_t)50,  (int32_t)128, tmp39,  (int32_t)12);

uint64_t* tmp41 = make_array<uint64_t>( (int32_t)50,  (int32_t)128);

uint64_t* tmp42 = make_array<uint64_t>( (int32_t)6400);

uint64_t* tmp43 = make_array<uint64_t>( (int32_t)6400);

uint64_t* tmp44 = make_array<uint64_t>( (int32_t)6400);

int32_t tmp45;
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)50; i5++){
for (uint32_t i6 =  (int32_t)0; i6 <  (int32_t)128; i6++){
tmp45 = (( (int32_t)0 + (i5 *  (int32_t)128)) + (i6 *  (int32_t)1));
Arr1DIdxRowM(tmp42, (int32_t)6400,tmp45) = Arr2DIdxRowM(tmp39, (int32_t)50, (int32_t)128,i5,i6);
Arr1DIdxRowM(tmp43, (int32_t)6400,tmp45) = Arr2DIdxRowM(tmp9, (int32_t)50, (int32_t)128,i5,i6);
}
}
ElemWiseActModelVectorMult( (int32_t)6400, tmp42, tmp43, tmp44);
ClearMemSecret1( (int32_t)6400, tmp42);
ClearMemSecret1( (int32_t)6400, tmp43);
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)50; i5++){
for (uint32_t i6 =  (int32_t)0; i6 <  (int32_t)128; i6++){
tmp45 = (( (int32_t)0 + (i5 *  (int32_t)128)) + (i6 *  (int32_t)1));
Arr2DIdxRowM(tmp41, (int32_t)50, (int32_t)128,i5,i6) = Arr1DIdxRowM(tmp44, (int32_t)6400,tmp45);
}
}
ClearMemSecret1( (int32_t)6400, tmp44);
ClearMemSecret2( (int32_t)50,  (int32_t)128, tmp39);
...
uint64_t* tmp50 = make_array<uint64_t>( (int32_t)128);
for (uint32_t i7 =  (int32_t)0; i7 <  (int32_t)128; i7++){
tmp49 = funcSSCons( (int64_t)0);
for (uint32_t i8 =  (int32_t)0; i8 <  (int32_t)50; i8++){
tmp49 = SecretAdd(tmp49, Arr2DIdxRowM(tmp41, (int32_t)50, (int32_t)128,i8,i7));
}
Arr1DIdxRowM(tmp50, (int32_t)128,i7) = tmp49;
}
ClearMemSecret2( (int32_t)50,  (int32_t)128, tmp41);

int32_t* tmp52 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp52, (int32_t)2, (int64_t)0) =  (int32_t)-1;
Arr1DIdxRowM(tmp52, (int32_t)2, (int64_t)1) =  (int32_t)128;

uint64_t* tmp53 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);
...
Arr2DIdxRowM(tmp53, (int32_t)1, (int32_t)128,i10,i11) = Arr1DIdxRowM(tmp50, (int32_t)128,i9);
i9 = (i9 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)128, tmp50);
ScaleUp2( (int32_t)1,  (int32_t)128, tmp37,  (int32_t)12);

uint64_t* tmp55 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp55, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp53, (int32_t)1, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp37, (int32_t)1, (int32_t)128,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp53);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp37);

uint64_t* tmp58 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);
ScaleDown2( (int32_t)1,  (int32_t)128, tmp55,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)128,  (int32_t)128, tmp55, tmp10, tmp58, 0);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp55);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp61, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp58, (int32_t)1, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp11, (int32_t)1, (int32_t)128,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp11);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp58);

uint64_t* tmp64 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);
Relu2( (int32_t)1,  (int32_t)128, tmp61, tmp64,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp61);
ScaleUp2( (int32_t)50,  (int32_t)128, tmp2,  (int32_t)12);

uint64_t* tmp66 = make_array<uint64_t>( (int32_t)50,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp66, (int32_t)50, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp2, (int32_t)50, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp21, (int32_t)50, (int32_t)128,i0,i1));
}
}
ClearMemSecret2( (int32_t)50,  (int32_t)128, tmp2);
ScaleDown2( (int32_t)50,  (int32_t)128, tmp66,  (int32_t)12);

uint64_t* tmp68 = make_array<uint64_t>( (int32_t)50,  (int32_t)128);

uint64_t* tmp69 = make_array<uint64_t>( (int32_t)6400);

uint64_t* tmp70 = make_array<uint64_t>( (int32_t)6400);

uint64_t* tmp71 = make_array<uint64_t>( (int32_t)6400);

int32_t tmp72;
for (uint32_t i12 =  (int32_t)0; i12 <  (int32_t)50; i12++){
for (uint32_t i13 =  (int32_t)0; i13 <  (int32_t)128; i13++){
tmp72 = (( (int32_t)0 + (i12 *  (int32_t)128)) + (i13 *  (int32_t)1));
Arr1DIdxRowM(tmp69, (int32_t)6400,tmp72) = Arr2DIdxRowM(tmp66, (int32_t)50, (int32_t)128,i12,i13);
Arr1DIdxRowM(tmp70, (int32_t)6400,tmp72) = Arr2DIdxRowM(tmp12, (int32_t)50, (int32_t)128,i12,i13);
}
}
ElemWiseActModelVectorMult( (int32_t)6400, tmp69, tmp70, tmp71);
ClearMemSecret1( (int32_t)6400, tmp69);
ClearMemSecret1( (int32_t)6400, tmp70);
for (uint32_t i12 =  (int32_t)0; i12 <  (int32_t)50; i12++){
for (uint32_t i13 =  (int32_t)0; i13 <  (int32_t)128; i13++){
tmp72 = (( (int32_t)0 + (i12 *  (int32_t)128)) + (i13 *  (int32_t)1));
Arr2DIdxRowM(tmp68, (int32_t)50, (int32_t)128,i12,i13) = Arr1DIdxRowM(tmp71, (int32_t)6400,tmp72);
}
}
ClearMemSecret1( (int32_t)6400, tmp71);
ClearMemSecret2( (int32_t)50,  (int32_t)128, tmp66);
ClearMemSecret2( (int32_t)50,  (int32_t)128, tmp12);
...
tmp76 = SecretAdd(tmp76, Arr2DIdxRowM(tmp68, (int32_t)50, (int32_t)128,i15,i14));
}
Arr1DIdxRowM(tmp77, (int32_t)128,i14) = tmp76;
}
ClearMemSecret2( (int32_t)50,  (int32_t)128, tmp68);

int32_t* tmp79 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp79, (int32_t)2, (int64_t)0) =  (int32_t)-1;
Arr1DIdxRowM(tmp79, (int32_t)2, (int64_t)1) =  (int32_t)128;
...
Arr2DIdxRowM(tmp80, (int32_t)1, (int32_t)128,i17,i18) = Arr1DIdxRowM(tmp77, (int32_t)128,i16);
i16 = (i16 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)128, tmp77);
ScaleUp2( (int32_t)1,  (int32_t)128, tmp64,  (int32_t)12);

uint64_t* tmp82 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp82, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp80, (int32_t)1, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp64, (int32_t)1, (int32_t)128,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp80);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp64);

uint64_t* tmp85 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);
ScaleDown2( (int32_t)1,  (int32_t)128, tmp82,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)128,  (int32_t)128, tmp82, tmp13, tmp85, 0);
ClearMemSecret2( (int32_t)128,  (int32_t)128, tmp13);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp82);
ScaleUp2( (int32_t)1,  (int32_t)128, tmp14,  (int32_t)12);

uint64_t* tmp88 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp88, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp85, (int32_t)1, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp14, (int32_t)1, (int32_t)128,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp14);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp85);

uint64_t* tmp91 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);
Relu2( (int32_t)1,  (int32_t)128, tmp88, tmp91,  (int32_t)12, 1);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp93, (int32_t)50, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp3, (int32_t)50, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp21, (int32_t)50, (int32_t)128,i0,i1));
}
}
ClearMemSecret2( (int32_t)50,  (int32_t)128, tmp3);
ScaleDown2( (int32_t)50,  (int32_t)128, tmp93,  (int32_t)12);

uint64_t* tmp95 = make_array<uint64_t>( (int32_t)50,  (int32_t)128);

uint64_t* tmp96 = make_array<uint64_t>( (int32_t)6400);

uint64_t* tmp97 = make_array<uint64_t>( (int32_t)6400);

uint64_t* tmp98 = make_array<uint64_t>( (int32_t)6400);

int32_t tmp99;
for (uint32_t i19 =  (int32_t)0; i19 <  (int32_t)50; i19++){
for (uint32_t i20 =  (int32_t)0; i20 <  (int32_t)128; i20++){
tmp99 = (( (int32_t)0 + (i19 *  (int32_t)128)) + (i20 *  (int32_t)1));
Arr1DIdxRowM(tmp96, (int32_t)6400,tmp99) = Arr2DIdxRowM(tmp93, (int32_t)50, (int32_t)128,i19,i20);
Arr1DIdxRowM(tmp97, (int32_t)6400,tmp99) = Arr2DIdxRowM(tmp15, (int32_t)50, (int32_t)128,i19,i20);
}
}
ElemWiseActModelVectorMult( (int32_t)6400, tmp96, tmp97, tmp98);
ClearMemSecret1( (int32_t)6400, tmp96);
ClearMemSecret1( (int32_t)6400, tmp97);
for (uint32_t i19 =  (int32_t)0; i19 <  (int32_t)50; i19++){
for (uint32_t i20 =  (int32_t)0; i20 <  (int32_t)128; i20++){
tmp99 = (( (int32_t)0 + (i19 *  (int32_t)128)) + (i20 *  (int32_t)1));
Arr2DIdxRowM(tmp95, (int32_t)50, (int32_t)128,i19,i20) = Arr1DIdxRowM(tmp98, (int32_t)6400,tmp99);
}
}
ClearMemSecret1( (int32_t)6400, tmp98);
ClearMemSecret2( (int32_t)50,  (int32_t)128, tmp15);
...
tmp103 = SecretAdd(tmp103, Arr2DIdxRowM(tmp95, (int32_t)50, (int32_t)128,i22,i21));
}
Arr1DIdxRowM(tmp104, (int32_t)128,i21) = tmp103;
}
ClearMemSecret2( (int32_t)50,  (int32_t)128, tmp95);

int32_t* tmp106 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp106, (int32_t)2, (int64_t)0) =  (int32_t)-1;
Arr1DIdxRowM(tmp106, (int32_t)2, (int64_t)1) =  (int32_t)128;
...
Arr2DIdxRowM(tmp107, (int32_t)1, (int32_t)128,i24,i25) = Arr1DIdxRowM(tmp104, (int32_t)128,i23);
i23 = (i23 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)128, tmp104);
ScaleUp2( (int32_t)1,  (int32_t)128, tmp91,  (int32_t)12);

uint64_t* tmp109 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp109, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp107, (int32_t)1, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp91, (int32_t)1, (int32_t)128,i0,i1));
}
}
...
ScaleDown2( (int32_t)1,  (int32_t)128, tmp109,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)128,  (int32_t)128, tmp109, tmp16, tmp112, 0);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp115, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp112, (int32_t)1, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp17, (int32_t)1, (int32_t)128,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp112);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp17);

uint64_t* tmp118 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);
Relu2( (int32_t)1,  (int32_t)128, tmp115, tmp118,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp115);
ScaleUp2( (int32_t)50,  (int32_t)128, tmp4,  (int32_t)12);

uint64_t* tmp120 = make_array<uint64_t>( (int32_t)50,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp120, (int32_t)50, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp4, (int32_t)50, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp21, (int32_t)50, (int32_t)128,i0,i1));
}
}
ClearMemSecret2( (int32_t)50,  (int32_t)128, tmp21);
ClearMemSecret2( (int32_t)50,  (int32_t)128, tmp4);
ScaleDown2( (int32_t)50,  (int32_t)128, tmp120,  (int32_t)12);

uint64_t* tmp123 = make_array<uint64_t>( (int32_t)50,  (int32_t)128);

uint64_t* tmp124 = make_array<uint64_t>( (int32_t)6400);

uint64_t* tmp125 = make_array<uint64_t>( (int32_t)6400);

uint64_t* tmp126 = make_array<uint64_t>( (int32_t)6400);

int32_t tmp127;
for (uint32_t i26 =  (int32_t)0; i26 <  (int32_t)50; i26++){
for (uint32_t i27 =  (int32_t)0; i27 <  (int32_t)128; i27++){
tmp127 = (( (int32_t)0 + (i26 *  (int32_t)128)) + (i27 *  (int32_t)1));
Arr1DIdxRowM(tmp124, (int32_t)6400,tmp127) = Arr2DIdxRowM(tmp120, (int32_t)50, (int32_t)128,i26,i27);
Arr1DIdxRowM(tmp125, (int32_t)6400,tmp127) = Arr2DIdxRowM(tmp18, (int32_t)50, (int32_t)128,i26,i27);
}
}
ElemWiseActModelVectorMult( (int32_t)6400, tmp124, tmp125, tmp126);
ClearMemSecret1( (int32_t)6400, tmp124);
ClearMemSecret1( (int32_t)6400, tmp125);
for (uint32_t i26 =  (int32_t)0; i26 <  (int32_t)50; i26++){
for (uint32_t i27 =  (int32_t)0; i27 <  (int32_t)128; i27++){
tmp127 = (( (int32_t)0 + (i26 *  (int32_t)128)) + (i27 *  (int32_t)1));
Arr2DIdxRowM(tmp123, (int32_t)50, (int32_t)128,i26,i27) = Arr1DIdxRowM(tmp126, (int32_t)6400,tmp127);
}
}
ClearMemSecret1( (int32_t)6400, tmp126);
ClearMemSecret2( (int32_t)50,  (int32_t)128, tmp18);
ClearMemSecret2( (int32_t)50,  (int32_t)128, tmp120);
...
tmp131 = SecretAdd(tmp131, Arr2DIdxRowM(tmp123, (int32_t)50, (int32_t)128,i29,i28));
}
Arr1DIdxRowM(tmp132, (int32_t)128,i28) = tmp131;
}
ClearMemSecret2( (int32_t)50,  (int32_t)128, tmp123);
...
Arr2DIdxRowM(tmp135, (int32_t)1, (int32_t)128,i31,i32) = Arr1DIdxRowM(tmp132, (int32_t)128,i30);
i30 = (i30 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)128, tmp132);
ScaleUp2( (int32_t)1,  (int32_t)128, tmp118,  (int32_t)12);

uint64_t* tmp137 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp137, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp135, (int32_t)1, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp118, (int32_t)1, (int32_t)128,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp135);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp118);

uint64_t* tmp140 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);
ScaleDown2( (int32_t)1,  (int32_t)128, tmp137,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)128,  (int32_t)128, tmp137, tmp19, tmp140, 0);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp143, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp140, (int32_t)1, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp20, (int32_t)1, (int32_t)128,i0,i1));
}
}
...
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (uint32_t)0; i1 <  (int32_t)128; i1++){
cout << (funcReconstruct2PCCons(Arr2DIdxRowM(tmp146, (int32_t)1, (int32_t)128,i0,i1), 2)) << endl;
}
}
}
