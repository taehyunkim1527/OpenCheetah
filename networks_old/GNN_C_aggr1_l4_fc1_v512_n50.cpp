...
tmp5 = SecretAdd(tmp5, Arr2DIdxRowM(tmp0, (int32_t)50, (int32_t)512,i1,i0));
}
Arr1DIdxRowM(tmp6, (int32_t)512,i0) = tmp5;
}
...
for (uint32_t i3 =  (int32_t)0; i3 <  (int32_t)50; i3++){
tmp9 = SecretAdd(tmp9, Arr2DIdxRowM(tmp1, (int32_t)50, (int32_t)512,i3,i2));
}
Arr1DIdxRowM(tmp10, (int32_t)512,i2) = tmp9;
}
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp1);

int32_t tmp12 =  (int32_t)0;

uint64_t tmp13;

uint64_t* tmp14 = make_array<uint64_t>( (int32_t)512);
for (uint32_t i4 =  (int32_t)0; i4 <  (int32_t)512; i4++){
tmp13 = funcSSCons( (int64_t)0);
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)50; i5++){
tmp13 = SecretAdd(tmp13, Arr2DIdxRowM(tmp2, (int32_t)50, (int32_t)512,i5,i4));
}
Arr1DIdxRowM(tmp14, (int32_t)512,i4) = tmp13;
}
...
tmp17 = SecretAdd(tmp17, Arr2DIdxRowM(tmp3, (int32_t)50, (int32_t)512,i7,i6));
}
Arr1DIdxRowM(tmp18, (int32_t)512,i6) = tmp17;
}
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp3);
EndComputation();
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)512; i0++){
cout << (funcReconstruct2PCCons(Arr1DIdxRowM(tmp18, (int32_t)512,i0), 2)) << endl;
}
}
