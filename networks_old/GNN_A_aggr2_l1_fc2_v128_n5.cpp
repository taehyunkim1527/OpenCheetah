...
tmp33 = SecretAdd(tmp33, Arr2DIdxRowM(tmp29, (int32_t)5, (int32_t)128,i6,i5));
}
Arr1DIdxRowM(tmp34, (int32_t)128,i5) = tmp33;
}
...
Arr2DIdxRowM(tmp37, (int32_t)1, (int32_t)128,i8,i9) = Arr1DIdxRowM(tmp34, (int32_t)128,i7);
i7 = (i7 +  (int64_t)1);
}
}
...
tmp46 = (( (int32_t)0 + (i10 *  (int32_t)128)) + (i11 *  (int32_t)1));
Arr1DIdxRowM(tmp43, (int32_t)128,tmp46) = Arr2DIdxRowM(tmp39, (int32_t)1, (int32_t)128,i10,i11);
Arr1DIdxRowM(tmp44, (int32_t)128,tmp46) = Arr2DIdxRowM(tmp6, (int32_t)1, (int32_t)1,i10, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)128, tmp43, tmp44, tmp45);
ClearMemSecret1( (int32_t)128, tmp43);
ClearMemSecret1( (int32_t)128, tmp44);
for (uint32_t i10 =  (int32_t)0; i10 <  (int32_t)1; i10++){
for (uint32_t i11 =  (int32_t)0; i11 <  (int32_t)128; i11++){
tmp46 = (( (int32_t)0 + (i10 *  (int32_t)128)) + (i11 *  (int32_t)1));
Arr2DIdxRowM(tmp42, (int32_t)1, (int32_t)128,i10,i11) = Arr1DIdxRowM(tmp45, (int32_t)128,tmp46);
}
}
...
MatMul2D( (int32_t)1,  (int32_t)128,  (int32_t)128, tmp42, tmp7, tmp49, 0);
