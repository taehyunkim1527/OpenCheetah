...
uint64_t* tmp12 = make_array<uint64_t>( (int32_t)30,  (int32_t)1);
...
Arr2DIdxRowM(tmp12, (int32_t)30, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp12 : 0;
}
}
...
uint64_t* tmp15 = make_array<uint64_t>( (int32_t)30,  (int32_t)1);
...
Arr2DIdxRowM(tmp15, (int32_t)30, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp15 : 0;
}
}
...
uint64_t* tmp18 = make_array<uint64_t>( (int32_t)30,  (int32_t)1);
...
Arr2DIdxRowM(tmp18, (int32_t)30, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp18 : 0;
}
}
...
Arr1DIdxRowM(tmp43, (int32_t)15360,tmp45) = Arr2DIdxRowM(tmp9, (int32_t)30, (int32_t)1,i5, (int32_t)0);
}
}
...
Arr1DIdxRowM(tmp70, (int32_t)15360,tmp72) = Arr2DIdxRowM(tmp12, (int32_t)30, (int32_t)1,i12, (int32_t)0);
}
}
...
ClearMemSecret2( (int32_t)30,  (int32_t)1, tmp12);
...
Arr1DIdxRowM(tmp97, (int32_t)15360,tmp99) = Arr2DIdxRowM(tmp15, (int32_t)30, (int32_t)1,i19, (int32_t)0);
}
}
...
ClearMemSecret2( (int32_t)30,  (int32_t)1, tmp15);
...
Arr1DIdxRowM(tmp125, (int32_t)15360,tmp127) = Arr2DIdxRowM(tmp18, (int32_t)30, (int32_t)1,i26, (int32_t)0);
}
}
...
ClearMemSecret2( (int32_t)30,  (int32_t)1, tmp18);
