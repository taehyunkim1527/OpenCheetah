...
uint64_t* tmp4 = make_array<uint64_t>( (int32_t)25600);
...
tmp7 = (( (int32_t)0 + (i0 *  (int32_t)128)) + (i1 *  (int32_t)1));
Arr1DIdxRowM(tmp4, (int32_t)25600,tmp7) = Arr2DIdxRowM(tmp0, (int32_t)200, (int32_t)128,i0,i1);
Arr1DIdxRowM(tmp5, (int32_t)25600,tmp7) = Arr1DIdxRowM(tmp2, (int32_t)1, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)25600, tmp4, tmp5, tmp6);
ClearMemSecret1( (int32_t)25600, tmp4);
ClearMemSecret1( (int32_t)25600, tmp5);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)200; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
tmp7 = (( (int32_t)0 + (i0 *  (int32_t)128)) + (i1 *  (int32_t)1));
Arr2DIdxRowM(tmp3, (int32_t)200, (int32_t)128,i0,i1) = Arr1DIdxRowM(tmp6, (int32_t)25600,tmp7);
}
}
...
tmp10 = SecretAdd(tmp10, Arr2DIdxRowM(tmp3, (int32_t)200, (int32_t)128,i3,i2));
}
Arr1DIdxRowM(tmp11, (int32_t)128,i2) = tmp10;
}
...
tmp17 = (( (int32_t)0 + (i4 *  (int32_t)128)) + (i5 *  (int32_t)1));
Arr1DIdxRowM(tmp14, (int32_t)25600,tmp17) = Arr2DIdxRowM(tmp1, (int32_t)200, (int32_t)128,i4,i5);
Arr1DIdxRowM(tmp15, (int32_t)25600,tmp17) = Arr1DIdxRowM(tmp2, (int32_t)1, (int32_t)0);
}
}
...
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)128; i5++){
tmp17 = (( (int32_t)0 + (i4 *  (int32_t)128)) + (i5 *  (int32_t)1));
Arr2DIdxRowM(tmp13, (int32_t)200, (int32_t)128,i4,i5) = Arr1DIdxRowM(tmp16, (int32_t)25600,tmp17);
}
}
ClearMemSecret1( (int32_t)25600, tmp16);
ClearMemSecret2( (int32_t)200,  (int32_t)128, tmp1);
ClearMemSecret1( (int32_t)1, tmp2);
...
tmp21 = SecretAdd(tmp21, Arr2DIdxRowM(tmp13, (int32_t)200, (int32_t)128,i7,i6));
}
Arr1DIdxRowM(tmp22, (int32_t)128,i6) = tmp21;
}
...
cout << (funcReconstruct2PCCons(Arr1DIdxRowM(tmp22, (int32_t)128,i0), 2)) << endl;
}
}
