...
uint64_t* tmp4 = make_array<uint64_t>( (int32_t)3,  (int32_t)1);
...
Arr2DIdxRowM(tmp4, (int32_t)3, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp4 : 0;
}
}
StartComputation();
...
Arr1DIdxRowM(tmp17, (int32_t)1536,tmp19) = Arr2DIdxRowM(tmp4, (int32_t)3, (int32_t)1,i2, (int32_t)0);
}
}
...
ClearMemSecret2( (int32_t)3,  (int32_t)1, tmp4);
