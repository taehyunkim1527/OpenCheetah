...
uint64_t* tmp45 = make_array<uint64_t>( (int32_t)256);
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)256; i5++){
tmp44 = funcSSCons( (int64_t)0);
for (uint32_t i6 =  (int32_t)0; i6 <  (int32_t)5; i6++){
tmp44 = SecretAdd(tmp44, Arr2DIdxRowM(tmp41, (int32_t)5, (int32_t)256,i6,i5));
}
Arr1DIdxRowM(tmp45, (int32_t)256,i5) = tmp44;
}
...
Arr1DIdxRowM(tmp47, (int32_t)2, (int64_t)1) =  (int32_t)256;
...
Arr2DIdxRowM(tmp48, (int32_t)1, (int32_t)256,i8,i9) = Arr1DIdxRowM(tmp45, (int32_t)256,i7);
i7 = (i7 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)256, tmp45);
ScaleUp2( (int32_t)1,  (int32_t)256, tmp39,  (int32_t)12);

uint64_t* tmp50 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp50, (int32_t)1, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp48, (int32_t)1, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp39, (int32_t)1, (int32_t)256,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp48);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp39);
ScaleDown2( (int32_t)1,  (int32_t)256, tmp50,  (int32_t)12);

uint64_t* tmp53 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);

uint64_t* tmp54 = make_array<uint64_t>( (int32_t)256);

uint64_t* tmp55 = make_array<uint64_t>( (int32_t)256);

uint64_t* tmp56 = make_array<uint64_t>( (int32_t)256);

int32_t tmp57;
for (uint32_t i10 =  (int32_t)0; i10 <  (int32_t)1; i10++){
for (uint32_t i11 =  (int32_t)0; i11 <  (int32_t)256; i11++){
tmp57 = (( (int32_t)0 + (i10 *  (int32_t)256)) + (i11 *  (int32_t)1));
Arr1DIdxRowM(tmp54, (int32_t)256,tmp57) = Arr2DIdxRowM(tmp50, (int32_t)1, (int32_t)256,i10,i11);
Arr1DIdxRowM(tmp55, (int32_t)256,tmp57) = Arr2DIdxRowM(tmp8, (int32_t)1, (int32_t)1,i10, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)256, tmp54, tmp55, tmp56);
ClearMemSecret1( (int32_t)256, tmp54);
ClearMemSecret1( (int32_t)256, tmp55);
for (uint32_t i10 =  (int32_t)0; i10 <  (int32_t)1; i10++){
for (uint32_t i11 =  (int32_t)0; i11 <  (int32_t)256; i11++){
tmp57 = (( (int32_t)0 + (i10 *  (int32_t)256)) + (i11 *  (int32_t)1));
Arr2DIdxRowM(tmp53, (int32_t)1, (int32_t)256,i10,i11) = Arr1DIdxRowM(tmp56, (int32_t)256,tmp57);
}
}
...
ScaleDown2( (int32_t)1,  (int32_t)256, tmp53,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)256,  (int32_t)256, tmp53, tmp9, tmp60, 0);
...
tmp79 = SecretAdd(tmp79, Arr2DIdxRowM(tmp76, (int32_t)5, (int32_t)256,i13,i12));
}
Arr1DIdxRowM(tmp80, (int32_t)256,i12) = tmp79;
}
...
Arr1DIdxRowM(tmp82, (int32_t)2, (int64_t)1) =  (int32_t)256;
...
Arr2DIdxRowM(tmp83, (int32_t)1, (int32_t)256,i15,i16) = Arr1DIdxRowM(tmp80, (int32_t)256,i14);
i14 = (i14 +  (int64_t)1);
}
}
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp85, (int32_t)1, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp83, (int32_t)1, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp74, (int32_t)1, (int32_t)256,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp83);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp74);
ScaleDown2( (int32_t)1,  (int32_t)256, tmp85,  (int32_t)12);

uint64_t* tmp88 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);

uint64_t* tmp89 = make_array<uint64_t>( (int32_t)256);

uint64_t* tmp90 = make_array<uint64_t>( (int32_t)256);

uint64_t* tmp91 = make_array<uint64_t>( (int32_t)256);

int32_t tmp92;
for (uint32_t i17 =  (int32_t)0; i17 <  (int32_t)1; i17++){
for (uint32_t i18 =  (int32_t)0; i18 <  (int32_t)256; i18++){
tmp92 = (( (int32_t)0 + (i17 *  (int32_t)256)) + (i18 *  (int32_t)1));
Arr1DIdxRowM(tmp89, (int32_t)256,tmp92) = Arr2DIdxRowM(tmp85, (int32_t)1, (int32_t)256,i17,i18);
Arr1DIdxRowM(tmp90, (int32_t)256,tmp92) = Arr2DIdxRowM(tmp13, (int32_t)1, (int32_t)1,i17, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)256, tmp89, tmp90, tmp91);
ClearMemSecret1( (int32_t)256, tmp89);
ClearMemSecret1( (int32_t)256, tmp90);
for (uint32_t i17 =  (int32_t)0; i17 <  (int32_t)1; i17++){
for (uint32_t i18 =  (int32_t)0; i18 <  (int32_t)256; i18++){
tmp92 = (( (int32_t)0 + (i17 *  (int32_t)256)) + (i18 *  (int32_t)1));
Arr2DIdxRowM(tmp88, (int32_t)1, (int32_t)256,i17,i18) = Arr1DIdxRowM(tmp91, (int32_t)256,tmp92);
}
}
...
ScaleDown2( (int32_t)1,  (int32_t)256, tmp88,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)256,  (int32_t)256, tmp88, tmp14, tmp95, 0);
...
tmp115 = SecretAdd(tmp115, Arr2DIdxRowM(tmp111, (int32_t)5, (int32_t)256,i20,i19));
}
Arr1DIdxRowM(tmp116, (int32_t)256,i19) = tmp115;
}
...
Arr1DIdxRowM(tmp118, (int32_t)2, (int64_t)1) =  (int32_t)256;
...
Arr2DIdxRowM(tmp119, (int32_t)1, (int32_t)256,i22,i23) = Arr1DIdxRowM(tmp116, (int32_t)256,i21);
i21 = (i21 +  (int64_t)1);
}
}
...
uint64_t* tmp121 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp121, (int32_t)1, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp119, (int32_t)1, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp109, (int32_t)1, (int32_t)256,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp119);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp109);
ScaleDown2( (int32_t)1,  (int32_t)256, tmp121,  (int32_t)12);
...
uint64_t* tmp127 = make_array<uint64_t>( (int32_t)256);

int32_t tmp128;
for (uint32_t i24 =  (int32_t)0; i24 <  (int32_t)1; i24++){
for (uint32_t i25 =  (int32_t)0; i25 <  (int32_t)256; i25++){
tmp128 = (( (int32_t)0 + (i24 *  (int32_t)256)) + (i25 *  (int32_t)1));
Arr1DIdxRowM(tmp125, (int32_t)256,tmp128) = Arr2DIdxRowM(tmp121, (int32_t)1, (int32_t)256,i24,i25);
Arr1DIdxRowM(tmp126, (int32_t)256,tmp128) = Arr2DIdxRowM(tmp18, (int32_t)1, (int32_t)1,i24, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)256, tmp125, tmp126, tmp127);
ClearMemSecret1( (int32_t)256, tmp125);
ClearMemSecret1( (int32_t)256, tmp126);
for (uint32_t i24 =  (int32_t)0; i24 <  (int32_t)1; i24++){
for (uint32_t i25 =  (int32_t)0; i25 <  (int32_t)256; i25++){
tmp128 = (( (int32_t)0 + (i24 *  (int32_t)256)) + (i25 *  (int32_t)1));
Arr2DIdxRowM(tmp124, (int32_t)1, (int32_t)256,i24,i25) = Arr1DIdxRowM(tmp127, (int32_t)256,tmp128);
}
}
ClearMemSecret1( (int32_t)256, tmp127);
ClearMemSecret2( (int32_t)1,  (int32_t)1, tmp18);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp121);

uint64_t* tmp131 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
ScaleDown2( (int32_t)1,  (int32_t)256, tmp124,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)256,  (int32_t)256, tmp124, tmp19, tmp131, 0);
