...
uint64_t* tmp1 = make_array<uint64_t>( (int32_t)512);
/* Variable to read the clear value corresponding to the input variable tmp1 at (9030,1-9030,35) */
uint64_t __tmp_in_tmp1;
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)512; i0++){
if ((party == SERVER)) {
__tmp_in_tmp1 = 2;
}
Arr1DIdxRowM(tmp1, (int32_t)512,i0) = (party == SERVER) ? __tmp_in_tmp1 : 0;
}
...
int32_t tmp5 =  (int32_t)0;

uint64_t tmp6;

uint64_t* tmp7 = make_array<uint64_t>( (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)512; i0++){
tmp6 = funcSSCons( (int64_t)0);
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)50; i1++){
tmp6 = SecretAdd(tmp6, Arr2DIdxRowM(tmp2, (int32_t)50, (int32_t)512,i1,i0));
}
Arr1DIdxRowM(tmp7, (int32_t)512,i0) = tmp6;
}
...
tmp13 = ( (int32_t)0 + (i2 *  (int32_t)1));
Arr1DIdxRowM(tmp10, (int32_t)512,tmp13) = Arr1DIdxRowM(tmp7, (int32_t)512,i2);
Arr1DIdxRowM(tmp11, (int32_t)512,tmp13) = Arr1DIdxRowM(tmp1, (int32_t)512,i2);
}
ElemWiseActModelVectorMult( (int32_t)512, tmp10, tmp11, tmp12);
ClearMemSecret1( (int32_t)512, tmp10);
ClearMemSecret1( (int32_t)512, tmp11);
for (uint32_t i2 =  (int32_t)0; i2 <  (int32_t)512; i2++){
tmp13 = ( (int32_t)0 + (i2 *  (int32_t)1));
Arr1DIdxRowM(tmp9, (int32_t)512,i2) = Arr1DIdxRowM(tmp12, (int32_t)512,tmp13);
}
ClearMemSecret1( (int32_t)512, tmp12);
ClearMemSecret1( (int32_t)512, tmp7);
ClearMemSecret1( (int32_t)512, tmp1);

int32_t tmp16 =  (int32_t)0;

uint64_t tmp17;

uint64_t* tmp18 = make_array<uint64_t>( (int32_t)512);
for (uint32_t i3 =  (int32_t)0; i3 <  (int32_t)512; i3++){
tmp17 = funcSSCons( (int64_t)0);
for (uint32_t i4 =  (int32_t)0; i4 <  (int32_t)50; i4++){
tmp17 = SecretAdd(tmp17, Arr2DIdxRowM(tmp0, (int32_t)50, (int32_t)512,i4,i3));
}
Arr1DIdxRowM(tmp18, (int32_t)512,i3) = tmp17;
}
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp0);
ScaleUp1( (int32_t)512, tmp18,  (int32_t)12);

uint64_t* tmp20 = make_array<uint64_t>( (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)512; i0++){
Arr1DIdxRowM(tmp20, (int32_t)512,i0) = SecretAdd(Arr1DIdxRowM(tmp18, (int32_t)512,i0), Arr1DIdxRowM(tmp9, (int32_t)512,i0));
}
ClearMemSecret1( (int32_t)512, tmp18);
ClearMemSecret1( (int32_t)512, tmp9);
ScaleDown1( (int32_t)512, tmp20,  (int32_t)12);
...
Arr1DIdxRowM(tmp24, (int32_t)512,tmp27) = Arr1DIdxRowM(tmp20, (int32_t)512,i5);
Arr1DIdxRowM(tmp25, (int32_t)512,tmp27) = Arr1DIdxRowM(tmp4, (int32_t)1, (int32_t)0);
}
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)512; i0++){
Arr1DIdxRowM(tmp30, (int32_t)512,i0) = SecretAdd(Arr1DIdxRowM(tmp23, (int32_t)512,i0), Arr1DIdxRowM(tmp3, (int32_t)512,i0));
}
ClearMemSecret1( (int32_t)512, tmp23);
ClearMemSecret1( (int32_t)512, tmp3);
ScaleDown1( (int32_t)512, tmp30,  (int32_t)12);
EndComputation();
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)512; i0++){
cout << (funcReconstruct2PCCons(Arr1DIdxRowM(tmp30, (int32_t)512,i0), 2)) << endl;
}
}
