...
Arr1DIdxRowM(tmp49, (int32_t)128,tmp51) = Arr2DIdxRowM(tmp7, (int32_t)1, (int32_t)1,i10, (int32_t)0);
}
}
...
MatMul2D( (int32_t)1,  (int32_t)128,  (int32_t)128, tmp47, tmp8, tmp54, 0);
...
tmp74 = SecretAdd(tmp74, Arr2DIdxRowM(tmp70, (int32_t)50, (int32_t)128,i13,i12));
}
Arr1DIdxRowM(tmp75, (int32_t)128,i12) = tmp74;
}
...
Arr2DIdxRowM(tmp78, (int32_t)1, (int32_t)128,i15,i16) = Arr1DIdxRowM(tmp75, (int32_t)128,i14);
i14 = (i14 +  (int64_t)1);
}
}
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp80, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp78, (int32_t)1, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp68, (int32_t)1, (int32_t)128,i0,i1));
}
}
...
tmp87 = (( (int32_t)0 + (i17 *  (int32_t)128)) + (i18 *  (int32_t)1));
Arr1DIdxRowM(tmp84, (int32_t)128,tmp87) = Arr2DIdxRowM(tmp80, (int32_t)1, (int32_t)128,i17,i18);
Arr1DIdxRowM(tmp85, (int32_t)128,tmp87) = Arr2DIdxRowM(tmp12, (int32_t)1, (int32_t)1,i17, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)128, tmp84, tmp85, tmp86);
ClearMemSecret1( (int32_t)128, tmp84);
ClearMemSecret1( (int32_t)128, tmp85);
for (uint32_t i17 =  (int32_t)0; i17 <  (int32_t)1; i17++){
for (uint32_t i18 =  (int32_t)0; i18 <  (int32_t)128; i18++){
tmp87 = (( (int32_t)0 + (i17 *  (int32_t)128)) + (i18 *  (int32_t)1));
Arr2DIdxRowM(tmp83, (int32_t)1, (int32_t)128,i17,i18) = Arr1DIdxRowM(tmp86, (int32_t)128,tmp87);
}
}
...
ScaleDown2( (int32_t)1,  (int32_t)128, tmp83,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)128,  (int32_t)128, tmp83, tmp13, tmp90, 0);
