...
uint64_t* tmp11 = make_array<uint64_t>( (int32_t)50,  (int32_t)1);
/* Variable to read the clear value corresponding to the input variable tmp11 at (9060,1-9060,38) */
...
Arr2DIdxRowM(tmp11, (int32_t)50, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp11 : 0;
}
}
...
Arr1DIdxRowM(tmp39, (int32_t)25600,tmp41) = Arr2DIdxRowM(tmp8, (int32_t)50, (int32_t)1,i5, (int32_t)0);
}
}
...
Arr1DIdxRowM(tmp66, (int32_t)25600,tmp68) = Arr2DIdxRowM(tmp11, (int32_t)50, (int32_t)1,i12, (int32_t)0);
}
}
...
ClearMemSecret2( (int32_t)50,  (int32_t)1, tmp11);
...
Arr1DIdxRowM(tmp94, (int32_t)25600,tmp96) = Arr2DIdxRowM(tmp14, (int32_t)50, (int32_t)1,i19, (int32_t)0);
}
}
