...
uint64_t* tmp14 = make_array<uint64_t>( (int32_t)6400);
...
tmp17 = (( (int32_t)0 + (i0 *  (int32_t)128)) + (i1 *  (int32_t)1));
Arr1DIdxRowM(tmp14, (int32_t)6400,tmp17) = Arr2DIdxRowM(tmp4, (int32_t)50, (int32_t)128,i0,i1);
Arr1DIdxRowM(tmp15, (int32_t)6400,tmp17) = Arr2DIdxRowM(tmp3, (int32_t)1, (int32_t)128, (int32_t)0,i1);
}
}
ElemWiseActModelVectorMult( (int32_t)6400, tmp14, tmp15, tmp16);
ClearMemSecret1( (int32_t)6400, tmp14);
ClearMemSecret1( (int32_t)6400, tmp15);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
tmp17 = (( (int32_t)0 + (i0 *  (int32_t)128)) + (i1 *  (int32_t)1));
Arr2DIdxRowM(tmp13, (int32_t)50, (int32_t)128,i0,i1) = Arr1DIdxRowM(tmp16, (int32_t)6400,tmp17);
}
}
...
Arr1DIdxRowM(tmp20, (int32_t)2, (int64_t)1) =  (int32_t)128;
...
Arr2DIdxRowM(tmp21, (int32_t)1, (int32_t)128,i3,i4) = Arr1DIdxRowM(tmp0, (int32_t)128,i2);
i2 = (i2 +  (int64_t)1);
}
}
...
MatMul2D( (int32_t)1,  (int32_t)128,  (int32_t)128, tmp21, tmp5, tmp23, 0);
...
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp26, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp23, (int32_t)1, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp6, (int32_t)1, (int32_t)128,i0,i1));
}
}
...
Relu2( (int32_t)1,  (int32_t)128, tmp26, tmp29,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp26);
ScaleUp2( (int32_t)50,  (int32_t)128, tmp1,  (int32_t)12);

uint64_t* tmp31 = make_array<uint64_t>( (int32_t)50,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp31, (int32_t)50, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp1, (int32_t)50, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp13, (int32_t)50, (int32_t)128,i0,i1));
}
}
ClearMemSecret2( (int32_t)50,  (int32_t)128, tmp1);
ScaleDown2( (int32_t)50,  (int32_t)128, tmp31,  (int32_t)12);
...
tmp37 = (( (int32_t)0 + (i5 *  (int32_t)128)) + (i6 *  (int32_t)1));
Arr1DIdxRowM(tmp34, (int32_t)6400,tmp37) = Arr2DIdxRowM(tmp31, (int32_t)50, (int32_t)128,i5,i6);
Arr1DIdxRowM(tmp35, (int32_t)6400,tmp37) = Arr2DIdxRowM(tmp7, (int32_t)50, (int32_t)1,i5, (int32_t)0);
}
}
...
for (uint32_t i6 =  (int32_t)0; i6 <  (int32_t)128; i6++){
tmp37 = (( (int32_t)0 + (i5 *  (int32_t)128)) + (i6 *  (int32_t)1));
Arr2DIdxRowM(tmp33, (int32_t)50, (int32_t)128,i5,i6) = Arr1DIdxRowM(tmp36, (int32_t)6400,tmp37);
}
}
ClearMemSecret1( (int32_t)6400, tmp36);
ClearMemSecret2( (int32_t)50,  (int32_t)128, tmp31);
...
tmp41 = SecretAdd(tmp41, Arr2DIdxRowM(tmp33, (int32_t)50, (int32_t)128,i8,i7));
}
Arr1DIdxRowM(tmp42, (int32_t)128,i7) = tmp41;
}
...
Arr2DIdxRowM(tmp45, (int32_t)1, (int32_t)128,i10,i11) = Arr1DIdxRowM(tmp42, (int32_t)128,i9);
i9 = (i9 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)128, tmp42);
ScaleUp2( (int32_t)1,  (int32_t)128, tmp29,  (int32_t)12);

uint64_t* tmp47 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp47, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp45, (int32_t)1, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp29, (int32_t)1, (int32_t)128,i0,i1));
}
}
...
uint64_t* tmp58 = make_array<uint64_t>( (int32_t)50,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp58, (int32_t)50, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp2, (int32_t)50, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp13, (int32_t)50, (int32_t)128,i0,i1));
}
}
ClearMemSecret2( (int32_t)50,  (int32_t)128, tmp13);
ClearMemSecret2( (int32_t)50,  (int32_t)128, tmp2);
ScaleDown2( (int32_t)50,  (int32_t)128, tmp58,  (int32_t)12);

uint64_t* tmp61 = make_array<uint64_t>( (int32_t)50,  (int32_t)128);

uint64_t* tmp62 = make_array<uint64_t>( (int32_t)6400);

uint64_t* tmp63 = make_array<uint64_t>( (int32_t)6400);

uint64_t* tmp64 = make_array<uint64_t>( (int32_t)6400);

int32_t tmp65;
for (uint32_t i12 =  (int32_t)0; i12 <  (int32_t)50; i12++){
for (uint32_t i13 =  (int32_t)0; i13 <  (int32_t)128; i13++){
tmp65 = (( (int32_t)0 + (i12 *  (int32_t)128)) + (i13 *  (int32_t)1));
Arr1DIdxRowM(tmp62, (int32_t)6400,tmp65) = Arr2DIdxRowM(tmp58, (int32_t)50, (int32_t)128,i12,i13);
Arr1DIdxRowM(tmp63, (int32_t)6400,tmp65) = Arr2DIdxRowM(tmp10, (int32_t)50, (int32_t)1,i12, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)6400, tmp62, tmp63, tmp64);
ClearMemSecret1( (int32_t)6400, tmp62);
ClearMemSecret1( (int32_t)6400, tmp63);
for (uint32_t i12 =  (int32_t)0; i12 <  (int32_t)50; i12++){
for (uint32_t i13 =  (int32_t)0; i13 <  (int32_t)128; i13++){
tmp65 = (( (int32_t)0 + (i12 *  (int32_t)128)) + (i13 *  (int32_t)1));
Arr2DIdxRowM(tmp61, (int32_t)50, (int32_t)128,i12,i13) = Arr1DIdxRowM(tmp64, (int32_t)6400,tmp65);
}
}
ClearMemSecret1( (int32_t)6400, tmp64);
ClearMemSecret2( (int32_t)50,  (int32_t)1, tmp10);
ClearMemSecret2( (int32_t)50,  (int32_t)128, tmp58);
...
tmp69 = SecretAdd(tmp69, Arr2DIdxRowM(tmp61, (int32_t)50, (int32_t)128,i15,i14));
}
Arr1DIdxRowM(tmp70, (int32_t)128,i14) = tmp69;
}
...
Arr2DIdxRowM(tmp73, (int32_t)1, (int32_t)128,i17,i18) = Arr1DIdxRowM(tmp70, (int32_t)128,i16);
i16 = (i16 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)128, tmp70);
ScaleUp2( (int32_t)1,  (int32_t)128, tmp56,  (int32_t)12);

uint64_t* tmp75 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp75, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp73, (int32_t)1, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp56, (int32_t)1, (int32_t)128,i0,i1));
}
}
...
MatMul2D( (int32_t)1,  (int32_t)128,  (int32_t)128, tmp75, tmp11, tmp78, 0);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp81, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp78, (int32_t)1, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp12, (int32_t)1, (int32_t)128,i0,i1));
}
}
...
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (uint32_t)0; i1 <  (int32_t)128; i1++){
cout << (funcReconstruct2PCCons(Arr2DIdxRowM(tmp84, (int32_t)1, (int32_t)128,i0,i1), 2)) << endl;
}
}
}
