...
Arr1DIdxRowM(tmp5, (int32_t)2, (int64_t)1) =  (int32_t)512;
...
Arr2DIdxRowM(tmp6, (int32_t)1, (int32_t)512,i1,i2) = Arr1DIdxRowM(tmp0, (int32_t)512,i0);
i0 = (i0 +  (int64_t)1);
}
}
...
Arr2DIdxRowM(tmp8, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp2, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp6, (int32_t)1, (int32_t)512,i0,i1));
}
}
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp11, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp8, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp1, (int32_t)1, (int32_t)512,i0,i1));
}
}
...
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp11, tmp3, tmp14, 0);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp17, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp14, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp4, (int32_t)1, (int32_t)512,i0,i1));
}
}
...
Relu2( (int32_t)1,  (int32_t)512, tmp17, tmp20,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp17);
EndComputation();
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (uint32_t)0; i1 <  (int32_t)512; i1++){
cout << (funcReconstruct2PCCons(Arr2DIdxRowM(tmp20, (int32_t)1, (int32_t)512,i0,i1), 2)) << endl;
}
}
}
