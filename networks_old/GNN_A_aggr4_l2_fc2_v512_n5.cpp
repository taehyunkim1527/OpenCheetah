...
uint64_t* tmp7 = make_array<uint64_t>( (int32_t)5,  (int32_t)1);
/* Variable to read the clear value corresponding to the input variable tmp7 at (9048,1-9048,36) */
...
Arr2DIdxRowM(tmp7, (int32_t)5, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp7 : 0;
}
}
...
Arr1DIdxRowM(tmp39, (int32_t)2560,tmp41) = Arr2DIdxRowM(tmp7, (int32_t)5, (int32_t)1,i5, (int32_t)0);
}
}
...
ClearMemSecret2( (int32_t)5,  (int32_t)1, tmp7);
...
Arr1DIdxRowM(tmp75, (int32_t)2560,tmp77) = Arr2DIdxRowM(tmp12, (int32_t)5, (int32_t)1,i12, (int32_t)0);
}
}
