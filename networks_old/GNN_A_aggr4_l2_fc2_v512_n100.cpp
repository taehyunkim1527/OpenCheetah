...
uint64_t* tmp7 = make_array<uint64_t>( (int32_t)100,  (int32_t)1);
...
Arr2DIdxRowM(tmp7, (int32_t)100, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp7 : 0;
}
}
...
Arr1DIdxRowM(tmp39, (int32_t)51200,tmp41) = Arr2DIdxRowM(tmp7, (int32_t)100, (int32_t)1,i5, (int32_t)0);
}
}
...
ClearMemSecret2( (int32_t)100,  (int32_t)1, tmp7);
...
Arr1DIdxRowM(tmp75, (int32_t)51200,tmp77) = Arr2DIdxRowM(tmp12, (int32_t)100, (int32_t)1,i12, (int32_t)0);
}
}
