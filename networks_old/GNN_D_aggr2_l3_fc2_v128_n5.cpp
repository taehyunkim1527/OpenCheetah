...
tmp8 = SecretAdd(tmp8, Arr2DIdxRowM(tmp4, (int32_t)5, (int32_t)128,i1,i0));
}
...
tmp19 = SecretAdd(tmp19, Arr2DIdxRowM(tmp0, (int32_t)5, (int32_t)128,i4,i3));
}
...
tmp33 = SecretAdd(tmp33, Arr2DIdxRowM(tmp1, (int32_t)5, (int32_t)128,i7,i6));
}
...
tmp47 = SecretAdd(tmp47, Arr2DIdxRowM(tmp2, (int32_t)5, (int32_t)128,i10,i9));
}
