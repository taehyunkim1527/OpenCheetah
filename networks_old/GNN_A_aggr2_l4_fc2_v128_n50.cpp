...
tmp50 = SecretAdd(tmp50, Arr2DIdxRowM(tmp47, (int32_t)50, (int32_t)128,i6,i5));
}
Arr1DIdxRowM(tmp51, (int32_t)128,i5) = tmp50;
}
...
Arr1DIdxRowM(tmp53, (int32_t)2, (int64_t)1) =  (int32_t)128;

uint64_t* tmp54 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);
...
for (uint32_t i9 =  (int32_t)0; i9 <  (int32_t)128; i9++){
Arr2DIdxRowM(tmp54, (int32_t)1, (int32_t)128,i8,i9) = Arr1DIdxRowM(tmp51, (int32_t)128,i7);
i7 = (i7 +  (int64_t)1);
}
}
...
uint64_t* tmp56 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp56, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp54, (int32_t)1, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp45, (int32_t)1, (int32_t)128,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp54);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp45);
ScaleDown2( (int32_t)1,  (int32_t)128, tmp56,  (int32_t)12);

uint64_t* tmp59 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);
...
tmp63 = (( (int32_t)0 + (i10 *  (int32_t)128)) + (i11 *  (int32_t)1));
Arr1DIdxRowM(tmp60, (int32_t)128,tmp63) = Arr2DIdxRowM(tmp56, (int32_t)1, (int32_t)128,i10,i11);
Arr1DIdxRowM(tmp61, (int32_t)128,tmp63) = Arr2DIdxRowM(tmp9, (int32_t)1, (int32_t)1,i10, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)128, tmp60, tmp61, tmp62);
ClearMemSecret1( (int32_t)128, tmp60);
ClearMemSecret1( (int32_t)128, tmp61);
for (uint32_t i10 =  (int32_t)0; i10 <  (int32_t)1; i10++){
for (uint32_t i11 =  (int32_t)0; i11 <  (int32_t)128; i11++){
tmp63 = (( (int32_t)0 + (i10 *  (int32_t)128)) + (i11 *  (int32_t)1));
Arr2DIdxRowM(tmp59, (int32_t)1, (int32_t)128,i10,i11) = Arr1DIdxRowM(tmp62, (int32_t)128,tmp63);
}
}
ClearMemSecret1( (int32_t)128, tmp62);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp56);
ClearMemSecret2( (int32_t)1,  (int32_t)1, tmp9);

uint64_t* tmp66 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);
ScaleDown2( (int32_t)1,  (int32_t)128, tmp59,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)128,  (int32_t)128, tmp59, tmp10, tmp66, 0);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp59);
...
for (uint32_t i12 =  (int32_t)0; i12 <  (int32_t)128; i12++){
tmp85 = funcSSCons( (int64_t)0);
for (uint32_t i13 =  (int32_t)0; i13 <  (int32_t)50; i13++){
tmp85 = SecretAdd(tmp85, Arr2DIdxRowM(tmp82, (int32_t)50, (int32_t)128,i13,i12));
}
Arr1DIdxRowM(tmp86, (int32_t)128,i12) = tmp85;
}
...
Arr1DIdxRowM(tmp88, (int32_t)2, (int64_t)1) =  (int32_t)128;

uint64_t* tmp89 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);
...
Arr2DIdxRowM(tmp89, (int32_t)1, (int32_t)128,i15,i16) = Arr1DIdxRowM(tmp86, (int32_t)128,i14);
i14 = (i14 +  (int64_t)1);
}
}
...
uint64_t* tmp91 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp91, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp89, (int32_t)1, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp80, (int32_t)1, (int32_t)128,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp89);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp80);
ScaleDown2( (int32_t)1,  (int32_t)128, tmp91,  (int32_t)12);

uint64_t* tmp94 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);

uint64_t* tmp95 = make_array<uint64_t>( (int32_t)128);
...
tmp98 = (( (int32_t)0 + (i17 *  (int32_t)128)) + (i18 *  (int32_t)1));
Arr1DIdxRowM(tmp95, (int32_t)128,tmp98) = Arr2DIdxRowM(tmp91, (int32_t)1, (int32_t)128,i17,i18);
Arr1DIdxRowM(tmp96, (int32_t)128,tmp98) = Arr2DIdxRowM(tmp14, (int32_t)1, (int32_t)1,i17, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)128, tmp95, tmp96, tmp97);
ClearMemSecret1( (int32_t)128, tmp95);
ClearMemSecret1( (int32_t)128, tmp96);
for (uint32_t i17 =  (int32_t)0; i17 <  (int32_t)1; i17++){
for (uint32_t i18 =  (int32_t)0; i18 <  (int32_t)128; i18++){
tmp98 = (( (int32_t)0 + (i17 *  (int32_t)128)) + (i18 *  (int32_t)1));
Arr2DIdxRowM(tmp94, (int32_t)1, (int32_t)128,i17,i18) = Arr1DIdxRowM(tmp97, (int32_t)128,tmp98);
}
}
ClearMemSecret1( (int32_t)128, tmp97);
ClearMemSecret2( (int32_t)1,  (int32_t)1, tmp14);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp91);

uint64_t* tmp101 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);
ScaleDown2( (int32_t)1,  (int32_t)128, tmp94,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)128,  (int32_t)128, tmp94, tmp15, tmp101, 0);
ClearMemSecret2( (int32_t)128,  (int32_t)128, tmp15);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp94);
...
uint64_t* tmp121 = make_array<uint64_t>( (int32_t)128);
for (uint32_t i19 =  (int32_t)0; i19 <  (int32_t)128; i19++){
tmp120 = funcSSCons( (int64_t)0);
for (uint32_t i20 =  (int32_t)0; i20 <  (int32_t)50; i20++){
tmp120 = SecretAdd(tmp120, Arr2DIdxRowM(tmp117, (int32_t)50, (int32_t)128,i20,i19));
}
Arr1DIdxRowM(tmp121, (int32_t)128,i19) = tmp120;
}
...
Arr1DIdxRowM(tmp123, (int32_t)2, (int64_t)1) =  (int32_t)128;

uint64_t* tmp124 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);
...
for (uint32_t i23 =  (int32_t)0; i23 <  (int32_t)128; i23++){
Arr2DIdxRowM(tmp124, (int32_t)1, (int32_t)128,i22,i23) = Arr1DIdxRowM(tmp121, (int32_t)128,i21);
i21 = (i21 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)128, tmp121);
ScaleUp2( (int32_t)1,  (int32_t)128, tmp115,  (int32_t)12);

uint64_t* tmp126 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp126, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp124, (int32_t)1, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp115, (int32_t)1, (int32_t)128,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp115);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp124);
ScaleDown2( (int32_t)1,  (int32_t)128, tmp126,  (int32_t)12);

uint64_t* tmp129 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);

uint64_t* tmp130 = make_array<uint64_t>( (int32_t)128);

uint64_t* tmp131 = make_array<uint64_t>( (int32_t)128);

uint64_t* tmp132 = make_array<uint64_t>( (int32_t)128);

int32_t tmp133;
for (uint32_t i24 =  (int32_t)0; i24 <  (int32_t)1; i24++){
for (uint32_t i25 =  (int32_t)0; i25 <  (int32_t)128; i25++){
tmp133 = (( (int32_t)0 + (i24 *  (int32_t)128)) + (i25 *  (int32_t)1));
Arr1DIdxRowM(tmp130, (int32_t)128,tmp133) = Arr2DIdxRowM(tmp126, (int32_t)1, (int32_t)128,i24,i25);
Arr1DIdxRowM(tmp131, (int32_t)128,tmp133) = Arr2DIdxRowM(tmp19, (int32_t)1, (int32_t)1,i24, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)128, tmp130, tmp131, tmp132);
ClearMemSecret1( (int32_t)128, tmp130);
ClearMemSecret1( (int32_t)128, tmp131);
for (uint32_t i24 =  (int32_t)0; i24 <  (int32_t)1; i24++){
for (uint32_t i25 =  (int32_t)0; i25 <  (int32_t)128; i25++){
tmp133 = (( (int32_t)0 + (i24 *  (int32_t)128)) + (i25 *  (int32_t)1));
Arr2DIdxRowM(tmp129, (int32_t)1, (int32_t)128,i24,i25) = Arr1DIdxRowM(tmp132, (int32_t)128,tmp133);
}
}
ClearMemSecret1( (int32_t)128, tmp132);
ClearMemSecret2( (int32_t)1,  (int32_t)1, tmp19);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp126);

uint64_t* tmp136 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);
ScaleDown2( (int32_t)1,  (int32_t)128, tmp129,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)128,  (int32_t)128, tmp129, tmp20, tmp136, 0);
ClearMemSecret2( (int32_t)128,  (int32_t)128, tmp20);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp129);
...
for (uint32_t i26 =  (int32_t)0; i26 <  (int32_t)128; i26++){
tmp156 = funcSSCons( (int64_t)0);
for (uint32_t i27 =  (int32_t)0; i27 <  (int32_t)50; i27++){
tmp156 = SecretAdd(tmp156, Arr2DIdxRowM(tmp152, (int32_t)50, (int32_t)128,i27,i26));
}
Arr1DIdxRowM(tmp157, (int32_t)128,i26) = tmp156;
}
...
Arr1DIdxRowM(tmp159, (int32_t)2, (int64_t)1) =  (int32_t)128;
...
for (uint32_t i30 =  (int32_t)0; i30 <  (int32_t)128; i30++){
Arr2DIdxRowM(tmp160, (int32_t)1, (int32_t)128,i29,i30) = Arr1DIdxRowM(tmp157, (int32_t)128,i28);
i28 = (i28 +  (int64_t)1);
}
}
...
uint64_t* tmp162 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp162, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp160, (int32_t)1, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp150, (int32_t)1, (int32_t)128,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp150);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp160);
ScaleDown2( (int32_t)1,  (int32_t)128, tmp162,  (int32_t)12);

uint64_t* tmp165 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);
...
tmp169 = (( (int32_t)0 + (i31 *  (int32_t)128)) + (i32 *  (int32_t)1));
Arr1DIdxRowM(tmp166, (int32_t)128,tmp169) = Arr2DIdxRowM(tmp162, (int32_t)1, (int32_t)128,i31,i32);
Arr1DIdxRowM(tmp167, (int32_t)128,tmp169) = Arr2DIdxRowM(tmp24, (int32_t)1, (int32_t)1,i31, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)128, tmp166, tmp167, tmp168);
ClearMemSecret1( (int32_t)128, tmp166);
ClearMemSecret1( (int32_t)128, tmp167);
for (uint32_t i31 =  (int32_t)0; i31 <  (int32_t)1; i31++){
for (uint32_t i32 =  (int32_t)0; i32 <  (int32_t)128; i32++){
tmp169 = (( (int32_t)0 + (i31 *  (int32_t)128)) + (i32 *  (int32_t)1));
Arr2DIdxRowM(tmp165, (int32_t)1, (int32_t)128,i31,i32) = Arr1DIdxRowM(tmp168, (int32_t)128,tmp169);
}
}
ClearMemSecret1( (int32_t)128, tmp168);
ClearMemSecret2( (int32_t)1,  (int32_t)1, tmp24);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp162);

uint64_t* tmp172 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);
ScaleDown2( (int32_t)1,  (int32_t)128, tmp165,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)128,  (int32_t)128, tmp165, tmp25, tmp172, 0);
ClearMemSecret2( (int32_t)128,  (int32_t)128, tmp25);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp165);
