...
Arr1DIdxRowM(tmp12, (int32_t)15360,tmp15) = Arr2DIdxRowM(tmp3, (int32_t)30, (int32_t)512,i0,i1);
Arr1DIdxRowM(tmp13, (int32_t)15360,tmp15) = Arr2DIdxRowM(tmp2, (int32_t)1, (int32_t)512, (int32_t)0,i1);
}
}
...
ScaleDown2( (int32_t)30,  (int32_t)512, tmp29,  (int32_t)12);

uint64_t* tmp32 = make_array<uint64_t>( (int32_t)30,  (int32_t)512);

uint64_t* tmp33 = make_array<uint64_t>( (int32_t)15360);
...
Arr1DIdxRowM(tmp33, (int32_t)15360,tmp36) = Arr2DIdxRowM(tmp29, (int32_t)30, (int32_t)512,i5,i6);
Arr1DIdxRowM(tmp34, (int32_t)15360,tmp36) = Arr2DIdxRowM(tmp6, (int32_t)30, (int32_t)512,i5,i6);
}
}
ElemWiseActModelVectorMult( (int32_t)15360, tmp33, tmp34, tmp35);
ClearMemSecret1( (int32_t)15360, tmp33);
ClearMemSecret1( (int32_t)15360, tmp34);
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)30; i5++){
for (uint32_t i6 =  (int32_t)0; i6 <  (int32_t)512; i6++){
tmp36 = (( (int32_t)0 + (i5 *  (int32_t)512)) + (i6 *  (int32_t)1));
Arr2DIdxRowM(tmp32, (int32_t)30, (int32_t)512,i5,i6) = Arr1DIdxRowM(tmp35, (int32_t)15360,tmp36);
}
}
...
tmp40 = SecretAdd(tmp40, Arr2DIdxRowM(tmp32, (int32_t)30, (int32_t)512,i8,i7));
}
