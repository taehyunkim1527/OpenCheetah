...
int32_t tmp40 =  (int32_t)0;

uint64_t tmp41;

uint64_t* tmp42 = make_array<uint64_t>( (int32_t)512);
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)512; i5++){
tmp41 = funcSSCons( (int64_t)0);
for (uint32_t i6 =  (int32_t)0; i6 <  (int32_t)5; i6++){
tmp41 = SecretAdd(tmp41, Arr2DIdxRowM(tmp38, (int32_t)5, (int32_t)512,i6,i5));
}
Arr1DIdxRowM(tmp42, (int32_t)512,i5) = tmp41;
}
ClearMemSecret2( (int32_t)5,  (int32_t)512, tmp38);

int32_t* tmp44 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp44, (int32_t)2, (int64_t)0) =  (int32_t)-1;
Arr1DIdxRowM(tmp44, (int32_t)2, (int64_t)1) =  (int32_t)512;
...
Arr2DIdxRowM(tmp45, (int32_t)1, (int32_t)512,i8,i9) = Arr1DIdxRowM(tmp42, (int32_t)512,i7);
i7 = (i7 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)512, tmp42);
ScaleUp2( (int32_t)1,  (int32_t)512, tmp36,  (int32_t)12);

uint64_t* tmp47 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp47, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp45, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp36, (int32_t)1, (int32_t)512,i0,i1));
}
}
...
ScaleDown2( (int32_t)1,  (int32_t)512, tmp47,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp47, tmp8, tmp50, 0);
ClearMemSecret2( (int32_t)512,  (int32_t)512, tmp8);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp47);
ScaleUp2( (int32_t)1,  (int32_t)512, tmp9,  (int32_t)12);

uint64_t* tmp53 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp53, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp50, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp9, (int32_t)1, (int32_t)512,i0,i1));
}
}
...
Relu2( (int32_t)1,  (int32_t)512, tmp53, tmp56,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp53);

uint64_t* tmp58 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp56, tmp10, tmp58, 0);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)5; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp66, (int32_t)5, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp2, (int32_t)5, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp20, (int32_t)5, (int32_t)512,i0,i1));
}
}
...
tmp69 = SecretAdd(tmp69, Arr2DIdxRowM(tmp66, (int32_t)5, (int32_t)512,i11,i10));
}
Arr1DIdxRowM(tmp70, (int32_t)512,i10) = tmp69;
}
...
Arr2DIdxRowM(tmp73, (int32_t)1, (int32_t)512,i13,i14) = Arr1DIdxRowM(tmp70, (int32_t)512,i12);
i12 = (i12 +  (int64_t)1);
}
}
...
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp75, tmp12, tmp78, 0);
...
uint64_t* tmp81 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp81, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp78, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp13, (int32_t)1, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp13);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp78);

uint64_t* tmp84 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
Relu2( (int32_t)1,  (int32_t)512, tmp81, tmp84,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp81);

uint64_t* tmp86 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp84, tmp14, tmp86, 0);
ClearMemSecret2( (int32_t)512,  (int32_t)512, tmp14);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp84);
ScaleUp2( (int32_t)1,  (int32_t)512, tmp15,  (int32_t)12);

uint64_t* tmp89 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp89, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp86, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp15, (int32_t)1, (int32_t)512,i0,i1));
}
}
...
Relu2( (int32_t)1,  (int32_t)512, tmp89, tmp92,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp89);
ScaleUp2( (int32_t)5,  (int32_t)512, tmp3,  (int32_t)12);

uint64_t* tmp94 = make_array<uint64_t>( (int32_t)5,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)5; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp94, (int32_t)5, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp3, (int32_t)5, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp20, (int32_t)5, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)5,  (int32_t)512, tmp3);
ClearMemSecret2( (int32_t)5,  (int32_t)512, tmp20);

int32_t tmp97 =  (int32_t)0;

uint64_t tmp98;

uint64_t* tmp99 = make_array<uint64_t>( (int32_t)512);
for (uint32_t i15 =  (int32_t)0; i15 <  (int32_t)512; i15++){
tmp98 = funcSSCons( (int64_t)0);
for (uint32_t i16 =  (int32_t)0; i16 <  (int32_t)5; i16++){
tmp98 = SecretAdd(tmp98, Arr2DIdxRowM(tmp94, (int32_t)5, (int32_t)512,i16,i15));
}
Arr1DIdxRowM(tmp99, (int32_t)512,i15) = tmp98;
}
ClearMemSecret2( (int32_t)5,  (int32_t)512, tmp94);

int32_t* tmp101 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp101, (int32_t)2, (int64_t)0) =  (int32_t)-1;
Arr1DIdxRowM(tmp101, (int32_t)2, (int64_t)1) =  (int32_t)512;
...
Arr2DIdxRowM(tmp102, (int32_t)1, (int32_t)512,i18,i19) = Arr1DIdxRowM(tmp99, (int32_t)512,i17);
i17 = (i17 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)512, tmp99);
ScaleUp2( (int32_t)1,  (int32_t)512, tmp92,  (int32_t)12);

uint64_t* tmp104 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp104, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp102, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp92, (int32_t)1, (int32_t)512,i0,i1));
}
}
...
ScaleDown2( (int32_t)1,  (int32_t)512, tmp104,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp104, tmp16, tmp107, 0);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp110, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp107, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp17, (int32_t)1, (int32_t)512,i0,i1));
}
}
...
Relu2( (int32_t)1,  (int32_t)512, tmp110, tmp113,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp110);

uint64_t* tmp115 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp113, tmp18, tmp115, 0);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp118, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp115, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp19, (int32_t)1, (int32_t)512,i0,i1));
}
}
...
Relu2( (int32_t)1,  (int32_t)512, tmp118, tmp121,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp118);
EndComputation();
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (uint32_t)0; i1 <  (int32_t)512; i1++){
cout << (funcReconstruct2PCCons(Arr2DIdxRowM(tmp121, (int32_t)1, (int32_t)512,i0,i1), 2)) << endl;
}
}
}
