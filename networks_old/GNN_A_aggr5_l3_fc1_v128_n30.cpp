...
uint64_t* tmp11 = make_array<uint64_t>( (int32_t)30,  (int32_t)128);
...
Arr2DIdxRowM(tmp11, (int32_t)30, (int32_t)128,i0,i1) = (party == SERVER) ? __tmp_in_tmp11 : 0;
}
}
...
uint64_t* tmp17 = make_array<uint64_t>( (int32_t)30,  (int32_t)128);

uint64_t* tmp18 = make_array<uint64_t>( (int32_t)3840);

uint64_t* tmp19 = make_array<uint64_t>( (int32_t)3840);
...
Arr1DIdxRowM(tmp18, (int32_t)3840,tmp21) = Arr2DIdxRowM(tmp5, (int32_t)30, (int32_t)128,i0,i1);
Arr1DIdxRowM(tmp19, (int32_t)3840,tmp21) = Arr2DIdxRowM(tmp4, (int32_t)1, (int32_t)128, (int32_t)0,i1);
}
}
ElemWiseActModelVectorMult( (int32_t)3840, tmp18, tmp19, tmp20);
ClearMemSecret1( (int32_t)3840, tmp18);
ClearMemSecret1( (int32_t)3840, tmp19);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)30; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
tmp21 = (( (int32_t)0 + (i0 *  (int32_t)128)) + (i1 *  (int32_t)1));
Arr2DIdxRowM(tmp17, (int32_t)30, (int32_t)128,i0,i1) = Arr1DIdxRowM(tmp20, (int32_t)3840,tmp21);
}
}
...
uint64_t* tmp35 = make_array<uint64_t>( (int32_t)30,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)30; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp35, (int32_t)30, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp1, (int32_t)30, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp17, (int32_t)30, (int32_t)128,i0,i1));
}
}
ClearMemSecret2( (int32_t)30,  (int32_t)128, tmp1);
ScaleDown2( (int32_t)30,  (int32_t)128, tmp35,  (int32_t)12);

uint64_t* tmp37 = make_array<uint64_t>( (int32_t)30,  (int32_t)128);

uint64_t* tmp38 = make_array<uint64_t>( (int32_t)3840);

uint64_t* tmp39 = make_array<uint64_t>( (int32_t)3840);

uint64_t* tmp40 = make_array<uint64_t>( (int32_t)3840);
...
Arr1DIdxRowM(tmp38, (int32_t)3840,tmp41) = Arr2DIdxRowM(tmp35, (int32_t)30, (int32_t)128,i5,i6);
Arr1DIdxRowM(tmp39, (int32_t)3840,tmp41) = Arr2DIdxRowM(tmp8, (int32_t)30, (int32_t)128,i5,i6);
}
}
ElemWiseActModelVectorMult( (int32_t)3840, tmp38, tmp39, tmp40);
ClearMemSecret1( (int32_t)3840, tmp38);
ClearMemSecret1( (int32_t)3840, tmp39);
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)30; i5++){
for (uint32_t i6 =  (int32_t)0; i6 <  (int32_t)128; i6++){
tmp41 = (( (int32_t)0 + (i5 *  (int32_t)128)) + (i6 *  (int32_t)1));
Arr2DIdxRowM(tmp37, (int32_t)30, (int32_t)128,i5,i6) = Arr1DIdxRowM(tmp40, (int32_t)3840,tmp41);
}
}
ClearMemSecret1( (int32_t)3840, tmp40);
ClearMemSecret2( (int32_t)30,  (int32_t)128, tmp35);
...
tmp45 = SecretAdd(tmp45, Arr2DIdxRowM(tmp37, (int32_t)30, (int32_t)128,i8,i7));
}
...
uint64_t* tmp62 = make_array<uint64_t>( (int32_t)30,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)30; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp62, (int32_t)30, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp2, (int32_t)30, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp17, (int32_t)30, (int32_t)128,i0,i1));
}
}
ClearMemSecret2( (int32_t)30,  (int32_t)128, tmp2);
ScaleDown2( (int32_t)30,  (int32_t)128, tmp62,  (int32_t)12);

uint64_t* tmp64 = make_array<uint64_t>( (int32_t)30,  (int32_t)128);

uint64_t* tmp65 = make_array<uint64_t>( (int32_t)3840);

uint64_t* tmp66 = make_array<uint64_t>( (int32_t)3840);

uint64_t* tmp67 = make_array<uint64_t>( (int32_t)3840);
...
Arr1DIdxRowM(tmp65, (int32_t)3840,tmp68) = Arr2DIdxRowM(tmp62, (int32_t)30, (int32_t)128,i12,i13);
Arr1DIdxRowM(tmp66, (int32_t)3840,tmp68) = Arr2DIdxRowM(tmp11, (int32_t)30, (int32_t)128,i12,i13);
}
}
ElemWiseActModelVectorMult( (int32_t)3840, tmp65, tmp66, tmp67);
ClearMemSecret1( (int32_t)3840, tmp65);
ClearMemSecret1( (int32_t)3840, tmp66);
for (uint32_t i12 =  (int32_t)0; i12 <  (int32_t)30; i12++){
for (uint32_t i13 =  (int32_t)0; i13 <  (int32_t)128; i13++){
tmp68 = (( (int32_t)0 + (i12 *  (int32_t)128)) + (i13 *  (int32_t)1));
Arr2DIdxRowM(tmp64, (int32_t)30, (int32_t)128,i12,i13) = Arr1DIdxRowM(tmp67, (int32_t)3840,tmp68);
}
}
ClearMemSecret1( (int32_t)3840, tmp67);
ClearMemSecret2( (int32_t)30,  (int32_t)128, tmp62);
ClearMemSecret2( (int32_t)30,  (int32_t)128, tmp11);
...
tmp72 = SecretAdd(tmp72, Arr2DIdxRowM(tmp64, (int32_t)30, (int32_t)128,i15,i14));
}
Arr1DIdxRowM(tmp73, (int32_t)128,i14) = tmp72;
}
ClearMemSecret2( (int32_t)30,  (int32_t)128, tmp64);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)30; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp89, (int32_t)30, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp3, (int32_t)30, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp17, (int32_t)30, (int32_t)128,i0,i1));
}
}
ClearMemSecret2( (int32_t)30,  (int32_t)128, tmp17);
ClearMemSecret2( (int32_t)30,  (int32_t)128, tmp3);
ScaleDown2( (int32_t)30,  (int32_t)128, tmp89,  (int32_t)12);

uint64_t* tmp92 = make_array<uint64_t>( (int32_t)30,  (int32_t)128);

uint64_t* tmp93 = make_array<uint64_t>( (int32_t)3840);

uint64_t* tmp94 = make_array<uint64_t>( (int32_t)3840);

uint64_t* tmp95 = make_array<uint64_t>( (int32_t)3840);
...
Arr1DIdxRowM(tmp93, (int32_t)3840,tmp96) = Arr2DIdxRowM(tmp89, (int32_t)30, (int32_t)128,i19,i20);
Arr1DIdxRowM(tmp94, (int32_t)3840,tmp96) = Arr2DIdxRowM(tmp14, (int32_t)30, (int32_t)128,i19,i20);
}
}
ElemWiseActModelVectorMult( (int32_t)3840, tmp93, tmp94, tmp95);
ClearMemSecret1( (int32_t)3840, tmp93);
ClearMemSecret1( (int32_t)3840, tmp94);
for (uint32_t i19 =  (int32_t)0; i19 <  (int32_t)30; i19++){
for (uint32_t i20 =  (int32_t)0; i20 <  (int32_t)128; i20++){
tmp96 = (( (int32_t)0 + (i19 *  (int32_t)128)) + (i20 *  (int32_t)1));
Arr2DIdxRowM(tmp92, (int32_t)30, (int32_t)128,i19,i20) = Arr1DIdxRowM(tmp95, (int32_t)3840,tmp96);
}
}
ClearMemSecret1( (int32_t)3840, tmp95);
...
tmp100 = SecretAdd(tmp100, Arr2DIdxRowM(tmp92, (int32_t)30, (int32_t)128,i22,i21));
}
Arr1DIdxRowM(tmp101, (int32_t)128,i21) = tmp100;
}
ClearMemSecret2( (int32_t)30,  (int32_t)128, tmp92);
