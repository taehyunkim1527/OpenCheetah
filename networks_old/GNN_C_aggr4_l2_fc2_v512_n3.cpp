...
uint64_t* tmp5 = make_array<uint64_t>( (int32_t)3,  (int32_t)1);
...
Arr2DIdxRowM(tmp5, (int32_t)3, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp5 : 0;
}
}
...
Arr1DIdxRowM(tmp18, (int32_t)1536,tmp20) = Arr2DIdxRowM(tmp5, (int32_t)3, (int32_t)1,i2, (int32_t)0);
}
}
...
ClearMemSecret2( (int32_t)3,  (int32_t)1, tmp5);
...
Arr1DIdxRowM(tmp34, (int32_t)1536,tmp36) = Arr2DIdxRowM(tmp6, (int32_t)3, (int32_t)1,i6, (int32_t)0);
}
}
