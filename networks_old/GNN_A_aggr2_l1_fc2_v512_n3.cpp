...
uint64_t* tmp6 = make_array<uint64_t>( (int32_t)1,  (int32_t)1);
...
Arr2DIdxRowM(tmp6, (int32_t)1, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp6 : 0;
}
}
...
int32_t tmp32 =  (int32_t)0;

uint64_t tmp33;

uint64_t* tmp34 = make_array<uint64_t>( (int32_t)512);
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)512; i5++){
tmp33 = funcSSCons( (int64_t)0);
for (uint32_t i6 =  (int32_t)0; i6 <  (int32_t)3; i6++){
tmp33 = SecretAdd(tmp33, Arr2DIdxRowM(tmp29, (int32_t)3, (int32_t)512,i6,i5));
}
Arr1DIdxRowM(tmp34, (int32_t)512,i5) = tmp33;
}
...
Arr2DIdxRowM(tmp37, (int32_t)1, (int32_t)512,i8,i9) = Arr1DIdxRowM(tmp34, (int32_t)512,i7);
i7 = (i7 +  (int64_t)1);
}
}
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp39, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp37, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp27, (int32_t)1, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp27);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp37);
ScaleDown2( (int32_t)1,  (int32_t)512, tmp39,  (int32_t)12);
...
tmp46 = (( (int32_t)0 + (i10 *  (int32_t)512)) + (i11 *  (int32_t)1));
Arr1DIdxRowM(tmp43, (int32_t)512,tmp46) = Arr2DIdxRowM(tmp39, (int32_t)1, (int32_t)512,i10,i11);
Arr1DIdxRowM(tmp44, (int32_t)512,tmp46) = Arr2DIdxRowM(tmp6, (int32_t)1, (int32_t)1,i10, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)512, tmp43, tmp44, tmp45);
ClearMemSecret1( (int32_t)512, tmp43);
ClearMemSecret1( (int32_t)512, tmp44);
for (uint32_t i10 =  (int32_t)0; i10 <  (int32_t)1; i10++){
for (uint32_t i11 =  (int32_t)0; i11 <  (int32_t)512; i11++){
tmp46 = (( (int32_t)0 + (i10 *  (int32_t)512)) + (i11 *  (int32_t)1));
Arr2DIdxRowM(tmp42, (int32_t)1, (int32_t)512,i10,i11) = Arr1DIdxRowM(tmp45, (int32_t)512,tmp46);
}
}
ClearMemSecret1( (int32_t)512, tmp45);
ClearMemSecret2( (int32_t)1,  (int32_t)1, tmp6);
...
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp42, tmp7, tmp49, 0);
