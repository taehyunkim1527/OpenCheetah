...
uint64_t* tmp1 = make_array<uint64_t>( (int32_t)5,  (int32_t)512);
/* Variable to read the clear value corresponding to the input variable tmp1 at (9030,1-9030,38) */
...
Arr2DIdxRowM(tmp1, (int32_t)5, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp1 : 0;
}
}

uint64_t* tmp2 = make_array<uint64_t>( (int32_t)5,  (int32_t)512);
/* Variable to read the clear value corresponding to the input variable tmp2 at (9033,1-9033,38) */
...
Arr2DIdxRowM(tmp2, (int32_t)5, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp2 : 0;
}
}

uint64_t* tmp3 = make_array<uint64_t>( (int32_t)5,  (int32_t)512);
/* Variable to read the clear value corresponding to the input variable tmp3 at (9036,1-9036,38) */
...
Arr2DIdxRowM(tmp3, (int32_t)5, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp3 : 0;
}
}

uint64_t* tmp4 = make_array<uint64_t>( (int32_t)5,  (int32_t)512);
/* Variable to read the clear value corresponding to the input variable tmp4 at (9039,1-9039,38) */
...
Arr2DIdxRowM(tmp4, (int32_t)5, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp4 : 0;
}
}
...
uint64_t* tmp6 = make_array<uint64_t>( (int32_t)5,  (int32_t)512);
/* Variable to read the clear value corresponding to the input variable tmp6 at (9045,1-9045,38) */
...
Arr2DIdxRowM(tmp6, (int32_t)5, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp6 : 0;
}
}
...
uint64_t* tmp33 = make_array<uint64_t>( (int32_t)5,  (int32_t)512);

uint64_t* tmp34 = make_array<uint64_t>( (int32_t)2560);

uint64_t* tmp35 = make_array<uint64_t>( (int32_t)2560);

uint64_t* tmp36 = make_array<uint64_t>( (int32_t)2560);

int32_t tmp37;
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)5; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
tmp37 = (( (int32_t)0 + (i0 *  (int32_t)512)) + (i1 *  (int32_t)1));
Arr1DIdxRowM(tmp34, (int32_t)2560,tmp37) = Arr2DIdxRowM(tmp6, (int32_t)5, (int32_t)512,i0,i1);
Arr1DIdxRowM(tmp35, (int32_t)2560,tmp37) = Arr2DIdxRowM(tmp5, (int32_t)1, (int32_t)512, (int32_t)0,i1);
}
}
ElemWiseActModelVectorMult( (int32_t)2560, tmp34, tmp35, tmp36);
ClearMemSecret1( (int32_t)2560, tmp34);
ClearMemSecret1( (int32_t)2560, tmp35);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)5; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
tmp37 = (( (int32_t)0 + (i0 *  (int32_t)512)) + (i1 *  (int32_t)1));
Arr2DIdxRowM(tmp33, (int32_t)5, (int32_t)512,i0,i1) = Arr1DIdxRowM(tmp36, (int32_t)2560,tmp37);
}
}
ClearMemSecret1( (int32_t)2560, tmp36);
ClearMemSecret2( (int32_t)5,  (int32_t)512, tmp6);
...
ScaleUp2( (int32_t)5,  (int32_t)512, tmp1,  (int32_t)12);

uint64_t* tmp51 = make_array<uint64_t>( (int32_t)5,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)5; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp51, (int32_t)5, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp1, (int32_t)5, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp33, (int32_t)5, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)5,  (int32_t)512, tmp1);

uint64_t* tmp53 = make_array<uint64_t>( (int32_t)5,  (int32_t)512);
ScaleDown2( (int32_t)5,  (int32_t)512, tmp51,  (int32_t)12);
MatMul2D( (int32_t)5,  (int32_t)512,  (int32_t)512, tmp51, tmp9, tmp53, 0);
ClearMemSecret2( (int32_t)5,  (int32_t)512, tmp51);
ClearMemSecret2( (int32_t)512,  (int32_t)512, tmp9);
ScaleUp2( (int32_t)1,  (int32_t)512, tmp10,  (int32_t)12);

uint64_t* tmp56 = make_array<uint64_t>( (int32_t)5,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)5; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp56, (int32_t)5, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp53, (int32_t)5, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp10, (int32_t)1, (int32_t)512, (int32_t)0,i1));
}
}
ClearMemSecret2( (int32_t)5,  (int32_t)512, tmp53);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp10);

uint64_t* tmp59 = make_array<uint64_t>( (int32_t)5,  (int32_t)512);
Relu2( (int32_t)5,  (int32_t)512, tmp56, tmp59,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)5,  (int32_t)512, tmp56);
...
Arr1DIdxRowM(tmp61, (int32_t)4, (int64_t)2) =  (int32_t)5;
Arr1DIdxRowM(tmp61, (int32_t)4, (int64_t)3) =  (int32_t)1;

uint64_t* tmp62 = make_array<uint64_t>( (int32_t)512,  (int32_t)1,  (int32_t)5,  (int32_t)1);
...
for (uint32_t i9 =  (int32_t)0; i9 <  (int32_t)5; i9++){
for (uint32_t i10 =  (int32_t)0; i10 <  (int32_t)1; i10++){
Arr4DIdxRowM(tmp62, (int32_t)512, (int32_t)1, (int32_t)5, (int32_t)1,i7,i8,i9,i10) = Arr2DIdxRowM(tmp59, (int32_t)5, (int32_t)512,i5,i6);
i6 = (i6 +  (int64_t)1);
if ((i6 ==  (int64_t)512)) {
i6 =  (int64_t)0;
i5 = (i5 +  (int64_t)1);
...
ClearMemSecret2( (int32_t)5,  (int32_t)512, tmp59);

uint64_t* tmp64 = make_array<uint64_t>( (int32_t)512,  (int32_t)1,  (int32_t)1,  (int32_t)1);
MaxPool( (int32_t)512,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)5,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1,  (int32_t)512,  (int32_t)1,  (int32_t)5,  (int32_t)1, tmp62, tmp64);
ClearMemSecret4( (int32_t)512,  (int32_t)1,  (int32_t)5,  (int32_t)1, tmp62);
...
ScaleUp2( (int32_t)5,  (int32_t)512, tmp2,  (int32_t)12);

uint64_t* tmp88 = make_array<uint64_t>( (int32_t)5,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)5; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp88, (int32_t)5, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp2, (int32_t)5, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp33, (int32_t)5, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)5,  (int32_t)512, tmp2);

uint64_t* tmp90 = make_array<uint64_t>( (int32_t)5,  (int32_t)512);
ScaleDown2( (int32_t)5,  (int32_t)512, tmp88,  (int32_t)12);
MatMul2D( (int32_t)5,  (int32_t)512,  (int32_t)512, tmp88, tmp15, tmp90, 0);
ClearMemSecret2( (int32_t)5,  (int32_t)512, tmp88);
ClearMemSecret2( (int32_t)512,  (int32_t)512, tmp15);
ScaleUp2( (int32_t)1,  (int32_t)512, tmp16,  (int32_t)12);

uint64_t* tmp93 = make_array<uint64_t>( (int32_t)5,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)5; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp93, (int32_t)5, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp90, (int32_t)5, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp16, (int32_t)1, (int32_t)512, (int32_t)0,i1));
}
}
ClearMemSecret2( (int32_t)5,  (int32_t)512, tmp90);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp16);

uint64_t* tmp96 = make_array<uint64_t>( (int32_t)5,  (int32_t)512);
Relu2( (int32_t)5,  (int32_t)512, tmp93, tmp96,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)5,  (int32_t)512, tmp93);
...
Arr1DIdxRowM(tmp98, (int32_t)4, (int64_t)2) =  (int32_t)5;
Arr1DIdxRowM(tmp98, (int32_t)4, (int64_t)3) =  (int32_t)1;

uint64_t* tmp99 = make_array<uint64_t>( (int32_t)512,  (int32_t)1,  (int32_t)5,  (int32_t)1);
...
for (uint32_t i21 =  (int32_t)0; i21 <  (int32_t)5; i21++){
for (uint32_t i22 =  (int32_t)0; i22 <  (int32_t)1; i22++){
Arr4DIdxRowM(tmp99, (int32_t)512, (int32_t)1, (int32_t)5, (int32_t)1,i19,i20,i21,i22) = Arr2DIdxRowM(tmp96, (int32_t)5, (int32_t)512,i17,i18);
i18 = (i18 +  (int64_t)1);
if ((i18 ==  (int64_t)512)) {
i18 =  (int64_t)0;
i17 = (i17 +  (int64_t)1);
...
ClearMemSecret2( (int32_t)5,  (int32_t)512, tmp96);

uint64_t* tmp101 = make_array<uint64_t>( (int32_t)512,  (int32_t)1,  (int32_t)1,  (int32_t)1);
MaxPool( (int32_t)512,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)5,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1,  (int32_t)512,  (int32_t)1,  (int32_t)5,  (int32_t)1, tmp99, tmp101);
ClearMemSecret4( (int32_t)512,  (int32_t)1,  (int32_t)5,  (int32_t)1, tmp99);
...
ScaleUp2( (int32_t)5,  (int32_t)512, tmp3,  (int32_t)12);

uint64_t* tmp125 = make_array<uint64_t>( (int32_t)5,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)5; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp125, (int32_t)5, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp3, (int32_t)5, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp33, (int32_t)5, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)5,  (int32_t)512, tmp3);

uint64_t* tmp127 = make_array<uint64_t>( (int32_t)5,  (int32_t)512);
ScaleDown2( (int32_t)5,  (int32_t)512, tmp125,  (int32_t)12);
MatMul2D( (int32_t)5,  (int32_t)512,  (int32_t)512, tmp125, tmp21, tmp127, 0);
ClearMemSecret2( (int32_t)512,  (int32_t)512, tmp21);
ClearMemSecret2( (int32_t)5,  (int32_t)512, tmp125);
ScaleUp2( (int32_t)1,  (int32_t)512, tmp22,  (int32_t)12);

uint64_t* tmp130 = make_array<uint64_t>( (int32_t)5,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)5; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp130, (int32_t)5, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp127, (int32_t)5, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp22, (int32_t)1, (int32_t)512, (int32_t)0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp22);
ClearMemSecret2( (int32_t)5,  (int32_t)512, tmp127);

uint64_t* tmp133 = make_array<uint64_t>( (int32_t)5,  (int32_t)512);
Relu2( (int32_t)5,  (int32_t)512, tmp130, tmp133,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)5,  (int32_t)512, tmp130);
...
Arr1DIdxRowM(tmp135, (int32_t)4, (int64_t)2) =  (int32_t)5;
Arr1DIdxRowM(tmp135, (int32_t)4, (int64_t)3) =  (int32_t)1;

uint64_t* tmp136 = make_array<uint64_t>( (int32_t)512,  (int32_t)1,  (int32_t)5,  (int32_t)1);
...
for (uint32_t i33 =  (int32_t)0; i33 <  (int32_t)5; i33++){
for (uint32_t i34 =  (int32_t)0; i34 <  (int32_t)1; i34++){
Arr4DIdxRowM(tmp136, (int32_t)512, (int32_t)1, (int32_t)5, (int32_t)1,i31,i32,i33,i34) = Arr2DIdxRowM(tmp133, (int32_t)5, (int32_t)512,i29,i30);
i30 = (i30 +  (int64_t)1);
if ((i30 ==  (int64_t)512)) {
i30 =  (int64_t)0;
i29 = (i29 +  (int64_t)1);
...
ClearMemSecret2( (int32_t)5,  (int32_t)512, tmp133);

uint64_t* tmp138 = make_array<uint64_t>( (int32_t)512,  (int32_t)1,  (int32_t)1,  (int32_t)1);
MaxPool( (int32_t)512,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)5,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1,  (int32_t)512,  (int32_t)1,  (int32_t)5,  (int32_t)1, tmp136, tmp138);
ClearMemSecret4( (int32_t)512,  (int32_t)1,  (int32_t)5,  (int32_t)1, tmp136);
...
ScaleUp2( (int32_t)5,  (int32_t)512, tmp4,  (int32_t)12);

uint64_t* tmp162 = make_array<uint64_t>( (int32_t)5,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)5; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp162, (int32_t)5, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp4, (int32_t)5, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp33, (int32_t)5, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)5,  (int32_t)512, tmp4);
ClearMemSecret2( (int32_t)5,  (int32_t)512, tmp33);

uint64_t* tmp165 = make_array<uint64_t>( (int32_t)5,  (int32_t)512);
ScaleDown2( (int32_t)5,  (int32_t)512, tmp162,  (int32_t)12);
MatMul2D( (int32_t)5,  (int32_t)512,  (int32_t)512, tmp162, tmp27, tmp165, 0);
ClearMemSecret2( (int32_t)512,  (int32_t)512, tmp27);
ClearMemSecret2( (int32_t)5,  (int32_t)512, tmp162);
ScaleUp2( (int32_t)1,  (int32_t)512, tmp28,  (int32_t)12);

uint64_t* tmp168 = make_array<uint64_t>( (int32_t)5,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)5; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp168, (int32_t)5, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp165, (int32_t)5, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp28, (int32_t)1, (int32_t)512, (int32_t)0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp28);
ClearMemSecret2( (int32_t)5,  (int32_t)512, tmp165);

uint64_t* tmp171 = make_array<uint64_t>( (int32_t)5,  (int32_t)512);
Relu2( (int32_t)5,  (int32_t)512, tmp168, tmp171,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)5,  (int32_t)512, tmp168);
...
Arr1DIdxRowM(tmp173, (int32_t)4, (int64_t)2) =  (int32_t)5;
Arr1DIdxRowM(tmp173, (int32_t)4, (int64_t)3) =  (int32_t)1;

uint64_t* tmp174 = make_array<uint64_t>( (int32_t)512,  (int32_t)1,  (int32_t)5,  (int32_t)1);
...
for (uint32_t i45 =  (int32_t)0; i45 <  (int32_t)5; i45++){
for (uint32_t i46 =  (int32_t)0; i46 <  (int32_t)1; i46++){
Arr4DIdxRowM(tmp174, (int32_t)512, (int32_t)1, (int32_t)5, (int32_t)1,i43,i44,i45,i46) = Arr2DIdxRowM(tmp171, (int32_t)5, (int32_t)512,i41,i42);
i42 = (i42 +  (int64_t)1);
if ((i42 ==  (int64_t)512)) {
i42 =  (int64_t)0;
i41 = (i41 +  (int64_t)1);
...
ClearMemSecret2( (int32_t)5,  (int32_t)512, tmp171);

uint64_t* tmp176 = make_array<uint64_t>( (int32_t)512,  (int32_t)1,  (int32_t)1,  (int32_t)1);
MaxPool( (int32_t)512,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)5,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1,  (int32_t)512,  (int32_t)1,  (int32_t)5,  (int32_t)1, tmp174, tmp176);
ClearMemSecret4( (int32_t)512,  (int32_t)1,  (int32_t)5,  (int32_t)1, tmp174);
