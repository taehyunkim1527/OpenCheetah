...
Arr1DIdxRowM(tmp7, (int32_t)25600,tmp10) = Arr2DIdxRowM(tmp2, (int32_t)50, (int32_t)512,i0,i1);
Arr1DIdxRowM(tmp8, (int32_t)25600,tmp10) = Arr2DIdxRowM(tmp1, (int32_t)1, (int32_t)512, (int32_t)0,i1);
}
}
...
Arr1DIdxRowM(tmp16, (int32_t)512,i0) = SecretAdd(Arr1DIdxRowM(tmp4, (int32_t)512,i0), Arr1DIdxRowM(tmp5, (int32_t)512,i0));
}
ClearMemSecret1( (int32_t)512, tmp5);
ClearMemSecret1( (int32_t)512, tmp4);

uint64_t* tmp19 = make_array<uint64_t>( (int32_t)512);
Relu1( (int32_t)512, tmp16, tmp19,  (int32_t)0, 0);
...
Arr2DIdxRowM(tmp22, (int32_t)1, (int32_t)512,i3,i4) = Arr1DIdxRowM(tmp19, (int32_t)512,i2);
i2 = (i2 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)512, tmp19);
ScaleDown2( (int32_t)50,  (int32_t)512, tmp13,  (int32_t)12);
...
tmp28 = (( (int32_t)0 + (i5 *  (int32_t)512)) + (i6 *  (int32_t)1));
Arr1DIdxRowM(tmp25, (int32_t)25600,tmp28) = Arr2DIdxRowM(tmp13, (int32_t)50, (int32_t)512,i5,i6);
Arr1DIdxRowM(tmp26, (int32_t)25600,tmp28) = Arr2DIdxRowM(tmp22, (int32_t)1, (int32_t)512, (int32_t)0,i6);
}
}
...
for (uint32_t i6 =  (int32_t)0; i6 <  (int32_t)512; i6++){
tmp28 = (( (int32_t)0 + (i5 *  (int32_t)512)) + (i6 *  (int32_t)1));
Arr2DIdxRowM(tmp24, (int32_t)50, (int32_t)512,i5,i6) = Arr1DIdxRowM(tmp27, (int32_t)25600,tmp28);
}
}
...
tmp32 = SecretAdd(tmp32, Arr2DIdxRowM(tmp24, (int32_t)50, (int32_t)512,i8,i7));
}
Arr1DIdxRowM(tmp33, (int32_t)512,i7) = tmp32;
}
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp24);
ScaleUp1( (int32_t)512, tmp3,  (int32_t)12);

uint64_t* tmp35 = make_array<uint64_t>( (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)512; i0++){
Arr1DIdxRowM(tmp35, (int32_t)512,i0) = SecretAdd(Arr1DIdxRowM(tmp33, (int32_t)512,i0), Arr1DIdxRowM(tmp3, (int32_t)512,i0));
}
ClearMemSecret1( (int32_t)512, tmp33);
ClearMemSecret1( (int32_t)512, tmp3);
ScaleDown1( (int32_t)512, tmp35,  (int32_t)12);
EndComputation();
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)512; i0++){
cout << (funcReconstruct2PCCons(Arr1DIdxRowM(tmp35, (int32_t)512,i0), 2)) << endl;
}
}
