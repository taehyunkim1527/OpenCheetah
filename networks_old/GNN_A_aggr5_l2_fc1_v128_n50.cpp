...
uint64_t* tmp10 = make_array<uint64_t>( (int32_t)50,  (int32_t)128);
...
Arr2DIdxRowM(tmp10, (int32_t)50, (int32_t)128,i0,i1) = (party == SERVER) ? __tmp_in_tmp10 : 0;
}
}
...
Arr1DIdxRowM(tmp35, (int32_t)6400,tmp37) = Arr2DIdxRowM(tmp7, (int32_t)50, (int32_t)128,i5,i6);
}
}
...
Arr1DIdxRowM(tmp63, (int32_t)6400,tmp65) = Arr2DIdxRowM(tmp10, (int32_t)50, (int32_t)128,i12,i13);
}
}
...
ClearMemSecret2( (int32_t)50,  (int32_t)128, tmp10);
