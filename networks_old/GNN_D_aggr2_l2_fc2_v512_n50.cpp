...
uint64_t* tmp5 = make_array<uint64_t>( (int32_t)1);
...
Arr1DIdxRowM(tmp5, (int32_t)1,i0) = (party == SERVER) ? __tmp_in_tmp5 : 0;
}
StartComputation();

int32_t tmp6 =  (int32_t)0;

uint64_t tmp7;

uint64_t* tmp8 = make_array<uint64_t>( (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)512; i0++){
tmp7 = funcSSCons( (int64_t)0);
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)50; i1++){
tmp7 = SecretAdd(tmp7, Arr2DIdxRowM(tmp3, (int32_t)50, (int32_t)512,i1,i0));
}
Arr1DIdxRowM(tmp8, (int32_t)512,i0) = tmp7;
}
...
tmp14 = ( (int32_t)0 + (i2 *  (int32_t)1));
Arr1DIdxRowM(tmp11, (int32_t)512,tmp14) = Arr1DIdxRowM(tmp8, (int32_t)512,i2);
Arr1DIdxRowM(tmp12, (int32_t)512,tmp14) = Arr1DIdxRowM(tmp2, (int32_t)512,i2);
}
ElemWiseActModelVectorMult( (int32_t)512, tmp11, tmp12, tmp13);
ClearMemSecret1( (int32_t)512, tmp11);
ClearMemSecret1( (int32_t)512, tmp12);
for (uint32_t i2 =  (int32_t)0; i2 <  (int32_t)512; i2++){
tmp14 = ( (int32_t)0 + (i2 *  (int32_t)1));
Arr1DIdxRowM(tmp10, (int32_t)512,i2) = Arr1DIdxRowM(tmp13, (int32_t)512,tmp14);
}
...
tmp18 = SecretAdd(tmp18, Arr2DIdxRowM(tmp0, (int32_t)50, (int32_t)512,i4,i3));
}
Arr1DIdxRowM(tmp19, (int32_t)512,i3) = tmp18;
}
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp0);
ScaleUp1( (int32_t)512, tmp19,  (int32_t)12);

uint64_t* tmp21 = make_array<uint64_t>( (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)512; i0++){
Arr1DIdxRowM(tmp21, (int32_t)512,i0) = SecretAdd(Arr1DIdxRowM(tmp19, (int32_t)512,i0), Arr1DIdxRowM(tmp10, (int32_t)512,i0));
}
ClearMemSecret1( (int32_t)512, tmp19);
ScaleDown1( (int32_t)512, tmp21,  (int32_t)12);
...
tmp27 = ( (int32_t)0 + (i5 *  (int32_t)1));
Arr1DIdxRowM(tmp24, (int32_t)512,tmp27) = Arr1DIdxRowM(tmp21, (int32_t)512,i5);
Arr1DIdxRowM(tmp25, (int32_t)512,tmp27) = Arr1DIdxRowM(tmp5, (int32_t)1, (int32_t)0);
}
ElemWiseActModelVectorMult( (int32_t)512, tmp24, tmp25, tmp26);
ClearMemSecret1( (int32_t)512, tmp24);
ClearMemSecret1( (int32_t)512, tmp25);
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)512; i5++){
tmp27 = ( (int32_t)0 + (i5 *  (int32_t)1));
Arr1DIdxRowM(tmp23, (int32_t)512,i5) = Arr1DIdxRowM(tmp26, (int32_t)512,tmp27);
}
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)512; i0++){
Arr1DIdxRowM(tmp29, (int32_t)512,i0) = SecretAdd(Arr1DIdxRowM(tmp23, (int32_t)512,i0), Arr1DIdxRowM(tmp4, (int32_t)512,i0));
}
...
tmp32 = SecretAdd(tmp32, Arr2DIdxRowM(tmp1, (int32_t)50, (int32_t)512,i7,i6));
}
Arr1DIdxRowM(tmp33, (int32_t)512,i6) = tmp32;
}
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp1);
ScaleUp1( (int32_t)512, tmp33,  (int32_t)12);

uint64_t* tmp35 = make_array<uint64_t>( (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)512; i0++){
Arr1DIdxRowM(tmp35, (int32_t)512,i0) = SecretAdd(Arr1DIdxRowM(tmp33, (int32_t)512,i0), Arr1DIdxRowM(tmp10, (int32_t)512,i0));
}
...
Arr1DIdxRowM(tmp39, (int32_t)512,tmp42) = Arr1DIdxRowM(tmp35, (int32_t)512,i8);
Arr1DIdxRowM(tmp40, (int32_t)512,tmp42) = Arr1DIdxRowM(tmp5, (int32_t)1, (int32_t)0);
}
...
ClearMemSecret1( (int32_t)1, tmp5);
ClearMemSecret1( (int32_t)512, tmp35);

uint64_t* tmp45 = make_array<uint64_t>( (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)512; i0++){
Arr1DIdxRowM(tmp45, (int32_t)512,i0) = SecretAdd(Arr1DIdxRowM(tmp38, (int32_t)512,i0), Arr1DIdxRowM(tmp4, (int32_t)512,i0));
}
ClearMemSecret1( (int32_t)512, tmp38);
ClearMemSecret1( (int32_t)512, tmp4);
ScaleDown1( (int32_t)512, tmp45,  (int32_t)12);
EndComputation();
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)512; i0++){
cout << (funcReconstruct2PCCons(Arr1DIdxRowM(tmp45, (int32_t)512,i0), 2)) << endl;
}
}
