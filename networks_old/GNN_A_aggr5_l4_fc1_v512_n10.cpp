...
uint64_t* tmp12 = make_array<uint64_t>( (int32_t)10,  (int32_t)512);
...
Arr2DIdxRowM(tmp12, (int32_t)10, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp12 : 0;
}
}
...
uint64_t* tmp15 = make_array<uint64_t>( (int32_t)10,  (int32_t)512);
...
Arr2DIdxRowM(tmp15, (int32_t)10, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp15 : 0;
}
}
...
uint64_t* tmp18 = make_array<uint64_t>( (int32_t)10,  (int32_t)512);
...
Arr2DIdxRowM(tmp18, (int32_t)10, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp18 : 0;
}
}
...
uint64_t* tmp21 = make_array<uint64_t>( (int32_t)10,  (int32_t)512);

uint64_t* tmp22 = make_array<uint64_t>( (int32_t)5120);

uint64_t* tmp23 = make_array<uint64_t>( (int32_t)5120);

uint64_t* tmp24 = make_array<uint64_t>( (int32_t)5120);
...
Arr1DIdxRowM(tmp22, (int32_t)5120,tmp25) = Arr2DIdxRowM(tmp6, (int32_t)10, (int32_t)512,i0,i1);
Arr1DIdxRowM(tmp23, (int32_t)5120,tmp25) = Arr2DIdxRowM(tmp5, (int32_t)1, (int32_t)512, (int32_t)0,i1);
}
}
ElemWiseActModelVectorMult( (int32_t)5120, tmp22, tmp23, tmp24);
ClearMemSecret1( (int32_t)5120, tmp22);
ClearMemSecret1( (int32_t)5120, tmp23);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)10; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
tmp25 = (( (int32_t)0 + (i0 *  (int32_t)512)) + (i1 *  (int32_t)1));
Arr2DIdxRowM(tmp21, (int32_t)10, (int32_t)512,i0,i1) = Arr1DIdxRowM(tmp24, (int32_t)5120,tmp25);
}
}
ClearMemSecret1( (int32_t)5120, tmp24);
...
uint64_t* tmp39 = make_array<uint64_t>( (int32_t)10,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)10; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp39, (int32_t)10, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp1, (int32_t)10, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp21, (int32_t)10, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)10,  (int32_t)512, tmp1);
ScaleDown2( (int32_t)10,  (int32_t)512, tmp39,  (int32_t)12);

uint64_t* tmp41 = make_array<uint64_t>( (int32_t)10,  (int32_t)512);

uint64_t* tmp42 = make_array<uint64_t>( (int32_t)5120);

uint64_t* tmp43 = make_array<uint64_t>( (int32_t)5120);

uint64_t* tmp44 = make_array<uint64_t>( (int32_t)5120);
...
Arr1DIdxRowM(tmp42, (int32_t)5120,tmp45) = Arr2DIdxRowM(tmp39, (int32_t)10, (int32_t)512,i5,i6);
Arr1DIdxRowM(tmp43, (int32_t)5120,tmp45) = Arr2DIdxRowM(tmp9, (int32_t)10, (int32_t)512,i5,i6);
}
}
ElemWiseActModelVectorMult( (int32_t)5120, tmp42, tmp43, tmp44);
ClearMemSecret1( (int32_t)5120, tmp42);
ClearMemSecret1( (int32_t)5120, tmp43);
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)10; i5++){
for (uint32_t i6 =  (int32_t)0; i6 <  (int32_t)512; i6++){
tmp45 = (( (int32_t)0 + (i5 *  (int32_t)512)) + (i6 *  (int32_t)1));
Arr2DIdxRowM(tmp41, (int32_t)10, (int32_t)512,i5,i6) = Arr1DIdxRowM(tmp44, (int32_t)5120,tmp45);
}
}
ClearMemSecret1( (int32_t)5120, tmp44);
ClearMemSecret2( (int32_t)10,  (int32_t)512, tmp9);
ClearMemSecret2( (int32_t)10,  (int32_t)512, tmp39);
...
tmp49 = SecretAdd(tmp49, Arr2DIdxRowM(tmp41, (int32_t)10, (int32_t)512,i8,i7));
}
Arr1DIdxRowM(tmp50, (int32_t)512,i7) = tmp49;
}
ClearMemSecret2( (int32_t)10,  (int32_t)512, tmp41);
...
uint64_t* tmp66 = make_array<uint64_t>( (int32_t)10,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)10; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp66, (int32_t)10, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp2, (int32_t)10, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp21, (int32_t)10, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)10,  (int32_t)512, tmp2);
ScaleDown2( (int32_t)10,  (int32_t)512, tmp66,  (int32_t)12);

uint64_t* tmp68 = make_array<uint64_t>( (int32_t)10,  (int32_t)512);

uint64_t* tmp69 = make_array<uint64_t>( (int32_t)5120);

uint64_t* tmp70 = make_array<uint64_t>( (int32_t)5120);

uint64_t* tmp71 = make_array<uint64_t>( (int32_t)5120);
...
Arr1DIdxRowM(tmp69, (int32_t)5120,tmp72) = Arr2DIdxRowM(tmp66, (int32_t)10, (int32_t)512,i12,i13);
Arr1DIdxRowM(tmp70, (int32_t)5120,tmp72) = Arr2DIdxRowM(tmp12, (int32_t)10, (int32_t)512,i12,i13);
}
}
ElemWiseActModelVectorMult( (int32_t)5120, tmp69, tmp70, tmp71);
ClearMemSecret1( (int32_t)5120, tmp69);
ClearMemSecret1( (int32_t)5120, tmp70);
for (uint32_t i12 =  (int32_t)0; i12 <  (int32_t)10; i12++){
for (uint32_t i13 =  (int32_t)0; i13 <  (int32_t)512; i13++){
tmp72 = (( (int32_t)0 + (i12 *  (int32_t)512)) + (i13 *  (int32_t)1));
Arr2DIdxRowM(tmp68, (int32_t)10, (int32_t)512,i12,i13) = Arr1DIdxRowM(tmp71, (int32_t)5120,tmp72);
}
}
ClearMemSecret1( (int32_t)5120, tmp71);
ClearMemSecret2( (int32_t)10,  (int32_t)512, tmp66);
ClearMemSecret2( (int32_t)10,  (int32_t)512, tmp12);
...
tmp76 = SecretAdd(tmp76, Arr2DIdxRowM(tmp68, (int32_t)10, (int32_t)512,i15,i14));
}
Arr1DIdxRowM(tmp77, (int32_t)512,i14) = tmp76;
}
ClearMemSecret2( (int32_t)10,  (int32_t)512, tmp68);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)10; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp93, (int32_t)10, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp3, (int32_t)10, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp21, (int32_t)10, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)10,  (int32_t)512, tmp3);
ScaleDown2( (int32_t)10,  (int32_t)512, tmp93,  (int32_t)12);

uint64_t* tmp95 = make_array<uint64_t>( (int32_t)10,  (int32_t)512);

uint64_t* tmp96 = make_array<uint64_t>( (int32_t)5120);

uint64_t* tmp97 = make_array<uint64_t>( (int32_t)5120);

uint64_t* tmp98 = make_array<uint64_t>( (int32_t)5120);
...
Arr1DIdxRowM(tmp96, (int32_t)5120,tmp99) = Arr2DIdxRowM(tmp93, (int32_t)10, (int32_t)512,i19,i20);
Arr1DIdxRowM(tmp97, (int32_t)5120,tmp99) = Arr2DIdxRowM(tmp15, (int32_t)10, (int32_t)512,i19,i20);
}
}
ElemWiseActModelVectorMult( (int32_t)5120, tmp96, tmp97, tmp98);
ClearMemSecret1( (int32_t)5120, tmp96);
ClearMemSecret1( (int32_t)5120, tmp97);
for (uint32_t i19 =  (int32_t)0; i19 <  (int32_t)10; i19++){
for (uint32_t i20 =  (int32_t)0; i20 <  (int32_t)512; i20++){
tmp99 = (( (int32_t)0 + (i19 *  (int32_t)512)) + (i20 *  (int32_t)1));
Arr2DIdxRowM(tmp95, (int32_t)10, (int32_t)512,i19,i20) = Arr1DIdxRowM(tmp98, (int32_t)5120,tmp99);
}
}
ClearMemSecret1( (int32_t)5120, tmp98);
ClearMemSecret2( (int32_t)10,  (int32_t)512, tmp15);
...
tmp103 = SecretAdd(tmp103, Arr2DIdxRowM(tmp95, (int32_t)10, (int32_t)512,i22,i21));
}
Arr1DIdxRowM(tmp104, (int32_t)512,i21) = tmp103;
}
ClearMemSecret2( (int32_t)10,  (int32_t)512, tmp95);
...
uint64_t* tmp120 = make_array<uint64_t>( (int32_t)10,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)10; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp120, (int32_t)10, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp4, (int32_t)10, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp21, (int32_t)10, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)10,  (int32_t)512, tmp21);
ClearMemSecret2( (int32_t)10,  (int32_t)512, tmp4);
ScaleDown2( (int32_t)10,  (int32_t)512, tmp120,  (int32_t)12);

uint64_t* tmp123 = make_array<uint64_t>( (int32_t)10,  (int32_t)512);

uint64_t* tmp124 = make_array<uint64_t>( (int32_t)5120);

uint64_t* tmp125 = make_array<uint64_t>( (int32_t)5120);

uint64_t* tmp126 = make_array<uint64_t>( (int32_t)5120);
...
Arr1DIdxRowM(tmp124, (int32_t)5120,tmp127) = Arr2DIdxRowM(tmp120, (int32_t)10, (int32_t)512,i26,i27);
Arr1DIdxRowM(tmp125, (int32_t)5120,tmp127) = Arr2DIdxRowM(tmp18, (int32_t)10, (int32_t)512,i26,i27);
}
}
ElemWiseActModelVectorMult( (int32_t)5120, tmp124, tmp125, tmp126);
ClearMemSecret1( (int32_t)5120, tmp124);
ClearMemSecret1( (int32_t)5120, tmp125);
for (uint32_t i26 =  (int32_t)0; i26 <  (int32_t)10; i26++){
for (uint32_t i27 =  (int32_t)0; i27 <  (int32_t)512; i27++){
tmp127 = (( (int32_t)0 + (i26 *  (int32_t)512)) + (i27 *  (int32_t)1));
Arr2DIdxRowM(tmp123, (int32_t)10, (int32_t)512,i26,i27) = Arr1DIdxRowM(tmp126, (int32_t)5120,tmp127);
}
}
ClearMemSecret1( (int32_t)5120, tmp126);
ClearMemSecret2( (int32_t)10,  (int32_t)512, tmp18);
ClearMemSecret2( (int32_t)10,  (int32_t)512, tmp120);
...
tmp131 = SecretAdd(tmp131, Arr2DIdxRowM(tmp123, (int32_t)10, (int32_t)512,i29,i28));
}
Arr1DIdxRowM(tmp132, (int32_t)512,i28) = tmp131;
}
ClearMemSecret2( (int32_t)10,  (int32_t)512, tmp123);
