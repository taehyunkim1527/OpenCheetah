...
Arr1DIdxRowM(tmp6, (int32_t)384,tmp9) = Arr2DIdxRowM(tmp2, (int32_t)3, (int32_t)128,i0,i1);
Arr1DIdxRowM(tmp7, (int32_t)384,tmp9) = Arr2DIdxRowM(tmp1, (int32_t)1, (int32_t)128, (int32_t)0,i1);
}
}
...
ScaleDown2( (int32_t)3,  (int32_t)128, tmp12,  (int32_t)12);
...
Arr1DIdxRowM(tmp16, (int32_t)384,tmp19) = Arr2DIdxRowM(tmp12, (int32_t)3, (int32_t)128,i2,i3);
Arr1DIdxRowM(tmp17, (int32_t)384,tmp19) = Arr2DIdxRowM(tmp4, (int32_t)3, (int32_t)128,i2,i3);
}
}
...
for (uint32_t i3 =  (int32_t)0; i3 <  (int32_t)128; i3++){
tmp19 = (( (int32_t)0 + (i2 *  (int32_t)128)) + (i3 *  (int32_t)1));
Arr2DIdxRowM(tmp15, (int32_t)3, (int32_t)128,i2,i3) = Arr1DIdxRowM(tmp18, (int32_t)384,tmp19);
}
}
...
tmp23 = SecretAdd(tmp23, Arr2DIdxRowM(tmp15, (int32_t)3, (int32_t)128,i5,i4));
}
