...
uint64_t* tmp0 = make_array<uint64_t>( (int32_t)5,  (int32_t)128);
...
Arr2DIdxRowM(tmp0, (int32_t)5, (int32_t)128,i0,i1) = (party == SERVER) ? __tmp_in_tmp0 : 0;
}
}
...
uint64_t* tmp12 = make_array<uint64_t>( (int32_t)640);

uint64_t* tmp13 = make_array<uint64_t>( (int32_t)640);
...
Arr1DIdxRowM(tmp12, (int32_t)640,tmp15) = Arr2DIdxRowM(tmp5, (int32_t)5, (int32_t)128,i0,i1);
Arr1DIdxRowM(tmp13, (int32_t)640,tmp15) = Arr2DIdxRowM(tmp4, (int32_t)1, (int32_t)128, (int32_t)0,i1);
}
}
ElemWiseActModelVectorMult( (int32_t)640, tmp12, tmp13, tmp14);
ClearMemSecret1( (int32_t)640, tmp12);
ClearMemSecret1( (int32_t)640, tmp13);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)5; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
tmp15 = (( (int32_t)0 + (i0 *  (int32_t)128)) + (i1 *  (int32_t)1));
Arr2DIdxRowM(tmp11, (int32_t)5, (int32_t)128,i0,i1) = Arr1DIdxRowM(tmp14, (int32_t)640,tmp15);
}
}
ClearMemSecret1( (int32_t)640, tmp14);
ClearMemSecret2( (int32_t)5,  (int32_t)128, tmp5);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp4);
ScaleUp2( (int32_t)5,  (int32_t)128, tmp0,  (int32_t)12);

uint64_t* tmp18 = make_array<uint64_t>( (int32_t)5,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)5; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp18, (int32_t)5, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp0, (int32_t)5, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp11, (int32_t)5, (int32_t)128,i0,i1));
}
}
ClearMemSecret2( (int32_t)5,  (int32_t)128, tmp0);
ScaleDown2( (int32_t)5,  (int32_t)128, tmp18,  (int32_t)12);
...
Arr1DIdxRowM(tmp21, (int32_t)640,tmp24) = Arr2DIdxRowM(tmp18, (int32_t)5, (int32_t)128,i2,i3);
Arr1DIdxRowM(tmp22, (int32_t)640,tmp24) = Arr2DIdxRowM(tmp7, (int32_t)5, (int32_t)128,i2,i3);
}
}
...
for (uint32_t i3 =  (int32_t)0; i3 <  (int32_t)128; i3++){
tmp24 = (( (int32_t)0 + (i2 *  (int32_t)128)) + (i3 *  (int32_t)1));
Arr2DIdxRowM(tmp20, (int32_t)5, (int32_t)128,i2,i3) = Arr1DIdxRowM(tmp23, (int32_t)640,tmp24);
}
}
...
tmp28 = SecretAdd(tmp28, Arr2DIdxRowM(tmp20, (int32_t)5, (int32_t)128,i5,i4));
}
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)5; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp33, (int32_t)5, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp1, (int32_t)5, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp11, (int32_t)5, (int32_t)128,i0,i1));
}
}
...
uint64_t* tmp37 = make_array<uint64_t>( (int32_t)640);
...
Arr1DIdxRowM(tmp36, (int32_t)640,tmp39) = Arr2DIdxRowM(tmp33, (int32_t)5, (int32_t)128,i6,i7);
Arr1DIdxRowM(tmp37, (int32_t)640,tmp39) = Arr2DIdxRowM(tmp8, (int32_t)5, (int32_t)128,i6,i7);
}
}
ElemWiseActModelVectorMult( (int32_t)640, tmp36, tmp37, tmp38);
ClearMemSecret1( (int32_t)640, tmp36);
ClearMemSecret1( (int32_t)640, tmp37);
for (uint32_t i6 =  (int32_t)0; i6 <  (int32_t)5; i6++){
for (uint32_t i7 =  (int32_t)0; i7 <  (int32_t)128; i7++){
tmp39 = (( (int32_t)0 + (i6 *  (int32_t)128)) + (i7 *  (int32_t)1));
Arr2DIdxRowM(tmp35, (int32_t)5, (int32_t)128,i6,i7) = Arr1DIdxRowM(tmp38, (int32_t)640,tmp39);
}
}
...
tmp43 = SecretAdd(tmp43, Arr2DIdxRowM(tmp35, (int32_t)5, (int32_t)128,i9,i8));
}
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)5; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp48, (int32_t)5, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp2, (int32_t)5, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp11, (int32_t)5, (int32_t)128,i0,i1));
}
}
ClearMemSecret2( (int32_t)5,  (int32_t)128, tmp2);
ScaleDown2( (int32_t)5,  (int32_t)128, tmp48,  (int32_t)12);

uint64_t* tmp50 = make_array<uint64_t>( (int32_t)5,  (int32_t)128);

uint64_t* tmp51 = make_array<uint64_t>( (int32_t)640);

uint64_t* tmp52 = make_array<uint64_t>( (int32_t)640);

uint64_t* tmp53 = make_array<uint64_t>( (int32_t)640);
...
Arr1DIdxRowM(tmp51, (int32_t)640,tmp54) = Arr2DIdxRowM(tmp48, (int32_t)5, (int32_t)128,i10,i11);
Arr1DIdxRowM(tmp52, (int32_t)640,tmp54) = Arr2DIdxRowM(tmp9, (int32_t)5, (int32_t)128,i10,i11);
}
}
ElemWiseActModelVectorMult( (int32_t)640, tmp51, tmp52, tmp53);
ClearMemSecret1( (int32_t)640, tmp51);
ClearMemSecret1( (int32_t)640, tmp52);
for (uint32_t i10 =  (int32_t)0; i10 <  (int32_t)5; i10++){
for (uint32_t i11 =  (int32_t)0; i11 <  (int32_t)128; i11++){
tmp54 = (( (int32_t)0 + (i10 *  (int32_t)128)) + (i11 *  (int32_t)1));
Arr2DIdxRowM(tmp50, (int32_t)5, (int32_t)128,i10,i11) = Arr1DIdxRowM(tmp53, (int32_t)640,tmp54);
}
}
ClearMemSecret1( (int32_t)640, tmp53);
...
tmp58 = SecretAdd(tmp58, Arr2DIdxRowM(tmp50, (int32_t)5, (int32_t)128,i13,i12));
}
Arr1DIdxRowM(tmp59, (int32_t)128,i12) = tmp58;
}
ClearMemSecret2( (int32_t)5,  (int32_t)128, tmp50);
...
uint64_t* tmp63 = make_array<uint64_t>( (int32_t)5,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)5; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp63, (int32_t)5, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp3, (int32_t)5, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp11, (int32_t)5, (int32_t)128,i0,i1));
}
}
ClearMemSecret2( (int32_t)5,  (int32_t)128, tmp11);
ClearMemSecret2( (int32_t)5,  (int32_t)128, tmp3);
ScaleDown2( (int32_t)5,  (int32_t)128, tmp63,  (int32_t)12);

uint64_t* tmp66 = make_array<uint64_t>( (int32_t)5,  (int32_t)128);

uint64_t* tmp67 = make_array<uint64_t>( (int32_t)640);

uint64_t* tmp68 = make_array<uint64_t>( (int32_t)640);
...
Arr1DIdxRowM(tmp67, (int32_t)640,tmp70) = Arr2DIdxRowM(tmp63, (int32_t)5, (int32_t)128,i14,i15);
Arr1DIdxRowM(tmp68, (int32_t)640,tmp70) = Arr2DIdxRowM(tmp10, (int32_t)5, (int32_t)128,i14,i15);
}
}
ElemWiseActModelVectorMult( (int32_t)640, tmp67, tmp68, tmp69);
ClearMemSecret1( (int32_t)640, tmp67);
ClearMemSecret1( (int32_t)640, tmp68);
for (uint32_t i14 =  (int32_t)0; i14 <  (int32_t)5; i14++){
for (uint32_t i15 =  (int32_t)0; i15 <  (int32_t)128; i15++){
tmp70 = (( (int32_t)0 + (i14 *  (int32_t)128)) + (i15 *  (int32_t)1));
Arr2DIdxRowM(tmp66, (int32_t)5, (int32_t)128,i14,i15) = Arr1DIdxRowM(tmp69, (int32_t)640,tmp70);
}
}
ClearMemSecret1( (int32_t)640, tmp69);
ClearMemSecret2( (int32_t)5,  (int32_t)128, tmp10);
ClearMemSecret2( (int32_t)5,  (int32_t)128, tmp63);
...
tmp74 = SecretAdd(tmp74, Arr2DIdxRowM(tmp66, (int32_t)5, (int32_t)128,i17,i16));
}
