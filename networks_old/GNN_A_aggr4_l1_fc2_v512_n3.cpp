...
uint64_t* tmp6 = make_array<uint64_t>( (int32_t)3,  (int32_t)1);
...
Arr2DIdxRowM(tmp6, (int32_t)3, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp6 : 0;
}
}
...
Arr1DIdxRowM(tmp34, (int32_t)1536,tmp36) = Arr2DIdxRowM(tmp6, (int32_t)3, (int32_t)1,i5, (int32_t)0);
}
}
...
ClearMemSecret2( (int32_t)3,  (int32_t)1, tmp6);
