...
uint64_t* tmp12 = make_array<uint64_t>( (int32_t)100,  (int32_t)512);
...
Arr2DIdxRowM(tmp12, (int32_t)100, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp12 : 0;
}
}
...
uint64_t* tmp15 = make_array<uint64_t>( (int32_t)100,  (int32_t)512);
...
Arr2DIdxRowM(tmp15, (int32_t)100, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp15 : 0;
}
}
...
uint64_t* tmp18 = make_array<uint64_t>( (int32_t)100,  (int32_t)512);
...
Arr2DIdxRowM(tmp18, (int32_t)100, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp18 : 0;
}
}
...
Arr1DIdxRowM(tmp43, (int32_t)51200,tmp45) = Arr2DIdxRowM(tmp9, (int32_t)100, (int32_t)512,i5,i6);
}
}
...
Arr1DIdxRowM(tmp70, (int32_t)51200,tmp72) = Arr2DIdxRowM(tmp12, (int32_t)100, (int32_t)512,i12,i13);
}
}
...
ClearMemSecret2( (int32_t)100,  (int32_t)512, tmp12);
...
Arr1DIdxRowM(tmp97, (int32_t)51200,tmp99) = Arr2DIdxRowM(tmp15, (int32_t)100, (int32_t)512,i19,i20);
}
}
...
ClearMemSecret2( (int32_t)100,  (int32_t)512, tmp15);
...
Arr1DIdxRowM(tmp125, (int32_t)51200,tmp127) = Arr2DIdxRowM(tmp18, (int32_t)100, (int32_t)512,i26,i27);
}
}
...
ClearMemSecret2( (int32_t)100,  (int32_t)512, tmp18);
