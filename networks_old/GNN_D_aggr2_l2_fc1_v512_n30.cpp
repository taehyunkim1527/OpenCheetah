...
tmp7 = SecretAdd(tmp7, Arr2DIdxRowM(tmp3, (int32_t)30, (int32_t)512,i1,i0));
}
...
tmp18 = SecretAdd(tmp18, Arr2DIdxRowM(tmp0, (int32_t)30, (int32_t)512,i4,i3));
}
...
tmp32 = SecretAdd(tmp32, Arr2DIdxRowM(tmp1, (int32_t)30, (int32_t)512,i7,i6));
}
