...
tmp31 = SecretAdd(tmp31, Arr2DIdxRowM(tmp27, (int32_t)5, (int32_t)256,i6,i5));
}
Arr1DIdxRowM(tmp32, (int32_t)256,i5) = tmp31;
}
...
Arr2DIdxRowM(tmp35, (int32_t)1, (int32_t)256,i8,i9) = Arr1DIdxRowM(tmp32, (int32_t)256,i7);
i7 = (i7 +  (int64_t)1);
}
}
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp37, (int32_t)1, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp35, (int32_t)1, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp25, (int32_t)1, (int32_t)256,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp25);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp35);
ScaleDown2( (int32_t)1,  (int32_t)256, tmp37,  (int32_t)12);
...
tmp44 = (( (int32_t)0 + (i10 *  (int32_t)256)) + (i11 *  (int32_t)1));
Arr1DIdxRowM(tmp41, (int32_t)256,tmp44) = Arr2DIdxRowM(tmp37, (int32_t)1, (int32_t)256,i10,i11);
Arr1DIdxRowM(tmp42, (int32_t)256,tmp44) = Arr2DIdxRowM(tmp6, (int32_t)1, (int32_t)1,i10, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)256, tmp41, tmp42, tmp43);
ClearMemSecret1( (int32_t)256, tmp41);
ClearMemSecret1( (int32_t)256, tmp42);
for (uint32_t i10 =  (int32_t)0; i10 <  (int32_t)1; i10++){
for (uint32_t i11 =  (int32_t)0; i11 <  (int32_t)256; i11++){
tmp44 = (( (int32_t)0 + (i10 *  (int32_t)256)) + (i11 *  (int32_t)1));
Arr2DIdxRowM(tmp40, (int32_t)1, (int32_t)256,i10,i11) = Arr1DIdxRowM(tmp43, (int32_t)256,tmp44);
}
}
...
MatMul2D( (int32_t)1,  (int32_t)256,  (int32_t)256, tmp40, tmp7, tmp47, 0);
