...
uint64_t* tmp9 = make_array<uint64_t>( (int32_t)50,  (int32_t)256);
...
Arr2DIdxRowM(tmp9, (int32_t)50, (int32_t)256,i0,i1) = (party == SERVER) ? __tmp_in_tmp9 : 0;
}
}

uint64_t* tmp10 = make_array<uint64_t>( (int32_t)256,  (int32_t)256);
...
Arr2DIdxRowM(tmp10, (int32_t)256, (int32_t)256,i0,i1) = (party == SERVER) ? __tmp_in_tmp10 : 0;
}
}

uint64_t* tmp11 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
...
Arr2DIdxRowM(tmp11, (int32_t)1, (int32_t)256,i0,i1) = (party == SERVER) ? __tmp_in_tmp11 : 0;
}
}

uint64_t* tmp12 = make_array<uint64_t>( (int32_t)256,  (int32_t)256);
...
Arr2DIdxRowM(tmp12, (int32_t)256, (int32_t)256,i0,i1) = (party == SERVER) ? __tmp_in_tmp12 : 0;
}
}

uint64_t* tmp13 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
...
Arr2DIdxRowM(tmp13, (int32_t)1, (int32_t)256,i0,i1) = (party == SERVER) ? __tmp_in_tmp13 : 0;
}
}

uint64_t* tmp14 = make_array<uint64_t>( (int32_t)50,  (int32_t)256);
...
Arr2DIdxRowM(tmp14, (int32_t)50, (int32_t)256,i0,i1) = (party == SERVER) ? __tmp_in_tmp14 : 0;
}
}
...
uint64_t* tmp19 = make_array<uint64_t>( (int32_t)50,  (int32_t)256);
...
Arr2DIdxRowM(tmp19, (int32_t)50, (int32_t)256,i0,i1) = (party == SERVER) ? __tmp_in_tmp19 : 0;
}
}

uint64_t* tmp20 = make_array<uint64_t>( (int32_t)256,  (int32_t)256);
...
Arr2DIdxRowM(tmp20, (int32_t)256, (int32_t)256,i0,i1) = (party == SERVER) ? __tmp_in_tmp20 : 0;
}
}

uint64_t* tmp21 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
...
Arr2DIdxRowM(tmp21, (int32_t)1, (int32_t)256,i0,i1) = (party == SERVER) ? __tmp_in_tmp21 : 0;
}
}

uint64_t* tmp22 = make_array<uint64_t>( (int32_t)256,  (int32_t)256);
...
Arr2DIdxRowM(tmp22, (int32_t)256, (int32_t)256,i0,i1) = (party == SERVER) ? __tmp_in_tmp22 : 0;
}
}

uint64_t* tmp23 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
...
Arr2DIdxRowM(tmp23, (int32_t)1, (int32_t)256,i0,i1) = (party == SERVER) ? __tmp_in_tmp23 : 0;
}
}

uint64_t* tmp24 = make_array<uint64_t>( (int32_t)50,  (int32_t)256);
...
Arr2DIdxRowM(tmp24, (int32_t)50, (int32_t)256,i0,i1) = (party == SERVER) ? __tmp_in_tmp24 : 0;
}
}
...
uint64_t* tmp29 = make_array<uint64_t>( (int32_t)50,  (int32_t)256);

uint64_t* tmp30 = make_array<uint64_t>( (int32_t)12800);

uint64_t* tmp31 = make_array<uint64_t>( (int32_t)12800);

uint64_t* tmp32 = make_array<uint64_t>( (int32_t)12800);

int32_t tmp33;
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
tmp33 = (( (int32_t)0 + (i0 *  (int32_t)256)) + (i1 *  (int32_t)1));
Arr1DIdxRowM(tmp30, (int32_t)12800,tmp33) = Arr2DIdxRowM(tmp6, (int32_t)50, (int32_t)256,i0,i1);
Arr1DIdxRowM(tmp31, (int32_t)12800,tmp33) = Arr2DIdxRowM(tmp5, (int32_t)1, (int32_t)256, (int32_t)0,i1);
}
}
ElemWiseActModelVectorMult( (int32_t)12800, tmp30, tmp31, tmp32);
ClearMemSecret1( (int32_t)12800, tmp30);
ClearMemSecret1( (int32_t)12800, tmp31);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
tmp33 = (( (int32_t)0 + (i0 *  (int32_t)256)) + (i1 *  (int32_t)1));
Arr2DIdxRowM(tmp29, (int32_t)50, (int32_t)256,i0,i1) = Arr1DIdxRowM(tmp32, (int32_t)12800,tmp33);
}
}
ClearMemSecret1( (int32_t)12800, tmp32);
...
Arr1DIdxRowM(tmp36, (int32_t)2, (int64_t)1) =  (int32_t)256;

uint64_t* tmp37 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
...
Arr2DIdxRowM(tmp37, (int32_t)1, (int32_t)256,i3,i4) = Arr1DIdxRowM(tmp0, (int32_t)256,i2);
i2 = (i2 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)256, tmp0);

uint64_t* tmp39 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
MatMul2D( (int32_t)1,  (int32_t)256,  (int32_t)256, tmp37, tmp7, tmp39, 0);
ClearMemSecret2( (int32_t)256,  (int32_t)256, tmp7);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp37);
ScaleUp2( (int32_t)1,  (int32_t)256, tmp8,  (int32_t)12);

uint64_t* tmp42 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp42, (int32_t)1, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp39, (int32_t)1, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp8, (int32_t)1, (int32_t)256,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp8);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp39);

uint64_t* tmp45 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
Relu2( (int32_t)1,  (int32_t)256, tmp42, tmp45,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp42);
ScaleUp2( (int32_t)50,  (int32_t)256, tmp1,  (int32_t)12);

uint64_t* tmp47 = make_array<uint64_t>( (int32_t)50,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp47, (int32_t)50, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp1, (int32_t)50, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp29, (int32_t)50, (int32_t)256,i0,i1));
}
}
ClearMemSecret2( (int32_t)50,  (int32_t)256, tmp1);
ScaleDown2( (int32_t)50,  (int32_t)256, tmp47,  (int32_t)12);

uint64_t* tmp49 = make_array<uint64_t>( (int32_t)50,  (int32_t)256);

uint64_t* tmp50 = make_array<uint64_t>( (int32_t)12800);

uint64_t* tmp51 = make_array<uint64_t>( (int32_t)12800);

uint64_t* tmp52 = make_array<uint64_t>( (int32_t)12800);

int32_t tmp53;
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)50; i5++){
for (uint32_t i6 =  (int32_t)0; i6 <  (int32_t)256; i6++){
tmp53 = (( (int32_t)0 + (i5 *  (int32_t)256)) + (i6 *  (int32_t)1));
Arr1DIdxRowM(tmp50, (int32_t)12800,tmp53) = Arr2DIdxRowM(tmp47, (int32_t)50, (int32_t)256,i5,i6);
Arr1DIdxRowM(tmp51, (int32_t)12800,tmp53) = Arr2DIdxRowM(tmp9, (int32_t)50, (int32_t)256,i5,i6);
}
}
ElemWiseActModelVectorMult( (int32_t)12800, tmp50, tmp51, tmp52);
ClearMemSecret1( (int32_t)12800, tmp50);
ClearMemSecret1( (int32_t)12800, tmp51);
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)50; i5++){
for (uint32_t i6 =  (int32_t)0; i6 <  (int32_t)256; i6++){
tmp53 = (( (int32_t)0 + (i5 *  (int32_t)256)) + (i6 *  (int32_t)1));
Arr2DIdxRowM(tmp49, (int32_t)50, (int32_t)256,i5,i6) = Arr1DIdxRowM(tmp52, (int32_t)12800,tmp53);
}
}
ClearMemSecret1( (int32_t)12800, tmp52);
ClearMemSecret2( (int32_t)50,  (int32_t)256, tmp47);
ClearMemSecret2( (int32_t)50,  (int32_t)256, tmp9);

int32_t tmp56 =  (int32_t)0;

uint64_t tmp57;

uint64_t* tmp58 = make_array<uint64_t>( (int32_t)256);
for (uint32_t i7 =  (int32_t)0; i7 <  (int32_t)256; i7++){
tmp57 = funcSSCons( (int64_t)0);
for (uint32_t i8 =  (int32_t)0; i8 <  (int32_t)50; i8++){
tmp57 = SecretAdd(tmp57, Arr2DIdxRowM(tmp49, (int32_t)50, (int32_t)256,i8,i7));
}
Arr1DIdxRowM(tmp58, (int32_t)256,i7) = tmp57;
}
ClearMemSecret2( (int32_t)50,  (int32_t)256, tmp49);

int32_t* tmp60 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp60, (int32_t)2, (int64_t)0) =  (int32_t)-1;
Arr1DIdxRowM(tmp60, (int32_t)2, (int64_t)1) =  (int32_t)256;

uint64_t* tmp61 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
...
Arr2DIdxRowM(tmp61, (int32_t)1, (int32_t)256,i10,i11) = Arr1DIdxRowM(tmp58, (int32_t)256,i9);
i9 = (i9 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)256, tmp58);
ScaleUp2( (int32_t)1,  (int32_t)256, tmp45,  (int32_t)12);

uint64_t* tmp63 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp63, (int32_t)1, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp61, (int32_t)1, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp45, (int32_t)1, (int32_t)256,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp45);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp61);

uint64_t* tmp66 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
ScaleDown2( (int32_t)1,  (int32_t)256, tmp63,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)256,  (int32_t)256, tmp63, tmp10, tmp66, 0);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp63);
ClearMemSecret2( (int32_t)256,  (int32_t)256, tmp10);
ScaleUp2( (int32_t)1,  (int32_t)256, tmp11,  (int32_t)12);

uint64_t* tmp69 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp69, (int32_t)1, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp66, (int32_t)1, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp11, (int32_t)1, (int32_t)256,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp66);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp11);

uint64_t* tmp72 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
Relu2( (int32_t)1,  (int32_t)256, tmp69, tmp72,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp69);

uint64_t* tmp74 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
MatMul2D( (int32_t)1,  (int32_t)256,  (int32_t)256, tmp72, tmp12, tmp74, 0);
ClearMemSecret2( (int32_t)256,  (int32_t)256, tmp12);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp72);
ScaleUp2( (int32_t)1,  (int32_t)256, tmp13,  (int32_t)12);

uint64_t* tmp77 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp77, (int32_t)1, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp74, (int32_t)1, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp13, (int32_t)1, (int32_t)256,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp74);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp13);

uint64_t* tmp80 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
Relu2( (int32_t)1,  (int32_t)256, tmp77, tmp80,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp77);
ScaleUp2( (int32_t)50,  (int32_t)256, tmp2,  (int32_t)12);

uint64_t* tmp82 = make_array<uint64_t>( (int32_t)50,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp82, (int32_t)50, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp2, (int32_t)50, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp29, (int32_t)50, (int32_t)256,i0,i1));
}
}
ClearMemSecret2( (int32_t)50,  (int32_t)256, tmp2);
ScaleDown2( (int32_t)50,  (int32_t)256, tmp82,  (int32_t)12);

uint64_t* tmp84 = make_array<uint64_t>( (int32_t)50,  (int32_t)256);

uint64_t* tmp85 = make_array<uint64_t>( (int32_t)12800);

uint64_t* tmp86 = make_array<uint64_t>( (int32_t)12800);

uint64_t* tmp87 = make_array<uint64_t>( (int32_t)12800);

int32_t tmp88;
for (uint32_t i12 =  (int32_t)0; i12 <  (int32_t)50; i12++){
for (uint32_t i13 =  (int32_t)0; i13 <  (int32_t)256; i13++){
tmp88 = (( (int32_t)0 + (i12 *  (int32_t)256)) + (i13 *  (int32_t)1));
Arr1DIdxRowM(tmp85, (int32_t)12800,tmp88) = Arr2DIdxRowM(tmp82, (int32_t)50, (int32_t)256,i12,i13);
Arr1DIdxRowM(tmp86, (int32_t)12800,tmp88) = Arr2DIdxRowM(tmp14, (int32_t)50, (int32_t)256,i12,i13);
}
}
ElemWiseActModelVectorMult( (int32_t)12800, tmp85, tmp86, tmp87);
ClearMemSecret1( (int32_t)12800, tmp85);
ClearMemSecret1( (int32_t)12800, tmp86);
for (uint32_t i12 =  (int32_t)0; i12 <  (int32_t)50; i12++){
for (uint32_t i13 =  (int32_t)0; i13 <  (int32_t)256; i13++){
tmp88 = (( (int32_t)0 + (i12 *  (int32_t)256)) + (i13 *  (int32_t)1));
Arr2DIdxRowM(tmp84, (int32_t)50, (int32_t)256,i12,i13) = Arr1DIdxRowM(tmp87, (int32_t)12800,tmp88);
}
}
ClearMemSecret1( (int32_t)12800, tmp87);
ClearMemSecret2( (int32_t)50,  (int32_t)256, tmp14);
ClearMemSecret2( (int32_t)50,  (int32_t)256, tmp82);

int32_t tmp91 =  (int32_t)0;

uint64_t tmp92;

uint64_t* tmp93 = make_array<uint64_t>( (int32_t)256);
for (uint32_t i14 =  (int32_t)0; i14 <  (int32_t)256; i14++){
tmp92 = funcSSCons( (int64_t)0);
for (uint32_t i15 =  (int32_t)0; i15 <  (int32_t)50; i15++){
tmp92 = SecretAdd(tmp92, Arr2DIdxRowM(tmp84, (int32_t)50, (int32_t)256,i15,i14));
}
Arr1DIdxRowM(tmp93, (int32_t)256,i14) = tmp92;
}
ClearMemSecret2( (int32_t)50,  (int32_t)256, tmp84);

int32_t* tmp95 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp95, (int32_t)2, (int64_t)0) =  (int32_t)-1;
Arr1DIdxRowM(tmp95, (int32_t)2, (int64_t)1) =  (int32_t)256;

uint64_t* tmp96 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
...
Arr2DIdxRowM(tmp96, (int32_t)1, (int32_t)256,i17,i18) = Arr1DIdxRowM(tmp93, (int32_t)256,i16);
i16 = (i16 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)256, tmp93);
ScaleUp2( (int32_t)1,  (int32_t)256, tmp80,  (int32_t)12);

uint64_t* tmp98 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp98, (int32_t)1, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp96, (int32_t)1, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp80, (int32_t)1, (int32_t)256,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp80);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp96);

uint64_t* tmp101 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
ScaleDown2( (int32_t)1,  (int32_t)256, tmp98,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)256,  (int32_t)256, tmp98, tmp15, tmp101, 0);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp98);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp104, (int32_t)1, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp101, (int32_t)1, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp16, (int32_t)1, (int32_t)256,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp101);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp16);

uint64_t* tmp107 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
Relu2( (int32_t)1,  (int32_t)256, tmp104, tmp107,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp104);

uint64_t* tmp109 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
MatMul2D( (int32_t)1,  (int32_t)256,  (int32_t)256, tmp107, tmp17, tmp109, 0);
ClearMemSecret2( (int32_t)256,  (int32_t)256, tmp17);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp107);
...
uint64_t* tmp117 = make_array<uint64_t>( (int32_t)50,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp117, (int32_t)50, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp3, (int32_t)50, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp29, (int32_t)50, (int32_t)256,i0,i1));
}
}
ClearMemSecret2( (int32_t)50,  (int32_t)256, tmp3);
ScaleDown2( (int32_t)50,  (int32_t)256, tmp117,  (int32_t)12);

uint64_t* tmp119 = make_array<uint64_t>( (int32_t)50,  (int32_t)256);

uint64_t* tmp120 = make_array<uint64_t>( (int32_t)12800);

uint64_t* tmp121 = make_array<uint64_t>( (int32_t)12800);

uint64_t* tmp122 = make_array<uint64_t>( (int32_t)12800);

int32_t tmp123;
for (uint32_t i19 =  (int32_t)0; i19 <  (int32_t)50; i19++){
for (uint32_t i20 =  (int32_t)0; i20 <  (int32_t)256; i20++){
tmp123 = (( (int32_t)0 + (i19 *  (int32_t)256)) + (i20 *  (int32_t)1));
Arr1DIdxRowM(tmp120, (int32_t)12800,tmp123) = Arr2DIdxRowM(tmp117, (int32_t)50, (int32_t)256,i19,i20);
Arr1DIdxRowM(tmp121, (int32_t)12800,tmp123) = Arr2DIdxRowM(tmp19, (int32_t)50, (int32_t)256,i19,i20);
}
}
ElemWiseActModelVectorMult( (int32_t)12800, tmp120, tmp121, tmp122);
ClearMemSecret1( (int32_t)12800, tmp120);
ClearMemSecret1( (int32_t)12800, tmp121);
for (uint32_t i19 =  (int32_t)0; i19 <  (int32_t)50; i19++){
for (uint32_t i20 =  (int32_t)0; i20 <  (int32_t)256; i20++){
tmp123 = (( (int32_t)0 + (i19 *  (int32_t)256)) + (i20 *  (int32_t)1));
Arr2DIdxRowM(tmp119, (int32_t)50, (int32_t)256,i19,i20) = Arr1DIdxRowM(tmp122, (int32_t)12800,tmp123);
}
}
ClearMemSecret1( (int32_t)12800, tmp122);
ClearMemSecret2( (int32_t)50,  (int32_t)256, tmp117);
ClearMemSecret2( (int32_t)50,  (int32_t)256, tmp19);
...
for (uint32_t i21 =  (int32_t)0; i21 <  (int32_t)256; i21++){
tmp127 = funcSSCons( (int64_t)0);
for (uint32_t i22 =  (int32_t)0; i22 <  (int32_t)50; i22++){
tmp127 = SecretAdd(tmp127, Arr2DIdxRowM(tmp119, (int32_t)50, (int32_t)256,i22,i21));
}
Arr1DIdxRowM(tmp128, (int32_t)256,i21) = tmp127;
}
ClearMemSecret2( (int32_t)50,  (int32_t)256, tmp119);

int32_t* tmp130 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp130, (int32_t)2, (int64_t)0) =  (int32_t)-1;
Arr1DIdxRowM(tmp130, (int32_t)2, (int64_t)1) =  (int32_t)256;

uint64_t* tmp131 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
...
for (uint32_t i25 =  (int32_t)0; i25 <  (int32_t)256; i25++){
Arr2DIdxRowM(tmp131, (int32_t)1, (int32_t)256,i24,i25) = Arr1DIdxRowM(tmp128, (int32_t)256,i23);
i23 = (i23 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)256, tmp128);
ScaleUp2( (int32_t)1,  (int32_t)256, tmp115,  (int32_t)12);

uint64_t* tmp133 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp133, (int32_t)1, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp131, (int32_t)1, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp115, (int32_t)1, (int32_t)256,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp115);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp131);

uint64_t* tmp136 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
ScaleDown2( (int32_t)1,  (int32_t)256, tmp133,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)256,  (int32_t)256, tmp133, tmp20, tmp136, 0);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp133);
ClearMemSecret2( (int32_t)256,  (int32_t)256, tmp20);
ScaleUp2( (int32_t)1,  (int32_t)256, tmp21,  (int32_t)12);

uint64_t* tmp139 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp139, (int32_t)1, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp136, (int32_t)1, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp21, (int32_t)1, (int32_t)256,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp136);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp21);

uint64_t* tmp142 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
Relu2( (int32_t)1,  (int32_t)256, tmp139, tmp142,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp139);

uint64_t* tmp144 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
MatMul2D( (int32_t)1,  (int32_t)256,  (int32_t)256, tmp142, tmp22, tmp144, 0);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp142);
ClearMemSecret2( (int32_t)256,  (int32_t)256, tmp22);
ScaleUp2( (int32_t)1,  (int32_t)256, tmp23,  (int32_t)12);

uint64_t* tmp147 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp147, (int32_t)1, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp144, (int32_t)1, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp23, (int32_t)1, (int32_t)256,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp144);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp23);

uint64_t* tmp150 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
Relu2( (int32_t)1,  (int32_t)256, tmp147, tmp150,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp147);
ScaleUp2( (int32_t)50,  (int32_t)256, tmp4,  (int32_t)12);

uint64_t* tmp152 = make_array<uint64_t>( (int32_t)50,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp152, (int32_t)50, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp4, (int32_t)50, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp29, (int32_t)50, (int32_t)256,i0,i1));
}
}
ClearMemSecret2( (int32_t)50,  (int32_t)256, tmp29);
ClearMemSecret2( (int32_t)50,  (int32_t)256, tmp4);
ScaleDown2( (int32_t)50,  (int32_t)256, tmp152,  (int32_t)12);

uint64_t* tmp155 = make_array<uint64_t>( (int32_t)50,  (int32_t)256);

uint64_t* tmp156 = make_array<uint64_t>( (int32_t)12800);

uint64_t* tmp157 = make_array<uint64_t>( (int32_t)12800);

uint64_t* tmp158 = make_array<uint64_t>( (int32_t)12800);

int32_t tmp159;
for (uint32_t i26 =  (int32_t)0; i26 <  (int32_t)50; i26++){
for (uint32_t i27 =  (int32_t)0; i27 <  (int32_t)256; i27++){
tmp159 = (( (int32_t)0 + (i26 *  (int32_t)256)) + (i27 *  (int32_t)1));
Arr1DIdxRowM(tmp156, (int32_t)12800,tmp159) = Arr2DIdxRowM(tmp152, (int32_t)50, (int32_t)256,i26,i27);
Arr1DIdxRowM(tmp157, (int32_t)12800,tmp159) = Arr2DIdxRowM(tmp24, (int32_t)50, (int32_t)256,i26,i27);
}
}
ElemWiseActModelVectorMult( (int32_t)12800, tmp156, tmp157, tmp158);
ClearMemSecret1( (int32_t)12800, tmp156);
ClearMemSecret1( (int32_t)12800, tmp157);
for (uint32_t i26 =  (int32_t)0; i26 <  (int32_t)50; i26++){
for (uint32_t i27 =  (int32_t)0; i27 <  (int32_t)256; i27++){
tmp159 = (( (int32_t)0 + (i26 *  (int32_t)256)) + (i27 *  (int32_t)1));
Arr2DIdxRowM(tmp155, (int32_t)50, (int32_t)256,i26,i27) = Arr1DIdxRowM(tmp158, (int32_t)12800,tmp159);
}
}
ClearMemSecret1( (int32_t)12800, tmp158);
ClearMemSecret2( (int32_t)50,  (int32_t)256, tmp152);
ClearMemSecret2( (int32_t)50,  (int32_t)256, tmp24);
...
tmp163 = SecretAdd(tmp163, Arr2DIdxRowM(tmp155, (int32_t)50, (int32_t)256,i29,i28));
}
Arr1DIdxRowM(tmp164, (int32_t)256,i28) = tmp163;
}
ClearMemSecret2( (int32_t)50,  (int32_t)256, tmp155);

int32_t* tmp166 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp166, (int32_t)2, (int64_t)0) =  (int32_t)-1;
Arr1DIdxRowM(tmp166, (int32_t)2, (int64_t)1) =  (int32_t)256;

uint64_t* tmp167 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
...
for (uint32_t i32 =  (int32_t)0; i32 <  (int32_t)256; i32++){
Arr2DIdxRowM(tmp167, (int32_t)1, (int32_t)256,i31,i32) = Arr1DIdxRowM(tmp164, (int32_t)256,i30);
i30 = (i30 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)256, tmp164);
ScaleUp2( (int32_t)1,  (int32_t)256, tmp150,  (int32_t)12);

uint64_t* tmp169 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp169, (int32_t)1, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp167, (int32_t)1, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp150, (int32_t)1, (int32_t)256,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp167);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp150);

uint64_t* tmp172 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
ScaleDown2( (int32_t)1,  (int32_t)256, tmp169,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)256,  (int32_t)256, tmp169, tmp25, tmp172, 0);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp169);
ClearMemSecret2( (int32_t)256,  (int32_t)256, tmp25);
ScaleUp2( (int32_t)1,  (int32_t)256, tmp26,  (int32_t)12);

uint64_t* tmp175 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp175, (int32_t)1, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp172, (int32_t)1, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp26, (int32_t)1, (int32_t)256,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp172);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp26);

uint64_t* tmp178 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
Relu2( (int32_t)1,  (int32_t)256, tmp175, tmp178,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp175);

uint64_t* tmp180 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
MatMul2D( (int32_t)1,  (int32_t)256,  (int32_t)256, tmp178, tmp27, tmp180, 0);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp178);
ClearMemSecret2( (int32_t)256,  (int32_t)256, tmp27);
ScaleUp2( (int32_t)1,  (int32_t)256, tmp28,  (int32_t)12);

uint64_t* tmp183 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp183, (int32_t)1, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp180, (int32_t)1, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp28, (int32_t)1, (int32_t)256,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp180);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp28);

uint64_t* tmp186 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
Relu2( (int32_t)1,  (int32_t)256, tmp183, tmp186,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp183);
EndComputation();
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (uint32_t)0; i1 <  (int32_t)256; i1++){
cout << (funcReconstruct2PCCons(Arr2DIdxRowM(tmp186, (int32_t)1, (int32_t)256,i0,i1), 2)) << endl;
}
}
}
