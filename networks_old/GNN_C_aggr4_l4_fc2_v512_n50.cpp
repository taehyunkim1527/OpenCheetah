...
uint64_t* tmp0 = make_array<uint64_t>( (int32_t)50,  (int32_t)512);
/* Variable to read the clear value corresponding to the input variable tmp0 at (9027,1-9027,39) */
...
Arr2DIdxRowM(tmp0, (int32_t)50, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp0 : 0;
}
}
...
uint64_t* tmp12 = make_array<uint64_t>( (int32_t)25600);

uint64_t* tmp13 = make_array<uint64_t>( (int32_t)25600);
...
tmp15 = (( (int32_t)0 + (i0 *  (int32_t)512)) + (i1 *  (int32_t)1));
Arr1DIdxRowM(tmp12, (int32_t)25600,tmp15) = Arr2DIdxRowM(tmp5, (int32_t)50, (int32_t)512,i0,i1);
Arr1DIdxRowM(tmp13, (int32_t)25600,tmp15) = Arr2DIdxRowM(tmp4, (int32_t)1, (int32_t)512, (int32_t)0,i1);
}
}
ElemWiseActModelVectorMult( (int32_t)25600, tmp12, tmp13, tmp14);
ClearMemSecret1( (int32_t)25600, tmp12);
ClearMemSecret1( (int32_t)25600, tmp13);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
tmp15 = (( (int32_t)0 + (i0 *  (int32_t)512)) + (i1 *  (int32_t)1));
Arr2DIdxRowM(tmp11, (int32_t)50, (int32_t)512,i0,i1) = Arr1DIdxRowM(tmp14, (int32_t)25600,tmp15);
}
}
ClearMemSecret1( (int32_t)25600, tmp14);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp4);
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp5);
ScaleUp2( (int32_t)50,  (int32_t)512, tmp0,  (int32_t)12);

uint64_t* tmp18 = make_array<uint64_t>( (int32_t)50,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp18, (int32_t)50, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp0, (int32_t)50, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp11, (int32_t)50, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp0);
ScaleDown2( (int32_t)50,  (int32_t)512, tmp18,  (int32_t)12);
...
int32_t tmp24;
for (uint32_t i2 =  (int32_t)0; i2 <  (int32_t)50; i2++){
for (uint32_t i3 =  (int32_t)0; i3 <  (int32_t)512; i3++){
tmp24 = (( (int32_t)0 + (i2 *  (int32_t)512)) + (i3 *  (int32_t)1));
Arr1DIdxRowM(tmp21, (int32_t)25600,tmp24) = Arr2DIdxRowM(tmp18, (int32_t)50, (int32_t)512,i2,i3);
Arr1DIdxRowM(tmp22, (int32_t)25600,tmp24) = Arr2DIdxRowM(tmp7, (int32_t)50, (int32_t)1,i2, (int32_t)0);
}
}
...
for (uint32_t i3 =  (int32_t)0; i3 <  (int32_t)512; i3++){
tmp24 = (( (int32_t)0 + (i2 *  (int32_t)512)) + (i3 *  (int32_t)1));
Arr2DIdxRowM(tmp20, (int32_t)50, (int32_t)512,i2,i3) = Arr1DIdxRowM(tmp23, (int32_t)25600,tmp24);
}
}
...
int32_t tmp27 =  (int32_t)0;

uint64_t tmp28;

uint64_t* tmp29 = make_array<uint64_t>( (int32_t)512);
for (uint32_t i4 =  (int32_t)0; i4 <  (int32_t)512; i4++){
tmp28 = funcSSCons( (int64_t)0);
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)50; i5++){
tmp28 = SecretAdd(tmp28, Arr2DIdxRowM(tmp20, (int32_t)50, (int32_t)512,i5,i4));
}
Arr1DIdxRowM(tmp29, (int32_t)512,i4) = tmp28;
}
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp20);
ScaleUp1( (int32_t)512, tmp6,  (int32_t)12);

uint64_t* tmp31 = make_array<uint64_t>( (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)512; i0++){
Arr1DIdxRowM(tmp31, (int32_t)512,i0) = SecretAdd(Arr1DIdxRowM(tmp29, (int32_t)512,i0), Arr1DIdxRowM(tmp6, (int32_t)512,i0));
}
ClearMemSecret1( (int32_t)512, tmp29);
ScaleUp2( (int32_t)50,  (int32_t)512, tmp1,  (int32_t)12);

uint64_t* tmp33 = make_array<uint64_t>( (int32_t)50,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp33, (int32_t)50, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp1, (int32_t)50, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp11, (int32_t)50, (int32_t)512,i0,i1));
}
}
...
uint64_t* tmp37 = make_array<uint64_t>( (int32_t)25600);
...
tmp39 = (( (int32_t)0 + (i6 *  (int32_t)512)) + (i7 *  (int32_t)1));
Arr1DIdxRowM(tmp36, (int32_t)25600,tmp39) = Arr2DIdxRowM(tmp33, (int32_t)50, (int32_t)512,i6,i7);
Arr1DIdxRowM(tmp37, (int32_t)25600,tmp39) = Arr2DIdxRowM(tmp8, (int32_t)50, (int32_t)1,i6, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)25600, tmp36, tmp37, tmp38);
ClearMemSecret1( (int32_t)25600, tmp36);
ClearMemSecret1( (int32_t)25600, tmp37);
for (uint32_t i6 =  (int32_t)0; i6 <  (int32_t)50; i6++){
for (uint32_t i7 =  (int32_t)0; i7 <  (int32_t)512; i7++){
tmp39 = (( (int32_t)0 + (i6 *  (int32_t)512)) + (i7 *  (int32_t)1));
Arr2DIdxRowM(tmp35, (int32_t)50, (int32_t)512,i6,i7) = Arr1DIdxRowM(tmp38, (int32_t)25600,tmp39);
}
}
...
int32_t tmp42 =  (int32_t)0;

uint64_t tmp43;

uint64_t* tmp44 = make_array<uint64_t>( (int32_t)512);
for (uint32_t i8 =  (int32_t)0; i8 <  (int32_t)512; i8++){
tmp43 = funcSSCons( (int64_t)0);
for (uint32_t i9 =  (int32_t)0; i9 <  (int32_t)50; i9++){
tmp43 = SecretAdd(tmp43, Arr2DIdxRowM(tmp35, (int32_t)50, (int32_t)512,i9,i8));
}
Arr1DIdxRowM(tmp44, (int32_t)512,i8) = tmp43;
}
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp35);

uint64_t* tmp46 = make_array<uint64_t>( (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)512; i0++){
Arr1DIdxRowM(tmp46, (int32_t)512,i0) = SecretAdd(Arr1DIdxRowM(tmp44, (int32_t)512,i0), Arr1DIdxRowM(tmp6, (int32_t)512,i0));
}
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp48, (int32_t)50, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp2, (int32_t)50, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp11, (int32_t)50, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp2);
ScaleDown2( (int32_t)50,  (int32_t)512, tmp48,  (int32_t)12);

uint64_t* tmp50 = make_array<uint64_t>( (int32_t)50,  (int32_t)512);
...
int32_t tmp54;
for (uint32_t i10 =  (int32_t)0; i10 <  (int32_t)50; i10++){
for (uint32_t i11 =  (int32_t)0; i11 <  (int32_t)512; i11++){
tmp54 = (( (int32_t)0 + (i10 *  (int32_t)512)) + (i11 *  (int32_t)1));
Arr1DIdxRowM(tmp51, (int32_t)25600,tmp54) = Arr2DIdxRowM(tmp48, (int32_t)50, (int32_t)512,i10,i11);
Arr1DIdxRowM(tmp52, (int32_t)25600,tmp54) = Arr2DIdxRowM(tmp9, (int32_t)50, (int32_t)1,i10, (int32_t)0);
}
}
...
for (uint32_t i11 =  (int32_t)0; i11 <  (int32_t)512; i11++){
tmp54 = (( (int32_t)0 + (i10 *  (int32_t)512)) + (i11 *  (int32_t)1));
Arr2DIdxRowM(tmp50, (int32_t)50, (int32_t)512,i10,i11) = Arr1DIdxRowM(tmp53, (int32_t)25600,tmp54);
}
}
...
tmp58 = SecretAdd(tmp58, Arr2DIdxRowM(tmp50, (int32_t)50, (int32_t)512,i13,i12));
}
Arr1DIdxRowM(tmp59, (int32_t)512,i12) = tmp58;
}
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp50);

uint64_t* tmp61 = make_array<uint64_t>( (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)512; i0++){
Arr1DIdxRowM(tmp61, (int32_t)512,i0) = SecretAdd(Arr1DIdxRowM(tmp59, (int32_t)512,i0), Arr1DIdxRowM(tmp6, (int32_t)512,i0));
}
ClearMemSecret1( (int32_t)512, tmp59);
ScaleUp2( (int32_t)50,  (int32_t)512, tmp3,  (int32_t)12);

uint64_t* tmp63 = make_array<uint64_t>( (int32_t)50,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp63, (int32_t)50, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp3, (int32_t)50, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp11, (int32_t)50, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp11);
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp3);
ScaleDown2( (int32_t)50,  (int32_t)512, tmp63,  (int32_t)12);

uint64_t* tmp66 = make_array<uint64_t>( (int32_t)50,  (int32_t)512);

uint64_t* tmp67 = make_array<uint64_t>( (int32_t)25600);

uint64_t* tmp68 = make_array<uint64_t>( (int32_t)25600);

uint64_t* tmp69 = make_array<uint64_t>( (int32_t)25600);

int32_t tmp70;
for (uint32_t i14 =  (int32_t)0; i14 <  (int32_t)50; i14++){
for (uint32_t i15 =  (int32_t)0; i15 <  (int32_t)512; i15++){
tmp70 = (( (int32_t)0 + (i14 *  (int32_t)512)) + (i15 *  (int32_t)1));
Arr1DIdxRowM(tmp67, (int32_t)25600,tmp70) = Arr2DIdxRowM(tmp63, (int32_t)50, (int32_t)512,i14,i15);
Arr1DIdxRowM(tmp68, (int32_t)25600,tmp70) = Arr2DIdxRowM(tmp10, (int32_t)50, (int32_t)1,i14, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)25600, tmp67, tmp68, tmp69);
ClearMemSecret1( (int32_t)25600, tmp67);
ClearMemSecret1( (int32_t)25600, tmp68);
for (uint32_t i14 =  (int32_t)0; i14 <  (int32_t)50; i14++){
for (uint32_t i15 =  (int32_t)0; i15 <  (int32_t)512; i15++){
tmp70 = (( (int32_t)0 + (i14 *  (int32_t)512)) + (i15 *  (int32_t)1));
Arr2DIdxRowM(tmp66, (int32_t)50, (int32_t)512,i14,i15) = Arr1DIdxRowM(tmp69, (int32_t)25600,tmp70);
}
}
ClearMemSecret1( (int32_t)25600, tmp69);
ClearMemSecret2( (int32_t)50,  (int32_t)1, tmp10);
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp63);
...
for (uint32_t i17 =  (int32_t)0; i17 <  (int32_t)50; i17++){
tmp74 = SecretAdd(tmp74, Arr2DIdxRowM(tmp66, (int32_t)50, (int32_t)512,i17,i16));
}
Arr1DIdxRowM(tmp75, (int32_t)512,i16) = tmp74;
}
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp66);

uint64_t* tmp77 = make_array<uint64_t>( (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)512; i0++){
Arr1DIdxRowM(tmp77, (int32_t)512,i0) = SecretAdd(Arr1DIdxRowM(tmp75, (int32_t)512,i0), Arr1DIdxRowM(tmp6, (int32_t)512,i0));
}
ClearMemSecret1( (int32_t)512, tmp6);
ClearMemSecret1( (int32_t)512, tmp75);
ScaleDown1( (int32_t)512, tmp77,  (int32_t)12);
EndComputation();
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)512; i0++){
cout << (funcReconstruct2PCCons(Arr1DIdxRowM(tmp77, (int32_t)512,i0), 2)) << endl;
}
}
