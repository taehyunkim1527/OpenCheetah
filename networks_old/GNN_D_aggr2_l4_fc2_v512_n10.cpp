...
tmp9 = SecretAdd(tmp9, Arr2DIdxRowM(tmp5, (int32_t)10, (int32_t)512,i1,i0));
}
...
tmp20 = SecretAdd(tmp20, Arr2DIdxRowM(tmp0, (int32_t)10, (int32_t)512,i4,i3));
}
...
tmp34 = SecretAdd(tmp34, Arr2DIdxRowM(tmp1, (int32_t)10, (int32_t)512,i7,i6));
}
...
tmp48 = SecretAdd(tmp48, Arr2DIdxRowM(tmp2, (int32_t)10, (int32_t)512,i10,i9));
}
...
tmp62 = SecretAdd(tmp62, Arr2DIdxRowM(tmp3, (int32_t)10, (int32_t)512,i13,i12));
}
