...
tmp36 = SecretAdd(tmp36, Arr2DIdxRowM(tmp33, (int32_t)30, (int32_t)512,i6,i5));
}
...
uint64_t* tmp61 = make_array<uint64_t>( (int32_t)30,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)30; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp61, (int32_t)30, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp2, (int32_t)30, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp15, (int32_t)30, (int32_t)512,i0,i1));
}
}
...
tmp65 = SecretAdd(tmp65, Arr2DIdxRowM(tmp61, (int32_t)30, (int32_t)512,i11,i10));
}
Arr1DIdxRowM(tmp66, (int32_t)512,i10) = tmp65;
}
ClearMemSecret2( (int32_t)30,  (int32_t)512, tmp61);
