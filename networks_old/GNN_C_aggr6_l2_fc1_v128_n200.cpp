...
uint64_t* tmp0 = make_array<uint64_t>( (int32_t)200,  (int32_t)128);
...
Arr2DIdxRowM(tmp0, (int32_t)200, (int32_t)128,i0,i1) = (party == SERVER) ? __tmp_in_tmp0 : 0;
}
}
...
uint64_t* tmp4 = make_array<uint64_t>( (int32_t)128);
...
Arr1DIdxRowM(tmp4, (int32_t)128,i0) = (party == SERVER) ? __tmp_in_tmp4 : 0;
}

uint64_t* tmp5 = make_array<uint64_t>( (int32_t)200,  (int32_t)1);
...
Arr2DIdxRowM(tmp5, (int32_t)200, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp5 : 0;
}
}
...
uint64_t* tmp9 = make_array<uint64_t>( (int32_t)200,  (int32_t)128);
...
tmp13 = (( (int32_t)0 + (i0 *  (int32_t)128)) + (i1 *  (int32_t)1));
Arr1DIdxRowM(tmp10, (int32_t)25600,tmp13) = Arr2DIdxRowM(tmp3, (int32_t)200, (int32_t)128,i0,i1);
Arr1DIdxRowM(tmp11, (int32_t)25600,tmp13) = Arr2DIdxRowM(tmp2, (int32_t)1, (int32_t)128, (int32_t)0,i1);
}
}
...
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
tmp13 = (( (int32_t)0 + (i0 *  (int32_t)128)) + (i1 *  (int32_t)1));
Arr2DIdxRowM(tmp9, (int32_t)200, (int32_t)128,i0,i1) = Arr1DIdxRowM(tmp12, (int32_t)25600,tmp13);
}
}
...
ScaleUp2( (int32_t)200,  (int32_t)128, tmp0,  (int32_t)12);

uint64_t* tmp16 = make_array<uint64_t>( (int32_t)200,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)200; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp16, (int32_t)200, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp0, (int32_t)200, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp9, (int32_t)200, (int32_t)128,i0,i1));
}
}
ClearMemSecret2( (int32_t)200,  (int32_t)128, tmp0);

uint64_t* tmp18 = make_array<uint64_t>( (int32_t)200,  (int32_t)1);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)200; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)1; i1++){
Arr2DIdxRowM(tmp18, (int32_t)200, (int32_t)1,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp5, (int32_t)200, (int32_t)1,i0,i1), Arr2DIdxRowM(tmp6, (int32_t)200, (int32_t)1,i0,i1));
}
}
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp5);
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp6);

uint64_t* tmp21 = make_array<uint64_t>( (int32_t)200,  (int32_t)1);
Relu2( (int32_t)200,  (int32_t)1, tmp18, tmp21,  (int32_t)0, 0);
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp18);

int32_t* tmp23 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp23, (int32_t)2, (int64_t)0) =  (int32_t)0;
Arr1DIdxRowM(tmp23, (int32_t)2, (int64_t)1) =  (int32_t)1;

uint64_t tmp24;

uint64_t* tmp25 = make_array<uint64_t>( (int32_t)1);
tmp24 = funcSSCons( (int64_t)0);
for (uint32_t i2 =  (int32_t)0; i2 <  (int32_t)200; i2++){
for (uint32_t i3 =  (int32_t)0; i3 <  (int32_t)1; i3++){
tmp24 = SecretAdd(tmp24, Arr2DIdxRowM(tmp21, (int32_t)200, (int32_t)1,i2,i3));
}
}
Arr1DIdxRowM(tmp25, (int32_t)1, (int32_t)0) = tmp24;
ScaleDown2( (int32_t)200,  (int32_t)128, tmp16,  (int32_t)12);

uint64_t* tmp26 = make_array<uint64_t>( (int32_t)200,  (int32_t)128);
...
tmp30 = (( (int32_t)0 + (i4 *  (int32_t)128)) + (i5 *  (int32_t)1));
Arr1DIdxRowM(tmp27, (int32_t)25600,tmp30) = Arr2DIdxRowM(tmp16, (int32_t)200, (int32_t)128,i4,i5);
Arr1DIdxRowM(tmp28, (int32_t)25600,tmp30) = Arr2DIdxRowM(tmp21, (int32_t)200, (int32_t)1,i4, (int32_t)0);
}
}
...
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)128; i5++){
tmp30 = (( (int32_t)0 + (i4 *  (int32_t)128)) + (i5 *  (int32_t)1));
Arr2DIdxRowM(tmp26, (int32_t)200, (int32_t)128,i4,i5) = Arr1DIdxRowM(tmp29, (int32_t)25600,tmp30);
}
}
ClearMemSecret1( (int32_t)25600, tmp29);
ClearMemSecret2( (int32_t)200,  (int32_t)128, tmp16);
...
tmp34 = SecretAdd(tmp34, Arr2DIdxRowM(tmp26, (int32_t)200, (int32_t)128,i7,i6));
}
Arr1DIdxRowM(tmp35, (int32_t)128,i6) = tmp34;
}
ClearMemSecret2( (int32_t)200,  (int32_t)128, tmp26);
...
Arr1DIdxRowM(tmp37, (int32_t)128,i0) = SecretAdd(Arr1DIdxRowM(tmp35, (int32_t)128,i0), Arr1DIdxRowM(tmp4, (int32_t)128,i0));
}
ClearMemSecret1( (int32_t)128, tmp35);
ScaleUp2( (int32_t)200,  (int32_t)128, tmp1,  (int32_t)12);

uint64_t* tmp39 = make_array<uint64_t>( (int32_t)200,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)200; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp39, (int32_t)200, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp1, (int32_t)200, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp9, (int32_t)200, (int32_t)128,i0,i1));
}
}
ClearMemSecret2( (int32_t)200,  (int32_t)128, tmp1);
ClearMemSecret2( (int32_t)200,  (int32_t)128, tmp9);

uint64_t* tmp42 = make_array<uint64_t>( (int32_t)200,  (int32_t)1);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)200; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)1; i1++){
Arr2DIdxRowM(tmp42, (int32_t)200, (int32_t)1,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp7, (int32_t)200, (int32_t)1,i0,i1), Arr2DIdxRowM(tmp8, (int32_t)200, (int32_t)1,i0,i1));
}
}
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp7);
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp8);

uint64_t* tmp45 = make_array<uint64_t>( (int32_t)200,  (int32_t)1);
Relu2( (int32_t)200,  (int32_t)1, tmp42, tmp45,  (int32_t)0, 0);
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp42);

int32_t* tmp47 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp47, (int32_t)2, (int64_t)0) =  (int32_t)0;
Arr1DIdxRowM(tmp47, (int32_t)2, (int64_t)1) =  (int32_t)1;

uint64_t tmp48;

uint64_t* tmp49 = make_array<uint64_t>( (int32_t)1);
tmp48 = funcSSCons( (int64_t)0);
for (uint32_t i8 =  (int32_t)0; i8 <  (int32_t)200; i8++){
for (uint32_t i9 =  (int32_t)0; i9 <  (int32_t)1; i9++){
tmp48 = SecretAdd(tmp48, Arr2DIdxRowM(tmp45, (int32_t)200, (int32_t)1,i8,i9));
}
}
Arr1DIdxRowM(tmp49, (int32_t)1, (int32_t)0) = tmp48;
ScaleDown2( (int32_t)200,  (int32_t)128, tmp39,  (int32_t)12);
...
Arr1DIdxRowM(tmp51, (int32_t)25600,tmp54) = Arr2DIdxRowM(tmp39, (int32_t)200, (int32_t)128,i10,i11);
Arr1DIdxRowM(tmp52, (int32_t)25600,tmp54) = Arr2DIdxRowM(tmp45, (int32_t)200, (int32_t)1,i10, (int32_t)0);
}
}
...
for (uint32_t i11 =  (int32_t)0; i11 <  (int32_t)128; i11++){
tmp54 = (( (int32_t)0 + (i10 *  (int32_t)128)) + (i11 *  (int32_t)1));
Arr2DIdxRowM(tmp50, (int32_t)200, (int32_t)128,i10,i11) = Arr1DIdxRowM(tmp53, (int32_t)25600,tmp54);
}
}
ClearMemSecret1( (int32_t)25600, tmp53);
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp45);
ClearMemSecret2( (int32_t)200,  (int32_t)128, tmp39);
...
tmp58 = SecretAdd(tmp58, Arr2DIdxRowM(tmp50, (int32_t)200, (int32_t)128,i13,i12));
}
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)128; i0++){
Arr1DIdxRowM(tmp61, (int32_t)128,i0) = SecretAdd(Arr1DIdxRowM(tmp59, (int32_t)128,i0), Arr1DIdxRowM(tmp4, (int32_t)128,i0));
}
ClearMemSecret1( (int32_t)128, tmp59);
ClearMemSecret1( (int32_t)128, tmp4);
ScaleDown1( (int32_t)128, tmp61,  (int32_t)12);
EndComputation();
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)128; i0++){
cout << (funcReconstruct2PCCons(Arr1DIdxRowM(tmp61, (int32_t)128,i0), 2)) << endl;
}
}
