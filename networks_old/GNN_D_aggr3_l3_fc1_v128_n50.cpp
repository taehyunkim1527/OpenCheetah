...
uint64_t* tmp7 = make_array<uint64_t>( (int32_t)6400);
...
tmp10 = (( (int32_t)0 + (i0 *  (int32_t)128)) + (i1 *  (int32_t)1));
Arr1DIdxRowM(tmp7, (int32_t)6400,tmp10) = Arr2DIdxRowM(tmp4, (int32_t)50, (int32_t)128,i0,i1);
Arr1DIdxRowM(tmp8, (int32_t)6400,tmp10) = Arr2DIdxRowM(tmp3, (int32_t)1, (int32_t)128, (int32_t)0,i1);
}
}
ElemWiseActModelVectorMult( (int32_t)6400, tmp7, tmp8, tmp9);
ClearMemSecret1( (int32_t)6400, tmp7);
ClearMemSecret1( (int32_t)6400, tmp8);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
tmp10 = (( (int32_t)0 + (i0 *  (int32_t)128)) + (i1 *  (int32_t)1));
Arr2DIdxRowM(tmp6, (int32_t)50, (int32_t)128,i0,i1) = Arr1DIdxRowM(tmp9, (int32_t)6400,tmp10);
}
}
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp13, (int32_t)50, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp0, (int32_t)50, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp6, (int32_t)50, (int32_t)128,i0,i1));
}
}
ClearMemSecret2( (int32_t)50,  (int32_t)128, tmp0);

int32_t* tmp15 = make_array<int32_t>( (int32_t)4);
Arr1DIdxRowM(tmp15, (int32_t)4, (int64_t)0) =  (int32_t)128;
...
uint64_t* tmp16 = make_array<uint64_t>( (int32_t)128,  (int32_t)1,  (int32_t)50,  (int32_t)1);
...
Arr4DIdxRowM(tmp16, (int32_t)128, (int32_t)1, (int32_t)50, (int32_t)1,i4,i5,i6,i7) = Arr2DIdxRowM(tmp13, (int32_t)50, (int32_t)128,i2,i3);
i3 = (i3 +  (int64_t)1);
if ((i3 ==  (int64_t)128)) {
i3 =  (int64_t)0;
i2 = (i2 +  (int64_t)1);
...
uint64_t* tmp18 = make_array<uint64_t>( (int32_t)128,  (int32_t)1,  (int32_t)1,  (int32_t)1);
MaxPool( (int32_t)128,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)50,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1,  (int32_t)128,  (int32_t)1,  (int32_t)50,  (int32_t)1, tmp16, tmp18);
ClearMemSecret4( (int32_t)128,  (int32_t)1,  (int32_t)50,  (int32_t)1, tmp16);
ScaleUp1( (int32_t)128, tmp5,  (int32_t)12);

uint64_t* tmp20 = make_array<uint64_t>( (int32_t)128,  (int32_t)1,  (int32_t)1,  (int32_t)128);
...
Arr4DIdxRowM(tmp20, (int32_t)128, (int32_t)1, (int32_t)1, (int32_t)128,i0,i1,i2,i3) = SecretAdd(Arr4DIdxRowM(tmp18, (int32_t)128, (int32_t)1, (int32_t)1, (int32_t)1,i0,i1,i2, (int32_t)0), Arr1DIdxRowM(tmp5, (int32_t)128,i3));
}
}
}
}
ClearMemSecret4( (int32_t)128,  (int32_t)1,  (int32_t)1,  (int32_t)1, tmp18);
ScaleUp2( (int32_t)50,  (int32_t)128, tmp1,  (int32_t)12);

uint64_t* tmp22 = make_array<uint64_t>( (int32_t)50,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp22, (int32_t)50, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp1, (int32_t)50, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp6, (int32_t)50, (int32_t)128,i0,i1));
}
}
ClearMemSecret2( (int32_t)50,  (int32_t)128, tmp1);

int32_t* tmp24 = make_array<int32_t>( (int32_t)4);
Arr1DIdxRowM(tmp24, (int32_t)4, (int64_t)0) =  (int32_t)128;
...
uint64_t* tmp25 = make_array<uint64_t>( (int32_t)128,  (int32_t)1,  (int32_t)50,  (int32_t)1);
...
Arr4DIdxRowM(tmp25, (int32_t)128, (int32_t)1, (int32_t)50, (int32_t)1,i10,i11,i12,i13) = Arr2DIdxRowM(tmp22, (int32_t)50, (int32_t)128,i8,i9);
i9 = (i9 +  (int64_t)1);
if ((i9 ==  (int64_t)128)) {
i9 =  (int64_t)0;
i8 = (i8 +  (int64_t)1);
...
ClearMemSecret2( (int32_t)50,  (int32_t)128, tmp22);

uint64_t* tmp27 = make_array<uint64_t>( (int32_t)128,  (int32_t)1,  (int32_t)1,  (int32_t)1);
MaxPool( (int32_t)128,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)50,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1,  (int32_t)128,  (int32_t)1,  (int32_t)50,  (int32_t)1, tmp25, tmp27);
ClearMemSecret4( (int32_t)128,  (int32_t)1,  (int32_t)50,  (int32_t)1, tmp25);

uint64_t* tmp29 = make_array<uint64_t>( (int32_t)128,  (int32_t)1,  (int32_t)1,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)128; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)1; i1++){
for (uint32_t i2 =  (int32_t)0; i2 <  (int32_t)1; i2++){
for (uint32_t i3 =  (int32_t)0; i3 <  (int32_t)128; i3++){
Arr4DIdxRowM(tmp29, (int32_t)128, (int32_t)1, (int32_t)1, (int32_t)128,i0,i1,i2,i3) = SecretAdd(Arr4DIdxRowM(tmp27, (int32_t)128, (int32_t)1, (int32_t)1, (int32_t)1,i0,i1,i2, (int32_t)0), Arr1DIdxRowM(tmp5, (int32_t)128,i3));
}
}
}
}
ClearMemSecret4( (int32_t)128,  (int32_t)1,  (int32_t)1,  (int32_t)1, tmp27);
ScaleUp2( (int32_t)50,  (int32_t)128, tmp2,  (int32_t)12);

uint64_t* tmp31 = make_array<uint64_t>( (int32_t)50,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp31, (int32_t)50, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp2, (int32_t)50, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp6, (int32_t)50, (int32_t)128,i0,i1));
}
}
...
Arr4DIdxRowM(tmp35, (int32_t)128, (int32_t)1, (int32_t)50, (int32_t)1,i16,i17,i18,i19) = Arr2DIdxRowM(tmp31, (int32_t)50, (int32_t)128,i14,i15);
i15 = (i15 +  (int64_t)1);
if ((i15 ==  (int64_t)128)) {
i15 =  (int64_t)0;
i14 = (i14 +  (int64_t)1);
...
for (uint32_t i2 =  (int32_t)0; i2 <  (int32_t)1; i2++){
for (uint32_t i3 =  (int32_t)0; i3 <  (int32_t)128; i3++){
Arr4DIdxRowM(tmp39, (int32_t)128, (int32_t)1, (int32_t)1, (int32_t)128,i0,i1,i2,i3) = SecretAdd(Arr4DIdxRowM(tmp37, (int32_t)128, (int32_t)1, (int32_t)1, (int32_t)1,i0,i1,i2, (int32_t)0), Arr1DIdxRowM(tmp5, (int32_t)128,i3));
}
}
}
}
...
ScaleDown4( (int32_t)128,  (int32_t)1,  (int32_t)1,  (int32_t)128, tmp39,  (int32_t)12);
EndComputation();
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)128; i0++){
...
cout << (funcReconstruct2PCCons(Arr4DIdxRowM(tmp39, (int32_t)128, (int32_t)1, (int32_t)1, (int32_t)128,i0,i1,i2,i3), 2)) << endl;
}
}
}
}
