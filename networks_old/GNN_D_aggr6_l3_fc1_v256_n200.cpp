...
uint64_t* tmp5 = make_array<uint64_t>( (int32_t)51200);
...
tmp8 = (( (int32_t)0 + (i0 *  (int32_t)256)) + (i1 *  (int32_t)1));
Arr1DIdxRowM(tmp5, (int32_t)51200,tmp8) = Arr2DIdxRowM(tmp0, (int32_t)200, (int32_t)256,i0,i1);
Arr1DIdxRowM(tmp6, (int32_t)51200,tmp8) = Arr1DIdxRowM(tmp3, (int32_t)1, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)51200, tmp5, tmp6, tmp7);
ClearMemSecret1( (int32_t)51200, tmp5);
ClearMemSecret1( (int32_t)51200, tmp6);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)200; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
tmp8 = (( (int32_t)0 + (i0 *  (int32_t)256)) + (i1 *  (int32_t)1));
Arr2DIdxRowM(tmp4, (int32_t)200, (int32_t)256,i0,i1) = Arr1DIdxRowM(tmp7, (int32_t)51200,tmp8);
}
}
...
tmp11 = SecretAdd(tmp11, Arr2DIdxRowM(tmp4, (int32_t)200, (int32_t)256,i3,i2));
}
Arr1DIdxRowM(tmp12, (int32_t)256,i2) = tmp11;
}
...
tmp18 = (( (int32_t)0 + (i4 *  (int32_t)256)) + (i5 *  (int32_t)1));
Arr1DIdxRowM(tmp15, (int32_t)51200,tmp18) = Arr2DIdxRowM(tmp1, (int32_t)200, (int32_t)256,i4,i5);
Arr1DIdxRowM(tmp16, (int32_t)51200,tmp18) = Arr1DIdxRowM(tmp3, (int32_t)1, (int32_t)0);
}
}
...
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)256; i5++){
tmp18 = (( (int32_t)0 + (i4 *  (int32_t)256)) + (i5 *  (int32_t)1));
Arr2DIdxRowM(tmp14, (int32_t)200, (int32_t)256,i4,i5) = Arr1DIdxRowM(tmp17, (int32_t)51200,tmp18);
}
}
ClearMemSecret1( (int32_t)51200, tmp17);
ClearMemSecret2( (int32_t)200,  (int32_t)256, tmp1);

int32_t tmp20 =  (int32_t)0;

uint64_t tmp21;

uint64_t* tmp22 = make_array<uint64_t>( (int32_t)256);
for (uint32_t i6 =  (int32_t)0; i6 <  (int32_t)256; i6++){
tmp21 = funcSSCons( (int64_t)0);
for (uint32_t i7 =  (int32_t)0; i7 <  (int32_t)200; i7++){
tmp21 = SecretAdd(tmp21, Arr2DIdxRowM(tmp14, (int32_t)200, (int32_t)256,i7,i6));
}
Arr1DIdxRowM(tmp22, (int32_t)256,i6) = tmp21;
}
...
tmp28 = (( (int32_t)0 + (i8 *  (int32_t)256)) + (i9 *  (int32_t)1));
Arr1DIdxRowM(tmp25, (int32_t)51200,tmp28) = Arr2DIdxRowM(tmp2, (int32_t)200, (int32_t)256,i8,i9);
Arr1DIdxRowM(tmp26, (int32_t)51200,tmp28) = Arr1DIdxRowM(tmp3, (int32_t)1, (int32_t)0);
}
}
...
for (uint32_t i9 =  (int32_t)0; i9 <  (int32_t)256; i9++){
tmp28 = (( (int32_t)0 + (i8 *  (int32_t)256)) + (i9 *  (int32_t)1));
Arr2DIdxRowM(tmp24, (int32_t)200, (int32_t)256,i8,i9) = Arr1DIdxRowM(tmp27, (int32_t)51200,tmp28);
}
}
...
tmp32 = SecretAdd(tmp32, Arr2DIdxRowM(tmp24, (int32_t)200, (int32_t)256,i11,i10));
}
Arr1DIdxRowM(tmp33, (int32_t)256,i10) = tmp32;
}
ClearMemSecret2( (int32_t)200,  (int32_t)256, tmp24);
ScaleDown1( (int32_t)256, tmp33,  (int32_t)12);
EndComputation();
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)256; i0++){
cout << (funcReconstruct2PCCons(Arr1DIdxRowM(tmp33, (int32_t)256,i0), 2)) << endl;
}
}
