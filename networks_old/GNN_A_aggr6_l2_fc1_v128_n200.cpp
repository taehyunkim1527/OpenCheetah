...
uint64_t* tmp1 = make_array<uint64_t>( (int32_t)200,  (int32_t)128);
...
Arr2DIdxRowM(tmp1, (int32_t)200, (int32_t)128,i0,i1) = (party == SERVER) ? __tmp_in_tmp1 : 0;
}
}

uint64_t* tmp2 = make_array<uint64_t>( (int32_t)200,  (int32_t)128);
...
Arr2DIdxRowM(tmp2, (int32_t)200, (int32_t)128,i0,i1) = (party == SERVER) ? __tmp_in_tmp2 : 0;
}
}
...
uint64_t* tmp4 = make_array<uint64_t>( (int32_t)200,  (int32_t)128);
...
Arr2DIdxRowM(tmp4, (int32_t)200, (int32_t)128,i0,i1) = (party == SERVER) ? __tmp_in_tmp4 : 0;
}
}
...
uint64_t* tmp7 = make_array<uint64_t>( (int32_t)200,  (int32_t)1);
...
Arr2DIdxRowM(tmp7, (int32_t)200, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp7 : 0;
}
}
...
uint64_t* tmp11 = make_array<uint64_t>( (int32_t)200,  (int32_t)1);
...
Arr2DIdxRowM(tmp11, (int32_t)200, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp11 : 0;
}
}
...
uint64_t* tmp15 = make_array<uint64_t>( (int32_t)200,  (int32_t)128);

uint64_t* tmp16 = make_array<uint64_t>( (int32_t)25600);

uint64_t* tmp17 = make_array<uint64_t>( (int32_t)25600);
...
tmp19 = (( (int32_t)0 + (i0 *  (int32_t)128)) + (i1 *  (int32_t)1));
Arr1DIdxRowM(tmp16, (int32_t)25600,tmp19) = Arr2DIdxRowM(tmp4, (int32_t)200, (int32_t)128,i0,i1);
Arr1DIdxRowM(tmp17, (int32_t)25600,tmp19) = Arr2DIdxRowM(tmp3, (int32_t)1, (int32_t)128, (int32_t)0,i1);
}
}
ElemWiseActModelVectorMult( (int32_t)25600, tmp16, tmp17, tmp18);
ClearMemSecret1( (int32_t)25600, tmp16);
ClearMemSecret1( (int32_t)25600, tmp17);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)200; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
tmp19 = (( (int32_t)0 + (i0 *  (int32_t)128)) + (i1 *  (int32_t)1));
Arr2DIdxRowM(tmp15, (int32_t)200, (int32_t)128,i0,i1) = Arr1DIdxRowM(tmp18, (int32_t)25600,tmp19);
}
}
ClearMemSecret1( (int32_t)25600, tmp18);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp3);
ClearMemSecret2( (int32_t)200,  (int32_t)128, tmp4);

int32_t* tmp22 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp22, (int32_t)2, (int64_t)0) =  (int32_t)-1;
Arr1DIdxRowM(tmp22, (int32_t)2, (int64_t)1) =  (int32_t)128;
...
Arr2DIdxRowM(tmp23, (int32_t)1, (int32_t)128,i3,i4) = Arr1DIdxRowM(tmp0, (int32_t)128,i2);
i2 = (i2 +  (int64_t)1);
}
}
...
MatMul2D( (int32_t)1,  (int32_t)128,  (int32_t)128, tmp23, tmp5, tmp25, 0);
...
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp28, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp25, (int32_t)1, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp6, (int32_t)1, (int32_t)128,i0,i1));
}
}
...
Relu2( (int32_t)1,  (int32_t)128, tmp28, tmp31,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp28);
ScaleUp2( (int32_t)200,  (int32_t)128, tmp1,  (int32_t)12);

uint64_t* tmp33 = make_array<uint64_t>( (int32_t)200,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)200; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp33, (int32_t)200, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp1, (int32_t)200, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp15, (int32_t)200, (int32_t)128,i0,i1));
}
}
ClearMemSecret2( (int32_t)200,  (int32_t)128, tmp1);

uint64_t* tmp35 = make_array<uint64_t>( (int32_t)200,  (int32_t)1);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)200; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)1; i1++){
Arr2DIdxRowM(tmp35, (int32_t)200, (int32_t)1,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp7, (int32_t)200, (int32_t)1,i0,i1), Arr2DIdxRowM(tmp8, (int32_t)200, (int32_t)1,i0,i1));
}
}
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp7);
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp8);

uint64_t* tmp38 = make_array<uint64_t>( (int32_t)200,  (int32_t)1);
Relu2( (int32_t)200,  (int32_t)1, tmp35, tmp38,  (int32_t)0, 0);
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp35);

int32_t* tmp40 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp40, (int32_t)2, (int64_t)0) =  (int32_t)0;
Arr1DIdxRowM(tmp40, (int32_t)2, (int64_t)1) =  (int32_t)1;

uint64_t tmp41;

uint64_t* tmp42 = make_array<uint64_t>( (int32_t)1);
tmp41 = funcSSCons( (int64_t)0);
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)200; i5++){
for (uint32_t i6 =  (int32_t)0; i6 <  (int32_t)1; i6++){
tmp41 = SecretAdd(tmp41, Arr2DIdxRowM(tmp38, (int32_t)200, (int32_t)1,i5,i6));
}
}
Arr1DIdxRowM(tmp42, (int32_t)1, (int32_t)0) = tmp41;

uint64_t* tmp43 = make_array<uint64_t>( (int32_t)200,  (int32_t)1);

uint64_t* tmp44 = make_array<uint64_t>( (int32_t)200);

uint64_t* tmp45 = make_array<uint64_t>( (int32_t)200);

uint64_t* tmp46 = make_array<uint64_t>( (int32_t)200);

int32_t tmp47;
for (uint32_t i7 =  (int32_t)0; i7 <  (int32_t)200; i7++){
for (uint32_t i8 =  (int32_t)0; i8 <  (int32_t)1; i8++){
tmp47 = (( (int32_t)0 + (i7 *  (int32_t)1)) + (i8 *  (int32_t)1));
Arr1DIdxRowM(tmp44, (int32_t)200,tmp47) = Arr2DIdxRowM(tmp38, (int32_t)200, (int32_t)1,i7,i8);
Arr1DIdxRowM(tmp45, (int32_t)200,tmp47) = Arr1DIdxRowM(tmp42, (int32_t)1,i8);
}
}
ElemWiseActModelVectorMult( (int32_t)200, tmp44, tmp45, tmp46);
ClearMemSecret1( (int32_t)200, tmp44);
ClearMemSecret1( (int32_t)200, tmp45);
for (uint32_t i7 =  (int32_t)0; i7 <  (int32_t)200; i7++){
for (uint32_t i8 =  (int32_t)0; i8 <  (int32_t)1; i8++){
tmp47 = (( (int32_t)0 + (i7 *  (int32_t)1)) + (i8 *  (int32_t)1));
Arr2DIdxRowM(tmp43, (int32_t)200, (int32_t)1,i7,i8) = Arr1DIdxRowM(tmp46, (int32_t)200,tmp47);
}
}
ClearMemSecret1( (int32_t)200, tmp46);
ClearMemSecret1( (int32_t)1, tmp42);
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp38);
ScaleDown2( (int32_t)200,  (int32_t)128, tmp33,  (int32_t)12);
ScaleDown2( (int32_t)200,  (int32_t)1, tmp43,  (int32_t)12);

uint64_t* tmp50 = make_array<uint64_t>( (int32_t)200,  (int32_t)128);

uint64_t* tmp51 = make_array<uint64_t>( (int32_t)25600);

uint64_t* tmp52 = make_array<uint64_t>( (int32_t)25600);

uint64_t* tmp53 = make_array<uint64_t>( (int32_t)25600);

int32_t tmp54;
for (uint32_t i9 =  (int32_t)0; i9 <  (int32_t)200; i9++){
for (uint32_t i10 =  (int32_t)0; i10 <  (int32_t)128; i10++){
tmp54 = (( (int32_t)0 + (i9 *  (int32_t)128)) + (i10 *  (int32_t)1));
Arr1DIdxRowM(tmp51, (int32_t)25600,tmp54) = Arr2DIdxRowM(tmp33, (int32_t)200, (int32_t)128,i9,i10);
Arr1DIdxRowM(tmp52, (int32_t)25600,tmp54) = Arr2DIdxRowM(tmp43, (int32_t)200, (int32_t)1,i9, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)25600, tmp51, tmp52, tmp53);
ClearMemSecret1( (int32_t)25600, tmp51);
ClearMemSecret1( (int32_t)25600, tmp52);
for (uint32_t i9 =  (int32_t)0; i9 <  (int32_t)200; i9++){
for (uint32_t i10 =  (int32_t)0; i10 <  (int32_t)128; i10++){
tmp54 = (( (int32_t)0 + (i9 *  (int32_t)128)) + (i10 *  (int32_t)1));
Arr2DIdxRowM(tmp50, (int32_t)200, (int32_t)128,i9,i10) = Arr1DIdxRowM(tmp53, (int32_t)25600,tmp54);
}
}
ClearMemSecret1( (int32_t)25600, tmp53);
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp43);
ClearMemSecret2( (int32_t)200,  (int32_t)128, tmp33);

int32_t tmp57 =  (int32_t)0;

uint64_t tmp58;

uint64_t* tmp59 = make_array<uint64_t>( (int32_t)128);
for (uint32_t i11 =  (int32_t)0; i11 <  (int32_t)128; i11++){
tmp58 = funcSSCons( (int64_t)0);
for (uint32_t i12 =  (int32_t)0; i12 <  (int32_t)200; i12++){
tmp58 = SecretAdd(tmp58, Arr2DIdxRowM(tmp50, (int32_t)200, (int32_t)128,i12,i11));
}
Arr1DIdxRowM(tmp59, (int32_t)128,i11) = tmp58;
}
ClearMemSecret2( (int32_t)200,  (int32_t)128, tmp50);

int32_t* tmp61 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp61, (int32_t)2, (int64_t)0) =  (int32_t)-1;
Arr1DIdxRowM(tmp61, (int32_t)2, (int64_t)1) =  (int32_t)128;
...
Arr2DIdxRowM(tmp62, (int32_t)1, (int32_t)128,i14,i15) = Arr1DIdxRowM(tmp59, (int32_t)128,i13);
i13 = (i13 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)128, tmp59);
ScaleUp2( (int32_t)1,  (int32_t)128, tmp31,  (int32_t)12);

uint64_t* tmp64 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp64, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp62, (int32_t)1, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp31, (int32_t)1, (int32_t)128,i0,i1));
}
}
...
ScaleDown2( (int32_t)1,  (int32_t)128, tmp64,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)128,  (int32_t)128, tmp64, tmp9, tmp67, 0);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp70, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp67, (int32_t)1, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp10, (int32_t)1, (int32_t)128,i0,i1));
}
}
...
Relu2( (int32_t)1,  (int32_t)128, tmp70, tmp73,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp70);
ScaleUp2( (int32_t)200,  (int32_t)128, tmp2,  (int32_t)12);

uint64_t* tmp75 = make_array<uint64_t>( (int32_t)200,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)200; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp75, (int32_t)200, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp2, (int32_t)200, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp15, (int32_t)200, (int32_t)128,i0,i1));
}
}
ClearMemSecret2( (int32_t)200,  (int32_t)128, tmp15);
ClearMemSecret2( (int32_t)200,  (int32_t)128, tmp2);

uint64_t* tmp78 = make_array<uint64_t>( (int32_t)200,  (int32_t)1);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)200; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)1; i1++){
Arr2DIdxRowM(tmp78, (int32_t)200, (int32_t)1,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp11, (int32_t)200, (int32_t)1,i0,i1), Arr2DIdxRowM(tmp12, (int32_t)200, (int32_t)1,i0,i1));
}
}
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp11);
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp12);

uint64_t* tmp81 = make_array<uint64_t>( (int32_t)200,  (int32_t)1);
Relu2( (int32_t)200,  (int32_t)1, tmp78, tmp81,  (int32_t)0, 0);
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp78);

int32_t* tmp83 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp83, (int32_t)2, (int64_t)0) =  (int32_t)0;
Arr1DIdxRowM(tmp83, (int32_t)2, (int64_t)1) =  (int32_t)1;

uint64_t tmp84;

uint64_t* tmp85 = make_array<uint64_t>( (int32_t)1);
tmp84 = funcSSCons( (int64_t)0);
for (uint32_t i16 =  (int32_t)0; i16 <  (int32_t)200; i16++){
for (uint32_t i17 =  (int32_t)0; i17 <  (int32_t)1; i17++){
tmp84 = SecretAdd(tmp84, Arr2DIdxRowM(tmp81, (int32_t)200, (int32_t)1,i16,i17));
}
}
Arr1DIdxRowM(tmp85, (int32_t)1, (int32_t)0) = tmp84;

uint64_t* tmp86 = make_array<uint64_t>( (int32_t)200,  (int32_t)1);

uint64_t* tmp87 = make_array<uint64_t>( (int32_t)200);

uint64_t* tmp88 = make_array<uint64_t>( (int32_t)200);

uint64_t* tmp89 = make_array<uint64_t>( (int32_t)200);

int32_t tmp90;
for (uint32_t i18 =  (int32_t)0; i18 <  (int32_t)200; i18++){
for (uint32_t i19 =  (int32_t)0; i19 <  (int32_t)1; i19++){
tmp90 = (( (int32_t)0 + (i18 *  (int32_t)1)) + (i19 *  (int32_t)1));
Arr1DIdxRowM(tmp87, (int32_t)200,tmp90) = Arr2DIdxRowM(tmp81, (int32_t)200, (int32_t)1,i18,i19);
Arr1DIdxRowM(tmp88, (int32_t)200,tmp90) = Arr1DIdxRowM(tmp85, (int32_t)1,i19);
}
}
ElemWiseActModelVectorMult( (int32_t)200, tmp87, tmp88, tmp89);
ClearMemSecret1( (int32_t)200, tmp87);
ClearMemSecret1( (int32_t)200, tmp88);
for (uint32_t i18 =  (int32_t)0; i18 <  (int32_t)200; i18++){
for (uint32_t i19 =  (int32_t)0; i19 <  (int32_t)1; i19++){
tmp90 = (( (int32_t)0 + (i18 *  (int32_t)1)) + (i19 *  (int32_t)1));
Arr2DIdxRowM(tmp86, (int32_t)200, (int32_t)1,i18,i19) = Arr1DIdxRowM(tmp89, (int32_t)200,tmp90);
}
}
ClearMemSecret1( (int32_t)200, tmp89);
ClearMemSecret1( (int32_t)1, tmp85);
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp81);
ScaleDown2( (int32_t)200,  (int32_t)128, tmp75,  (int32_t)12);
ScaleDown2( (int32_t)200,  (int32_t)1, tmp86,  (int32_t)12);

uint64_t* tmp93 = make_array<uint64_t>( (int32_t)200,  (int32_t)128);
...
tmp97 = (( (int32_t)0 + (i20 *  (int32_t)128)) + (i21 *  (int32_t)1));
Arr1DIdxRowM(tmp94, (int32_t)25600,tmp97) = Arr2DIdxRowM(tmp75, (int32_t)200, (int32_t)128,i20,i21);
Arr1DIdxRowM(tmp95, (int32_t)25600,tmp97) = Arr2DIdxRowM(tmp86, (int32_t)200, (int32_t)1,i20, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)25600, tmp94, tmp95, tmp96);
ClearMemSecret1( (int32_t)25600, tmp94);
ClearMemSecret1( (int32_t)25600, tmp95);
for (uint32_t i20 =  (int32_t)0; i20 <  (int32_t)200; i20++){
for (uint32_t i21 =  (int32_t)0; i21 <  (int32_t)128; i21++){
tmp97 = (( (int32_t)0 + (i20 *  (int32_t)128)) + (i21 *  (int32_t)1));
Arr2DIdxRowM(tmp93, (int32_t)200, (int32_t)128,i20,i21) = Arr1DIdxRowM(tmp96, (int32_t)25600,tmp97);
}
}
ClearMemSecret1( (int32_t)25600, tmp96);
ClearMemSecret2( (int32_t)200,  (int32_t)128, tmp75);
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp86);

int32_t tmp100 =  (int32_t)0;

uint64_t tmp101;

uint64_t* tmp102 = make_array<uint64_t>( (int32_t)128);
for (uint32_t i22 =  (int32_t)0; i22 <  (int32_t)128; i22++){
tmp101 = funcSSCons( (int64_t)0);
for (uint32_t i23 =  (int32_t)0; i23 <  (int32_t)200; i23++){
tmp101 = SecretAdd(tmp101, Arr2DIdxRowM(tmp93, (int32_t)200, (int32_t)128,i23,i22));
}
Arr1DIdxRowM(tmp102, (int32_t)128,i22) = tmp101;
}
ClearMemSecret2( (int32_t)200,  (int32_t)128, tmp93);

int32_t* tmp104 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp104, (int32_t)2, (int64_t)0) =  (int32_t)-1;
Arr1DIdxRowM(tmp104, (int32_t)2, (int64_t)1) =  (int32_t)128;
...
Arr2DIdxRowM(tmp105, (int32_t)1, (int32_t)128,i25,i26) = Arr1DIdxRowM(tmp102, (int32_t)128,i24);
i24 = (i24 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)128, tmp102);
ScaleUp2( (int32_t)1,  (int32_t)128, tmp73,  (int32_t)12);

uint64_t* tmp107 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp107, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp105, (int32_t)1, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp73, (int32_t)1, (int32_t)128,i0,i1));
}
}
...
ScaleDown2( (int32_t)1,  (int32_t)128, tmp107,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)128,  (int32_t)128, tmp107, tmp13, tmp110, 0);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp113, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp110, (int32_t)1, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp14, (int32_t)1, (int32_t)128,i0,i1));
}
}
...
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (uint32_t)0; i1 <  (int32_t)128; i1++){
cout << (funcReconstruct2PCCons(Arr2DIdxRowM(tmp116, (int32_t)1, (int32_t)128,i0,i1), 2)) << endl;
}
}
}
