...
uint64_t* tmp0 = make_array<uint64_t>( (int32_t)200,  (int32_t)256);
/* Variable to read the clear value corresponding to the input variable tmp0 at (9027,1-9027,40) */
...
Arr2DIdxRowM(tmp0, (int32_t)200, (int32_t)256,i0,i1) = (party == SERVER) ? __tmp_in_tmp0 : 0;
}
}
...
uint64_t* tmp4 = make_array<uint64_t>( (int32_t)200,  (int32_t)256);
...
Arr2DIdxRowM(tmp4, (int32_t)200, (int32_t)256,i0,i1) = (party == SERVER) ? __tmp_in_tmp4 : 0;
}
}

uint64_t* tmp5 = make_array<uint64_t>( (int32_t)256);
...
Arr1DIdxRowM(tmp5, (int32_t)256,i0) = (party == SERVER) ? __tmp_in_tmp5 : 0;
}

uint64_t* tmp6 = make_array<uint64_t>( (int32_t)200,  (int32_t)1);
...
Arr2DIdxRowM(tmp6, (int32_t)200, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp6 : 0;
}
}
...
uint64_t* tmp10 = make_array<uint64_t>( (int32_t)200,  (int32_t)1);
...
Arr2DIdxRowM(tmp10, (int32_t)200, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp10 : 0;
}
}
...
uint64_t* tmp12 = make_array<uint64_t>( (int32_t)200,  (int32_t)256);

uint64_t* tmp13 = make_array<uint64_t>( (int32_t)51200);

uint64_t* tmp14 = make_array<uint64_t>( (int32_t)51200);
...
tmp16 = (( (int32_t)0 + (i0 *  (int32_t)256)) + (i1 *  (int32_t)1));
Arr1DIdxRowM(tmp13, (int32_t)51200,tmp16) = Arr2DIdxRowM(tmp4, (int32_t)200, (int32_t)256,i0,i1);
Arr1DIdxRowM(tmp14, (int32_t)51200,tmp16) = Arr2DIdxRowM(tmp3, (int32_t)1, (int32_t)256, (int32_t)0,i1);
}
}
ElemWiseActModelVectorMult( (int32_t)51200, tmp13, tmp14, tmp15);
ClearMemSecret1( (int32_t)51200, tmp13);
ClearMemSecret1( (int32_t)51200, tmp14);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)200; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
tmp16 = (( (int32_t)0 + (i0 *  (int32_t)256)) + (i1 *  (int32_t)1));
Arr2DIdxRowM(tmp12, (int32_t)200, (int32_t)256,i0,i1) = Arr1DIdxRowM(tmp15, (int32_t)51200,tmp16);
}
}
ClearMemSecret1( (int32_t)51200, tmp15);
ClearMemSecret2( (int32_t)200,  (int32_t)256, tmp4);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp3);
ScaleUp2( (int32_t)200,  (int32_t)256, tmp0,  (int32_t)12);

uint64_t* tmp19 = make_array<uint64_t>( (int32_t)200,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)200; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp19, (int32_t)200, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp0, (int32_t)200, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp12, (int32_t)200, (int32_t)256,i0,i1));
}
}
ClearMemSecret2( (int32_t)200,  (int32_t)256, tmp0);

uint64_t* tmp21 = make_array<uint64_t>( (int32_t)200,  (int32_t)1);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)200; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)1; i1++){
Arr2DIdxRowM(tmp21, (int32_t)200, (int32_t)1,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp6, (int32_t)200, (int32_t)1,i0,i1), Arr2DIdxRowM(tmp7, (int32_t)200, (int32_t)1,i0,i1));
}
}
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp6);
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp7);

uint64_t* tmp24 = make_array<uint64_t>( (int32_t)200,  (int32_t)1);
Relu2( (int32_t)200,  (int32_t)1, tmp21, tmp24,  (int32_t)0, 0);
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp21);

int32_t* tmp26 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp26, (int32_t)2, (int64_t)0) =  (int32_t)0;
Arr1DIdxRowM(tmp26, (int32_t)2, (int64_t)1) =  (int32_t)1;

uint64_t tmp27;

uint64_t* tmp28 = make_array<uint64_t>( (int32_t)1);
tmp27 = funcSSCons( (int64_t)0);
for (uint32_t i2 =  (int32_t)0; i2 <  (int32_t)200; i2++){
for (uint32_t i3 =  (int32_t)0; i3 <  (int32_t)1; i3++){
tmp27 = SecretAdd(tmp27, Arr2DIdxRowM(tmp24, (int32_t)200, (int32_t)1,i2,i3));
}
}
Arr1DIdxRowM(tmp28, (int32_t)1, (int32_t)0) = tmp27;
ScaleDown2( (int32_t)200,  (int32_t)256, tmp19,  (int32_t)12);

uint64_t* tmp29 = make_array<uint64_t>( (int32_t)200,  (int32_t)256);
...
int32_t tmp33;
for (uint32_t i4 =  (int32_t)0; i4 <  (int32_t)200; i4++){
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)256; i5++){
tmp33 = (( (int32_t)0 + (i4 *  (int32_t)256)) + (i5 *  (int32_t)1));
Arr1DIdxRowM(tmp30, (int32_t)51200,tmp33) = Arr2DIdxRowM(tmp19, (int32_t)200, (int32_t)256,i4,i5);
Arr1DIdxRowM(tmp31, (int32_t)51200,tmp33) = Arr2DIdxRowM(tmp24, (int32_t)200, (int32_t)1,i4, (int32_t)0);
}
}
...
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)256; i5++){
tmp33 = (( (int32_t)0 + (i4 *  (int32_t)256)) + (i5 *  (int32_t)1));
Arr2DIdxRowM(tmp29, (int32_t)200, (int32_t)256,i4,i5) = Arr1DIdxRowM(tmp32, (int32_t)51200,tmp33);
}
}
ClearMemSecret1( (int32_t)51200, tmp32);
ClearMemSecret2( (int32_t)200,  (int32_t)256, tmp19);
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp24);

int32_t tmp36 =  (int32_t)0;

uint64_t tmp37;

uint64_t* tmp38 = make_array<uint64_t>( (int32_t)256);
for (uint32_t i6 =  (int32_t)0; i6 <  (int32_t)256; i6++){
tmp37 = funcSSCons( (int64_t)0);
for (uint32_t i7 =  (int32_t)0; i7 <  (int32_t)200; i7++){
tmp37 = SecretAdd(tmp37, Arr2DIdxRowM(tmp29, (int32_t)200, (int32_t)256,i7,i6));
}
Arr1DIdxRowM(tmp38, (int32_t)256,i6) = tmp37;
}
ClearMemSecret2( (int32_t)200,  (int32_t)256, tmp29);
ScaleUp1( (int32_t)256, tmp5,  (int32_t)12);

uint64_t* tmp40 = make_array<uint64_t>( (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)256; i0++){
Arr1DIdxRowM(tmp40, (int32_t)256,i0) = SecretAdd(Arr1DIdxRowM(tmp38, (int32_t)256,i0), Arr1DIdxRowM(tmp5, (int32_t)256,i0));
}
ClearMemSecret1( (int32_t)256, tmp38);
ScaleUp2( (int32_t)200,  (int32_t)256, tmp1,  (int32_t)12);

uint64_t* tmp42 = make_array<uint64_t>( (int32_t)200,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)200; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp42, (int32_t)200, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp1, (int32_t)200, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp12, (int32_t)200, (int32_t)256,i0,i1));
}
}
ClearMemSecret2( (int32_t)200,  (int32_t)256, tmp1);

uint64_t* tmp44 = make_array<uint64_t>( (int32_t)200,  (int32_t)1);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)200; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)1; i1++){
Arr2DIdxRowM(tmp44, (int32_t)200, (int32_t)1,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp8, (int32_t)200, (int32_t)1,i0,i1), Arr2DIdxRowM(tmp9, (int32_t)200, (int32_t)1,i0,i1));
}
}
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp9);
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp8);

uint64_t* tmp47 = make_array<uint64_t>( (int32_t)200,  (int32_t)1);
Relu2( (int32_t)200,  (int32_t)1, tmp44, tmp47,  (int32_t)0, 0);
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp44);

int32_t* tmp49 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp49, (int32_t)2, (int64_t)0) =  (int32_t)0;
Arr1DIdxRowM(tmp49, (int32_t)2, (int64_t)1) =  (int32_t)1;

uint64_t tmp50;

uint64_t* tmp51 = make_array<uint64_t>( (int32_t)1);
tmp50 = funcSSCons( (int64_t)0);
for (uint32_t i8 =  (int32_t)0; i8 <  (int32_t)200; i8++){
for (uint32_t i9 =  (int32_t)0; i9 <  (int32_t)1; i9++){
tmp50 = SecretAdd(tmp50, Arr2DIdxRowM(tmp47, (int32_t)200, (int32_t)1,i8,i9));
}
}
Arr1DIdxRowM(tmp51, (int32_t)1, (int32_t)0) = tmp50;
ScaleDown2( (int32_t)200,  (int32_t)256, tmp42,  (int32_t)12);

uint64_t* tmp52 = make_array<uint64_t>( (int32_t)200,  (int32_t)256);

uint64_t* tmp53 = make_array<uint64_t>( (int32_t)51200);

uint64_t* tmp54 = make_array<uint64_t>( (int32_t)51200);

uint64_t* tmp55 = make_array<uint64_t>( (int32_t)51200);

int32_t tmp56;
for (uint32_t i10 =  (int32_t)0; i10 <  (int32_t)200; i10++){
for (uint32_t i11 =  (int32_t)0; i11 <  (int32_t)256; i11++){
tmp56 = (( (int32_t)0 + (i10 *  (int32_t)256)) + (i11 *  (int32_t)1));
Arr1DIdxRowM(tmp53, (int32_t)51200,tmp56) = Arr2DIdxRowM(tmp42, (int32_t)200, (int32_t)256,i10,i11);
Arr1DIdxRowM(tmp54, (int32_t)51200,tmp56) = Arr2DIdxRowM(tmp47, (int32_t)200, (int32_t)1,i10, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)51200, tmp53, tmp54, tmp55);
ClearMemSecret1( (int32_t)51200, tmp53);
ClearMemSecret1( (int32_t)51200, tmp54);
for (uint32_t i10 =  (int32_t)0; i10 <  (int32_t)200; i10++){
for (uint32_t i11 =  (int32_t)0; i11 <  (int32_t)256; i11++){
tmp56 = (( (int32_t)0 + (i10 *  (int32_t)256)) + (i11 *  (int32_t)1));
Arr2DIdxRowM(tmp52, (int32_t)200, (int32_t)256,i10,i11) = Arr1DIdxRowM(tmp55, (int32_t)51200,tmp56);
}
}
ClearMemSecret1( (int32_t)51200, tmp55);
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp47);
ClearMemSecret2( (int32_t)200,  (int32_t)256, tmp42);

int32_t tmp59 =  (int32_t)0;

uint64_t tmp60;

uint64_t* tmp61 = make_array<uint64_t>( (int32_t)256);
for (uint32_t i12 =  (int32_t)0; i12 <  (int32_t)256; i12++){
tmp60 = funcSSCons( (int64_t)0);
for (uint32_t i13 =  (int32_t)0; i13 <  (int32_t)200; i13++){
tmp60 = SecretAdd(tmp60, Arr2DIdxRowM(tmp52, (int32_t)200, (int32_t)256,i13,i12));
}
Arr1DIdxRowM(tmp61, (int32_t)256,i12) = tmp60;
}
ClearMemSecret2( (int32_t)200,  (int32_t)256, tmp52);

uint64_t* tmp63 = make_array<uint64_t>( (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)256; i0++){
Arr1DIdxRowM(tmp63, (int32_t)256,i0) = SecretAdd(Arr1DIdxRowM(tmp61, (int32_t)256,i0), Arr1DIdxRowM(tmp5, (int32_t)256,i0));
}
ClearMemSecret1( (int32_t)256, tmp61);
ScaleUp2( (int32_t)200,  (int32_t)256, tmp2,  (int32_t)12);

uint64_t* tmp65 = make_array<uint64_t>( (int32_t)200,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)200; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp65, (int32_t)200, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp2, (int32_t)200, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp12, (int32_t)200, (int32_t)256,i0,i1));
}
}
ClearMemSecret2( (int32_t)200,  (int32_t)256, tmp2);
ClearMemSecret2( (int32_t)200,  (int32_t)256, tmp12);

uint64_t* tmp68 = make_array<uint64_t>( (int32_t)200,  (int32_t)1);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)200; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)1; i1++){
Arr2DIdxRowM(tmp68, (int32_t)200, (int32_t)1,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp10, (int32_t)200, (int32_t)1,i0,i1), Arr2DIdxRowM(tmp11, (int32_t)200, (int32_t)1,i0,i1));
}
}
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp11);
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp10);

uint64_t* tmp71 = make_array<uint64_t>( (int32_t)200,  (int32_t)1);
Relu2( (int32_t)200,  (int32_t)1, tmp68, tmp71,  (int32_t)0, 0);
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp68);

int32_t* tmp73 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp73, (int32_t)2, (int64_t)0) =  (int32_t)0;
Arr1DIdxRowM(tmp73, (int32_t)2, (int64_t)1) =  (int32_t)1;

uint64_t tmp74;

uint64_t* tmp75 = make_array<uint64_t>( (int32_t)1);
tmp74 = funcSSCons( (int64_t)0);
for (uint32_t i14 =  (int32_t)0; i14 <  (int32_t)200; i14++){
for (uint32_t i15 =  (int32_t)0; i15 <  (int32_t)1; i15++){
tmp74 = SecretAdd(tmp74, Arr2DIdxRowM(tmp71, (int32_t)200, (int32_t)1,i14,i15));
}
}
Arr1DIdxRowM(tmp75, (int32_t)1, (int32_t)0) = tmp74;
ScaleDown2( (int32_t)200,  (int32_t)256, tmp65,  (int32_t)12);

uint64_t* tmp76 = make_array<uint64_t>( (int32_t)200,  (int32_t)256);

uint64_t* tmp77 = make_array<uint64_t>( (int32_t)51200);

uint64_t* tmp78 = make_array<uint64_t>( (int32_t)51200);
...
tmp80 = (( (int32_t)0 + (i16 *  (int32_t)256)) + (i17 *  (int32_t)1));
Arr1DIdxRowM(tmp77, (int32_t)51200,tmp80) = Arr2DIdxRowM(tmp65, (int32_t)200, (int32_t)256,i16,i17);
Arr1DIdxRowM(tmp78, (int32_t)51200,tmp80) = Arr2DIdxRowM(tmp71, (int32_t)200, (int32_t)1,i16, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)51200, tmp77, tmp78, tmp79);
ClearMemSecret1( (int32_t)51200, tmp77);
ClearMemSecret1( (int32_t)51200, tmp78);
for (uint32_t i16 =  (int32_t)0; i16 <  (int32_t)200; i16++){
for (uint32_t i17 =  (int32_t)0; i17 <  (int32_t)256; i17++){
tmp80 = (( (int32_t)0 + (i16 *  (int32_t)256)) + (i17 *  (int32_t)1));
Arr2DIdxRowM(tmp76, (int32_t)200, (int32_t)256,i16,i17) = Arr1DIdxRowM(tmp79, (int32_t)51200,tmp80);
}
}
ClearMemSecret1( (int32_t)51200, tmp79);
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp71);
ClearMemSecret2( (int32_t)200,  (int32_t)256, tmp65);

int32_t tmp83 =  (int32_t)0;
...
tmp84 = SecretAdd(tmp84, Arr2DIdxRowM(tmp76, (int32_t)200, (int32_t)256,i19,i18));
}
Arr1DIdxRowM(tmp85, (int32_t)256,i18) = tmp84;
}
ClearMemSecret2( (int32_t)200,  (int32_t)256, tmp76);

uint64_t* tmp87 = make_array<uint64_t>( (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)256; i0++){
Arr1DIdxRowM(tmp87, (int32_t)256,i0) = SecretAdd(Arr1DIdxRowM(tmp85, (int32_t)256,i0), Arr1DIdxRowM(tmp5, (int32_t)256,i0));
}
ClearMemSecret1( (int32_t)256, tmp5);
ClearMemSecret1( (int32_t)256, tmp85);
ScaleDown1( (int32_t)256, tmp87,  (int32_t)12);
EndComputation();
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)256; i0++){
cout << (funcReconstruct2PCCons(Arr1DIdxRowM(tmp87, (int32_t)256,i0), 2)) << endl;
}
}
