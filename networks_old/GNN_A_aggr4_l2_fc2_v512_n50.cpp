...
uint64_t* tmp7 = make_array<uint64_t>( (int32_t)50,  (int32_t)1);
...
Arr2DIdxRowM(tmp7, (int32_t)50, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp7 : 0;
}
}
...
Arr1DIdxRowM(tmp18, (int32_t)25600,tmp21) = Arr2DIdxRowM(tmp4, (int32_t)50, (int32_t)512,i0,i1);
Arr1DIdxRowM(tmp19, (int32_t)25600,tmp21) = Arr2DIdxRowM(tmp3, (int32_t)1, (int32_t)512, (int32_t)0,i1);
}
}
...
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp25, tmp5, tmp27, 0);
...
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp30, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp27, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp6, (int32_t)1, (int32_t)512,i0,i1));
}
}
...
Arr1DIdxRowM(tmp39, (int32_t)25600,tmp41) = Arr2DIdxRowM(tmp7, (int32_t)50, (int32_t)1,i5, (int32_t)0);
}
}
...
ClearMemSecret2( (int32_t)50,  (int32_t)1, tmp7);
...
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp51, tmp8, tmp54, 0);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp57, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp54, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp9, (int32_t)1, (int32_t)512,i0,i1));
}
}
...
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp60, tmp10, tmp62, 0);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp65, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp62, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp11, (int32_t)1, (int32_t)512,i0,i1));
}
}
...
Relu2( (int32_t)1,  (int32_t)512, tmp65, tmp68,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp65);
ScaleUp2( (int32_t)50,  (int32_t)512, tmp2,  (int32_t)12);

uint64_t* tmp70 = make_array<uint64_t>( (int32_t)50,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp70, (int32_t)50, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp2, (int32_t)50, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp17, (int32_t)50, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp17);
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp2);
ScaleDown2( (int32_t)50,  (int32_t)512, tmp70,  (int32_t)12);

uint64_t* tmp73 = make_array<uint64_t>( (int32_t)50,  (int32_t)512);

uint64_t* tmp74 = make_array<uint64_t>( (int32_t)25600);

uint64_t* tmp75 = make_array<uint64_t>( (int32_t)25600);

uint64_t* tmp76 = make_array<uint64_t>( (int32_t)25600);

int32_t tmp77;
for (uint32_t i12 =  (int32_t)0; i12 <  (int32_t)50; i12++){
for (uint32_t i13 =  (int32_t)0; i13 <  (int32_t)512; i13++){
tmp77 = (( (int32_t)0 + (i12 *  (int32_t)512)) + (i13 *  (int32_t)1));
Arr1DIdxRowM(tmp74, (int32_t)25600,tmp77) = Arr2DIdxRowM(tmp70, (int32_t)50, (int32_t)512,i12,i13);
Arr1DIdxRowM(tmp75, (int32_t)25600,tmp77) = Arr2DIdxRowM(tmp12, (int32_t)50, (int32_t)1,i12, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)25600, tmp74, tmp75, tmp76);
ClearMemSecret1( (int32_t)25600, tmp74);
ClearMemSecret1( (int32_t)25600, tmp75);
for (uint32_t i12 =  (int32_t)0; i12 <  (int32_t)50; i12++){
for (uint32_t i13 =  (int32_t)0; i13 <  (int32_t)512; i13++){
tmp77 = (( (int32_t)0 + (i12 *  (int32_t)512)) + (i13 *  (int32_t)1));
Arr2DIdxRowM(tmp73, (int32_t)50, (int32_t)512,i12,i13) = Arr1DIdxRowM(tmp76, (int32_t)25600,tmp77);
}
}
ClearMemSecret1( (int32_t)25600, tmp76);
ClearMemSecret2( (int32_t)50,  (int32_t)1, tmp12);
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp70);

int32_t tmp80 =  (int32_t)0;

uint64_t tmp81;

uint64_t* tmp82 = make_array<uint64_t>( (int32_t)512);
for (uint32_t i14 =  (int32_t)0; i14 <  (int32_t)512; i14++){
tmp81 = funcSSCons( (int64_t)0);
for (uint32_t i15 =  (int32_t)0; i15 <  (int32_t)50; i15++){
tmp81 = SecretAdd(tmp81, Arr2DIdxRowM(tmp73, (int32_t)50, (int32_t)512,i15,i14));
}
Arr1DIdxRowM(tmp82, (int32_t)512,i14) = tmp81;
}
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp73);

int32_t* tmp84 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp84, (int32_t)2, (int64_t)0) =  (int32_t)-1;
Arr1DIdxRowM(tmp84, (int32_t)2, (int64_t)1) =  (int32_t)512;
...
Arr2DIdxRowM(tmp85, (int32_t)1, (int32_t)512,i17,i18) = Arr1DIdxRowM(tmp82, (int32_t)512,i16);
i16 = (i16 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)512, tmp82);
ScaleUp2( (int32_t)1,  (int32_t)512, tmp68,  (int32_t)12);

uint64_t* tmp87 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp87, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp85, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp68, (int32_t)1, (int32_t)512,i0,i1));
}
}
...
ScaleDown2( (int32_t)1,  (int32_t)512, tmp87,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp87, tmp13, tmp90, 0);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp93, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp90, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp14, (int32_t)1, (int32_t)512,i0,i1));
}
}
...
Relu2( (int32_t)1,  (int32_t)512, tmp93, tmp96,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp93);

uint64_t* tmp98 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp96, tmp15, tmp98, 0);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp101, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp98, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp16, (int32_t)1, (int32_t)512,i0,i1));
}
}
...
Relu2( (int32_t)1,  (int32_t)512, tmp101, tmp104,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp101);
EndComputation();
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (uint32_t)0; i1 <  (int32_t)512; i1++){
cout << (funcReconstruct2PCCons(Arr2DIdxRowM(tmp104, (int32_t)1, (int32_t)512,i0,i1), 2)) << endl;
}
}
}
