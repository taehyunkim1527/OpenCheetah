...
uint64_t* tmp10 = make_array<uint64_t>( (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)128; i0++){
tmp9 = funcSSCons( (int64_t)0);
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)50; i1++){
tmp9 = SecretAdd(tmp9, Arr2DIdxRowM(tmp5, (int32_t)50, (int32_t)128,i1,i0));
}
Arr1DIdxRowM(tmp10, (int32_t)128,i0) = tmp9;
}
...
uint64_t* tmp15 = make_array<uint64_t>( (int32_t)128);

int32_t tmp16;
for (uint32_t i2 =  (int32_t)0; i2 <  (int32_t)128; i2++){
tmp16 = ( (int32_t)0 + (i2 *  (int32_t)1));
Arr1DIdxRowM(tmp13, (int32_t)128,tmp16) = Arr1DIdxRowM(tmp10, (int32_t)128,i2);
Arr1DIdxRowM(tmp14, (int32_t)128,tmp16) = Arr1DIdxRowM(tmp4, (int32_t)128,i2);
}
ElemWiseActModelVectorMult( (int32_t)128, tmp13, tmp14, tmp15);
ClearMemSecret1( (int32_t)128, tmp13);
ClearMemSecret1( (int32_t)128, tmp14);
for (uint32_t i2 =  (int32_t)0; i2 <  (int32_t)128; i2++){
tmp16 = ( (int32_t)0 + (i2 *  (int32_t)1));
Arr1DIdxRowM(tmp12, (int32_t)128,i2) = Arr1DIdxRowM(tmp15, (int32_t)128,tmp16);
}
ClearMemSecret1( (int32_t)128, tmp15);
ClearMemSecret1( (int32_t)128, tmp4);
ClearMemSecret1( (int32_t)128, tmp10);
...
tmp20 = SecretAdd(tmp20, Arr2DIdxRowM(tmp0, (int32_t)50, (int32_t)128,i4,i3));
}
Arr1DIdxRowM(tmp21, (int32_t)128,i3) = tmp20;
}
ClearMemSecret2( (int32_t)50,  (int32_t)128, tmp0);
ScaleUp1( (int32_t)128, tmp21,  (int32_t)12);

uint64_t* tmp23 = make_array<uint64_t>( (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)128; i0++){
Arr1DIdxRowM(tmp23, (int32_t)128,i0) = SecretAdd(Arr1DIdxRowM(tmp21, (int32_t)128,i0), Arr1DIdxRowM(tmp12, (int32_t)128,i0));
}
ClearMemSecret1( (int32_t)128, tmp21);
ScaleDown1( (int32_t)128, tmp23,  (int32_t)12);

uint64_t* tmp25 = make_array<uint64_t>( (int32_t)128);
...
Arr1DIdxRowM(tmp26, (int32_t)128,tmp29) = Arr1DIdxRowM(tmp23, (int32_t)128,i5);
Arr1DIdxRowM(tmp27, (int32_t)128,tmp29) = Arr1DIdxRowM(tmp7, (int32_t)1, (int32_t)0);
}
ElemWiseActModelVectorMult( (int32_t)128, tmp26, tmp27, tmp28);
ClearMemSecret1( (int32_t)128, tmp26);
ClearMemSecret1( (int32_t)128, tmp27);
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)128; i5++){
tmp29 = ( (int32_t)0 + (i5 *  (int32_t)1));
Arr1DIdxRowM(tmp25, (int32_t)128,i5) = Arr1DIdxRowM(tmp28, (int32_t)128,tmp29);
}
ClearMemSecret1( (int32_t)128, tmp28);
ClearMemSecret1( (int32_t)128, tmp23);
ScaleUp1( (int32_t)128, tmp6,  (int32_t)12);

uint64_t* tmp31 = make_array<uint64_t>( (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)128; i0++){
Arr1DIdxRowM(tmp31, (int32_t)128,i0) = SecretAdd(Arr1DIdxRowM(tmp25, (int32_t)128,i0), Arr1DIdxRowM(tmp6, (int32_t)128,i0));
}
ClearMemSecret1( (int32_t)128, tmp25);
...
tmp34 = SecretAdd(tmp34, Arr2DIdxRowM(tmp1, (int32_t)50, (int32_t)128,i7,i6));
}
Arr1DIdxRowM(tmp35, (int32_t)128,i6) = tmp34;
}
ClearMemSecret2( (int32_t)50,  (int32_t)128, tmp1);
ScaleUp1( (int32_t)128, tmp35,  (int32_t)12);

uint64_t* tmp37 = make_array<uint64_t>( (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)128; i0++){
Arr1DIdxRowM(tmp37, (int32_t)128,i0) = SecretAdd(Arr1DIdxRowM(tmp35, (int32_t)128,i0), Arr1DIdxRowM(tmp12, (int32_t)128,i0));
}
ClearMemSecret1( (int32_t)128, tmp35);
ScaleDown1( (int32_t)128, tmp37,  (int32_t)12);
...
Arr1DIdxRowM(tmp40, (int32_t)128,tmp43) = Arr1DIdxRowM(tmp37, (int32_t)128,i8);
Arr1DIdxRowM(tmp41, (int32_t)128,tmp43) = Arr1DIdxRowM(tmp7, (int32_t)1, (int32_t)0);
}
ElemWiseActModelVectorMult( (int32_t)128, tmp40, tmp41, tmp42);
ClearMemSecret1( (int32_t)128, tmp40);
ClearMemSecret1( (int32_t)128, tmp41);
for (uint32_t i8 =  (int32_t)0; i8 <  (int32_t)128; i8++){
tmp43 = ( (int32_t)0 + (i8 *  (int32_t)1));
Arr1DIdxRowM(tmp39, (int32_t)128,i8) = Arr1DIdxRowM(tmp42, (int32_t)128,tmp43);
}
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)128; i0++){
Arr1DIdxRowM(tmp45, (int32_t)128,i0) = SecretAdd(Arr1DIdxRowM(tmp39, (int32_t)128,i0), Arr1DIdxRowM(tmp6, (int32_t)128,i0));
}
...
tmp48 = SecretAdd(tmp48, Arr2DIdxRowM(tmp2, (int32_t)50, (int32_t)128,i10,i9));
}
Arr1DIdxRowM(tmp49, (int32_t)128,i9) = tmp48;
}
ClearMemSecret2( (int32_t)50,  (int32_t)128, tmp2);
ScaleUp1( (int32_t)128, tmp49,  (int32_t)12);

uint64_t* tmp51 = make_array<uint64_t>( (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)128; i0++){
Arr1DIdxRowM(tmp51, (int32_t)128,i0) = SecretAdd(Arr1DIdxRowM(tmp49, (int32_t)128,i0), Arr1DIdxRowM(tmp12, (int32_t)128,i0));
}
ClearMemSecret1( (int32_t)128, tmp49);
ScaleDown1( (int32_t)128, tmp51,  (int32_t)12);
...
Arr1DIdxRowM(tmp54, (int32_t)128,tmp57) = Arr1DIdxRowM(tmp51, (int32_t)128,i11);
Arr1DIdxRowM(tmp55, (int32_t)128,tmp57) = Arr1DIdxRowM(tmp7, (int32_t)1, (int32_t)0);
}
...
for (uint32_t i11 =  (int32_t)0; i11 <  (int32_t)128; i11++){
tmp57 = ( (int32_t)0 + (i11 *  (int32_t)1));
Arr1DIdxRowM(tmp53, (int32_t)128,i11) = Arr1DIdxRowM(tmp56, (int32_t)128,tmp57);
}
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)128; i0++){
Arr1DIdxRowM(tmp59, (int32_t)128,i0) = SecretAdd(Arr1DIdxRowM(tmp53, (int32_t)128,i0), Arr1DIdxRowM(tmp6, (int32_t)128,i0));
}
...
tmp62 = SecretAdd(tmp62, Arr2DIdxRowM(tmp3, (int32_t)50, (int32_t)128,i13,i12));
}
Arr1DIdxRowM(tmp63, (int32_t)128,i12) = tmp62;
}
ClearMemSecret2( (int32_t)50,  (int32_t)128, tmp3);
ScaleUp1( (int32_t)128, tmp63,  (int32_t)12);

uint64_t* tmp65 = make_array<uint64_t>( (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)128; i0++){
Arr1DIdxRowM(tmp65, (int32_t)128,i0) = SecretAdd(Arr1DIdxRowM(tmp63, (int32_t)128,i0), Arr1DIdxRowM(tmp12, (int32_t)128,i0));
}
ClearMemSecret1( (int32_t)128, tmp63);
ClearMemSecret1( (int32_t)128, tmp12);
ScaleDown1( (int32_t)128, tmp65,  (int32_t)12);

uint64_t* tmp68 = make_array<uint64_t>( (int32_t)128);
...
Arr1DIdxRowM(tmp69, (int32_t)128,tmp72) = Arr1DIdxRowM(tmp65, (int32_t)128,i14);
Arr1DIdxRowM(tmp70, (int32_t)128,tmp72) = Arr1DIdxRowM(tmp7, (int32_t)1, (int32_t)0);
}
ElemWiseActModelVectorMult( (int32_t)128, tmp69, tmp70, tmp71);
ClearMemSecret1( (int32_t)128, tmp69);
ClearMemSecret1( (int32_t)128, tmp70);
for (uint32_t i14 =  (int32_t)0; i14 <  (int32_t)128; i14++){
tmp72 = ( (int32_t)0 + (i14 *  (int32_t)1));
Arr1DIdxRowM(tmp68, (int32_t)128,i14) = Arr1DIdxRowM(tmp71, (int32_t)128,tmp72);
}
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)128; i0++){
Arr1DIdxRowM(tmp75, (int32_t)128,i0) = SecretAdd(Arr1DIdxRowM(tmp68, (int32_t)128,i0), Arr1DIdxRowM(tmp6, (int32_t)128,i0));
}
ClearMemSecret1( (int32_t)128, tmp6);
ClearMemSecret1( (int32_t)128, tmp68);
ScaleDown1( (int32_t)128, tmp75,  (int32_t)12);
EndComputation();
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)128; i0++){
cout << (funcReconstruct2PCCons(Arr1DIdxRowM(tmp75, (int32_t)128,i0), 2)) << endl;
}
}
