...
uint64_t* tmp4 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
...
Arr2DIdxRowM(tmp4, (int32_t)1, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp4 : 0;
}
}

uint64_t* tmp5 = make_array<uint64_t>( (int32_t)5,  (int32_t)512);
...
Arr2DIdxRowM(tmp5, (int32_t)5, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp5 : 0;
}
}

uint64_t* tmp6 = make_array<uint64_t>( (int32_t)512,  (int32_t)512);
...
Arr2DIdxRowM(tmp6, (int32_t)512, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp6 : 0;
}
}

uint64_t* tmp7 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
/* Variable to read the clear value corresponding to the input variable tmp7 at (9048,1-9048,38) */
...
Arr2DIdxRowM(tmp7, (int32_t)1, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp7 : 0;
}
}

uint64_t* tmp8 = make_array<uint64_t>( (int32_t)512,  (int32_t)512);
/* Variable to read the clear value corresponding to the input variable tmp8 at (9051,1-9051,40) */
...
Arr2DIdxRowM(tmp8, (int32_t)512, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp8 : 0;
}
}

uint64_t* tmp9 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
...
Arr2DIdxRowM(tmp9, (int32_t)1, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp9 : 0;
}
}
...
uint64_t* tmp14 = make_array<uint64_t>( (int32_t)512,  (int32_t)512);
...
Arr2DIdxRowM(tmp14, (int32_t)512, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp14 : 0;
}
}

uint64_t* tmp15 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
/* Variable to read the clear value corresponding to the input variable tmp15 at (9072,1-9072,39) */
...
Arr2DIdxRowM(tmp15, (int32_t)1, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp15 : 0;
}
}

uint64_t* tmp16 = make_array<uint64_t>( (int32_t)512,  (int32_t)512);
/* Variable to read the clear value corresponding to the input variable tmp16 at (9075,1-9075,41) */
...
Arr2DIdxRowM(tmp16, (int32_t)512, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp16 : 0;
}
}

uint64_t* tmp17 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
/* Variable to read the clear value corresponding to the input variable tmp17 at (9078,1-9078,39) */
...
Arr2DIdxRowM(tmp17, (int32_t)1, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp17 : 0;
}
}

uint64_t* tmp18 = make_array<uint64_t>( (int32_t)512,  (int32_t)512);
/* Variable to read the clear value corresponding to the input variable tmp18 at (9081,1-9081,41) */
...
Arr2DIdxRowM(tmp18, (int32_t)512, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp18 : 0;
}
}

uint64_t* tmp19 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
...
Arr2DIdxRowM(tmp19, (int32_t)1, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp19 : 0;
}
}
...
uint64_t* tmp24 = make_array<uint64_t>( (int32_t)512,  (int32_t)512);
...
Arr2DIdxRowM(tmp24, (int32_t)512, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp24 : 0;
}
}

uint64_t* tmp25 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
/* Variable to read the clear value corresponding to the input variable tmp25 at (9102,1-9102,39) */
...
Arr2DIdxRowM(tmp25, (int32_t)1, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp25 : 0;
}
}
StartComputation();

uint64_t* tmp26 = make_array<uint64_t>( (int32_t)5,  (int32_t)512);

uint64_t* tmp27 = make_array<uint64_t>( (int32_t)2560);

uint64_t* tmp28 = make_array<uint64_t>( (int32_t)2560);

uint64_t* tmp29 = make_array<uint64_t>( (int32_t)2560);

int32_t tmp30;
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)5; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
tmp30 = (( (int32_t)0 + (i0 *  (int32_t)512)) + (i1 *  (int32_t)1));
Arr1DIdxRowM(tmp27, (int32_t)2560,tmp30) = Arr2DIdxRowM(tmp5, (int32_t)5, (int32_t)512,i0,i1);
Arr1DIdxRowM(tmp28, (int32_t)2560,tmp30) = Arr2DIdxRowM(tmp4, (int32_t)1, (int32_t)512, (int32_t)0,i1);
}
}
ElemWiseActModelVectorMult( (int32_t)2560, tmp27, tmp28, tmp29);
ClearMemSecret1( (int32_t)2560, tmp27);
ClearMemSecret1( (int32_t)2560, tmp28);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)5; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
tmp30 = (( (int32_t)0 + (i0 *  (int32_t)512)) + (i1 *  (int32_t)1));
Arr2DIdxRowM(tmp26, (int32_t)5, (int32_t)512,i0,i1) = Arr1DIdxRowM(tmp29, (int32_t)2560,tmp30);
}
}
ClearMemSecret1( (int32_t)2560, tmp29);
ClearMemSecret2( (int32_t)5,  (int32_t)512, tmp5);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp4);

int32_t* tmp33 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp33, (int32_t)2, (int64_t)0) =  (int32_t)-1;
Arr1DIdxRowM(tmp33, (int32_t)2, (int64_t)1) =  (int32_t)512;

uint64_t* tmp34 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
...
Arr2DIdxRowM(tmp34, (int32_t)1, (int32_t)512,i3,i4) = Arr1DIdxRowM(tmp0, (int32_t)512,i2);
i2 = (i2 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)512, tmp0);

uint64_t* tmp36 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp34, tmp6, tmp36, 0);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp34);
ClearMemSecret2( (int32_t)512,  (int32_t)512, tmp6);
ScaleUp2( (int32_t)1,  (int32_t)512, tmp7,  (int32_t)12);

uint64_t* tmp39 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp39, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp36, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp7, (int32_t)1, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp7);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp36);

uint64_t* tmp42 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
Relu2( (int32_t)1,  (int32_t)512, tmp39, tmp42,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp39);
ScaleUp2( (int32_t)5,  (int32_t)512, tmp1,  (int32_t)12);

uint64_t* tmp44 = make_array<uint64_t>( (int32_t)5,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)5; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp44, (int32_t)5, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp1, (int32_t)5, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp26, (int32_t)5, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)5,  (int32_t)512, tmp1);

uint64_t* tmp46 = make_array<uint64_t>( (int32_t)5,  (int32_t)512);
ScaleDown2( (int32_t)5,  (int32_t)512, tmp44,  (int32_t)12);
MatMul2D( (int32_t)5,  (int32_t)512,  (int32_t)512, tmp44, tmp8, tmp46, 0);
ClearMemSecret2( (int32_t)512,  (int32_t)512, tmp8);
ClearMemSecret2( (int32_t)5,  (int32_t)512, tmp44);
ScaleUp2( (int32_t)1,  (int32_t)512, tmp9,  (int32_t)12);

uint64_t* tmp49 = make_array<uint64_t>( (int32_t)5,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)5; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp49, (int32_t)5, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp46, (int32_t)5, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp9, (int32_t)1, (int32_t)512, (int32_t)0,i1));
}
}
ClearMemSecret2( (int32_t)5,  (int32_t)512, tmp46);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp9);

uint64_t* tmp52 = make_array<uint64_t>( (int32_t)5,  (int32_t)512);
Relu2( (int32_t)5,  (int32_t)512, tmp49, tmp52,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)5,  (int32_t)512, tmp49);

int32_t* tmp54 = make_array<int32_t>( (int32_t)4);
Arr1DIdxRowM(tmp54, (int32_t)4, (int64_t)0) =  (int32_t)512;
Arr1DIdxRowM(tmp54, (int32_t)4, (int64_t)1) =  (int32_t)1;
Arr1DIdxRowM(tmp54, (int32_t)4, (int64_t)2) =  (int32_t)5;
Arr1DIdxRowM(tmp54, (int32_t)4, (int64_t)3) =  (int32_t)1;

uint64_t* tmp55 = make_array<uint64_t>( (int32_t)512,  (int32_t)1,  (int32_t)5,  (int32_t)1);
...
Arr4DIdxRowM(tmp55, (int32_t)512, (int32_t)1, (int32_t)5, (int32_t)1,i7,i8,i9,i10) = Arr2DIdxRowM(tmp52, (int32_t)5, (int32_t)512,i5,i6);
i6 = (i6 +  (int64_t)1);
if ((i6 ==  (int64_t)512)) {
i6 =  (int64_t)0;
i5 = (i5 +  (int64_t)1);
...
ClearMemSecret2( (int32_t)5,  (int32_t)512, tmp52);

uint64_t* tmp57 = make_array<uint64_t>( (int32_t)512,  (int32_t)1,  (int32_t)1,  (int32_t)1);
MaxPool( (int32_t)512,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)5,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1,  (int32_t)512,  (int32_t)1,  (int32_t)5,  (int32_t)1, tmp55, tmp57);
ClearMemSecret4( (int32_t)512,  (int32_t)1,  (int32_t)5,  (int32_t)1, tmp55);

int32_t* tmp59 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp59, (int32_t)2, (int64_t)0) =  (int32_t)-1;
Arr1DIdxRowM(tmp59, (int32_t)2, (int64_t)1) =  (int32_t)512;

uint64_t* tmp60 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
...
Arr2DIdxRowM(tmp60, (int32_t)1, (int32_t)512,i15,i16) = Arr4DIdxRowM(tmp57, (int32_t)512, (int32_t)1, (int32_t)1, (int32_t)1,i11,i12,i13,i14);
i14 = (i14 +  (int64_t)1);
if ((i14 ==  (int64_t)1)) {
i14 =  (int64_t)0;
i13 = (i13 +  (int64_t)1);
...
ClearMemSecret4( (int32_t)512,  (int32_t)1,  (int32_t)1,  (int32_t)1, tmp57);

uint64_t* tmp62 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp62, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp60, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp42, (int32_t)1, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp60);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp42);

uint64_t* tmp65 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp62, tmp10, tmp65, 0);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp62);
ClearMemSecret2( (int32_t)512,  (int32_t)512, tmp10);
ScaleUp2( (int32_t)1,  (int32_t)512, tmp11,  (int32_t)12);

uint64_t* tmp68 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp68, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp65, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp11, (int32_t)1, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp65);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp11);

uint64_t* tmp71 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
Relu2( (int32_t)1,  (int32_t)512, tmp68, tmp71,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp68);

uint64_t* tmp73 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp71, tmp12, tmp73, 0);
ClearMemSecret2( (int32_t)512,  (int32_t)512, tmp12);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp71);
ScaleUp2( (int32_t)1,  (int32_t)512, tmp13,  (int32_t)12);

uint64_t* tmp76 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp76, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp73, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp13, (int32_t)1, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp73);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp13);

uint64_t* tmp79 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
Relu2( (int32_t)1,  (int32_t)512, tmp76, tmp79,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp76);
ScaleUp2( (int32_t)5,  (int32_t)512, tmp2,  (int32_t)12);

uint64_t* tmp81 = make_array<uint64_t>( (int32_t)5,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)5; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp81, (int32_t)5, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp2, (int32_t)5, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp26, (int32_t)5, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)5,  (int32_t)512, tmp2);

uint64_t* tmp83 = make_array<uint64_t>( (int32_t)5,  (int32_t)512);
ScaleDown2( (int32_t)5,  (int32_t)512, tmp81,  (int32_t)12);
MatMul2D( (int32_t)5,  (int32_t)512,  (int32_t)512, tmp81, tmp14, tmp83, 0);
ClearMemSecret2( (int32_t)5,  (int32_t)512, tmp81);
ClearMemSecret2( (int32_t)512,  (int32_t)512, tmp14);
ScaleUp2( (int32_t)1,  (int32_t)512, tmp15,  (int32_t)12);

uint64_t* tmp86 = make_array<uint64_t>( (int32_t)5,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)5; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp86, (int32_t)5, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp83, (int32_t)5, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp15, (int32_t)1, (int32_t)512, (int32_t)0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp15);
ClearMemSecret2( (int32_t)5,  (int32_t)512, tmp83);

uint64_t* tmp89 = make_array<uint64_t>( (int32_t)5,  (int32_t)512);
Relu2( (int32_t)5,  (int32_t)512, tmp86, tmp89,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)5,  (int32_t)512, tmp86);

int32_t* tmp91 = make_array<int32_t>( (int32_t)4);
Arr1DIdxRowM(tmp91, (int32_t)4, (int64_t)0) =  (int32_t)512;
Arr1DIdxRowM(tmp91, (int32_t)4, (int64_t)1) =  (int32_t)1;
Arr1DIdxRowM(tmp91, (int32_t)4, (int64_t)2) =  (int32_t)5;
Arr1DIdxRowM(tmp91, (int32_t)4, (int64_t)3) =  (int32_t)1;

uint64_t* tmp92 = make_array<uint64_t>( (int32_t)512,  (int32_t)1,  (int32_t)5,  (int32_t)1);
...
Arr4DIdxRowM(tmp92, (int32_t)512, (int32_t)1, (int32_t)5, (int32_t)1,i19,i20,i21,i22) = Arr2DIdxRowM(tmp89, (int32_t)5, (int32_t)512,i17,i18);
i18 = (i18 +  (int64_t)1);
if ((i18 ==  (int64_t)512)) {
i18 =  (int64_t)0;
i17 = (i17 +  (int64_t)1);
...
ClearMemSecret2( (int32_t)5,  (int32_t)512, tmp89);

uint64_t* tmp94 = make_array<uint64_t>( (int32_t)512,  (int32_t)1,  (int32_t)1,  (int32_t)1);
MaxPool( (int32_t)512,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)5,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1,  (int32_t)512,  (int32_t)1,  (int32_t)5,  (int32_t)1, tmp92, tmp94);
ClearMemSecret4( (int32_t)512,  (int32_t)1,  (int32_t)5,  (int32_t)1, tmp92);

int32_t* tmp96 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp96, (int32_t)2, (int64_t)0) =  (int32_t)-1;
Arr1DIdxRowM(tmp96, (int32_t)2, (int64_t)1) =  (int32_t)512;

uint64_t* tmp97 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
...
Arr2DIdxRowM(tmp97, (int32_t)1, (int32_t)512,i27,i28) = Arr4DIdxRowM(tmp94, (int32_t)512, (int32_t)1, (int32_t)1, (int32_t)1,i23,i24,i25,i26);
i26 = (i26 +  (int64_t)1);
if ((i26 ==  (int64_t)1)) {
i26 =  (int64_t)0;
i25 = (i25 +  (int64_t)1);
...
ClearMemSecret4( (int32_t)512,  (int32_t)1,  (int32_t)1,  (int32_t)1, tmp94);

uint64_t* tmp99 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp99, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp97, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp79, (int32_t)1, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp79);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp97);

uint64_t* tmp102 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp99, tmp16, tmp102, 0);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp99);
ClearMemSecret2( (int32_t)512,  (int32_t)512, tmp16);
ScaleUp2( (int32_t)1,  (int32_t)512, tmp17,  (int32_t)12);

uint64_t* tmp105 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp105, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp102, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp17, (int32_t)1, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp17);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp102);

uint64_t* tmp108 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
Relu2( (int32_t)1,  (int32_t)512, tmp105, tmp108,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp105);

uint64_t* tmp110 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp108, tmp18, tmp110, 0);
ClearMemSecret2( (int32_t)512,  (int32_t)512, tmp18);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp108);
ScaleUp2( (int32_t)1,  (int32_t)512, tmp19,  (int32_t)12);

uint64_t* tmp113 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp113, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp110, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp19, (int32_t)1, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp19);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp110);

uint64_t* tmp116 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
Relu2( (int32_t)1,  (int32_t)512, tmp113, tmp116,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp113);
ScaleUp2( (int32_t)5,  (int32_t)512, tmp3,  (int32_t)12);

uint64_t* tmp118 = make_array<uint64_t>( (int32_t)5,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)5; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp118, (int32_t)5, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp3, (int32_t)5, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp26, (int32_t)5, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)5,  (int32_t)512, tmp3);
ClearMemSecret2( (int32_t)5,  (int32_t)512, tmp26);

uint64_t* tmp121 = make_array<uint64_t>( (int32_t)5,  (int32_t)512);
ScaleDown2( (int32_t)5,  (int32_t)512, tmp118,  (int32_t)12);
MatMul2D( (int32_t)5,  (int32_t)512,  (int32_t)512, tmp118, tmp20, tmp121, 0);
ClearMemSecret2( (int32_t)5,  (int32_t)512, tmp118);
ClearMemSecret2( (int32_t)512,  (int32_t)512, tmp20);
ScaleUp2( (int32_t)1,  (int32_t)512, tmp21,  (int32_t)12);

uint64_t* tmp124 = make_array<uint64_t>( (int32_t)5,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)5; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp124, (int32_t)5, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp121, (int32_t)5, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp21, (int32_t)1, (int32_t)512, (int32_t)0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp21);
ClearMemSecret2( (int32_t)5,  (int32_t)512, tmp121);

uint64_t* tmp127 = make_array<uint64_t>( (int32_t)5,  (int32_t)512);
Relu2( (int32_t)5,  (int32_t)512, tmp124, tmp127,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)5,  (int32_t)512, tmp124);

int32_t* tmp129 = make_array<int32_t>( (int32_t)4);
Arr1DIdxRowM(tmp129, (int32_t)4, (int64_t)0) =  (int32_t)512;
Arr1DIdxRowM(tmp129, (int32_t)4, (int64_t)1) =  (int32_t)1;
Arr1DIdxRowM(tmp129, (int32_t)4, (int64_t)2) =  (int32_t)5;
Arr1DIdxRowM(tmp129, (int32_t)4, (int64_t)3) =  (int32_t)1;

uint64_t* tmp130 = make_array<uint64_t>( (int32_t)512,  (int32_t)1,  (int32_t)5,  (int32_t)1);
...
Arr4DIdxRowM(tmp130, (int32_t)512, (int32_t)1, (int32_t)5, (int32_t)1,i31,i32,i33,i34) = Arr2DIdxRowM(tmp127, (int32_t)5, (int32_t)512,i29,i30);
i30 = (i30 +  (int64_t)1);
if ((i30 ==  (int64_t)512)) {
i30 =  (int64_t)0;
i29 = (i29 +  (int64_t)1);
...
uint64_t* tmp132 = make_array<uint64_t>( (int32_t)512,  (int32_t)1,  (int32_t)1,  (int32_t)1);
MaxPool( (int32_t)512,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)5,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1,  (int32_t)512,  (int32_t)1,  (int32_t)5,  (int32_t)1, tmp130, tmp132);
ClearMemSecret4( (int32_t)512,  (int32_t)1,  (int32_t)5,  (int32_t)1, tmp130);

int32_t* tmp134 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp134, (int32_t)2, (int64_t)0) =  (int32_t)-1;
Arr1DIdxRowM(tmp134, (int32_t)2, (int64_t)1) =  (int32_t)512;

uint64_t* tmp135 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
...
Arr2DIdxRowM(tmp135, (int32_t)1, (int32_t)512,i39,i40) = Arr4DIdxRowM(tmp132, (int32_t)512, (int32_t)1, (int32_t)1, (int32_t)1,i35,i36,i37,i38);
i38 = (i38 +  (int64_t)1);
if ((i38 ==  (int64_t)1)) {
i38 =  (int64_t)0;
i37 = (i37 +  (int64_t)1);
...
ClearMemSecret4( (int32_t)512,  (int32_t)1,  (int32_t)1,  (int32_t)1, tmp132);

uint64_t* tmp137 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp137, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp135, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp116, (int32_t)1, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp116);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp135);

uint64_t* tmp140 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp137, tmp22, tmp140, 0);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp137);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp143, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp140, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp23, (int32_t)1, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp140);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp23);

uint64_t* tmp146 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
Relu2( (int32_t)1,  (int32_t)512, tmp143, tmp146,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp143);

uint64_t* tmp148 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp146, tmp24, tmp148, 0);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp146);
ClearMemSecret2( (int32_t)512,  (int32_t)512, tmp24);
ScaleUp2( (int32_t)1,  (int32_t)512, tmp25,  (int32_t)12);

uint64_t* tmp151 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp151, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp148, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp25, (int32_t)1, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp25);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp148);

uint64_t* tmp154 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
Relu2( (int32_t)1,  (int32_t)512, tmp151, tmp154,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp151);
EndComputation();
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (uint32_t)0; i1 <  (int32_t)512; i1++){
cout << (funcReconstruct2PCCons(Arr2DIdxRowM(tmp154, (int32_t)1, (int32_t)512,i0,i1), 2)) << endl;
}
}
}
