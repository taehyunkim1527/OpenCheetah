...
tmp4 = SecretAdd(tmp4, Arr2DIdxRowM(tmp0, (int32_t)3, (int32_t)128,i1,i0));
}
...
tmp8 = SecretAdd(tmp8, Arr2DIdxRowM(tmp1, (int32_t)3, (int32_t)128,i3,i2));
}
...
tmp12 = SecretAdd(tmp12, Arr2DIdxRowM(tmp2, (int32_t)3, (int32_t)128,i5,i4));
}
