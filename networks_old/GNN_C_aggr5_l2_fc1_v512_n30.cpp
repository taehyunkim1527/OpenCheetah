...
Arr1DIdxRowM(tmp18, (int32_t)15360,tmp20) = Arr2DIdxRowM(tmp5, (int32_t)30, (int32_t)512,i2,i3);
}
}
...
Arr1DIdxRowM(tmp34, (int32_t)15360,tmp36) = Arr2DIdxRowM(tmp6, (int32_t)30, (int32_t)512,i6,i7);
}
}
