...
Arr1DIdxRowM(tmp12, (int32_t)25600,tmp15) = Arr2DIdxRowM(tmp3, (int32_t)50, (int32_t)512,i0,i1);
Arr1DIdxRowM(tmp13, (int32_t)25600,tmp15) = Arr2DIdxRowM(tmp2, (int32_t)1, (int32_t)512, (int32_t)0,i1);
}
}
...
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp19, tmp4, tmp21, 0);
...
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp24, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp21, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp5, (int32_t)1, (int32_t)512,i0,i1));
}
}
...
ScaleDown2( (int32_t)50,  (int32_t)512, tmp29,  (int32_t)12);

uint64_t* tmp32 = make_array<uint64_t>( (int32_t)50,  (int32_t)512);

uint64_t* tmp33 = make_array<uint64_t>( (int32_t)25600);
...
tmp36 = (( (int32_t)0 + (i5 *  (int32_t)512)) + (i6 *  (int32_t)1));
Arr1DIdxRowM(tmp33, (int32_t)25600,tmp36) = Arr2DIdxRowM(tmp29, (int32_t)50, (int32_t)512,i5,i6);
Arr1DIdxRowM(tmp34, (int32_t)25600,tmp36) = Arr2DIdxRowM(tmp6, (int32_t)50, (int32_t)512,i5,i6);
}
}
ElemWiseActModelVectorMult( (int32_t)25600, tmp33, tmp34, tmp35);
ClearMemSecret1( (int32_t)25600, tmp33);
ClearMemSecret1( (int32_t)25600, tmp34);
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)50; i5++){
for (uint32_t i6 =  (int32_t)0; i6 <  (int32_t)512; i6++){
tmp36 = (( (int32_t)0 + (i5 *  (int32_t)512)) + (i6 *  (int32_t)1));
Arr2DIdxRowM(tmp32, (int32_t)50, (int32_t)512,i5,i6) = Arr1DIdxRowM(tmp35, (int32_t)25600,tmp36);
}
}
...
int32_t tmp39 =  (int32_t)0;

uint64_t tmp40;

uint64_t* tmp41 = make_array<uint64_t>( (int32_t)512);
for (uint32_t i7 =  (int32_t)0; i7 <  (int32_t)512; i7++){
tmp40 = funcSSCons( (int64_t)0);
for (uint32_t i8 =  (int32_t)0; i8 <  (int32_t)50; i8++){
tmp40 = SecretAdd(tmp40, Arr2DIdxRowM(tmp32, (int32_t)50, (int32_t)512,i8,i7));
}
Arr1DIdxRowM(tmp41, (int32_t)512,i7) = tmp40;
}
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp32);

int32_t* tmp43 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp43, (int32_t)2, (int64_t)0) =  (int32_t)-1;
Arr1DIdxRowM(tmp43, (int32_t)2, (int64_t)1) =  (int32_t)512;
...
Arr2DIdxRowM(tmp44, (int32_t)1, (int32_t)512,i10,i11) = Arr1DIdxRowM(tmp41, (int32_t)512,i9);
i9 = (i9 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)512, tmp41);
ScaleUp2( (int32_t)1,  (int32_t)512, tmp27,  (int32_t)12);

uint64_t* tmp46 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp46, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp44, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp27, (int32_t)1, (int32_t)512,i0,i1));
}
}
...
ScaleDown2( (int32_t)1,  (int32_t)512, tmp46,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp46, tmp7, tmp49, 0);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp52, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp49, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp8, (int32_t)1, (int32_t)512,i0,i1));
}
}
...
Relu2( (int32_t)1,  (int32_t)512, tmp52, tmp55,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp52);

uint64_t* tmp57 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp55, tmp9, tmp57, 0);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp60, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp57, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp10, (int32_t)1, (int32_t)512,i0,i1));
}
}
...
Relu2( (int32_t)1,  (int32_t)512, tmp60, tmp63,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp60);
EndComputation();
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (uint32_t)0; i1 <  (int32_t)512; i1++){
cout << (funcReconstruct2PCCons(Arr2DIdxRowM(tmp63, (int32_t)1, (int32_t)512,i0,i1), 2)) << endl;
}
}
}
