...
uint64_t* tmp4 = make_array<uint64_t>( (int32_t)512,  (int32_t)512);
...
Arr2DIdxRowM(tmp4, (int32_t)512, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp4 : 0;
}
}
...
tmp16 = (( (int32_t)0 + (i0 *  (int32_t)512)) + (i1 *  (int32_t)1));
Arr1DIdxRowM(tmp13, (int32_t)2560,tmp16) = Arr2DIdxRowM(tmp3, (int32_t)5, (int32_t)512,i0,i1);
Arr1DIdxRowM(tmp14, (int32_t)2560,tmp16) = Arr2DIdxRowM(tmp2, (int32_t)1, (int32_t)512, (int32_t)0,i1);
}
}
ElemWiseActModelVectorMult( (int32_t)2560, tmp13, tmp14, tmp15);
ClearMemSecret1( (int32_t)2560, tmp13);
ClearMemSecret1( (int32_t)2560, tmp14);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)5; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
tmp16 = (( (int32_t)0 + (i0 *  (int32_t)512)) + (i1 *  (int32_t)1));
Arr2DIdxRowM(tmp12, (int32_t)5, (int32_t)512,i0,i1) = Arr1DIdxRowM(tmp15, (int32_t)2560,tmp16);
}
}
...
int32_t* tmp19 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp19, (int32_t)2, (int64_t)0) =  (int32_t)-1;
Arr1DIdxRowM(tmp19, (int32_t)2, (int64_t)1) =  (int32_t)512;
...
Arr2DIdxRowM(tmp20, (int32_t)1, (int32_t)512,i3,i4) = Arr1DIdxRowM(tmp0, (int32_t)512,i2);
i2 = (i2 +  (int64_t)1);
}
}
...
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp20, tmp4, tmp22, 0);
ClearMemSecret2( (int32_t)512,  (int32_t)512, tmp4);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp20);
ScaleUp2( (int32_t)1,  (int32_t)512, tmp5,  (int32_t)12);

uint64_t* tmp25 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp25, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp22, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp5, (int32_t)1, (int32_t)512,i0,i1));
}
}
...
Relu2( (int32_t)1,  (int32_t)512, tmp25, tmp28,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp25);
ScaleUp2( (int32_t)5,  (int32_t)512, tmp1,  (int32_t)12);

uint64_t* tmp30 = make_array<uint64_t>( (int32_t)5,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)5; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp30, (int32_t)5, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp1, (int32_t)5, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp12, (int32_t)5, (int32_t)512,i0,i1));
}
}
...
ScaleDown2( (int32_t)5,  (int32_t)512, tmp30,  (int32_t)12);
MatMul2D( (int32_t)5,  (int32_t)512,  (int32_t)512, tmp30, tmp6, tmp33, 0);
ClearMemSecret2( (int32_t)5,  (int32_t)512, tmp30);
ClearMemSecret2( (int32_t)512,  (int32_t)512, tmp6);
ScaleUp2( (int32_t)1,  (int32_t)512, tmp7,  (int32_t)12);

uint64_t* tmp36 = make_array<uint64_t>( (int32_t)5,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)5; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp36, (int32_t)5, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp33, (int32_t)5, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp7, (int32_t)1, (int32_t)512, (int32_t)0,i1));
}
}
...
Relu2( (int32_t)5,  (int32_t)512, tmp36, tmp39,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)5,  (int32_t)512, tmp36);

int32_t* tmp41 = make_array<int32_t>( (int32_t)4);
Arr1DIdxRowM(tmp41, (int32_t)4, (int64_t)0) =  (int32_t)512;
Arr1DIdxRowM(tmp41, (int32_t)4, (int64_t)1) =  (int32_t)1;
Arr1DIdxRowM(tmp41, (int32_t)4, (int64_t)2) =  (int32_t)5;
Arr1DIdxRowM(tmp41, (int32_t)4, (int64_t)3) =  (int32_t)1;

uint64_t* tmp42 = make_array<uint64_t>( (int32_t)512,  (int32_t)1,  (int32_t)5,  (int32_t)1);
...
Arr4DIdxRowM(tmp42, (int32_t)512, (int32_t)1, (int32_t)5, (int32_t)1,i7,i8,i9,i10) = Arr2DIdxRowM(tmp39, (int32_t)5, (int32_t)512,i5,i6);
i6 = (i6 +  (int64_t)1);
if ((i6 ==  (int64_t)512)) {
i6 =  (int64_t)0;
i5 = (i5 +  (int64_t)1);
...
uint64_t* tmp44 = make_array<uint64_t>( (int32_t)512,  (int32_t)1,  (int32_t)1,  (int32_t)1);
MaxPool( (int32_t)512,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)5,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1,  (int32_t)512,  (int32_t)1,  (int32_t)5,  (int32_t)1, tmp42, tmp44);
ClearMemSecret4( (int32_t)512,  (int32_t)1,  (int32_t)5,  (int32_t)1, tmp42);

int32_t* tmp46 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp46, (int32_t)2, (int64_t)0) =  (int32_t)-1;
Arr1DIdxRowM(tmp46, (int32_t)2, (int64_t)1) =  (int32_t)512;
...
Arr2DIdxRowM(tmp47, (int32_t)1, (int32_t)512,i15,i16) = Arr4DIdxRowM(tmp44, (int32_t)512, (int32_t)1, (int32_t)1, (int32_t)1,i11,i12,i13,i14);
i14 = (i14 +  (int64_t)1);
if ((i14 ==  (int64_t)1)) {
i14 =  (int64_t)0;
i13 = (i13 +  (int64_t)1);
...
ClearMemSecret4( (int32_t)512,  (int32_t)1,  (int32_t)1,  (int32_t)1, tmp44);

uint64_t* tmp49 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp49, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp47, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp28, (int32_t)1, (int32_t)512,i0,i1));
}
}
...
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp49, tmp8, tmp52, 0);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp55, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp52, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp9, (int32_t)1, (int32_t)512,i0,i1));
}
}
...
Relu2( (int32_t)1,  (int32_t)512, tmp55, tmp58,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp55);

uint64_t* tmp60 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp58, tmp10, tmp60, 0);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp63, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp60, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp11, (int32_t)1, (int32_t)512,i0,i1));
}
}
...
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (uint32_t)0; i1 <  (int32_t)512; i1++){
cout << (funcReconstruct2PCCons(Arr2DIdxRowM(tmp66, (int32_t)1, (int32_t)512,i0,i1), 2)) << endl;
}
}
}
