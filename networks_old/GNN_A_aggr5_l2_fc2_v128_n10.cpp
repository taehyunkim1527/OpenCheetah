...
uint64_t* tmp7 = make_array<uint64_t>( (int32_t)10,  (int32_t)128);
...
Arr2DIdxRowM(tmp7, (int32_t)10, (int32_t)128,i0,i1) = (party == SERVER) ? __tmp_in_tmp7 : 0;
}
}
...
Arr1DIdxRowM(tmp39, (int32_t)1280,tmp41) = Arr2DIdxRowM(tmp7, (int32_t)10, (int32_t)128,i5,i6);
}
}
...
ClearMemSecret2( (int32_t)10,  (int32_t)128, tmp7);
...
Arr1DIdxRowM(tmp75, (int32_t)1280,tmp77) = Arr2DIdxRowM(tmp12, (int32_t)10, (int32_t)128,i12,i13);
}
}
