...
Arr1DIdxRowM(tmp13, (int32_t)25600,tmp16) = Arr2DIdxRowM(tmp3, (int32_t)100, (int32_t)256,i0,i1);
Arr1DIdxRowM(tmp14, (int32_t)25600,tmp16) = Arr2DIdxRowM(tmp2, (int32_t)1, (int32_t)256, (int32_t)0,i1);
}
}
...
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
tmp16 = (( (int32_t)0 + (i0 *  (int32_t)256)) + (i1 *  (int32_t)1));
Arr2DIdxRowM(tmp12, (int32_t)100, (int32_t)256,i0,i1) = Arr1DIdxRowM(tmp15, (int32_t)25600,tmp16);
}
}
...
uint64_t* tmp30 = make_array<uint64_t>( (int32_t)100,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)100; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp30, (int32_t)100, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp1, (int32_t)100, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp12, (int32_t)100, (int32_t)256,i0,i1));
}
}
...
ScaleDown2( (int32_t)100,  (int32_t)256, tmp30,  (int32_t)12);
MatMul2D( (int32_t)100,  (int32_t)256,  (int32_t)256, tmp30, tmp6, tmp33, 0);
ClearMemSecret2( (int32_t)100,  (int32_t)256, tmp30);
ClearMemSecret2( (int32_t)256,  (int32_t)256, tmp6);
ScaleUp2( (int32_t)1,  (int32_t)256, tmp7,  (int32_t)12);

uint64_t* tmp36 = make_array<uint64_t>( (int32_t)100,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)100; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp36, (int32_t)100, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp33, (int32_t)100, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp7, (int32_t)1, (int32_t)256, (int32_t)0,i1));
}
}
...
Relu2( (int32_t)100,  (int32_t)256, tmp36, tmp39,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)100,  (int32_t)256, tmp36);
...
uint64_t* tmp42 = make_array<uint64_t>( (int32_t)256,  (int32_t)1,  (int32_t)100,  (int32_t)1);
...
Arr4DIdxRowM(tmp42, (int32_t)256, (int32_t)1, (int32_t)100, (int32_t)1,i7,i8,i9,i10) = Arr2DIdxRowM(tmp39, (int32_t)100, (int32_t)256,i5,i6);
i6 = (i6 +  (int64_t)1);
if ((i6 ==  (int64_t)256)) {
i6 =  (int64_t)0;
i5 = (i5 +  (int64_t)1);
...
MaxPool( (int32_t)256,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)100,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1,  (int32_t)256,  (int32_t)1,  (int32_t)100,  (int32_t)1, tmp42, tmp44);
ClearMemSecret4( (int32_t)256,  (int32_t)1,  (int32_t)100,  (int32_t)1, tmp42);
