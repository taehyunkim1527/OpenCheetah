...
tmp41 = SecretAdd(tmp41, Arr2DIdxRowM(tmp38, (int32_t)30, (int32_t)256,i6,i5));
}
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)30; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp66, (int32_t)30, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp2, (int32_t)30, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp20, (int32_t)30, (int32_t)256,i0,i1));
}
}
...
tmp69 = SecretAdd(tmp69, Arr2DIdxRowM(tmp66, (int32_t)30, (int32_t)256,i11,i10));
}
...
uint64_t* tmp94 = make_array<uint64_t>( (int32_t)30,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)30; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp94, (int32_t)30, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp3, (int32_t)30, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp20, (int32_t)30, (int32_t)256,i0,i1));
}
}
...
tmp98 = SecretAdd(tmp98, Arr2DIdxRowM(tmp94, (int32_t)30, (int32_t)256,i16,i15));
}
Arr1DIdxRowM(tmp99, (int32_t)256,i15) = tmp98;
}
ClearMemSecret2( (int32_t)30,  (int32_t)256, tmp94);
