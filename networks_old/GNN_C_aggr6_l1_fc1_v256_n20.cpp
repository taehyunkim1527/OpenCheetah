...
Arr1DIdxRowM(tmp7, (int32_t)5120,tmp10) = Arr2DIdxRowM(tmp2, (int32_t)20, (int32_t)256,i0,i1);
Arr1DIdxRowM(tmp8, (int32_t)5120,tmp10) = Arr2DIdxRowM(tmp1, (int32_t)1, (int32_t)256, (int32_t)0,i1);
}
}
...
ScaleDown2( (int32_t)20,  (int32_t)256, tmp13,  (int32_t)12);

uint64_t* tmp24 = make_array<uint64_t>( (int32_t)20,  (int32_t)256);
...
tmp28 = (( (int32_t)0 + (i4 *  (int32_t)256)) + (i5 *  (int32_t)1));
Arr1DIdxRowM(tmp25, (int32_t)5120,tmp28) = Arr2DIdxRowM(tmp13, (int32_t)20, (int32_t)256,i4,i5);
Arr1DIdxRowM(tmp26, (int32_t)5120,tmp28) = Arr2DIdxRowM(tmp19, (int32_t)20, (int32_t)1,i4, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)5120, tmp25, tmp26, tmp27);
ClearMemSecret1( (int32_t)5120, tmp25);
ClearMemSecret1( (int32_t)5120, tmp26);
for (uint32_t i4 =  (int32_t)0; i4 <  (int32_t)20; i4++){
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)256; i5++){
tmp28 = (( (int32_t)0 + (i4 *  (int32_t)256)) + (i5 *  (int32_t)1));
Arr2DIdxRowM(tmp24, (int32_t)20, (int32_t)256,i4,i5) = Arr1DIdxRowM(tmp27, (int32_t)5120,tmp28);
}
}
...
tmp32 = SecretAdd(tmp32, Arr2DIdxRowM(tmp24, (int32_t)20, (int32_t)256,i7,i6));
}
Arr1DIdxRowM(tmp33, (int32_t)256,i6) = tmp32;
}
ClearMemSecret2( (int32_t)20,  (int32_t)256, tmp24);
ScaleUp1( (int32_t)256, tmp3,  (int32_t)12);

uint64_t* tmp35 = make_array<uint64_t>( (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)256; i0++){
Arr1DIdxRowM(tmp35, (int32_t)256,i0) = SecretAdd(Arr1DIdxRowM(tmp33, (int32_t)256,i0), Arr1DIdxRowM(tmp3, (int32_t)256,i0));
}
ClearMemSecret1( (int32_t)256, tmp33);
ClearMemSecret1( (int32_t)256, tmp3);
ScaleDown1( (int32_t)256, tmp35,  (int32_t)12);
EndComputation();
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)256; i0++){
cout << (funcReconstruct2PCCons(Arr1DIdxRowM(tmp35, (int32_t)256,i0), 2)) << endl;
}
}
