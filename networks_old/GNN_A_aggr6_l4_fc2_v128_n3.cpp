...
uint64_t* tmp9 = make_array<uint64_t>( (int32_t)100,  (int32_t)512);
...
Arr2DIdxRowM(tmp9, (int32_t)100, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp9 : 0;
}
}
...
uint64_t* tmp14 = make_array<uint64_t>( (int32_t)100,  (int32_t)512);
/* Variable to read the clear value corresponding to the input variable tmp14 at (9069,1-9069,41) */
...
Arr2DIdxRowM(tmp14, (int32_t)100, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp14 : 0;
}
}
...
uint64_t* tmp19 = make_array<uint64_t>( (int32_t)100,  (int32_t)512);
...
Arr2DIdxRowM(tmp19, (int32_t)100, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp19 : 0;
}
}
...
uint64_t* tmp24 = make_array<uint64_t>( (int32_t)100,  (int32_t)512);
/* Variable to read the clear value corresponding to the input variable tmp24 at (9099,1-9099,41) */
...
Arr2DIdxRowM(tmp24, (int32_t)100, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp24 : 0;
}
}
...
Arr1DIdxRowM(tmp51, (int32_t)51200,tmp53) = Arr2DIdxRowM(tmp9, (int32_t)100, (int32_t)512,i5,i6);
}
}
...
ClearMemSecret2( (int32_t)100,  (int32_t)512, tmp9);
...
Arr1DIdxRowM(tmp86, (int32_t)51200,tmp88) = Arr2DIdxRowM(tmp14, (int32_t)100, (int32_t)512,i12,i13);
}
}
...
ClearMemSecret2( (int32_t)100,  (int32_t)512, tmp14);
...
Arr1DIdxRowM(tmp121, (int32_t)51200,tmp123) = Arr2DIdxRowM(tmp19, (int32_t)100, (int32_t)512,i19,i20);
}
}
...
ClearMemSecret2( (int32_t)100,  (int32_t)512, tmp19);
...
Arr1DIdxRowM(tmp157, (int32_t)51200,tmp159) = Arr2DIdxRowM(tmp24, (int32_t)100, (int32_t)512,i26,i27);
}
}
...
ClearMemSecret2( (int32_t)100,  (int32_t)512, tmp24);
