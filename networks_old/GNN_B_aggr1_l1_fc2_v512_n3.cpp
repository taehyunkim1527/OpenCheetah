...
Arr1DIdxRowM(tmp6, (int32_t)2, (int64_t)1) =  (int32_t)512;
...
Arr2DIdxRowM(tmp7, (int32_t)1, (int32_t)512,i1,i2) = Arr1DIdxRowM(tmp0, (int32_t)512,i0);
i0 = (i0 +  (int64_t)1);
}
}
...
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp7, tmp1, tmp9, 0);
ClearMemSecret2( (int32_t)512,  (int32_t)512, tmp1);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp7);
ScaleUp2( (int32_t)1,  (int32_t)512, tmp2,  (int32_t)12);
...
Arr2DIdxRowM(tmp12, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp9, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp2, (int32_t)1, (int32_t)512,i0,i1));
}
}
...
Relu2( (int32_t)1,  (int32_t)512, tmp12, tmp15,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp12);

uint64_t* tmp17 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp15, tmp3, tmp17, 0);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp20, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp17, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp4, (int32_t)1, (int32_t)512,i0,i1));
}
}
...
Relu2( (int32_t)1,  (int32_t)512, tmp20, tmp23,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp20);

uint64_t* tmp25 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp25, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp23, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp5, (int32_t)1, (int32_t)512,i0,i1));
}
}
...
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (uint32_t)0; i1 <  (int32_t)512; i1++){
cout << (funcReconstruct2PCCons(Arr2DIdxRowM(tmp25, (int32_t)1, (int32_t)512,i0,i1), 2)) << endl;
}
}
}
