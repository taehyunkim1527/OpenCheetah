...
Arr1DIdxRowM(tmp11, (int32_t)25600,tmp14) = Arr2DIdxRowM(tmp3, (int32_t)100, (int32_t)256,i0,i1);
Arr1DIdxRowM(tmp12, (int32_t)25600,tmp14) = Arr2DIdxRowM(tmp2, (int32_t)1, (int32_t)256, (int32_t)0,i1);
}
}
...
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
tmp14 = (( (int32_t)0 + (i0 *  (int32_t)256)) + (i1 *  (int32_t)1));
Arr2DIdxRowM(tmp10, (int32_t)100, (int32_t)256,i0,i1) = Arr1DIdxRowM(tmp13, (int32_t)25600,tmp14);
}
}
...
uint64_t* tmp28 = make_array<uint64_t>( (int32_t)100,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)100; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp28, (int32_t)100, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp1, (int32_t)100, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp10, (int32_t)100, (int32_t)256,i0,i1));
}
}
...
tmp32 = SecretAdd(tmp32, Arr2DIdxRowM(tmp28, (int32_t)100, (int32_t)256,i6,i5));
}
Arr1DIdxRowM(tmp33, (int32_t)256,i5) = tmp32;
}
ClearMemSecret2( (int32_t)100,  (int32_t)256, tmp28);
