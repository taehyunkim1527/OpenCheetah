...
uint64_t* tmp9 = make_array<uint64_t>( (int32_t)50,  (int32_t)512);
/* Variable to read the clear value corresponding to the input variable tmp9 at (9054,1-9054,39) */
...
Arr2DIdxRowM(tmp9, (int32_t)50, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp9 : 0;
}
}

uint64_t* tmp10 = make_array<uint64_t>( (int32_t)512,  (int32_t)512);
/* Variable to read the clear value corresponding to the input variable tmp10 at (9057,1-9057,41) */
...
Arr2DIdxRowM(tmp10, (int32_t)512, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp10 : 0;
}
}

uint64_t* tmp11 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
/* Variable to read the clear value corresponding to the input variable tmp11 at (9060,1-9060,39) */
...
Arr2DIdxRowM(tmp11, (int32_t)1, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp11 : 0;
}
}

uint64_t* tmp12 = make_array<uint64_t>( (int32_t)512,  (int32_t)512);
/* Variable to read the clear value corresponding to the input variable tmp12 at (9063,1-9063,41) */
...
Arr2DIdxRowM(tmp12, (int32_t)512, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp12 : 0;
}
}

uint64_t* tmp13 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
/* Variable to read the clear value corresponding to the input variable tmp13 at (9066,1-9066,39) */
...
Arr2DIdxRowM(tmp13, (int32_t)1, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp13 : 0;
}
}

uint64_t* tmp14 = make_array<uint64_t>( (int32_t)50,  (int32_t)512);
/* Variable to read the clear value corresponding to the input variable tmp14 at (9069,1-9069,40) */
...
Arr2DIdxRowM(tmp14, (int32_t)50, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp14 : 0;
}
}
...
uint64_t* tmp19 = make_array<uint64_t>( (int32_t)50,  (int32_t)512);
/* Variable to read the clear value corresponding to the input variable tmp19 at (9084,1-9084,40) */
...
Arr2DIdxRowM(tmp19, (int32_t)50, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp19 : 0;
}
}

uint64_t* tmp20 = make_array<uint64_t>( (int32_t)512,  (int32_t)512);
/* Variable to read the clear value corresponding to the input variable tmp20 at (9087,1-9087,41) */
...
Arr2DIdxRowM(tmp20, (int32_t)512, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp20 : 0;
}
}

uint64_t* tmp21 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
/* Variable to read the clear value corresponding to the input variable tmp21 at (9090,1-9090,39) */
...
Arr2DIdxRowM(tmp21, (int32_t)1, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp21 : 0;
}
}

uint64_t* tmp22 = make_array<uint64_t>( (int32_t)512,  (int32_t)512);
/* Variable to read the clear value corresponding to the input variable tmp22 at (9093,1-9093,41) */
...
Arr2DIdxRowM(tmp22, (int32_t)512, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp22 : 0;
}
}

uint64_t* tmp23 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
/* Variable to read the clear value corresponding to the input variable tmp23 at (9096,1-9096,39) */
...
Arr2DIdxRowM(tmp23, (int32_t)1, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp23 : 0;
}
}

uint64_t* tmp24 = make_array<uint64_t>( (int32_t)50,  (int32_t)512);
/* Variable to read the clear value corresponding to the input variable tmp24 at (9099,1-9099,40) */
...
Arr2DIdxRowM(tmp24, (int32_t)50, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp24 : 0;
}
}
...
uint64_t* tmp29 = make_array<uint64_t>( (int32_t)50,  (int32_t)512);

uint64_t* tmp30 = make_array<uint64_t>( (int32_t)25600);

uint64_t* tmp31 = make_array<uint64_t>( (int32_t)25600);

uint64_t* tmp32 = make_array<uint64_t>( (int32_t)25600);

int32_t tmp33;
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
tmp33 = (( (int32_t)0 + (i0 *  (int32_t)512)) + (i1 *  (int32_t)1));
Arr1DIdxRowM(tmp30, (int32_t)25600,tmp33) = Arr2DIdxRowM(tmp6, (int32_t)50, (int32_t)512,i0,i1);
Arr1DIdxRowM(tmp31, (int32_t)25600,tmp33) = Arr2DIdxRowM(tmp5, (int32_t)1, (int32_t)512, (int32_t)0,i1);
}
}
ElemWiseActModelVectorMult( (int32_t)25600, tmp30, tmp31, tmp32);
ClearMemSecret1( (int32_t)25600, tmp30);
ClearMemSecret1( (int32_t)25600, tmp31);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
tmp33 = (( (int32_t)0 + (i0 *  (int32_t)512)) + (i1 *  (int32_t)1));
Arr2DIdxRowM(tmp29, (int32_t)50, (int32_t)512,i0,i1) = Arr1DIdxRowM(tmp32, (int32_t)25600,tmp33);
}
}
ClearMemSecret1( (int32_t)25600, tmp32);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp5);
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp6);

int32_t* tmp36 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp36, (int32_t)2, (int64_t)0) =  (int32_t)-1;
Arr1DIdxRowM(tmp36, (int32_t)2, (int64_t)1) =  (int32_t)512;

uint64_t* tmp37 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
...
Arr2DIdxRowM(tmp37, (int32_t)1, (int32_t)512,i3,i4) = Arr1DIdxRowM(tmp0, (int32_t)512,i2);
i2 = (i2 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)512, tmp0);

uint64_t* tmp39 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp37, tmp7, tmp39, 0);
ClearMemSecret2( (int32_t)512,  (int32_t)512, tmp7);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp37);
ScaleUp2( (int32_t)1,  (int32_t)512, tmp8,  (int32_t)12);

uint64_t* tmp42 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp42, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp39, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp8, (int32_t)1, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp39);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp8);

uint64_t* tmp45 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
Relu2( (int32_t)1,  (int32_t)512, tmp42, tmp45,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp42);
ScaleUp2( (int32_t)50,  (int32_t)512, tmp1,  (int32_t)12);

uint64_t* tmp47 = make_array<uint64_t>( (int32_t)50,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp47, (int32_t)50, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp1, (int32_t)50, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp29, (int32_t)50, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp1);
ScaleDown2( (int32_t)50,  (int32_t)512, tmp47,  (int32_t)12);

uint64_t* tmp49 = make_array<uint64_t>( (int32_t)50,  (int32_t)512);

uint64_t* tmp50 = make_array<uint64_t>( (int32_t)25600);

uint64_t* tmp51 = make_array<uint64_t>( (int32_t)25600);

uint64_t* tmp52 = make_array<uint64_t>( (int32_t)25600);

int32_t tmp53;
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)50; i5++){
for (uint32_t i6 =  (int32_t)0; i6 <  (int32_t)512; i6++){
tmp53 = (( (int32_t)0 + (i5 *  (int32_t)512)) + (i6 *  (int32_t)1));
Arr1DIdxRowM(tmp50, (int32_t)25600,tmp53) = Arr2DIdxRowM(tmp47, (int32_t)50, (int32_t)512,i5,i6);
Arr1DIdxRowM(tmp51, (int32_t)25600,tmp53) = Arr2DIdxRowM(tmp9, (int32_t)50, (int32_t)512,i5,i6);
}
}
ElemWiseActModelVectorMult( (int32_t)25600, tmp50, tmp51, tmp52);
ClearMemSecret1( (int32_t)25600, tmp50);
ClearMemSecret1( (int32_t)25600, tmp51);
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)50; i5++){
for (uint32_t i6 =  (int32_t)0; i6 <  (int32_t)512; i6++){
tmp53 = (( (int32_t)0 + (i5 *  (int32_t)512)) + (i6 *  (int32_t)1));
Arr2DIdxRowM(tmp49, (int32_t)50, (int32_t)512,i5,i6) = Arr1DIdxRowM(tmp52, (int32_t)25600,tmp53);
}
}
ClearMemSecret1( (int32_t)25600, tmp52);
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp47);
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp9);

int32_t tmp56 =  (int32_t)0;

uint64_t tmp57;

uint64_t* tmp58 = make_array<uint64_t>( (int32_t)512);
for (uint32_t i7 =  (int32_t)0; i7 <  (int32_t)512; i7++){
tmp57 = funcSSCons( (int64_t)0);
for (uint32_t i8 =  (int32_t)0; i8 <  (int32_t)50; i8++){
tmp57 = SecretAdd(tmp57, Arr2DIdxRowM(tmp49, (int32_t)50, (int32_t)512,i8,i7));
}
Arr1DIdxRowM(tmp58, (int32_t)512,i7) = tmp57;
}
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp49);

int32_t* tmp60 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp60, (int32_t)2, (int64_t)0) =  (int32_t)-1;
Arr1DIdxRowM(tmp60, (int32_t)2, (int64_t)1) =  (int32_t)512;

uint64_t* tmp61 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
...
for (uint32_t i11 =  (int32_t)0; i11 <  (int32_t)512; i11++){
Arr2DIdxRowM(tmp61, (int32_t)1, (int32_t)512,i10,i11) = Arr1DIdxRowM(tmp58, (int32_t)512,i9);
i9 = (i9 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)512, tmp58);
ScaleUp2( (int32_t)1,  (int32_t)512, tmp45,  (int32_t)12);

uint64_t* tmp63 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp63, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp61, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp45, (int32_t)1, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp61);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp45);

uint64_t* tmp66 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
ScaleDown2( (int32_t)1,  (int32_t)512, tmp63,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp63, tmp10, tmp66, 0);
ClearMemSecret2( (int32_t)512,  (int32_t)512, tmp10);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp63);
ScaleUp2( (int32_t)1,  (int32_t)512, tmp11,  (int32_t)12);

uint64_t* tmp69 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp69, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp66, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp11, (int32_t)1, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp66);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp11);

uint64_t* tmp72 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
Relu2( (int32_t)1,  (int32_t)512, tmp69, tmp72,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp69);

uint64_t* tmp74 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp72, tmp12, tmp74, 0);
ClearMemSecret2( (int32_t)512,  (int32_t)512, tmp12);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp72);
ScaleUp2( (int32_t)1,  (int32_t)512, tmp13,  (int32_t)12);

uint64_t* tmp77 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp77, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp74, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp13, (int32_t)1, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp74);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp13);

uint64_t* tmp80 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
Relu2( (int32_t)1,  (int32_t)512, tmp77, tmp80,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp77);
ScaleUp2( (int32_t)50,  (int32_t)512, tmp2,  (int32_t)12);

uint64_t* tmp82 = make_array<uint64_t>( (int32_t)50,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp82, (int32_t)50, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp2, (int32_t)50, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp29, (int32_t)50, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp2);
ScaleDown2( (int32_t)50,  (int32_t)512, tmp82,  (int32_t)12);

uint64_t* tmp84 = make_array<uint64_t>( (int32_t)50,  (int32_t)512);

uint64_t* tmp85 = make_array<uint64_t>( (int32_t)25600);

uint64_t* tmp86 = make_array<uint64_t>( (int32_t)25600);

uint64_t* tmp87 = make_array<uint64_t>( (int32_t)25600);

int32_t tmp88;
for (uint32_t i12 =  (int32_t)0; i12 <  (int32_t)50; i12++){
for (uint32_t i13 =  (int32_t)0; i13 <  (int32_t)512; i13++){
tmp88 = (( (int32_t)0 + (i12 *  (int32_t)512)) + (i13 *  (int32_t)1));
Arr1DIdxRowM(tmp85, (int32_t)25600,tmp88) = Arr2DIdxRowM(tmp82, (int32_t)50, (int32_t)512,i12,i13);
Arr1DIdxRowM(tmp86, (int32_t)25600,tmp88) = Arr2DIdxRowM(tmp14, (int32_t)50, (int32_t)512,i12,i13);
}
}
ElemWiseActModelVectorMult( (int32_t)25600, tmp85, tmp86, tmp87);
ClearMemSecret1( (int32_t)25600, tmp85);
ClearMemSecret1( (int32_t)25600, tmp86);
for (uint32_t i12 =  (int32_t)0; i12 <  (int32_t)50; i12++){
for (uint32_t i13 =  (int32_t)0; i13 <  (int32_t)512; i13++){
tmp88 = (( (int32_t)0 + (i12 *  (int32_t)512)) + (i13 *  (int32_t)1));
Arr2DIdxRowM(tmp84, (int32_t)50, (int32_t)512,i12,i13) = Arr1DIdxRowM(tmp87, (int32_t)25600,tmp88);
}
}
ClearMemSecret1( (int32_t)25600, tmp87);
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp14);
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp82);

int32_t tmp91 =  (int32_t)0;

uint64_t tmp92;

uint64_t* tmp93 = make_array<uint64_t>( (int32_t)512);
for (uint32_t i14 =  (int32_t)0; i14 <  (int32_t)512; i14++){
tmp92 = funcSSCons( (int64_t)0);
for (uint32_t i15 =  (int32_t)0; i15 <  (int32_t)50; i15++){
tmp92 = SecretAdd(tmp92, Arr2DIdxRowM(tmp84, (int32_t)50, (int32_t)512,i15,i14));
}
Arr1DIdxRowM(tmp93, (int32_t)512,i14) = tmp92;
}
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp84);

int32_t* tmp95 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp95, (int32_t)2, (int64_t)0) =  (int32_t)-1;
Arr1DIdxRowM(tmp95, (int32_t)2, (int64_t)1) =  (int32_t)512;

uint64_t* tmp96 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
...
for (uint32_t i18 =  (int32_t)0; i18 <  (int32_t)512; i18++){
Arr2DIdxRowM(tmp96, (int32_t)1, (int32_t)512,i17,i18) = Arr1DIdxRowM(tmp93, (int32_t)512,i16);
i16 = (i16 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)512, tmp93);
ScaleUp2( (int32_t)1,  (int32_t)512, tmp80,  (int32_t)12);

uint64_t* tmp98 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp98, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp96, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp80, (int32_t)1, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp80);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp96);

uint64_t* tmp101 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
ScaleDown2( (int32_t)1,  (int32_t)512, tmp98,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp98, tmp15, tmp101, 0);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp98);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp104, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp101, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp16, (int32_t)1, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp101);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp16);

uint64_t* tmp107 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
Relu2( (int32_t)1,  (int32_t)512, tmp104, tmp107,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp104);

uint64_t* tmp109 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp107, tmp17, tmp109, 0);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp107);
...
uint64_t* tmp117 = make_array<uint64_t>( (int32_t)50,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp117, (int32_t)50, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp3, (int32_t)50, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp29, (int32_t)50, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp3);
ScaleDown2( (int32_t)50,  (int32_t)512, tmp117,  (int32_t)12);

uint64_t* tmp119 = make_array<uint64_t>( (int32_t)50,  (int32_t)512);

uint64_t* tmp120 = make_array<uint64_t>( (int32_t)25600);

uint64_t* tmp121 = make_array<uint64_t>( (int32_t)25600);

uint64_t* tmp122 = make_array<uint64_t>( (int32_t)25600);

int32_t tmp123;
for (uint32_t i19 =  (int32_t)0; i19 <  (int32_t)50; i19++){
for (uint32_t i20 =  (int32_t)0; i20 <  (int32_t)512; i20++){
tmp123 = (( (int32_t)0 + (i19 *  (int32_t)512)) + (i20 *  (int32_t)1));
Arr1DIdxRowM(tmp120, (int32_t)25600,tmp123) = Arr2DIdxRowM(tmp117, (int32_t)50, (int32_t)512,i19,i20);
Arr1DIdxRowM(tmp121, (int32_t)25600,tmp123) = Arr2DIdxRowM(tmp19, (int32_t)50, (int32_t)512,i19,i20);
}
}
ElemWiseActModelVectorMult( (int32_t)25600, tmp120, tmp121, tmp122);
ClearMemSecret1( (int32_t)25600, tmp120);
ClearMemSecret1( (int32_t)25600, tmp121);
for (uint32_t i19 =  (int32_t)0; i19 <  (int32_t)50; i19++){
for (uint32_t i20 =  (int32_t)0; i20 <  (int32_t)512; i20++){
tmp123 = (( (int32_t)0 + (i19 *  (int32_t)512)) + (i20 *  (int32_t)1));
Arr2DIdxRowM(tmp119, (int32_t)50, (int32_t)512,i19,i20) = Arr1DIdxRowM(tmp122, (int32_t)25600,tmp123);
}
}
ClearMemSecret1( (int32_t)25600, tmp122);
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp19);
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp117);

int32_t tmp126 =  (int32_t)0;

uint64_t tmp127;

uint64_t* tmp128 = make_array<uint64_t>( (int32_t)512);
for (uint32_t i21 =  (int32_t)0; i21 <  (int32_t)512; i21++){
tmp127 = funcSSCons( (int64_t)0);
for (uint32_t i22 =  (int32_t)0; i22 <  (int32_t)50; i22++){
tmp127 = SecretAdd(tmp127, Arr2DIdxRowM(tmp119, (int32_t)50, (int32_t)512,i22,i21));
}
Arr1DIdxRowM(tmp128, (int32_t)512,i21) = tmp127;
}
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp119);

int32_t* tmp130 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp130, (int32_t)2, (int64_t)0) =  (int32_t)-1;
Arr1DIdxRowM(tmp130, (int32_t)2, (int64_t)1) =  (int32_t)512;

uint64_t* tmp131 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
...
for (uint32_t i25 =  (int32_t)0; i25 <  (int32_t)512; i25++){
Arr2DIdxRowM(tmp131, (int32_t)1, (int32_t)512,i24,i25) = Arr1DIdxRowM(tmp128, (int32_t)512,i23);
i23 = (i23 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)512, tmp128);
ScaleUp2( (int32_t)1,  (int32_t)512, tmp115,  (int32_t)12);

uint64_t* tmp133 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp133, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp131, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp115, (int32_t)1, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp115);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp131);

uint64_t* tmp136 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
ScaleDown2( (int32_t)1,  (int32_t)512, tmp133,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp133, tmp20, tmp136, 0);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp133);
ClearMemSecret2( (int32_t)512,  (int32_t)512, tmp20);
ScaleUp2( (int32_t)1,  (int32_t)512, tmp21,  (int32_t)12);

uint64_t* tmp139 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp139, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp136, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp21, (int32_t)1, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp21);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp136);

uint64_t* tmp142 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
Relu2( (int32_t)1,  (int32_t)512, tmp139, tmp142,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp139);

uint64_t* tmp144 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp142, tmp22, tmp144, 0);
ClearMemSecret2( (int32_t)512,  (int32_t)512, tmp22);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp142);
ScaleUp2( (int32_t)1,  (int32_t)512, tmp23,  (int32_t)12);

uint64_t* tmp147 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp147, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp144, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp23, (int32_t)1, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp144);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp23);

uint64_t* tmp150 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
Relu2( (int32_t)1,  (int32_t)512, tmp147, tmp150,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp147);
ScaleUp2( (int32_t)50,  (int32_t)512, tmp4,  (int32_t)12);

uint64_t* tmp152 = make_array<uint64_t>( (int32_t)50,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)50; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp152, (int32_t)50, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp4, (int32_t)50, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp29, (int32_t)50, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp29);
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp4);
ScaleDown2( (int32_t)50,  (int32_t)512, tmp152,  (int32_t)12);

uint64_t* tmp155 = make_array<uint64_t>( (int32_t)50,  (int32_t)512);

uint64_t* tmp156 = make_array<uint64_t>( (int32_t)25600);

uint64_t* tmp157 = make_array<uint64_t>( (int32_t)25600);

uint64_t* tmp158 = make_array<uint64_t>( (int32_t)25600);

int32_t tmp159;
for (uint32_t i26 =  (int32_t)0; i26 <  (int32_t)50; i26++){
for (uint32_t i27 =  (int32_t)0; i27 <  (int32_t)512; i27++){
tmp159 = (( (int32_t)0 + (i26 *  (int32_t)512)) + (i27 *  (int32_t)1));
Arr1DIdxRowM(tmp156, (int32_t)25600,tmp159) = Arr2DIdxRowM(tmp152, (int32_t)50, (int32_t)512,i26,i27);
Arr1DIdxRowM(tmp157, (int32_t)25600,tmp159) = Arr2DIdxRowM(tmp24, (int32_t)50, (int32_t)512,i26,i27);
}
}
ElemWiseActModelVectorMult( (int32_t)25600, tmp156, tmp157, tmp158);
ClearMemSecret1( (int32_t)25600, tmp156);
ClearMemSecret1( (int32_t)25600, tmp157);
for (uint32_t i26 =  (int32_t)0; i26 <  (int32_t)50; i26++){
for (uint32_t i27 =  (int32_t)0; i27 <  (int32_t)512; i27++){
tmp159 = (( (int32_t)0 + (i26 *  (int32_t)512)) + (i27 *  (int32_t)1));
Arr2DIdxRowM(tmp155, (int32_t)50, (int32_t)512,i26,i27) = Arr1DIdxRowM(tmp158, (int32_t)25600,tmp159);
}
}
ClearMemSecret1( (int32_t)25600, tmp158);
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp24);
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp152);

int32_t tmp162 =  (int32_t)0;

uint64_t tmp163;

uint64_t* tmp164 = make_array<uint64_t>( (int32_t)512);
for (uint32_t i28 =  (int32_t)0; i28 <  (int32_t)512; i28++){
tmp163 = funcSSCons( (int64_t)0);
for (uint32_t i29 =  (int32_t)0; i29 <  (int32_t)50; i29++){
tmp163 = SecretAdd(tmp163, Arr2DIdxRowM(tmp155, (int32_t)50, (int32_t)512,i29,i28));
}
Arr1DIdxRowM(tmp164, (int32_t)512,i28) = tmp163;
}
ClearMemSecret2( (int32_t)50,  (int32_t)512, tmp155);

int32_t* tmp166 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp166, (int32_t)2, (int64_t)0) =  (int32_t)-1;
Arr1DIdxRowM(tmp166, (int32_t)2, (int64_t)1) =  (int32_t)512;

uint64_t* tmp167 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
...
int64_t i30;
i30 =  (int64_t)0;
for (uint32_t i31 =  (int32_t)0; i31 <  (int32_t)1; i31++){
for (uint32_t i32 =  (int32_t)0; i32 <  (int32_t)512; i32++){
Arr2DIdxRowM(tmp167, (int32_t)1, (int32_t)512,i31,i32) = Arr1DIdxRowM(tmp164, (int32_t)512,i30);
i30 = (i30 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)512, tmp164);
ScaleUp2( (int32_t)1,  (int32_t)512, tmp150,  (int32_t)12);

uint64_t* tmp169 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp169, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp167, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp150, (int32_t)1, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp167);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp150);

uint64_t* tmp172 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
ScaleDown2( (int32_t)1,  (int32_t)512, tmp169,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp169, tmp25, tmp172, 0);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp169);
ClearMemSecret2( (int32_t)512,  (int32_t)512, tmp25);
ScaleUp2( (int32_t)1,  (int32_t)512, tmp26,  (int32_t)12);

uint64_t* tmp175 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp175, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp172, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp26, (int32_t)1, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp172);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp26);

uint64_t* tmp178 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
Relu2( (int32_t)1,  (int32_t)512, tmp175, tmp178,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp175);

uint64_t* tmp180 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)512, tmp178, tmp27, tmp180, 0);
ClearMemSecret2( (int32_t)512,  (int32_t)512, tmp27);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp178);
ScaleUp2( (int32_t)1,  (int32_t)512, tmp28,  (int32_t)12);

uint64_t* tmp183 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)512; i1++){
Arr2DIdxRowM(tmp183, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp180, (int32_t)1, (int32_t)512,i0,i1), Arr2DIdxRowM(tmp28, (int32_t)1, (int32_t)512,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp28);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp180);

uint64_t* tmp186 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
Relu2( (int32_t)1,  (int32_t)512, tmp183, tmp186,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp183);
EndComputation();
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (uint32_t)0; i1 <  (int32_t)512; i1++){
cout << (funcReconstruct2PCCons(Arr2DIdxRowM(tmp186, (int32_t)1, (int32_t)512,i0,i1), 2)) << endl;
}
}
}
