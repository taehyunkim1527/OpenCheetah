...
uint64_t* tmp14 = make_array<uint64_t>( (int32_t)7680);
...
Arr1DIdxRowM(tmp14, (int32_t)7680,tmp17) = Arr2DIdxRowM(tmp4, (int32_t)30, (int32_t)256,i0,i1);
Arr1DIdxRowM(tmp15, (int32_t)7680,tmp17) = Arr2DIdxRowM(tmp3, (int32_t)1, (int32_t)256, (int32_t)0,i1);
}
}
ElemWiseActModelVectorMult( (int32_t)7680, tmp14, tmp15, tmp16);
ClearMemSecret1( (int32_t)7680, tmp14);
ClearMemSecret1( (int32_t)7680, tmp15);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)30; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
tmp17 = (( (int32_t)0 + (i0 *  (int32_t)256)) + (i1 *  (int32_t)1));
Arr2DIdxRowM(tmp13, (int32_t)30, (int32_t)256,i0,i1) = Arr1DIdxRowM(tmp16, (int32_t)7680,tmp17);
}
}
...
uint64_t* tmp31 = make_array<uint64_t>( (int32_t)30,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)30; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp31, (int32_t)30, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp1, (int32_t)30, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp13, (int32_t)30, (int32_t)256,i0,i1));
}
}
ClearMemSecret2( (int32_t)30,  (int32_t)256, tmp1);
ScaleDown2( (int32_t)30,  (int32_t)256, tmp31,  (int32_t)12);
...
Arr1DIdxRowM(tmp34, (int32_t)7680,tmp37) = Arr2DIdxRowM(tmp31, (int32_t)30, (int32_t)256,i5,i6);
Arr1DIdxRowM(tmp35, (int32_t)7680,tmp37) = Arr2DIdxRowM(tmp7, (int32_t)30, (int32_t)1,i5, (int32_t)0);
}
}
...
for (uint32_t i6 =  (int32_t)0; i6 <  (int32_t)256; i6++){
tmp37 = (( (int32_t)0 + (i5 *  (int32_t)256)) + (i6 *  (int32_t)1));
Arr2DIdxRowM(tmp33, (int32_t)30, (int32_t)256,i5,i6) = Arr1DIdxRowM(tmp36, (int32_t)7680,tmp37);
}
}
ClearMemSecret1( (int32_t)7680, tmp36);
ClearMemSecret2( (int32_t)30,  (int32_t)1, tmp7);
ClearMemSecret2( (int32_t)30,  (int32_t)256, tmp31);
...
tmp41 = SecretAdd(tmp41, Arr2DIdxRowM(tmp33, (int32_t)30, (int32_t)256,i8,i7));
}
...
uint64_t* tmp58 = make_array<uint64_t>( (int32_t)30,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)30; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp58, (int32_t)30, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp2, (int32_t)30, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp13, (int32_t)30, (int32_t)256,i0,i1));
}
}
ClearMemSecret2( (int32_t)30,  (int32_t)256, tmp13);
ClearMemSecret2( (int32_t)30,  (int32_t)256, tmp2);
ScaleDown2( (int32_t)30,  (int32_t)256, tmp58,  (int32_t)12);

uint64_t* tmp61 = make_array<uint64_t>( (int32_t)30,  (int32_t)256);

uint64_t* tmp62 = make_array<uint64_t>( (int32_t)7680);

uint64_t* tmp63 = make_array<uint64_t>( (int32_t)7680);

uint64_t* tmp64 = make_array<uint64_t>( (int32_t)7680);
...
Arr1DIdxRowM(tmp62, (int32_t)7680,tmp65) = Arr2DIdxRowM(tmp58, (int32_t)30, (int32_t)256,i12,i13);
Arr1DIdxRowM(tmp63, (int32_t)7680,tmp65) = Arr2DIdxRowM(tmp10, (int32_t)30, (int32_t)1,i12, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)7680, tmp62, tmp63, tmp64);
ClearMemSecret1( (int32_t)7680, tmp62);
ClearMemSecret1( (int32_t)7680, tmp63);
for (uint32_t i12 =  (int32_t)0; i12 <  (int32_t)30; i12++){
for (uint32_t i13 =  (int32_t)0; i13 <  (int32_t)256; i13++){
tmp65 = (( (int32_t)0 + (i12 *  (int32_t)256)) + (i13 *  (int32_t)1));
Arr2DIdxRowM(tmp61, (int32_t)30, (int32_t)256,i12,i13) = Arr1DIdxRowM(tmp64, (int32_t)7680,tmp65);
}
}
ClearMemSecret1( (int32_t)7680, tmp64);
ClearMemSecret2( (int32_t)30,  (int32_t)256, tmp58);
...
tmp69 = SecretAdd(tmp69, Arr2DIdxRowM(tmp61, (int32_t)30, (int32_t)256,i15,i14));
}
