...
uint64_t* tmp8 = make_array<uint64_t>( (int32_t)5,  (int32_t)1);
/* Variable to read the clear value corresponding to the input variable tmp8 at (9051,1-9051,36) */
...
Arr2DIdxRowM(tmp8, (int32_t)5, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp8 : 0;
}
}
...
uint64_t* tmp13 = make_array<uint64_t>( (int32_t)5,  (int32_t)1);
/* Variable to read the clear value corresponding to the input variable tmp13 at (9066,1-9066,37) */
...
Arr2DIdxRowM(tmp13, (int32_t)5, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp13 : 0;
}
}
...
Arr1DIdxRowM(tmp45, (int32_t)2560,tmp47) = Arr2DIdxRowM(tmp8, (int32_t)5, (int32_t)1,i5, (int32_t)0);
}
}
...
ClearMemSecret2( (int32_t)5,  (int32_t)1, tmp8);
...
Arr1DIdxRowM(tmp80, (int32_t)2560,tmp82) = Arr2DIdxRowM(tmp13, (int32_t)5, (int32_t)1,i12, (int32_t)0);
}
}
...
ClearMemSecret2( (int32_t)5,  (int32_t)1, tmp13);
...
Arr1DIdxRowM(tmp116, (int32_t)2560,tmp118) = Arr2DIdxRowM(tmp18, (int32_t)5, (int32_t)1,i19, (int32_t)0);
}
}
