...
Arr1DIdxRowM(tmp7, (int32_t)51200,tmp10) = Arr2DIdxRowM(tmp2, (int32_t)200, (int32_t)256,i0,i1);
Arr1DIdxRowM(tmp8, (int32_t)51200,tmp10) = Arr2DIdxRowM(tmp1, (int32_t)1, (int32_t)256, (int32_t)0,i1);
}
}
...
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
tmp10 = (( (int32_t)0 + (i0 *  (int32_t)256)) + (i1 *  (int32_t)1));
Arr2DIdxRowM(tmp6, (int32_t)200, (int32_t)256,i0,i1) = Arr1DIdxRowM(tmp9, (int32_t)51200,tmp10);
}
}
...
uint64_t* tmp13 = make_array<uint64_t>( (int32_t)200,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)200; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp13, (int32_t)200, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp0, (int32_t)200, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp6, (int32_t)200, (int32_t)256,i0,i1));
}
}
...
ScaleDown2( (int32_t)200,  (int32_t)256, tmp13,  (int32_t)12);

uint64_t* tmp24 = make_array<uint64_t>( (int32_t)200,  (int32_t)256);
...
Arr1DIdxRowM(tmp25, (int32_t)51200,tmp28) = Arr2DIdxRowM(tmp13, (int32_t)200, (int32_t)256,i4,i5);
Arr1DIdxRowM(tmp26, (int32_t)51200,tmp28) = Arr2DIdxRowM(tmp19, (int32_t)200, (int32_t)1,i4, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)51200, tmp25, tmp26, tmp27);
ClearMemSecret1( (int32_t)51200, tmp25);
ClearMemSecret1( (int32_t)51200, tmp26);
for (uint32_t i4 =  (int32_t)0; i4 <  (int32_t)200; i4++){
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)256; i5++){
tmp28 = (( (int32_t)0 + (i4 *  (int32_t)256)) + (i5 *  (int32_t)1));
Arr2DIdxRowM(tmp24, (int32_t)200, (int32_t)256,i4,i5) = Arr1DIdxRowM(tmp27, (int32_t)51200,tmp28);
}
}
ClearMemSecret1( (int32_t)51200, tmp27);
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp19);
ClearMemSecret2( (int32_t)200,  (int32_t)256, tmp13);
...
tmp32 = SecretAdd(tmp32, Arr2DIdxRowM(tmp24, (int32_t)200, (int32_t)256,i7,i6));
}
Arr1DIdxRowM(tmp33, (int32_t)256,i6) = tmp32;
}
ClearMemSecret2( (int32_t)200,  (int32_t)256, tmp24);
