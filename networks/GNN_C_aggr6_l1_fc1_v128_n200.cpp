...
uint64_t* tmp4 = make_array<uint64_t>( (int32_t)200,  (int32_t)1);
...
Arr2DIdxRowM(tmp4, (int32_t)200, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp4 : 0;
}
}
...
Arr1DIdxRowM(tmp7, (int32_t)25600,tmp10) = Arr2DIdxRowM(tmp2, (int32_t)200, (int32_t)128,i0,i1);
Arr1DIdxRowM(tmp8, (int32_t)25600,tmp10) = Arr2DIdxRowM(tmp1, (int32_t)1, (int32_t)128, (int32_t)0,i1);
}
}
...
Arr2DIdxRowM(tmp16, (int32_t)200, (int32_t)1,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp4, (int32_t)200, (int32_t)1,i0,i1), Arr2DIdxRowM(tmp5, (int32_t)200, (int32_t)1,i0,i1));
}
}
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp5);
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp4);

uint64_t* tmp19 = make_array<uint64_t>( (int32_t)200,  (int32_t)1);
Relu2( (int32_t)200,  (int32_t)1, tmp16, tmp19,  (int32_t)0, 0);
...
tmp22 = SecretAdd(tmp22, Arr2DIdxRowM(tmp19, (int32_t)200, (int32_t)1,i2,i3));
}
}
Arr1DIdxRowM(tmp23, (int32_t)1, (int32_t)0) = tmp22;
ScaleDown2( (int32_t)200,  (int32_t)128, tmp13,  (int32_t)12);

uint64_t* tmp24 = make_array<uint64_t>( (int32_t)200,  (int32_t)128);
...
Arr1DIdxRowM(tmp25, (int32_t)25600,tmp28) = Arr2DIdxRowM(tmp13, (int32_t)200, (int32_t)128,i4,i5);
Arr1DIdxRowM(tmp26, (int32_t)25600,tmp28) = Arr2DIdxRowM(tmp19, (int32_t)200, (int32_t)1,i4, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)25600, tmp25, tmp26, tmp27);
ClearMemSecret1( (int32_t)25600, tmp25);
ClearMemSecret1( (int32_t)25600, tmp26);
for (uint32_t i4 =  (int32_t)0; i4 <  (int32_t)200; i4++){
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)128; i5++){
tmp28 = (( (int32_t)0 + (i4 *  (int32_t)128)) + (i5 *  (int32_t)1));
Arr2DIdxRowM(tmp24, (int32_t)200, (int32_t)128,i4,i5) = Arr1DIdxRowM(tmp27, (int32_t)25600,tmp28);
}
}
ClearMemSecret1( (int32_t)25600, tmp27);
ClearMemSecret2( (int32_t)200,  (int32_t)128, tmp13);
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp19);
...
tmp32 = SecretAdd(tmp32, Arr2DIdxRowM(tmp24, (int32_t)200, (int32_t)128,i7,i6));
}
Arr1DIdxRowM(tmp33, (int32_t)128,i6) = tmp32;
}
ClearMemSecret2( (int32_t)200,  (int32_t)128, tmp24);
