...
Arr1DIdxRowM(tmp3, (int32_t)1,i0) = (party == SERVER) ? __tmp_in_tmp3 : 0;
}

uint64_t* tmp4 = make_array<uint64_t>( (int32_t)128,  (int32_t)128);
...
Arr2DIdxRowM(tmp4, (int32_t)128, (int32_t)128,i0,i1) = (party == SERVER) ? __tmp_in_tmp4 : 0;
}
}
...
uint64_t* tmp11 = make_array<uint64_t>( (int32_t)1280);
...
tmp14 = (( (int32_t)0 + (i0 *  (int32_t)128)) + (i1 *  (int32_t)1));
Arr1DIdxRowM(tmp11, (int32_t)1280,tmp14) = Arr2DIdxRowM(tmp2, (int32_t)10, (int32_t)128,i0,i1);
Arr1DIdxRowM(tmp12, (int32_t)1280,tmp14) = Arr1DIdxRowM(tmp3, (int32_t)1, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)1280, tmp11, tmp12, tmp13);
ClearMemSecret1( (int32_t)1280, tmp11);
ClearMemSecret1( (int32_t)1280, tmp12);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)10; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
tmp14 = (( (int32_t)0 + (i0 *  (int32_t)128)) + (i1 *  (int32_t)1));
Arr2DIdxRowM(tmp10, (int32_t)10, (int32_t)128,i0,i1) = Arr1DIdxRowM(tmp13, (int32_t)1280,tmp14);
}
}
ClearMemSecret1( (int32_t)1280, tmp13);
ClearMemSecret1( (int32_t)1, tmp3);
ClearMemSecret2( (int32_t)10,  (int32_t)128, tmp2);

int32_t tmp17 =  (int32_t)0;

uint64_t tmp18;

uint64_t* tmp19 = make_array<uint64_t>( (int32_t)128);
for (uint32_t i2 =  (int32_t)0; i2 <  (int32_t)128; i2++){
tmp18 = funcSSCons( (int64_t)0);
for (uint32_t i3 =  (int32_t)0; i3 <  (int32_t)10; i3++){
tmp18 = SecretAdd(tmp18, Arr2DIdxRowM(tmp10, (int32_t)10, (int32_t)128,i3,i2));
}
Arr1DIdxRowM(tmp19, (int32_t)128,i2) = tmp18;
}
...
Arr2DIdxRowM(tmp22, (int32_t)1, (int32_t)128,i5,i6) = Arr1DIdxRowM(tmp19, (int32_t)128,i4);
i4 = (i4 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)128, tmp19);
ScaleUp1( (int32_t)128, tmp0,  (int32_t)12);

uint64_t* tmp24 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp24, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp22, (int32_t)1, (int32_t)128,i0,i1), Arr1DIdxRowM(tmp0, (int32_t)128,i1));
}
}
...
ScaleDown2( (int32_t)1,  (int32_t)128, tmp24,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)128,  (int32_t)128, tmp24, tmp4, tmp27, 0);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp24);
ClearMemSecret2( (int32_t)128,  (int32_t)128, tmp4);
ScaleUp2( (int32_t)1,  (int32_t)128, tmp5,  (int32_t)12);

uint64_t* tmp30 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp30, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp27, (int32_t)1, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp5, (int32_t)1, (int32_t)128,i0,i1));
}
}
...
Arr2DIdxRowM(tmp35, (int32_t)200, (int32_t)1,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp6, (int32_t)200, (int32_t)1,i0,i1), Arr2DIdxRowM(tmp7, (int32_t)200, (int32_t)1,i0,i1));
}
}
...
tmp41 = SecretAdd(tmp41, Arr2DIdxRowM(tmp38, (int32_t)200, (int32_t)1,i7,i8));
}
}
...
tmp47 = (( (int32_t)0 + (i9 *  (int32_t)1)) + (i10 *  (int32_t)1));
Arr1DIdxRowM(tmp44, (int32_t)200,tmp47) = Arr2DIdxRowM(tmp38, (int32_t)200, (int32_t)1,i9,i10);
Arr1DIdxRowM(tmp45, (int32_t)200,tmp47) = Arr1DIdxRowM(tmp42, (int32_t)1,i10);
}
}
...
for (uint32_t i10 =  (int32_t)0; i10 <  (int32_t)1; i10++){
tmp47 = (( (int32_t)0 + (i9 *  (int32_t)1)) + (i10 *  (int32_t)1));
Arr2DIdxRowM(tmp43, (int32_t)200, (int32_t)1,i9,i10) = Arr1DIdxRowM(tmp46, (int32_t)200,tmp47);
}
}
...
tmp54 = (( (int32_t)0 + (i11 *  (int32_t)128)) + (i12 *  (int32_t)1));
Arr1DIdxRowM(tmp51, (int32_t)25600,tmp54) = Arr2DIdxRowM(tmp1, (int32_t)200, (int32_t)128,i11,i12);
Arr1DIdxRowM(tmp52, (int32_t)25600,tmp54) = Arr2DIdxRowM(tmp43, (int32_t)200, (int32_t)1,i11, (int32_t)0);
}
}
...
for (uint32_t i12 =  (int32_t)0; i12 <  (int32_t)128; i12++){
tmp54 = (( (int32_t)0 + (i11 *  (int32_t)128)) + (i12 *  (int32_t)1));
Arr2DIdxRowM(tmp50, (int32_t)200, (int32_t)128,i11,i12) = Arr1DIdxRowM(tmp53, (int32_t)25600,tmp54);
}
}
...
tmp58 = SecretAdd(tmp58, Arr2DIdxRowM(tmp50, (int32_t)200, (int32_t)128,i14,i13));
}
Arr1DIdxRowM(tmp59, (int32_t)128,i13) = tmp58;
}
...
for (uint32_t i17 =  (int32_t)0; i17 <  (int32_t)128; i17++){
Arr2DIdxRowM(tmp62, (int32_t)1, (int32_t)128,i16,i17) = Arr1DIdxRowM(tmp59, (int32_t)128,i15);
i15 = (i15 +  (int64_t)1);
}
}
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp64, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp62, (int32_t)1, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp33, (int32_t)1, (int32_t)128,i0,i1));
}
}
...
MatMul2D( (int32_t)1,  (int32_t)128,  (int32_t)128, tmp64, tmp8, tmp67, 0);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp70, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp67, (int32_t)1, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp9, (int32_t)1, (int32_t)128,i0,i1));
}
}
...
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (uint32_t)0; i1 <  (int32_t)128; i1++){
cout << (funcReconstruct2PCCons(Arr2DIdxRowM(tmp73, (int32_t)1, (int32_t)128,i0,i1), 2)) << endl;
}
}
}
