...
uint64_t* tmp1 = make_array<uint64_t>( (int32_t)200,  (int32_t)256);
...
Arr2DIdxRowM(tmp1, (int32_t)200, (int32_t)256,i0,i1) = (party == SERVER) ? __tmp_in_tmp1 : 0;
}
}

uint64_t* tmp2 = make_array<uint64_t>( (int32_t)200,  (int32_t)256);
...
Arr2DIdxRowM(tmp2, (int32_t)200, (int32_t)256,i0,i1) = (party == SERVER) ? __tmp_in_tmp2 : 0;
}
}

uint64_t* tmp3 = make_array<uint64_t>( (int32_t)200,  (int32_t)256);
...
Arr2DIdxRowM(tmp3, (int32_t)200, (int32_t)256,i0,i1) = (party == SERVER) ? __tmp_in_tmp3 : 0;
}
}
...
uint64_t* tmp5 = make_array<uint64_t>( (int32_t)200,  (int32_t)256);
...
Arr2DIdxRowM(tmp5, (int32_t)200, (int32_t)256,i0,i1) = (party == SERVER) ? __tmp_in_tmp5 : 0;
}
}
...
uint64_t* tmp8 = make_array<uint64_t>( (int32_t)200,  (int32_t)1);
...
Arr2DIdxRowM(tmp8, (int32_t)200, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp8 : 0;
}
}

uint64_t* tmp9 = make_array<uint64_t>( (int32_t)200,  (int32_t)1);
...
Arr2DIdxRowM(tmp9, (int32_t)200, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp9 : 0;
}
}
...
uint64_t* tmp12 = make_array<uint64_t>( (int32_t)200,  (int32_t)1);
...
Arr2DIdxRowM(tmp12, (int32_t)200, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp12 : 0;
}
}

uint64_t* tmp13 = make_array<uint64_t>( (int32_t)200,  (int32_t)1);
...
Arr2DIdxRowM(tmp13, (int32_t)200, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp13 : 0;
}
}
...
uint64_t* tmp16 = make_array<uint64_t>( (int32_t)200,  (int32_t)1);
...
Arr2DIdxRowM(tmp16, (int32_t)200, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp16 : 0;
}
}

uint64_t* tmp17 = make_array<uint64_t>( (int32_t)200,  (int32_t)1);
...
Arr2DIdxRowM(tmp17, (int32_t)200, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp17 : 0;
}
}
...
uint64_t* tmp20 = make_array<uint64_t>( (int32_t)200,  (int32_t)256);

uint64_t* tmp21 = make_array<uint64_t>( (int32_t)51200);

uint64_t* tmp22 = make_array<uint64_t>( (int32_t)51200);

uint64_t* tmp23 = make_array<uint64_t>( (int32_t)51200);

int32_t tmp24;
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)200; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
tmp24 = (( (int32_t)0 + (i0 *  (int32_t)256)) + (i1 *  (int32_t)1));
Arr1DIdxRowM(tmp21, (int32_t)51200,tmp24) = Arr2DIdxRowM(tmp5, (int32_t)200, (int32_t)256,i0,i1);
Arr1DIdxRowM(tmp22, (int32_t)51200,tmp24) = Arr2DIdxRowM(tmp4, (int32_t)1, (int32_t)256, (int32_t)0,i1);
}
}
ElemWiseActModelVectorMult( (int32_t)51200, tmp21, tmp22, tmp23);
ClearMemSecret1( (int32_t)51200, tmp21);
ClearMemSecret1( (int32_t)51200, tmp22);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)200; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
tmp24 = (( (int32_t)0 + (i0 *  (int32_t)256)) + (i1 *  (int32_t)1));
Arr2DIdxRowM(tmp20, (int32_t)200, (int32_t)256,i0,i1) = Arr1DIdxRowM(tmp23, (int32_t)51200,tmp24);
}
}
ClearMemSecret1( (int32_t)51200, tmp23);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp4);
ClearMemSecret2( (int32_t)200,  (int32_t)256, tmp5);

int32_t* tmp27 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp27, (int32_t)2, (int64_t)0) =  (int32_t)-1;
Arr1DIdxRowM(tmp27, (int32_t)2, (int64_t)1) =  (int32_t)256;
...
Arr2DIdxRowM(tmp28, (int32_t)1, (int32_t)256,i3,i4) = Arr1DIdxRowM(tmp0, (int32_t)256,i2);
i2 = (i2 +  (int64_t)1);
}
}
...
MatMul2D( (int32_t)1,  (int32_t)256,  (int32_t)256, tmp28, tmp6, tmp30, 0);
...
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp33, (int32_t)1, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp30, (int32_t)1, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp7, (int32_t)1, (int32_t)256,i0,i1));
}
}
...
Relu2( (int32_t)1,  (int32_t)256, tmp33, tmp36,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp33);
ScaleUp2( (int32_t)200,  (int32_t)256, tmp1,  (int32_t)12);

uint64_t* tmp38 = make_array<uint64_t>( (int32_t)200,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)200; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp38, (int32_t)200, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp1, (int32_t)200, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp20, (int32_t)200, (int32_t)256,i0,i1));
}
}
ClearMemSecret2( (int32_t)200,  (int32_t)256, tmp1);

uint64_t* tmp40 = make_array<uint64_t>( (int32_t)200,  (int32_t)1);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)200; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)1; i1++){
Arr2DIdxRowM(tmp40, (int32_t)200, (int32_t)1,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp8, (int32_t)200, (int32_t)1,i0,i1), Arr2DIdxRowM(tmp9, (int32_t)200, (int32_t)1,i0,i1));
}
}
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp8);
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp9);

uint64_t* tmp43 = make_array<uint64_t>( (int32_t)200,  (int32_t)1);
Relu2( (int32_t)200,  (int32_t)1, tmp40, tmp43,  (int32_t)0, 0);
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp40);

int32_t* tmp45 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp45, (int32_t)2, (int64_t)0) =  (int32_t)0;
Arr1DIdxRowM(tmp45, (int32_t)2, (int64_t)1) =  (int32_t)1;

uint64_t tmp46;

uint64_t* tmp47 = make_array<uint64_t>( (int32_t)1);
tmp46 = funcSSCons( (int64_t)0);
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)200; i5++){
for (uint32_t i6 =  (int32_t)0; i6 <  (int32_t)1; i6++){
tmp46 = SecretAdd(tmp46, Arr2DIdxRowM(tmp43, (int32_t)200, (int32_t)1,i5,i6));
}
}
Arr1DIdxRowM(tmp47, (int32_t)1, (int32_t)0) = tmp46;

uint64_t* tmp48 = make_array<uint64_t>( (int32_t)200,  (int32_t)1);

uint64_t* tmp49 = make_array<uint64_t>( (int32_t)200);

uint64_t* tmp50 = make_array<uint64_t>( (int32_t)200);

uint64_t* tmp51 = make_array<uint64_t>( (int32_t)200);

int32_t tmp52;
for (uint32_t i7 =  (int32_t)0; i7 <  (int32_t)200; i7++){
for (uint32_t i8 =  (int32_t)0; i8 <  (int32_t)1; i8++){
tmp52 = (( (int32_t)0 + (i7 *  (int32_t)1)) + (i8 *  (int32_t)1));
Arr1DIdxRowM(tmp49, (int32_t)200,tmp52) = Arr2DIdxRowM(tmp43, (int32_t)200, (int32_t)1,i7,i8);
Arr1DIdxRowM(tmp50, (int32_t)200,tmp52) = Arr1DIdxRowM(tmp47, (int32_t)1,i8);
}
}
ElemWiseActModelVectorMult( (int32_t)200, tmp49, tmp50, tmp51);
ClearMemSecret1( (int32_t)200, tmp49);
ClearMemSecret1( (int32_t)200, tmp50);
for (uint32_t i7 =  (int32_t)0; i7 <  (int32_t)200; i7++){
for (uint32_t i8 =  (int32_t)0; i8 <  (int32_t)1; i8++){
tmp52 = (( (int32_t)0 + (i7 *  (int32_t)1)) + (i8 *  (int32_t)1));
Arr2DIdxRowM(tmp48, (int32_t)200, (int32_t)1,i7,i8) = Arr1DIdxRowM(tmp51, (int32_t)200,tmp52);
}
}
ClearMemSecret1( (int32_t)200, tmp51);
ClearMemSecret1( (int32_t)1, tmp47);
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp43);
ScaleDown2( (int32_t)200,  (int32_t)256, tmp38,  (int32_t)12);
ScaleDown2( (int32_t)200,  (int32_t)1, tmp48,  (int32_t)12);

uint64_t* tmp55 = make_array<uint64_t>( (int32_t)200,  (int32_t)256);

uint64_t* tmp56 = make_array<uint64_t>( (int32_t)51200);

uint64_t* tmp57 = make_array<uint64_t>( (int32_t)51200);

uint64_t* tmp58 = make_array<uint64_t>( (int32_t)51200);

int32_t tmp59;
for (uint32_t i9 =  (int32_t)0; i9 <  (int32_t)200; i9++){
for (uint32_t i10 =  (int32_t)0; i10 <  (int32_t)256; i10++){
tmp59 = (( (int32_t)0 + (i9 *  (int32_t)256)) + (i10 *  (int32_t)1));
Arr1DIdxRowM(tmp56, (int32_t)51200,tmp59) = Arr2DIdxRowM(tmp38, (int32_t)200, (int32_t)256,i9,i10);
Arr1DIdxRowM(tmp57, (int32_t)51200,tmp59) = Arr2DIdxRowM(tmp48, (int32_t)200, (int32_t)1,i9, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)51200, tmp56, tmp57, tmp58);
ClearMemSecret1( (int32_t)51200, tmp56);
ClearMemSecret1( (int32_t)51200, tmp57);
for (uint32_t i9 =  (int32_t)0; i9 <  (int32_t)200; i9++){
for (uint32_t i10 =  (int32_t)0; i10 <  (int32_t)256; i10++){
tmp59 = (( (int32_t)0 + (i9 *  (int32_t)256)) + (i10 *  (int32_t)1));
Arr2DIdxRowM(tmp55, (int32_t)200, (int32_t)256,i9,i10) = Arr1DIdxRowM(tmp58, (int32_t)51200,tmp59);
}
}
ClearMemSecret1( (int32_t)51200, tmp58);
ClearMemSecret2( (int32_t)200,  (int32_t)256, tmp38);
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp48);

int32_t tmp62 =  (int32_t)0;

uint64_t tmp63;

uint64_t* tmp64 = make_array<uint64_t>( (int32_t)256);
for (uint32_t i11 =  (int32_t)0; i11 <  (int32_t)256; i11++){
tmp63 = funcSSCons( (int64_t)0);
for (uint32_t i12 =  (int32_t)0; i12 <  (int32_t)200; i12++){
tmp63 = SecretAdd(tmp63, Arr2DIdxRowM(tmp55, (int32_t)200, (int32_t)256,i12,i11));
}
Arr1DIdxRowM(tmp64, (int32_t)256,i11) = tmp63;
}
ClearMemSecret2( (int32_t)200,  (int32_t)256, tmp55);
...
for (uint32_t i15 =  (int32_t)0; i15 <  (int32_t)256; i15++){
Arr2DIdxRowM(tmp67, (int32_t)1, (int32_t)256,i14,i15) = Arr1DIdxRowM(tmp64, (int32_t)256,i13);
i13 = (i13 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)256, tmp64);
ScaleUp2( (int32_t)1,  (int32_t)256, tmp36,  (int32_t)12);

uint64_t* tmp69 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp69, (int32_t)1, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp67, (int32_t)1, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp36, (int32_t)1, (int32_t)256,i0,i1));
}
}
...
ScaleDown2( (int32_t)1,  (int32_t)256, tmp69,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)256,  (int32_t)256, tmp69, tmp10, tmp72, 0);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp75, (int32_t)1, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp72, (int32_t)1, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp11, (int32_t)1, (int32_t)256,i0,i1));
}
}
...
ScaleUp2( (int32_t)200,  (int32_t)256, tmp2,  (int32_t)12);

uint64_t* tmp80 = make_array<uint64_t>( (int32_t)200,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)200; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp80, (int32_t)200, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp2, (int32_t)200, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp20, (int32_t)200, (int32_t)256,i0,i1));
}
}
ClearMemSecret2( (int32_t)200,  (int32_t)256, tmp2);

uint64_t* tmp82 = make_array<uint64_t>( (int32_t)200,  (int32_t)1);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)200; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)1; i1++){
Arr2DIdxRowM(tmp82, (int32_t)200, (int32_t)1,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp12, (int32_t)200, (int32_t)1,i0,i1), Arr2DIdxRowM(tmp13, (int32_t)200, (int32_t)1,i0,i1));
}
}
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp13);
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp12);

uint64_t* tmp85 = make_array<uint64_t>( (int32_t)200,  (int32_t)1);
Relu2( (int32_t)200,  (int32_t)1, tmp82, tmp85,  (int32_t)0, 0);
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp82);

int32_t* tmp87 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp87, (int32_t)2, (int64_t)0) =  (int32_t)0;
Arr1DIdxRowM(tmp87, (int32_t)2, (int64_t)1) =  (int32_t)1;

uint64_t tmp88;

uint64_t* tmp89 = make_array<uint64_t>( (int32_t)1);
tmp88 = funcSSCons( (int64_t)0);
for (uint32_t i16 =  (int32_t)0; i16 <  (int32_t)200; i16++){
for (uint32_t i17 =  (int32_t)0; i17 <  (int32_t)1; i17++){
tmp88 = SecretAdd(tmp88, Arr2DIdxRowM(tmp85, (int32_t)200, (int32_t)1,i16,i17));
}
}
Arr1DIdxRowM(tmp89, (int32_t)1, (int32_t)0) = tmp88;

uint64_t* tmp90 = make_array<uint64_t>( (int32_t)200,  (int32_t)1);

uint64_t* tmp91 = make_array<uint64_t>( (int32_t)200);

uint64_t* tmp92 = make_array<uint64_t>( (int32_t)200);

uint64_t* tmp93 = make_array<uint64_t>( (int32_t)200);

int32_t tmp94;
for (uint32_t i18 =  (int32_t)0; i18 <  (int32_t)200; i18++){
for (uint32_t i19 =  (int32_t)0; i19 <  (int32_t)1; i19++){
tmp94 = (( (int32_t)0 + (i18 *  (int32_t)1)) + (i19 *  (int32_t)1));
Arr1DIdxRowM(tmp91, (int32_t)200,tmp94) = Arr2DIdxRowM(tmp85, (int32_t)200, (int32_t)1,i18,i19);
Arr1DIdxRowM(tmp92, (int32_t)200,tmp94) = Arr1DIdxRowM(tmp89, (int32_t)1,i19);
}
}
ElemWiseActModelVectorMult( (int32_t)200, tmp91, tmp92, tmp93);
ClearMemSecret1( (int32_t)200, tmp91);
ClearMemSecret1( (int32_t)200, tmp92);
for (uint32_t i18 =  (int32_t)0; i18 <  (int32_t)200; i18++){
for (uint32_t i19 =  (int32_t)0; i19 <  (int32_t)1; i19++){
tmp94 = (( (int32_t)0 + (i18 *  (int32_t)1)) + (i19 *  (int32_t)1));
Arr2DIdxRowM(tmp90, (int32_t)200, (int32_t)1,i18,i19) = Arr1DIdxRowM(tmp93, (int32_t)200,tmp94);
}
}
ClearMemSecret1( (int32_t)200, tmp93);
ClearMemSecret1( (int32_t)1, tmp89);
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp85);
ScaleDown2( (int32_t)200,  (int32_t)256, tmp80,  (int32_t)12);
ScaleDown2( (int32_t)200,  (int32_t)1, tmp90,  (int32_t)12);

uint64_t* tmp97 = make_array<uint64_t>( (int32_t)200,  (int32_t)256);

uint64_t* tmp98 = make_array<uint64_t>( (int32_t)51200);

uint64_t* tmp99 = make_array<uint64_t>( (int32_t)51200);

uint64_t* tmp100 = make_array<uint64_t>( (int32_t)51200);

int32_t tmp101;
for (uint32_t i20 =  (int32_t)0; i20 <  (int32_t)200; i20++){
for (uint32_t i21 =  (int32_t)0; i21 <  (int32_t)256; i21++){
tmp101 = (( (int32_t)0 + (i20 *  (int32_t)256)) + (i21 *  (int32_t)1));
Arr1DIdxRowM(tmp98, (int32_t)51200,tmp101) = Arr2DIdxRowM(tmp80, (int32_t)200, (int32_t)256,i20,i21);
Arr1DIdxRowM(tmp99, (int32_t)51200,tmp101) = Arr2DIdxRowM(tmp90, (int32_t)200, (int32_t)1,i20, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)51200, tmp98, tmp99, tmp100);
ClearMemSecret1( (int32_t)51200, tmp98);
ClearMemSecret1( (int32_t)51200, tmp99);
for (uint32_t i20 =  (int32_t)0; i20 <  (int32_t)200; i20++){
for (uint32_t i21 =  (int32_t)0; i21 <  (int32_t)256; i21++){
tmp101 = (( (int32_t)0 + (i20 *  (int32_t)256)) + (i21 *  (int32_t)1));
Arr2DIdxRowM(tmp97, (int32_t)200, (int32_t)256,i20,i21) = Arr1DIdxRowM(tmp100, (int32_t)51200,tmp101);
}
}
ClearMemSecret1( (int32_t)51200, tmp100);
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp90);
ClearMemSecret2( (int32_t)200,  (int32_t)256, tmp80);

int32_t tmp104 =  (int32_t)0;

uint64_t tmp105;

uint64_t* tmp106 = make_array<uint64_t>( (int32_t)256);
for (uint32_t i22 =  (int32_t)0; i22 <  (int32_t)256; i22++){
tmp105 = funcSSCons( (int64_t)0);
for (uint32_t i23 =  (int32_t)0; i23 <  (int32_t)200; i23++){
tmp105 = SecretAdd(tmp105, Arr2DIdxRowM(tmp97, (int32_t)200, (int32_t)256,i23,i22));
}
Arr1DIdxRowM(tmp106, (int32_t)256,i22) = tmp105;
}
ClearMemSecret2( (int32_t)200,  (int32_t)256, tmp97);

int32_t* tmp108 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp108, (int32_t)2, (int64_t)0) =  (int32_t)-1;
Arr1DIdxRowM(tmp108, (int32_t)2, (int64_t)1) =  (int32_t)256;
...
Arr2DIdxRowM(tmp109, (int32_t)1, (int32_t)256,i25,i26) = Arr1DIdxRowM(tmp106, (int32_t)256,i24);
i24 = (i24 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)256, tmp106);
ScaleUp2( (int32_t)1,  (int32_t)256, tmp78,  (int32_t)12);

uint64_t* tmp111 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp111, (int32_t)1, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp109, (int32_t)1, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp78, (int32_t)1, (int32_t)256,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp109);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp78);

uint64_t* tmp114 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
ScaleDown2( (int32_t)1,  (int32_t)256, tmp111,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)256,  (int32_t)256, tmp111, tmp14, tmp114, 0);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp111);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp117, (int32_t)1, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp114, (int32_t)1, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp15, (int32_t)1, (int32_t)256,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp15);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp114);

uint64_t* tmp120 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
Relu2( (int32_t)1,  (int32_t)256, tmp117, tmp120,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp117);
ScaleUp2( (int32_t)200,  (int32_t)256, tmp3,  (int32_t)12);

uint64_t* tmp122 = make_array<uint64_t>( (int32_t)200,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)200; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp122, (int32_t)200, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp3, (int32_t)200, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp20, (int32_t)200, (int32_t)256,i0,i1));
}
}
ClearMemSecret2( (int32_t)200,  (int32_t)256, tmp3);
ClearMemSecret2( (int32_t)200,  (int32_t)256, tmp20);

uint64_t* tmp125 = make_array<uint64_t>( (int32_t)200,  (int32_t)1);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)200; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)1; i1++){
Arr2DIdxRowM(tmp125, (int32_t)200, (int32_t)1,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp16, (int32_t)200, (int32_t)1,i0,i1), Arr2DIdxRowM(tmp17, (int32_t)200, (int32_t)1,i0,i1));
}
}
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp17);
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp16);

uint64_t* tmp128 = make_array<uint64_t>( (int32_t)200,  (int32_t)1);
Relu2( (int32_t)200,  (int32_t)1, tmp125, tmp128,  (int32_t)0, 0);
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp125);

int32_t* tmp130 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp130, (int32_t)2, (int64_t)0) =  (int32_t)0;
Arr1DIdxRowM(tmp130, (int32_t)2, (int64_t)1) =  (int32_t)1;

uint64_t tmp131;

uint64_t* tmp132 = make_array<uint64_t>( (int32_t)1);
tmp131 = funcSSCons( (int64_t)0);
for (uint32_t i27 =  (int32_t)0; i27 <  (int32_t)200; i27++){
for (uint32_t i28 =  (int32_t)0; i28 <  (int32_t)1; i28++){
tmp131 = SecretAdd(tmp131, Arr2DIdxRowM(tmp128, (int32_t)200, (int32_t)1,i27,i28));
}
}
Arr1DIdxRowM(tmp132, (int32_t)1, (int32_t)0) = tmp131;

uint64_t* tmp133 = make_array<uint64_t>( (int32_t)200,  (int32_t)1);

uint64_t* tmp134 = make_array<uint64_t>( (int32_t)200);

uint64_t* tmp135 = make_array<uint64_t>( (int32_t)200);

uint64_t* tmp136 = make_array<uint64_t>( (int32_t)200);

int32_t tmp137;
for (uint32_t i29 =  (int32_t)0; i29 <  (int32_t)200; i29++){
for (uint32_t i30 =  (int32_t)0; i30 <  (int32_t)1; i30++){
tmp137 = (( (int32_t)0 + (i29 *  (int32_t)1)) + (i30 *  (int32_t)1));
Arr1DIdxRowM(tmp134, (int32_t)200,tmp137) = Arr2DIdxRowM(tmp128, (int32_t)200, (int32_t)1,i29,i30);
Arr1DIdxRowM(tmp135, (int32_t)200,tmp137) = Arr1DIdxRowM(tmp132, (int32_t)1,i30);
}
}
ElemWiseActModelVectorMult( (int32_t)200, tmp134, tmp135, tmp136);
ClearMemSecret1( (int32_t)200, tmp134);
ClearMemSecret1( (int32_t)200, tmp135);
for (uint32_t i29 =  (int32_t)0; i29 <  (int32_t)200; i29++){
for (uint32_t i30 =  (int32_t)0; i30 <  (int32_t)1; i30++){
tmp137 = (( (int32_t)0 + (i29 *  (int32_t)1)) + (i30 *  (int32_t)1));
Arr2DIdxRowM(tmp133, (int32_t)200, (int32_t)1,i29,i30) = Arr1DIdxRowM(tmp136, (int32_t)200,tmp137);
}
}
ClearMemSecret1( (int32_t)200, tmp136);
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp128);
ClearMemSecret1( (int32_t)1, tmp132);
ScaleDown2( (int32_t)200,  (int32_t)256, tmp122,  (int32_t)12);
ScaleDown2( (int32_t)200,  (int32_t)1, tmp133,  (int32_t)12);

uint64_t* tmp140 = make_array<uint64_t>( (int32_t)200,  (int32_t)256);

uint64_t* tmp141 = make_array<uint64_t>( (int32_t)51200);

uint64_t* tmp142 = make_array<uint64_t>( (int32_t)51200);

uint64_t* tmp143 = make_array<uint64_t>( (int32_t)51200);

int32_t tmp144;
for (uint32_t i31 =  (int32_t)0; i31 <  (int32_t)200; i31++){
for (uint32_t i32 =  (int32_t)0; i32 <  (int32_t)256; i32++){
tmp144 = (( (int32_t)0 + (i31 *  (int32_t)256)) + (i32 *  (int32_t)1));
Arr1DIdxRowM(tmp141, (int32_t)51200,tmp144) = Arr2DIdxRowM(tmp122, (int32_t)200, (int32_t)256,i31,i32);
Arr1DIdxRowM(tmp142, (int32_t)51200,tmp144) = Arr2DIdxRowM(tmp133, (int32_t)200, (int32_t)1,i31, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)51200, tmp141, tmp142, tmp143);
ClearMemSecret1( (int32_t)51200, tmp141);
ClearMemSecret1( (int32_t)51200, tmp142);
for (uint32_t i31 =  (int32_t)0; i31 <  (int32_t)200; i31++){
for (uint32_t i32 =  (int32_t)0; i32 <  (int32_t)256; i32++){
tmp144 = (( (int32_t)0 + (i31 *  (int32_t)256)) + (i32 *  (int32_t)1));
Arr2DIdxRowM(tmp140, (int32_t)200, (int32_t)256,i31,i32) = Arr1DIdxRowM(tmp143, (int32_t)51200,tmp144);
}
}
ClearMemSecret1( (int32_t)51200, tmp143);
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp133);
ClearMemSecret2( (int32_t)200,  (int32_t)256, tmp122);

int32_t tmp147 =  (int32_t)0;

uint64_t tmp148;

uint64_t* tmp149 = make_array<uint64_t>( (int32_t)256);
for (uint32_t i33 =  (int32_t)0; i33 <  (int32_t)256; i33++){
tmp148 = funcSSCons( (int64_t)0);
for (uint32_t i34 =  (int32_t)0; i34 <  (int32_t)200; i34++){
tmp148 = SecretAdd(tmp148, Arr2DIdxRowM(tmp140, (int32_t)200, (int32_t)256,i34,i33));
}
Arr1DIdxRowM(tmp149, (int32_t)256,i33) = tmp148;
}
ClearMemSecret2( (int32_t)200,  (int32_t)256, tmp140);

int32_t* tmp151 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp151, (int32_t)2, (int64_t)0) =  (int32_t)-1;
Arr1DIdxRowM(tmp151, (int32_t)2, (int64_t)1) =  (int32_t)256;
...
for (uint32_t i37 =  (int32_t)0; i37 <  (int32_t)256; i37++){
Arr2DIdxRowM(tmp152, (int32_t)1, (int32_t)256,i36,i37) = Arr1DIdxRowM(tmp149, (int32_t)256,i35);
i35 = (i35 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)256, tmp149);
ScaleUp2( (int32_t)1,  (int32_t)256, tmp120,  (int32_t)12);

uint64_t* tmp154 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp154, (int32_t)1, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp152, (int32_t)1, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp120, (int32_t)1, (int32_t)256,i0,i1));
}
}
...
ScaleDown2( (int32_t)1,  (int32_t)256, tmp154,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)256,  (int32_t)256, tmp154, tmp18, tmp157, 0);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp160, (int32_t)1, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp157, (int32_t)1, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp19, (int32_t)1, (int32_t)256,i0,i1));
}
}
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp157);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp19);

uint64_t* tmp163 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
Relu2( (int32_t)1,  (int32_t)256, tmp160, tmp163,  (int32_t)12, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp160);
EndComputation();
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (uint32_t)0; i1 <  (int32_t)256; i1++){
cout << (funcReconstruct2PCCons(Arr2DIdxRowM(tmp163, (int32_t)1, (int32_t)256,i0,i1), 2)) << endl;
}
}
}
