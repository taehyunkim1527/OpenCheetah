...
int32_t tmp11 =  (int32_t)0;

uint64_t tmp12;

uint64_t* tmp13 = make_array<uint64_t>( (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)128; i0++){
tmp12 = funcSSCons( (int64_t)0);
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)10; i1++){
tmp12 = SecretAdd(tmp12, Arr2DIdxRowM(tmp1, (int32_t)10, (int32_t)128,i1,i0));
}
Arr1DIdxRowM(tmp13, (int32_t)128,i0) = tmp12;
}
...
Arr1DIdxRowM(tmp15, (int32_t)2, (int64_t)1) =  (int32_t)128;
...
Arr2DIdxRowM(tmp16, (int32_t)1, (int32_t)128,i3,i4) = Arr1DIdxRowM(tmp13, (int32_t)128,i2);
i2 = (i2 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)128, tmp13);
...
Arr2DIdxRowM(tmp18, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp16, (int32_t)1, (int32_t)128,i0,i1), Arr1DIdxRowM(tmp0, (int32_t)128,i1));
}
}
...
MatMul2D( (int32_t)1,  (int32_t)128,  (int32_t)128, tmp18, tmp3, tmp21, 0);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp24, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp21, (int32_t)1, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp4, (int32_t)1, (int32_t)128,i0,i1));
}
}
...
tmp38 = SecretAdd(tmp38, Arr2DIdxRowM(tmp2, (int32_t)10, (int32_t)128,i6,i5));
}
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp44, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp42, (int32_t)1, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp35, (int32_t)1, (int32_t)128,i0,i1));
}
}
...
MatMul2D( (int32_t)1,  (int32_t)128,  (int32_t)128, tmp53, tmp9, tmp55, 0);
...
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (uint32_t)0; i1 <  (int32_t)128; i1++){
cout << (funcReconstruct2PCCons(Arr2DIdxRowM(tmp61, (int32_t)1, (int32_t)128,i0,i1), 2)) << endl;
}
}
}
