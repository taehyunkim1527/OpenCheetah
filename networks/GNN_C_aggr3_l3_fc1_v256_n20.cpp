...
int32_t* tmp3 = make_array<int32_t>( (int32_t)4);
Arr1DIdxRowM(tmp3, (int32_t)4, (int64_t)0) =  (int32_t)256;
Arr1DIdxRowM(tmp3, (int32_t)4, (int64_t)1) =  (int32_t)1;
Arr1DIdxRowM(tmp3, (int32_t)4, (int64_t)2) =  (int32_t)20;
Arr1DIdxRowM(tmp3, (int32_t)4, (int64_t)3) =  (int32_t)1;

uint64_t* tmp4 = make_array<uint64_t>( (int32_t)256,  (int32_t)1,  (int32_t)20,  (int32_t)1);
...
Arr4DIdxRowM(tmp4, (int32_t)256, (int32_t)1, (int32_t)20, (int32_t)1,i2,i3,i4,i5) = Arr2DIdxRowM(tmp0, (int32_t)20, (int32_t)256,i0,i1);
i1 = (i1 +  (int64_t)1);
if ((i1 ==  (int64_t)256)) {
i1 =  (int64_t)0;
i0 = (i0 +  (int64_t)1);
...
uint64_t* tmp6 = make_array<uint64_t>( (int32_t)256,  (int32_t)1,  (int32_t)1,  (int32_t)1);
MaxPool( (int32_t)256,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)20,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1,  (int32_t)256,  (int32_t)1,  (int32_t)20,  (int32_t)1, tmp4, tmp6);
ClearMemSecret4( (int32_t)256,  (int32_t)1,  (int32_t)20,  (int32_t)1, tmp4);

int32_t* tmp8 = make_array<int32_t>( (int32_t)4);
Arr1DIdxRowM(tmp8, (int32_t)4, (int64_t)0) =  (int32_t)256;
Arr1DIdxRowM(tmp8, (int32_t)4, (int64_t)1) =  (int32_t)1;
Arr1DIdxRowM(tmp8, (int32_t)4, (int64_t)2) =  (int32_t)20;
Arr1DIdxRowM(tmp8, (int32_t)4, (int64_t)3) =  (int32_t)1;

uint64_t* tmp9 = make_array<uint64_t>( (int32_t)256,  (int32_t)1,  (int32_t)20,  (int32_t)1);
...
Arr4DIdxRowM(tmp9, (int32_t)256, (int32_t)1, (int32_t)20, (int32_t)1,i8,i9,i10,i11) = Arr2DIdxRowM(tmp1, (int32_t)20, (int32_t)256,i6,i7);
i7 = (i7 +  (int64_t)1);
if ((i7 ==  (int64_t)256)) {
i7 =  (int64_t)0;
i6 = (i6 +  (int64_t)1);
...
uint64_t* tmp11 = make_array<uint64_t>( (int32_t)256,  (int32_t)1,  (int32_t)1,  (int32_t)1);
MaxPool( (int32_t)256,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)20,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1,  (int32_t)256,  (int32_t)1,  (int32_t)20,  (int32_t)1, tmp9, tmp11);
ClearMemSecret4( (int32_t)256,  (int32_t)1,  (int32_t)20,  (int32_t)1, tmp9);

int32_t* tmp13 = make_array<int32_t>( (int32_t)4);
Arr1DIdxRowM(tmp13, (int32_t)4, (int64_t)0) =  (int32_t)256;
Arr1DIdxRowM(tmp13, (int32_t)4, (int64_t)1) =  (int32_t)1;
Arr1DIdxRowM(tmp13, (int32_t)4, (int64_t)2) =  (int32_t)20;
Arr1DIdxRowM(tmp13, (int32_t)4, (int64_t)3) =  (int32_t)1;

uint64_t* tmp14 = make_array<uint64_t>( (int32_t)256,  (int32_t)1,  (int32_t)20,  (int32_t)1);
...
for (uint32_t i16 =  (int32_t)0; i16 <  (int32_t)20; i16++){
for (uint32_t i17 =  (int32_t)0; i17 <  (int32_t)1; i17++){
Arr4DIdxRowM(tmp14, (int32_t)256, (int32_t)1, (int32_t)20, (int32_t)1,i14,i15,i16,i17) = Arr2DIdxRowM(tmp2, (int32_t)20, (int32_t)256,i12,i13);
i13 = (i13 +  (int64_t)1);
if ((i13 ==  (int64_t)256)) {
i13 =  (int64_t)0;
i12 = (i12 +  (int64_t)1);
...
uint64_t* tmp16 = make_array<uint64_t>( (int32_t)256,  (int32_t)1,  (int32_t)1,  (int32_t)1);
MaxPool( (int32_t)256,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)1,  (int32_t)20,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)1,  (int32_t)1,  (int32_t)256,  (int32_t)1,  (int32_t)20,  (int32_t)1, tmp14, tmp16);
ClearMemSecret4( (int32_t)256,  (int32_t)1,  (int32_t)20,  (int32_t)1, tmp14);
EndComputation();
...
cout << (funcReconstruct2PCCons(Arr4DIdxRowM(tmp16, (int32_t)256, (int32_t)1, (int32_t)1, (int32_t)1,i0,i1,i2,i3), 2)) << endl;
}
}
}
}
