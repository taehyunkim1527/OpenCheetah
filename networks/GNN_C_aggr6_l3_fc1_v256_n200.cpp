...
uint64_t* tmp1 = make_array<uint64_t>( (int32_t)200,  (int32_t)1);
...
Arr2DIdxRowM(tmp1, (int32_t)200, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp1 : 0;
}
}

uint64_t* tmp2 = make_array<uint64_t>( (int32_t)200,  (int32_t)1);
...
Arr2DIdxRowM(tmp2, (int32_t)200, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp2 : 0;
}
}
StartComputation();

uint64_t* tmp3 = make_array<uint64_t>( (int32_t)200,  (int32_t)1);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)200; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)1; i1++){
Arr2DIdxRowM(tmp3, (int32_t)200, (int32_t)1,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp1, (int32_t)200, (int32_t)1,i0,i1), Arr2DIdxRowM(tmp2, (int32_t)200, (int32_t)1,i0,i1));
}
}
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp1);
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp2);

uint64_t* tmp6 = make_array<uint64_t>( (int32_t)200,  (int32_t)1);
Relu2( (int32_t)200,  (int32_t)1, tmp3, tmp6,  (int32_t)0, 0);
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp3);

int32_t* tmp8 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp8, (int32_t)2, (int64_t)0) =  (int32_t)0;
Arr1DIdxRowM(tmp8, (int32_t)2, (int64_t)1) =  (int32_t)1;

uint64_t tmp9;

uint64_t* tmp10 = make_array<uint64_t>( (int32_t)1);
tmp9 = funcSSCons( (int64_t)0);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)200; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)1; i1++){
tmp9 = SecretAdd(tmp9, Arr2DIdxRowM(tmp6, (int32_t)200, (int32_t)1,i0,i1));
}
}
Arr1DIdxRowM(tmp10, (int32_t)1, (int32_t)0) = tmp9;
...
tmp15 = (( (int32_t)0 + (i2 *  (int32_t)256)) + (i3 *  (int32_t)1));
Arr1DIdxRowM(tmp12, (int32_t)51200,tmp15) = Arr2DIdxRowM(tmp0, (int32_t)200, (int32_t)256,i2,i3);
Arr1DIdxRowM(tmp13, (int32_t)51200,tmp15) = Arr2DIdxRowM(tmp6, (int32_t)200, (int32_t)1,i2, (int32_t)0);
}
}
...
for (uint32_t i3 =  (int32_t)0; i3 <  (int32_t)256; i3++){
tmp15 = (( (int32_t)0 + (i2 *  (int32_t)256)) + (i3 *  (int32_t)1));
Arr2DIdxRowM(tmp11, (int32_t)200, (int32_t)256,i2,i3) = Arr1DIdxRowM(tmp14, (int32_t)51200,tmp15);
}
}
...
tmp19 = SecretAdd(tmp19, Arr2DIdxRowM(tmp11, (int32_t)200, (int32_t)256,i5,i4));
}
Arr1DIdxRowM(tmp20, (int32_t)256,i4) = tmp19;
}
...
cout << (funcReconstruct2PCCons(Arr1DIdxRowM(tmp20, (int32_t)256,i0), 2)) << endl;
}
}
