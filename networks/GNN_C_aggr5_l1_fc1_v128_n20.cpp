...
uint64_t* tmp4 = make_array<uint64_t>( (int32_t)20,  (int32_t)128);
...
Arr2DIdxRowM(tmp4, (int32_t)20, (int32_t)128,i0,i1) = (party == SERVER) ? __tmp_in_tmp4 : 0;
}
}
StartComputation();
...
Arr1DIdxRowM(tmp6, (int32_t)2560,tmp9) = Arr2DIdxRowM(tmp2, (int32_t)20, (int32_t)128,i0,i1);
Arr1DIdxRowM(tmp7, (int32_t)2560,tmp9) = Arr2DIdxRowM(tmp1, (int32_t)1, (int32_t)128, (int32_t)0,i1);
}
}
...
ScaleDown2( (int32_t)20,  (int32_t)128, tmp12,  (int32_t)12);

uint64_t* tmp15 = make_array<uint64_t>( (int32_t)20,  (int32_t)128);
...
Arr1DIdxRowM(tmp16, (int32_t)2560,tmp19) = Arr2DIdxRowM(tmp12, (int32_t)20, (int32_t)128,i2,i3);
Arr1DIdxRowM(tmp17, (int32_t)2560,tmp19) = Arr2DIdxRowM(tmp4, (int32_t)20, (int32_t)128,i2,i3);
}
}
...
for (uint32_t i3 =  (int32_t)0; i3 <  (int32_t)128; i3++){
tmp19 = (( (int32_t)0 + (i2 *  (int32_t)128)) + (i3 *  (int32_t)1));
Arr2DIdxRowM(tmp15, (int32_t)20, (int32_t)128,i2,i3) = Arr1DIdxRowM(tmp18, (int32_t)2560,tmp19);
}
}
ClearMemSecret1( (int32_t)2560, tmp18);
ClearMemSecret2( (int32_t)20,  (int32_t)128, tmp4);
...
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)20; i5++){
tmp23 = SecretAdd(tmp23, Arr2DIdxRowM(tmp15, (int32_t)20, (int32_t)128,i5,i4));
}
Arr1DIdxRowM(tmp24, (int32_t)128,i4) = tmp23;
}
ClearMemSecret2( (int32_t)20,  (int32_t)128, tmp15);
