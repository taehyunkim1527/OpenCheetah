...
uint64_t* tmp1 = make_array<uint64_t>( (int32_t)20,  (int32_t)256);
...
Arr2DIdxRowM(tmp1, (int32_t)20, (int32_t)256,i0,i1) = (party == SERVER) ? __tmp_in_tmp1 : 0;
}
}

uint64_t* tmp2 = make_array<uint64_t>( (int32_t)20,  (int32_t)256);
...
Arr2DIdxRowM(tmp2, (int32_t)20, (int32_t)256,i0,i1) = (party == SERVER) ? __tmp_in_tmp2 : 0;
}
}
...
uint64_t* tmp7 = make_array<uint64_t>( (int32_t)20,  (int32_t)1);
/* Variable to read the clear value corresponding to the input variable tmp7 at (9048,1-9048,37) */
...
Arr2DIdxRowM(tmp7, (int32_t)20, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp7 : 0;
}
}

uint64_t* tmp8 = make_array<uint64_t>( (int32_t)20,  (int32_t)1);
...
Arr2DIdxRowM(tmp8, (int32_t)20, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp8 : 0;
}
}
...
uint64_t* tmp11 = make_array<uint64_t>( (int32_t)20,  (int32_t)1);
...
Arr2DIdxRowM(tmp11, (int32_t)20, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp11 : 0;
}
}

uint64_t* tmp12 = make_array<uint64_t>( (int32_t)20,  (int32_t)1);
...
Arr2DIdxRowM(tmp12, (int32_t)20, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp12 : 0;
}
}
...
uint64_t* tmp40 = make_array<uint64_t>( (int32_t)20,  (int32_t)1);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)20; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)1; i1++){
Arr2DIdxRowM(tmp40, (int32_t)20, (int32_t)1,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp7, (int32_t)20, (int32_t)1,i0,i1), Arr2DIdxRowM(tmp8, (int32_t)20, (int32_t)1,i0,i1));
}
}
ClearMemSecret2( (int32_t)20,  (int32_t)1, tmp8);
ClearMemSecret2( (int32_t)20,  (int32_t)1, tmp7);

uint64_t* tmp43 = make_array<uint64_t>( (int32_t)20,  (int32_t)1);
Relu2( (int32_t)20,  (int32_t)1, tmp40, tmp43,  (int32_t)0, 0);
ClearMemSecret2( (int32_t)20,  (int32_t)1, tmp40);
...
for (uint32_t i7 =  (int32_t)0; i7 <  (int32_t)20; i7++){
for (uint32_t i8 =  (int32_t)0; i8 <  (int32_t)1; i8++){
tmp46 = SecretAdd(tmp46, Arr2DIdxRowM(tmp43, (int32_t)20, (int32_t)1,i7,i8));
}
}
Arr1DIdxRowM(tmp47, (int32_t)1, (int32_t)0) = tmp46;

uint64_t* tmp48 = make_array<uint64_t>( (int32_t)20,  (int32_t)1);

uint64_t* tmp49 = make_array<uint64_t>( (int32_t)20);

uint64_t* tmp50 = make_array<uint64_t>( (int32_t)20);

uint64_t* tmp51 = make_array<uint64_t>( (int32_t)20);

int32_t tmp52;
for (uint32_t i9 =  (int32_t)0; i9 <  (int32_t)20; i9++){
for (uint32_t i10 =  (int32_t)0; i10 <  (int32_t)1; i10++){
tmp52 = (( (int32_t)0 + (i9 *  (int32_t)1)) + (i10 *  (int32_t)1));
Arr1DIdxRowM(tmp49, (int32_t)20,tmp52) = Arr2DIdxRowM(tmp43, (int32_t)20, (int32_t)1,i9,i10);
Arr1DIdxRowM(tmp50, (int32_t)20,tmp52) = Arr1DIdxRowM(tmp47, (int32_t)1,i10);
}
}
ElemWiseActModelVectorMult( (int32_t)20, tmp49, tmp50, tmp51);
ClearMemSecret1( (int32_t)20, tmp49);
ClearMemSecret1( (int32_t)20, tmp50);
for (uint32_t i9 =  (int32_t)0; i9 <  (int32_t)20; i9++){
for (uint32_t i10 =  (int32_t)0; i10 <  (int32_t)1; i10++){
tmp52 = (( (int32_t)0 + (i9 *  (int32_t)1)) + (i10 *  (int32_t)1));
Arr2DIdxRowM(tmp48, (int32_t)20, (int32_t)1,i9,i10) = Arr1DIdxRowM(tmp51, (int32_t)20,tmp52);
}
}
ClearMemSecret1( (int32_t)20, tmp51);
ClearMemSecret1( (int32_t)1, tmp47);
ClearMemSecret2( (int32_t)20,  (int32_t)1, tmp43);
ScaleDown2( (int32_t)20,  (int32_t)1, tmp48,  (int32_t)12);

uint64_t* tmp55 = make_array<uint64_t>( (int32_t)20,  (int32_t)256);

uint64_t* tmp56 = make_array<uint64_t>( (int32_t)5120);

uint64_t* tmp57 = make_array<uint64_t>( (int32_t)5120);

uint64_t* tmp58 = make_array<uint64_t>( (int32_t)5120);

int32_t tmp59;
for (uint32_t i11 =  (int32_t)0; i11 <  (int32_t)20; i11++){
for (uint32_t i12 =  (int32_t)0; i12 <  (int32_t)256; i12++){
tmp59 = (( (int32_t)0 + (i11 *  (int32_t)256)) + (i12 *  (int32_t)1));
Arr1DIdxRowM(tmp56, (int32_t)5120,tmp59) = Arr2DIdxRowM(tmp1, (int32_t)20, (int32_t)256,i11,i12);
Arr1DIdxRowM(tmp57, (int32_t)5120,tmp59) = Arr2DIdxRowM(tmp48, (int32_t)20, (int32_t)1,i11, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)5120, tmp56, tmp57, tmp58);
ClearMemSecret1( (int32_t)5120, tmp56);
ClearMemSecret1( (int32_t)5120, tmp57);
for (uint32_t i11 =  (int32_t)0; i11 <  (int32_t)20; i11++){
for (uint32_t i12 =  (int32_t)0; i12 <  (int32_t)256; i12++){
tmp59 = (( (int32_t)0 + (i11 *  (int32_t)256)) + (i12 *  (int32_t)1));
Arr2DIdxRowM(tmp55, (int32_t)20, (int32_t)256,i11,i12) = Arr1DIdxRowM(tmp58, (int32_t)5120,tmp59);
}
}
ClearMemSecret1( (int32_t)5120, tmp58);
ClearMemSecret2( (int32_t)20,  (int32_t)1, tmp48);
ClearMemSecret2( (int32_t)20,  (int32_t)256, tmp1);
...
for (uint32_t i14 =  (int32_t)0; i14 <  (int32_t)20; i14++){
tmp63 = SecretAdd(tmp63, Arr2DIdxRowM(tmp55, (int32_t)20, (int32_t)256,i14,i13));
}
Arr1DIdxRowM(tmp64, (int32_t)256,i13) = tmp63;
}
ClearMemSecret2( (int32_t)20,  (int32_t)256, tmp55);
...
uint64_t* tmp80 = make_array<uint64_t>( (int32_t)20,  (int32_t)1);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)20; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)1; i1++){
Arr2DIdxRowM(tmp80, (int32_t)20, (int32_t)1,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp11, (int32_t)20, (int32_t)1,i0,i1), Arr2DIdxRowM(tmp12, (int32_t)20, (int32_t)1,i0,i1));
}
}
ClearMemSecret2( (int32_t)20,  (int32_t)1, tmp11);
ClearMemSecret2( (int32_t)20,  (int32_t)1, tmp12);

uint64_t* tmp83 = make_array<uint64_t>( (int32_t)20,  (int32_t)1);
Relu2( (int32_t)20,  (int32_t)1, tmp80, tmp83,  (int32_t)0, 0);
ClearMemSecret2( (int32_t)20,  (int32_t)1, tmp80);
...
for (uint32_t i18 =  (int32_t)0; i18 <  (int32_t)20; i18++){
for (uint32_t i19 =  (int32_t)0; i19 <  (int32_t)1; i19++){
tmp86 = SecretAdd(tmp86, Arr2DIdxRowM(tmp83, (int32_t)20, (int32_t)1,i18,i19));
}
}
Arr1DIdxRowM(tmp87, (int32_t)1, (int32_t)0) = tmp86;

uint64_t* tmp88 = make_array<uint64_t>( (int32_t)20,  (int32_t)1);

uint64_t* tmp89 = make_array<uint64_t>( (int32_t)20);

uint64_t* tmp90 = make_array<uint64_t>( (int32_t)20);

uint64_t* tmp91 = make_array<uint64_t>( (int32_t)20);

int32_t tmp92;
for (uint32_t i20 =  (int32_t)0; i20 <  (int32_t)20; i20++){
for (uint32_t i21 =  (int32_t)0; i21 <  (int32_t)1; i21++){
tmp92 = (( (int32_t)0 + (i20 *  (int32_t)1)) + (i21 *  (int32_t)1));
Arr1DIdxRowM(tmp89, (int32_t)20,tmp92) = Arr2DIdxRowM(tmp83, (int32_t)20, (int32_t)1,i20,i21);
Arr1DIdxRowM(tmp90, (int32_t)20,tmp92) = Arr1DIdxRowM(tmp87, (int32_t)1,i21);
}
}
ElemWiseActModelVectorMult( (int32_t)20, tmp89, tmp90, tmp91);
ClearMemSecret1( (int32_t)20, tmp89);
ClearMemSecret1( (int32_t)20, tmp90);
for (uint32_t i20 =  (int32_t)0; i20 <  (int32_t)20; i20++){
for (uint32_t i21 =  (int32_t)0; i21 <  (int32_t)1; i21++){
tmp92 = (( (int32_t)0 + (i20 *  (int32_t)1)) + (i21 *  (int32_t)1));
Arr2DIdxRowM(tmp88, (int32_t)20, (int32_t)1,i20,i21) = Arr1DIdxRowM(tmp91, (int32_t)20,tmp92);
}
}
ClearMemSecret1( (int32_t)20, tmp91);
ClearMemSecret2( (int32_t)20,  (int32_t)1, tmp83);
ClearMemSecret1( (int32_t)1, tmp87);
ScaleDown2( (int32_t)20,  (int32_t)1, tmp88,  (int32_t)12);

uint64_t* tmp95 = make_array<uint64_t>( (int32_t)20,  (int32_t)256);
...
int32_t tmp99;
for (uint32_t i22 =  (int32_t)0; i22 <  (int32_t)20; i22++){
for (uint32_t i23 =  (int32_t)0; i23 <  (int32_t)256; i23++){
tmp99 = (( (int32_t)0 + (i22 *  (int32_t)256)) + (i23 *  (int32_t)1));
Arr1DIdxRowM(tmp96, (int32_t)5120,tmp99) = Arr2DIdxRowM(tmp2, (int32_t)20, (int32_t)256,i22,i23);
Arr1DIdxRowM(tmp97, (int32_t)5120,tmp99) = Arr2DIdxRowM(tmp88, (int32_t)20, (int32_t)1,i22, (int32_t)0);
}
}
...
for (uint32_t i23 =  (int32_t)0; i23 <  (int32_t)256; i23++){
tmp99 = (( (int32_t)0 + (i22 *  (int32_t)256)) + (i23 *  (int32_t)1));
Arr2DIdxRowM(tmp95, (int32_t)20, (int32_t)256,i22,i23) = Arr1DIdxRowM(tmp98, (int32_t)5120,tmp99);
}
}
ClearMemSecret1( (int32_t)5120, tmp98);
ClearMemSecret2( (int32_t)20,  (int32_t)256, tmp2);
ClearMemSecret2( (int32_t)20,  (int32_t)1, tmp88);
...
for (uint32_t i25 =  (int32_t)0; i25 <  (int32_t)20; i25++){
tmp103 = SecretAdd(tmp103, Arr2DIdxRowM(tmp95, (int32_t)20, (int32_t)256,i25,i24));
}
Arr1DIdxRowM(tmp104, (int32_t)256,i24) = tmp103;
}
ClearMemSecret2( (int32_t)20,  (int32_t)256, tmp95);
