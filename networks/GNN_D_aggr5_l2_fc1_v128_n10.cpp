...
tmp8 = SecretAdd(tmp8, Arr2DIdxRowM(tmp1, (int32_t)10, (int32_t)128,i1,i0));
}
...
Arr2DIdxRowM(tmp12, (int32_t)1, (int32_t)128,i3,i4) = Arr1DIdxRowM(tmp9, (int32_t)128,i2);
i2 = (i2 +  (int64_t)1);
}
}
...
Arr2DIdxRowM(tmp14, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp12, (int32_t)1, (int32_t)128,i0,i1), Arr1DIdxRowM(tmp0, (int32_t)128,i1));
}
}
...
MatMul2D( (int32_t)1,  (int32_t)128,  (int32_t)128, tmp14, tmp3, tmp17, 0);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp20, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp17, (int32_t)1, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp4, (int32_t)1, (int32_t)128,i0,i1));
}
}
...
Relu2( (int32_t)1,  (int32_t)128, tmp20, tmp23,  (int32_t)12, 1);
...
tmp26 = SecretAdd(tmp26, Arr2DIdxRowM(tmp2, (int32_t)10, (int32_t)128,i6,i5));
}
Arr1DIdxRowM(tmp27, (int32_t)128,i5) = tmp26;
}
ClearMemSecret2( (int32_t)10,  (int32_t)128, tmp2);

int32_t* tmp29 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp29, (int32_t)2, (int64_t)0) =  (int32_t)-1;
Arr1DIdxRowM(tmp29, (int32_t)2, (int64_t)1) =  (int32_t)128;
...
Arr2DIdxRowM(tmp30, (int32_t)1, (int32_t)128,i8,i9) = Arr1DIdxRowM(tmp27, (int32_t)128,i7);
i7 = (i7 +  (int64_t)1);
}
}
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp32, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp30, (int32_t)1, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp23, (int32_t)1, (int32_t)128,i0,i1));
}
}
...
MatMul2D( (int32_t)1,  (int32_t)128,  (int32_t)128, tmp32, tmp5, tmp35, 0);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp38, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp35, (int32_t)1, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp6, (int32_t)1, (int32_t)128,i0,i1));
}
}
...
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (uint32_t)0; i1 <  (int32_t)128; i1++){
cout << (funcReconstruct2PCCons(Arr2DIdxRowM(tmp41, (int32_t)1, (int32_t)128,i0,i1), 2)) << endl;
}
}
}
