...
uint64_t* tmp3 = make_array<uint64_t>( (int32_t)1,  (int32_t)1);
/* Variable to read the clear value corresponding to the input variable tmp3 at (9036,1-9036,36) */
...
Arr2DIdxRowM(tmp3, (int32_t)1, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp3 : 0;
}
}
...
int32_t tmp9 =  (int32_t)0;

uint64_t tmp10;

uint64_t* tmp11 = make_array<uint64_t>( (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)128; i0++){
tmp10 = funcSSCons( (int64_t)0);
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)10; i1++){
tmp10 = SecretAdd(tmp10, Arr2DIdxRowM(tmp1, (int32_t)10, (int32_t)128,i1,i0));
}
Arr1DIdxRowM(tmp11, (int32_t)128,i0) = tmp10;
}
ClearMemSecret2( (int32_t)10,  (int32_t)128, tmp1);

int32_t* tmp13 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp13, (int32_t)2, (int64_t)0) =  (int32_t)-1;
Arr1DIdxRowM(tmp13, (int32_t)2, (int64_t)1) =  (int32_t)128;
...
Arr2DIdxRowM(tmp14, (int32_t)1, (int32_t)128,i3,i4) = Arr1DIdxRowM(tmp11, (int32_t)128,i2);
i2 = (i2 +  (int64_t)1);
}
}
...
Arr2DIdxRowM(tmp16, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp14, (int32_t)1, (int32_t)128,i0,i1), Arr1DIdxRowM(tmp0, (int32_t)128,i1));
}
}
...
tmp23 = (( (int32_t)0 + (i5 *  (int32_t)128)) + (i6 *  (int32_t)1));
Arr1DIdxRowM(tmp20, (int32_t)128,tmp23) = Arr2DIdxRowM(tmp16, (int32_t)1, (int32_t)128,i5,i6);
Arr1DIdxRowM(tmp21, (int32_t)128,tmp23) = Arr2DIdxRowM(tmp3, (int32_t)1, (int32_t)1,i5, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)128, tmp20, tmp21, tmp22);
ClearMemSecret1( (int32_t)128, tmp20);
ClearMemSecret1( (int32_t)128, tmp21);
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)1; i5++){
for (uint32_t i6 =  (int32_t)0; i6 <  (int32_t)128; i6++){
tmp23 = (( (int32_t)0 + (i5 *  (int32_t)128)) + (i6 *  (int32_t)1));
Arr2DIdxRowM(tmp19, (int32_t)1, (int32_t)128,i5,i6) = Arr1DIdxRowM(tmp22, (int32_t)128,tmp23);
}
}
ClearMemSecret1( (int32_t)128, tmp22);
ClearMemSecret2( (int32_t)1,  (int32_t)1, tmp3);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp16);

uint64_t* tmp26 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);
ScaleDown2( (int32_t)1,  (int32_t)128, tmp19,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)128,  (int32_t)128, tmp19, tmp4, tmp26, 0);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp29, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp26, (int32_t)1, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp5, (int32_t)1, (int32_t)128,i0,i1));
}
}
...
Relu2( (int32_t)1,  (int32_t)128, tmp29, tmp32,  (int32_t)12, 1);
...
tmp35 = SecretAdd(tmp35, Arr2DIdxRowM(tmp2, (int32_t)10, (int32_t)128,i8,i7));
}
Arr1DIdxRowM(tmp36, (int32_t)128,i7) = tmp35;
}
...
Arr2DIdxRowM(tmp39, (int32_t)1, (int32_t)128,i10,i11) = Arr1DIdxRowM(tmp36, (int32_t)128,i9);
i9 = (i9 +  (int64_t)1);
}
}
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp41, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp39, (int32_t)1, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp32, (int32_t)1, (int32_t)128,i0,i1));
}
}
...
tmp48 = (( (int32_t)0 + (i12 *  (int32_t)128)) + (i13 *  (int32_t)1));
Arr1DIdxRowM(tmp45, (int32_t)128,tmp48) = Arr2DIdxRowM(tmp41, (int32_t)1, (int32_t)128,i12,i13);
Arr1DIdxRowM(tmp46, (int32_t)128,tmp48) = Arr2DIdxRowM(tmp6, (int32_t)1, (int32_t)1,i12, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)128, tmp45, tmp46, tmp47);
ClearMemSecret1( (int32_t)128, tmp45);
ClearMemSecret1( (int32_t)128, tmp46);
for (uint32_t i12 =  (int32_t)0; i12 <  (int32_t)1; i12++){
for (uint32_t i13 =  (int32_t)0; i13 <  (int32_t)128; i13++){
tmp48 = (( (int32_t)0 + (i12 *  (int32_t)128)) + (i13 *  (int32_t)1));
Arr2DIdxRowM(tmp44, (int32_t)1, (int32_t)128,i12,i13) = Arr1DIdxRowM(tmp47, (int32_t)128,tmp48);
}
}
...
MatMul2D( (int32_t)1,  (int32_t)128,  (int32_t)128, tmp44, tmp7, tmp51, 0);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp54, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp51, (int32_t)1, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp8, (int32_t)1, (int32_t)128,i0,i1));
}
}
...
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (uint32_t)0; i1 <  (int32_t)128; i1++){
cout << (funcReconstruct2PCCons(Arr2DIdxRowM(tmp57, (int32_t)1, (int32_t)128,i0,i1), 2)) << endl;
}
}
}
