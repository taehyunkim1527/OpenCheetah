...
Arr1DIdxRowM(tmp5, (int32_t)1280,tmp8) = Arr2DIdxRowM(tmp0, (int32_t)10, (int32_t)128,i0,i1);
Arr1DIdxRowM(tmp6, (int32_t)1280,tmp8) = Arr2DIdxRowM(tmp2, (int32_t)10, (int32_t)128,i0,i1);
}
}
...
tmp12 = SecretAdd(tmp12, Arr2DIdxRowM(tmp4, (int32_t)10, (int32_t)128,i3,i2));
}
...
Arr1DIdxRowM(tmp16, (int32_t)1280,tmp19) = Arr2DIdxRowM(tmp1, (int32_t)10, (int32_t)128,i4,i5);
Arr1DIdxRowM(tmp17, (int32_t)1280,tmp19) = Arr2DIdxRowM(tmp3, (int32_t)10, (int32_t)128,i4,i5);
}
}
...
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)128; i5++){
tmp19 = (( (int32_t)0 + (i4 *  (int32_t)128)) + (i5 *  (int32_t)1));
Arr2DIdxRowM(tmp15, (int32_t)10, (int32_t)128,i4,i5) = Arr1DIdxRowM(tmp18, (int32_t)1280,tmp19);
}
}
...
tmp23 = SecretAdd(tmp23, Arr2DIdxRowM(tmp15, (int32_t)10, (int32_t)128,i7,i6));
}
