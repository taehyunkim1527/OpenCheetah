...
uint64_t* tmp0 = make_array<uint64_t>( (int32_t)20,  (int32_t)512);
...
Arr2DIdxRowM(tmp0, (int32_t)20, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp0 : 0;
}
}

uint64_t* tmp1 = make_array<uint64_t>( (int32_t)20,  (int32_t)512);
...
Arr2DIdxRowM(tmp1, (int32_t)20, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp1 : 0;
}
}

uint64_t* tmp2 = make_array<uint64_t>( (int32_t)20,  (int32_t)512);
...
Arr2DIdxRowM(tmp2, (int32_t)20, (int32_t)512,i0,i1) = (party == SERVER) ? __tmp_in_tmp2 : 0;
}
}
StartComputation();
...
tmp4 = SecretAdd(tmp4, Arr2DIdxRowM(tmp0, (int32_t)20, (int32_t)512,i1,i0));
}
Arr1DIdxRowM(tmp5, (int32_t)512,i0) = tmp4;
}
ClearMemSecret2( (int32_t)20,  (int32_t)512, tmp0);
...
tmp8 = SecretAdd(tmp8, Arr2DIdxRowM(tmp1, (int32_t)20, (int32_t)512,i3,i2));
}
Arr1DIdxRowM(tmp9, (int32_t)512,i2) = tmp8;
}
ClearMemSecret2( (int32_t)20,  (int32_t)512, tmp1);
...
tmp12 = SecretAdd(tmp12, Arr2DIdxRowM(tmp2, (int32_t)20, (int32_t)512,i5,i4));
}
Arr1DIdxRowM(tmp13, (int32_t)512,i4) = tmp12;
}
ClearMemSecret2( (int32_t)20,  (int32_t)512, tmp2);
EndComputation();
