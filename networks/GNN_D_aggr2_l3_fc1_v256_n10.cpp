...
uint64_t* tmp4 = make_array<uint64_t>( (int32_t)1,  (int32_t)1);
/* Variable to read the clear value corresponding to the input variable tmp4 at (9039,1-9039,36) */
...
Arr2DIdxRowM(tmp4, (int32_t)1, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp4 : 0;
}
}
...
int32_t tmp13 =  (int32_t)0;

uint64_t tmp14;

uint64_t* tmp15 = make_array<uint64_t>( (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)256; i0++){
tmp14 = funcSSCons( (int64_t)0);
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)10; i1++){
tmp14 = SecretAdd(tmp14, Arr2DIdxRowM(tmp1, (int32_t)10, (int32_t)256,i1,i0));
}
Arr1DIdxRowM(tmp15, (int32_t)256,i0) = tmp14;
}
...
Arr2DIdxRowM(tmp18, (int32_t)1, (int32_t)256,i3,i4) = Arr1DIdxRowM(tmp15, (int32_t)256,i2);
i2 = (i2 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)256, tmp15);
...
Arr2DIdxRowM(tmp20, (int32_t)1, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp18, (int32_t)1, (int32_t)256,i0,i1), Arr1DIdxRowM(tmp0, (int32_t)256,i1));
}
}
...
uint64_t* tmp25 = make_array<uint64_t>( (int32_t)256);
...
tmp27 = (( (int32_t)0 + (i5 *  (int32_t)256)) + (i6 *  (int32_t)1));
Arr1DIdxRowM(tmp24, (int32_t)256,tmp27) = Arr2DIdxRowM(tmp20, (int32_t)1, (int32_t)256,i5,i6);
Arr1DIdxRowM(tmp25, (int32_t)256,tmp27) = Arr2DIdxRowM(tmp4, (int32_t)1, (int32_t)1,i5, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)256, tmp24, tmp25, tmp26);
ClearMemSecret1( (int32_t)256, tmp24);
ClearMemSecret1( (int32_t)256, tmp25);
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)1; i5++){
for (uint32_t i6 =  (int32_t)0; i6 <  (int32_t)256; i6++){
tmp27 = (( (int32_t)0 + (i5 *  (int32_t)256)) + (i6 *  (int32_t)1));
Arr2DIdxRowM(tmp23, (int32_t)1, (int32_t)256,i5,i6) = Arr1DIdxRowM(tmp26, (int32_t)256,tmp27);
}
}
ClearMemSecret1( (int32_t)256, tmp26);
ClearMemSecret2( (int32_t)1,  (int32_t)1, tmp4);
ClearMemSecret2( (int32_t)1,  (int32_t)256, tmp20);

uint64_t* tmp30 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
ScaleDown2( (int32_t)1,  (int32_t)256, tmp23,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)256,  (int32_t)256, tmp23, tmp5, tmp30, 0);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp33, (int32_t)1, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp30, (int32_t)1, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp6, (int32_t)1, (int32_t)256,i0,i1));
}
}
...
int32_t tmp38 =  (int32_t)0;

uint64_t tmp39;

uint64_t* tmp40 = make_array<uint64_t>( (int32_t)256);
for (uint32_t i7 =  (int32_t)0; i7 <  (int32_t)256; i7++){
tmp39 = funcSSCons( (int64_t)0);
for (uint32_t i8 =  (int32_t)0; i8 <  (int32_t)10; i8++){
tmp39 = SecretAdd(tmp39, Arr2DIdxRowM(tmp2, (int32_t)10, (int32_t)256,i8,i7));
}
Arr1DIdxRowM(tmp40, (int32_t)256,i7) = tmp39;
}
ClearMemSecret2( (int32_t)10,  (int32_t)256, tmp2);

int32_t* tmp42 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp42, (int32_t)2, (int64_t)0) =  (int32_t)-1;
Arr1DIdxRowM(tmp42, (int32_t)2, (int64_t)1) =  (int32_t)256;
...
Arr2DIdxRowM(tmp43, (int32_t)1, (int32_t)256,i10,i11) = Arr1DIdxRowM(tmp40, (int32_t)256,i9);
i9 = (i9 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)256, tmp40);

uint64_t* tmp45 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp45, (int32_t)1, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp43, (int32_t)1, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp36, (int32_t)1, (int32_t)256,i0,i1));
}
}
...
tmp52 = (( (int32_t)0 + (i12 *  (int32_t)256)) + (i13 *  (int32_t)1));
Arr1DIdxRowM(tmp49, (int32_t)256,tmp52) = Arr2DIdxRowM(tmp45, (int32_t)1, (int32_t)256,i12,i13);
Arr1DIdxRowM(tmp50, (int32_t)256,tmp52) = Arr2DIdxRowM(tmp7, (int32_t)1, (int32_t)1,i12, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)256, tmp49, tmp50, tmp51);
ClearMemSecret1( (int32_t)256, tmp49);
ClearMemSecret1( (int32_t)256, tmp50);
for (uint32_t i12 =  (int32_t)0; i12 <  (int32_t)1; i12++){
for (uint32_t i13 =  (int32_t)0; i13 <  (int32_t)256; i13++){
tmp52 = (( (int32_t)0 + (i12 *  (int32_t)256)) + (i13 *  (int32_t)1));
Arr2DIdxRowM(tmp48, (int32_t)1, (int32_t)256,i12,i13) = Arr1DIdxRowM(tmp51, (int32_t)256,tmp52);
}
}
...
MatMul2D( (int32_t)1,  (int32_t)256,  (int32_t)256, tmp48, tmp8, tmp55, 0);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp58, (int32_t)1, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp55, (int32_t)1, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp9, (int32_t)1, (int32_t)256,i0,i1));
}
}
...
int32_t tmp63 =  (int32_t)0;

uint64_t tmp64;

uint64_t* tmp65 = make_array<uint64_t>( (int32_t)256);
for (uint32_t i14 =  (int32_t)0; i14 <  (int32_t)256; i14++){
tmp64 = funcSSCons( (int64_t)0);
for (uint32_t i15 =  (int32_t)0; i15 <  (int32_t)10; i15++){
tmp64 = SecretAdd(tmp64, Arr2DIdxRowM(tmp3, (int32_t)10, (int32_t)256,i15,i14));
}
Arr1DIdxRowM(tmp65, (int32_t)256,i14) = tmp64;
}
ClearMemSecret2( (int32_t)10,  (int32_t)256, tmp3);

int32_t* tmp67 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp67, (int32_t)2, (int64_t)0) =  (int32_t)-1;
Arr1DIdxRowM(tmp67, (int32_t)2, (int64_t)1) =  (int32_t)256;
...
Arr2DIdxRowM(tmp68, (int32_t)1, (int32_t)256,i17,i18) = Arr1DIdxRowM(tmp65, (int32_t)256,i16);
i16 = (i16 +  (int64_t)1);
}
}
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp70, (int32_t)1, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp68, (int32_t)1, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp61, (int32_t)1, (int32_t)256,i0,i1));
}
}
...
tmp77 = (( (int32_t)0 + (i19 *  (int32_t)256)) + (i20 *  (int32_t)1));
Arr1DIdxRowM(tmp74, (int32_t)256,tmp77) = Arr2DIdxRowM(tmp70, (int32_t)1, (int32_t)256,i19,i20);
Arr1DIdxRowM(tmp75, (int32_t)256,tmp77) = Arr2DIdxRowM(tmp10, (int32_t)1, (int32_t)1,i19, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)256, tmp74, tmp75, tmp76);
ClearMemSecret1( (int32_t)256, tmp74);
ClearMemSecret1( (int32_t)256, tmp75);
for (uint32_t i19 =  (int32_t)0; i19 <  (int32_t)1; i19++){
for (uint32_t i20 =  (int32_t)0; i20 <  (int32_t)256; i20++){
tmp77 = (( (int32_t)0 + (i19 *  (int32_t)256)) + (i20 *  (int32_t)1));
Arr2DIdxRowM(tmp73, (int32_t)1, (int32_t)256,i19,i20) = Arr1DIdxRowM(tmp76, (int32_t)256,tmp77);
}
}
...
ScaleDown2( (int32_t)1,  (int32_t)256, tmp73,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)256,  (int32_t)256, tmp73, tmp11, tmp80, 0);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp83, (int32_t)1, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp80, (int32_t)1, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp12, (int32_t)1, (int32_t)256,i0,i1));
}
}
...
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (uint32_t)0; i1 <  (int32_t)256; i1++){
cout << (funcReconstruct2PCCons(Arr2DIdxRowM(tmp86, (int32_t)1, (int32_t)256,i0,i1), 2)) << endl;
}
}
}
