...
uint64_t* tmp6 = make_array<uint64_t>( (int32_t)10,  (int32_t)1);
...
Arr2DIdxRowM(tmp6, (int32_t)10, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp6 : 0;
}
}
...
Arr1DIdxRowM(tmp11, (int32_t)1280,tmp14) = Arr2DIdxRowM(tmp1, (int32_t)10, (int32_t)128,i0,i1);
...
uint64_t* tmp35 = make_array<uint64_t>( (int32_t)10,  (int32_t)1);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)10; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)1; i1++){
Arr2DIdxRowM(tmp35, (int32_t)10, (int32_t)1,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp6, (int32_t)10, (int32_t)1,i0,i1), Arr2DIdxRowM(tmp7, (int32_t)10, (int32_t)1,i0,i1));
}
}
ClearMemSecret2( (int32_t)10,  (int32_t)1, tmp7);
ClearMemSecret2( (int32_t)10,  (int32_t)1, tmp6);

uint64_t* tmp38 = make_array<uint64_t>( (int32_t)10,  (int32_t)1);
Relu2( (int32_t)10,  (int32_t)1, tmp35, tmp38,  (int32_t)0, 0);
ClearMemSecret2( (int32_t)10,  (int32_t)1, tmp35);
...
tmp41 = SecretAdd(tmp41, Arr2DIdxRowM(tmp38, (int32_t)10, (int32_t)1,i7,i8));
}
}
...
uint64_t* tmp44 = make_array<uint64_t>( (int32_t)10);

uint64_t* tmp45 = make_array<uint64_t>( (int32_t)10);

uint64_t* tmp46 = make_array<uint64_t>( (int32_t)10);
...
Arr1DIdxRowM(tmp44, (int32_t)10,tmp47) = Arr2DIdxRowM(tmp38, (int32_t)10, (int32_t)1,i9,i10);
Arr1DIdxRowM(tmp45, (int32_t)10,tmp47) = Arr1DIdxRowM(tmp42, (int32_t)1,i10);
}
}
ElemWiseActModelVectorMult( (int32_t)10, tmp44, tmp45, tmp46);
ClearMemSecret1( (int32_t)10, tmp44);
ClearMemSecret1( (int32_t)10, tmp45);
for (uint32_t i9 =  (int32_t)0; i9 <  (int32_t)10; i9++){
for (uint32_t i10 =  (int32_t)0; i10 <  (int32_t)1; i10++){
tmp47 = (( (int32_t)0 + (i9 *  (int32_t)1)) + (i10 *  (int32_t)1));
Arr2DIdxRowM(tmp43, (int32_t)10, (int32_t)1,i9,i10) = Arr1DIdxRowM(tmp46, (int32_t)10,tmp47);
}
}
ClearMemSecret1( (int32_t)10, tmp46);
ClearMemSecret1( (int32_t)1, tmp42);
ClearMemSecret2( (int32_t)10,  (int32_t)1, tmp38);
ScaleDown2( (int32_t)10,  (int32_t)1, tmp43,  (int32_t)12);
...
Arr1DIdxRowM(tmp51, (int32_t)1280,tmp54) = Arr2DIdxRowM(tmp2, (int32_t)10, (int32_t)128,i11,i12);
Arr1DIdxRowM(tmp52, (int32_t)1280,tmp54) = Arr2DIdxRowM(tmp43, (int32_t)10, (int32_t)1,i11, (int32_t)0);
}
}
...
for (uint32_t i12 =  (int32_t)0; i12 <  (int32_t)128; i12++){
tmp54 = (( (int32_t)0 + (i11 *  (int32_t)128)) + (i12 *  (int32_t)1));
Arr2DIdxRowM(tmp50, (int32_t)10, (int32_t)128,i11,i12) = Arr1DIdxRowM(tmp53, (int32_t)1280,tmp54);
}
}
...
tmp58 = SecretAdd(tmp58, Arr2DIdxRowM(tmp50, (int32_t)10, (int32_t)128,i14,i13));
}
