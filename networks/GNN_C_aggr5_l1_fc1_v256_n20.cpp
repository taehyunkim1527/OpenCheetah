...
Arr1DIdxRowM(tmp6, (int32_t)5120,tmp9) = Arr2DIdxRowM(tmp2, (int32_t)20, (int32_t)256,i0,i1);
Arr1DIdxRowM(tmp7, (int32_t)5120,tmp9) = Arr2DIdxRowM(tmp1, (int32_t)1, (int32_t)256, (int32_t)0,i1);
}
}
...
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
tmp9 = (( (int32_t)0 + (i0 *  (int32_t)256)) + (i1 *  (int32_t)1));
Arr2DIdxRowM(tmp5, (int32_t)20, (int32_t)256,i0,i1) = Arr1DIdxRowM(tmp8, (int32_t)5120,tmp9);
}
}
...
uint64_t* tmp12 = make_array<uint64_t>( (int32_t)20,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)20; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp12, (int32_t)20, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp0, (int32_t)20, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp5, (int32_t)20, (int32_t)256,i0,i1));
}
}
ClearMemSecret2( (int32_t)20,  (int32_t)256, tmp5);
ClearMemSecret2( (int32_t)20,  (int32_t)256, tmp0);
ScaleDown2( (int32_t)20,  (int32_t)256, tmp12,  (int32_t)12);

uint64_t* tmp15 = make_array<uint64_t>( (int32_t)20,  (int32_t)256);
...
Arr1DIdxRowM(tmp16, (int32_t)5120,tmp19) = Arr2DIdxRowM(tmp12, (int32_t)20, (int32_t)256,i2,i3);
Arr1DIdxRowM(tmp17, (int32_t)5120,tmp19) = Arr2DIdxRowM(tmp4, (int32_t)20, (int32_t)256,i2,i3);
}
}
...
for (uint32_t i3 =  (int32_t)0; i3 <  (int32_t)256; i3++){
tmp19 = (( (int32_t)0 + (i2 *  (int32_t)256)) + (i3 *  (int32_t)1));
Arr2DIdxRowM(tmp15, (int32_t)20, (int32_t)256,i2,i3) = Arr1DIdxRowM(tmp18, (int32_t)5120,tmp19);
}
}
ClearMemSecret1( (int32_t)5120, tmp18);
ClearMemSecret2( (int32_t)20,  (int32_t)256, tmp12);
...
tmp23 = SecretAdd(tmp23, Arr2DIdxRowM(tmp15, (int32_t)20, (int32_t)256,i5,i4));
}
Arr1DIdxRowM(tmp24, (int32_t)256,i4) = tmp23;
}
ClearMemSecret2( (int32_t)20,  (int32_t)256, tmp15);
