...
uint64_t* tmp4 = make_array<uint64_t>( (int32_t)1);
...
Arr1DIdxRowM(tmp4, (int32_t)1,i0) = (party == SERVER) ? __tmp_in_tmp4 : 0;
}
...
uint64_t* tmp16 = make_array<uint64_t>( (int32_t)2560);

uint64_t* tmp17 = make_array<uint64_t>( (int32_t)2560);
...
tmp19 = (( (int32_t)0 + (i0 *  (int32_t)256)) + (i1 *  (int32_t)1));
Arr1DIdxRowM(tmp16, (int32_t)2560,tmp19) = Arr2DIdxRowM(tmp3, (int32_t)10, (int32_t)256,i0,i1);
Arr1DIdxRowM(tmp17, (int32_t)2560,tmp19) = Arr1DIdxRowM(tmp4, (int32_t)1, (int32_t)0);
}
}
ElemWiseActModelVectorMult( (int32_t)2560, tmp16, tmp17, tmp18);
ClearMemSecret1( (int32_t)2560, tmp16);
ClearMemSecret1( (int32_t)2560, tmp17);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)10; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
tmp19 = (( (int32_t)0 + (i0 *  (int32_t)256)) + (i1 *  (int32_t)1));
Arr2DIdxRowM(tmp15, (int32_t)10, (int32_t)256,i0,i1) = Arr1DIdxRowM(tmp18, (int32_t)2560,tmp19);
}
}
ClearMemSecret1( (int32_t)2560, tmp18);
ClearMemSecret2( (int32_t)10,  (int32_t)256, tmp3);
ClearMemSecret1( (int32_t)1, tmp4);

int32_t tmp22 =  (int32_t)0;

uint64_t tmp23;

uint64_t* tmp24 = make_array<uint64_t>( (int32_t)256);
for (uint32_t i2 =  (int32_t)0; i2 <  (int32_t)256; i2++){
tmp23 = funcSSCons( (int64_t)0);
for (uint32_t i3 =  (int32_t)0; i3 <  (int32_t)10; i3++){
tmp23 = SecretAdd(tmp23, Arr2DIdxRowM(tmp15, (int32_t)10, (int32_t)256,i3,i2));
}
Arr1DIdxRowM(tmp24, (int32_t)256,i2) = tmp23;
}
...
Arr2DIdxRowM(tmp27, (int32_t)1, (int32_t)256,i5,i6) = Arr1DIdxRowM(tmp24, (int32_t)256,i4);
i4 = (i4 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)256, tmp24);
ScaleUp1( (int32_t)256, tmp0,  (int32_t)12);

uint64_t* tmp29 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp29, (int32_t)1, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp27, (int32_t)1, (int32_t)256,i0,i1), Arr1DIdxRowM(tmp0, (int32_t)256,i1));
}
}
...
ScaleDown2( (int32_t)1,  (int32_t)256, tmp29,  (int32_t)12);
MatMul2D( (int32_t)1,  (int32_t)256,  (int32_t)256, tmp29, tmp5, tmp32, 0);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp35, (int32_t)1, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp32, (int32_t)1, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp6, (int32_t)1, (int32_t)256,i0,i1));
}
}
...
Relu2( (int32_t)1,  (int32_t)256, tmp35, tmp38,  (int32_t)12, 1);
...
Arr2DIdxRowM(tmp40, (int32_t)200, (int32_t)1,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp7, (int32_t)200, (int32_t)1,i0,i1), Arr2DIdxRowM(tmp8, (int32_t)200, (int32_t)1,i0,i1));
}
}
...
tmp46 = SecretAdd(tmp46, Arr2DIdxRowM(tmp43, (int32_t)200, (int32_t)1,i7,i8));
}
}
...
tmp52 = (( (int32_t)0 + (i9 *  (int32_t)1)) + (i10 *  (int32_t)1));
Arr1DIdxRowM(tmp49, (int32_t)200,tmp52) = Arr2DIdxRowM(tmp43, (int32_t)200, (int32_t)1,i9,i10);
Arr1DIdxRowM(tmp50, (int32_t)200,tmp52) = Arr1DIdxRowM(tmp47, (int32_t)1,i10);
}
}
...
for (uint32_t i10 =  (int32_t)0; i10 <  (int32_t)1; i10++){
tmp52 = (( (int32_t)0 + (i9 *  (int32_t)1)) + (i10 *  (int32_t)1));
Arr2DIdxRowM(tmp48, (int32_t)200, (int32_t)1,i9,i10) = Arr1DIdxRowM(tmp51, (int32_t)200,tmp52);
}
}
...
int32_t tmp59;
for (uint32_t i11 =  (int32_t)0; i11 <  (int32_t)200; i11++){
for (uint32_t i12 =  (int32_t)0; i12 <  (int32_t)256; i12++){
tmp59 = (( (int32_t)0 + (i11 *  (int32_t)256)) + (i12 *  (int32_t)1));
Arr1DIdxRowM(tmp56, (int32_t)51200,tmp59) = Arr2DIdxRowM(tmp1, (int32_t)200, (int32_t)256,i11,i12);
Arr1DIdxRowM(tmp57, (int32_t)51200,tmp59) = Arr2DIdxRowM(tmp48, (int32_t)200, (int32_t)1,i11, (int32_t)0);
}
}
...
for (uint32_t i12 =  (int32_t)0; i12 <  (int32_t)256; i12++){
tmp59 = (( (int32_t)0 + (i11 *  (int32_t)256)) + (i12 *  (int32_t)1));
Arr2DIdxRowM(tmp55, (int32_t)200, (int32_t)256,i11,i12) = Arr1DIdxRowM(tmp58, (int32_t)51200,tmp59);
}
}
...
for (uint32_t i14 =  (int32_t)0; i14 <  (int32_t)200; i14++){
tmp63 = SecretAdd(tmp63, Arr2DIdxRowM(tmp55, (int32_t)200, (int32_t)256,i14,i13));
}
Arr1DIdxRowM(tmp64, (int32_t)256,i13) = tmp63;
}
...
int64_t i15;
i15 =  (int64_t)0;
for (uint32_t i16 =  (int32_t)0; i16 <  (int32_t)1; i16++){
for (uint32_t i17 =  (int32_t)0; i17 <  (int32_t)256; i17++){
Arr2DIdxRowM(tmp67, (int32_t)1, (int32_t)256,i16,i17) = Arr1DIdxRowM(tmp64, (int32_t)256,i15);
i15 = (i15 +  (int64_t)1);
}
}
ClearMemSecret1( (int32_t)256, tmp64);
ScaleUp2( (int32_t)1,  (int32_t)256, tmp38,  (int32_t)12);

uint64_t* tmp69 = make_array<uint64_t>( (int32_t)1,  (int32_t)256);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp69, (int32_t)1, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp67, (int32_t)1, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp38, (int32_t)1, (int32_t)256,i0,i1));
}
}
...
MatMul2D( (int32_t)1,  (int32_t)256,  (int32_t)256, tmp69, tmp9, tmp72, 0);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp75, (int32_t)1, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp72, (int32_t)1, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp10, (int32_t)1, (int32_t)256,i0,i1));
}
}
...
uint64_t* tmp80 = make_array<uint64_t>( (int32_t)200,  (int32_t)1);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)200; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)1; i1++){
Arr2DIdxRowM(tmp80, (int32_t)200, (int32_t)1,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp11, (int32_t)200, (int32_t)1,i0,i1), Arr2DIdxRowM(tmp12, (int32_t)200, (int32_t)1,i0,i1));
}
}
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp11);
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp12);

uint64_t* tmp83 = make_array<uint64_t>( (int32_t)200,  (int32_t)1);
Relu2( (int32_t)200,  (int32_t)1, tmp80, tmp83,  (int32_t)0, 0);
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp80);

int32_t* tmp85 = make_array<int32_t>( (int32_t)2);
Arr1DIdxRowM(tmp85, (int32_t)2, (int64_t)0) =  (int32_t)0;
Arr1DIdxRowM(tmp85, (int32_t)2, (int64_t)1) =  (int32_t)1;

uint64_t tmp86;

uint64_t* tmp87 = make_array<uint64_t>( (int32_t)1);
tmp86 = funcSSCons( (int64_t)0);
for (uint32_t i18 =  (int32_t)0; i18 <  (int32_t)200; i18++){
for (uint32_t i19 =  (int32_t)0; i19 <  (int32_t)1; i19++){
tmp86 = SecretAdd(tmp86, Arr2DIdxRowM(tmp83, (int32_t)200, (int32_t)1,i18,i19));
}
}
Arr1DIdxRowM(tmp87, (int32_t)1, (int32_t)0) = tmp86;

uint64_t* tmp88 = make_array<uint64_t>( (int32_t)200,  (int32_t)1);

uint64_t* tmp89 = make_array<uint64_t>( (int32_t)200);

uint64_t* tmp90 = make_array<uint64_t>( (int32_t)200);
...
tmp92 = (( (int32_t)0 + (i20 *  (int32_t)1)) + (i21 *  (int32_t)1));
Arr1DIdxRowM(tmp89, (int32_t)200,tmp92) = Arr2DIdxRowM(tmp83, (int32_t)200, (int32_t)1,i20,i21);
Arr1DIdxRowM(tmp90, (int32_t)200,tmp92) = Arr1DIdxRowM(tmp87, (int32_t)1,i21);
}
}
ElemWiseActModelVectorMult( (int32_t)200, tmp89, tmp90, tmp91);
ClearMemSecret1( (int32_t)200, tmp89);
ClearMemSecret1( (int32_t)200, tmp90);
for (uint32_t i20 =  (int32_t)0; i20 <  (int32_t)200; i20++){
for (uint32_t i21 =  (int32_t)0; i21 <  (int32_t)1; i21++){
tmp92 = (( (int32_t)0 + (i20 *  (int32_t)1)) + (i21 *  (int32_t)1));
Arr2DIdxRowM(tmp88, (int32_t)200, (int32_t)1,i20,i21) = Arr1DIdxRowM(tmp91, (int32_t)200,tmp92);
}
}
ClearMemSecret1( (int32_t)200, tmp91);
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp83);
ClearMemSecret1( (int32_t)1, tmp87);
ScaleDown2( (int32_t)200,  (int32_t)1, tmp88,  (int32_t)12);

uint64_t* tmp95 = make_array<uint64_t>( (int32_t)200,  (int32_t)256);
...
tmp99 = (( (int32_t)0 + (i22 *  (int32_t)256)) + (i23 *  (int32_t)1));
Arr1DIdxRowM(tmp96, (int32_t)51200,tmp99) = Arr2DIdxRowM(tmp2, (int32_t)200, (int32_t)256,i22,i23);
Arr1DIdxRowM(tmp97, (int32_t)51200,tmp99) = Arr2DIdxRowM(tmp88, (int32_t)200, (int32_t)1,i22, (int32_t)0);
}
}
...
for (uint32_t i23 =  (int32_t)0; i23 <  (int32_t)256; i23++){
tmp99 = (( (int32_t)0 + (i22 *  (int32_t)256)) + (i23 *  (int32_t)1));
Arr2DIdxRowM(tmp95, (int32_t)200, (int32_t)256,i22,i23) = Arr1DIdxRowM(tmp98, (int32_t)51200,tmp99);
}
}
ClearMemSecret1( (int32_t)51200, tmp98);
ClearMemSecret2( (int32_t)200,  (int32_t)1, tmp88);
...
for (uint32_t i25 =  (int32_t)0; i25 <  (int32_t)200; i25++){
tmp103 = SecretAdd(tmp103, Arr2DIdxRowM(tmp95, (int32_t)200, (int32_t)256,i25,i24));
}
Arr1DIdxRowM(tmp104, (int32_t)256,i24) = tmp103;
}
ClearMemSecret2( (int32_t)200,  (int32_t)256, tmp95);
...
Arr2DIdxRowM(tmp107, (int32_t)1, (int32_t)256,i27,i28) = Arr1DIdxRowM(tmp104, (int32_t)256,i26);
i26 = (i26 +  (int64_t)1);
}
}
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp109, (int32_t)1, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp107, (int32_t)1, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp78, (int32_t)1, (int32_t)256,i0,i1));
}
}
...
MatMul2D( (int32_t)1,  (int32_t)256,  (int32_t)256, tmp109, tmp13, tmp112, 0);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)256; i1++){
Arr2DIdxRowM(tmp115, (int32_t)1, (int32_t)256,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp112, (int32_t)1, (int32_t)256,i0,i1), Arr2DIdxRowM(tmp14, (int32_t)1, (int32_t)256,i0,i1));
}
}
...
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (uint32_t)0; i1 <  (int32_t)256; i1++){
cout << (funcReconstruct2PCCons(Arr2DIdxRowM(tmp118, (int32_t)1, (int32_t)256,i0,i1), 2)) << endl;
}
}
}
