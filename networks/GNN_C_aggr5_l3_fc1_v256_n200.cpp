...
Arr1DIdxRowM(tmp7, (int32_t)51200,tmp10) = Arr2DIdxRowM(tmp0, (int32_t)200, (int32_t)256,i0,i1);
Arr1DIdxRowM(tmp8, (int32_t)51200,tmp10) = Arr2DIdxRowM(tmp3, (int32_t)200, (int32_t)256,i0,i1);
}
}
...
for (uint32_t i3 =  (int32_t)0; i3 <  (int32_t)200; i3++){
tmp14 = SecretAdd(tmp14, Arr2DIdxRowM(tmp6, (int32_t)200, (int32_t)256,i3,i2));
}
...
Arr1DIdxRowM(tmp18, (int32_t)51200,tmp21) = Arr2DIdxRowM(tmp1, (int32_t)200, (int32_t)256,i4,i5);
Arr1DIdxRowM(tmp19, (int32_t)51200,tmp21) = Arr2DIdxRowM(tmp4, (int32_t)200, (int32_t)256,i4,i5);
}
}
...
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)256; i5++){
tmp21 = (( (int32_t)0 + (i4 *  (int32_t)256)) + (i5 *  (int32_t)1));
Arr2DIdxRowM(tmp17, (int32_t)200, (int32_t)256,i4,i5) = Arr1DIdxRowM(tmp20, (int32_t)51200,tmp21);
}
}
...
tmp25 = SecretAdd(tmp25, Arr2DIdxRowM(tmp17, (int32_t)200, (int32_t)256,i7,i6));
}
Arr1DIdxRowM(tmp26, (int32_t)256,i6) = tmp25;
}
ClearMemSecret2( (int32_t)200,  (int32_t)256, tmp17);

uint64_t* tmp28 = make_array<uint64_t>( (int32_t)200,  (int32_t)256);
...
Arr1DIdxRowM(tmp29, (int32_t)51200,tmp32) = Arr2DIdxRowM(tmp2, (int32_t)200, (int32_t)256,i8,i9);
Arr1DIdxRowM(tmp30, (int32_t)51200,tmp32) = Arr2DIdxRowM(tmp5, (int32_t)200, (int32_t)256,i8,i9);
}
}
ElemWiseActModelVectorMult( (int32_t)51200, tmp29, tmp30, tmp31);
ClearMemSecret1( (int32_t)51200, tmp29);
ClearMemSecret1( (int32_t)51200, tmp30);
for (uint32_t i8 =  (int32_t)0; i8 <  (int32_t)200; i8++){
for (uint32_t i9 =  (int32_t)0; i9 <  (int32_t)256; i9++){
tmp32 = (( (int32_t)0 + (i8 *  (int32_t)256)) + (i9 *  (int32_t)1));
Arr2DIdxRowM(tmp28, (int32_t)200, (int32_t)256,i8,i9) = Arr1DIdxRowM(tmp31, (int32_t)51200,tmp32);
}
}
...
tmp36 = SecretAdd(tmp36, Arr2DIdxRowM(tmp28, (int32_t)200, (int32_t)256,i11,i10));
}
Arr1DIdxRowM(tmp37, (int32_t)256,i10) = tmp36;
}
ClearMemSecret2( (int32_t)200,  (int32_t)256, tmp28);
