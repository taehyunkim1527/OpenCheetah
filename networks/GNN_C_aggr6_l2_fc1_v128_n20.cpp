...
uint64_t* tmp1 = make_array<uint64_t>( (int32_t)20,  (int32_t)1);
/* Variable to read the clear value corresponding to the input variable tmp1 at (9030,1-9030,37) */
...
Arr2DIdxRowM(tmp1, (int32_t)20, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp1 : 0;
}
}

uint64_t* tmp2 = make_array<uint64_t>( (int32_t)20,  (int32_t)1);
/* Variable to read the clear value corresponding to the input variable tmp2 at (9033,1-9033,37) */
...
Arr2DIdxRowM(tmp2, (int32_t)20, (int32_t)1,i0,i1) = (party == SERVER) ? __tmp_in_tmp2 : 0;
}
}
StartComputation();

uint64_t* tmp3 = make_array<uint64_t>( (int32_t)20,  (int32_t)1);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)20; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)1; i1++){
Arr2DIdxRowM(tmp3, (int32_t)20, (int32_t)1,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp1, (int32_t)20, (int32_t)1,i0,i1), Arr2DIdxRowM(tmp2, (int32_t)20, (int32_t)1,i0,i1));
}
}
ClearMemSecret2( (int32_t)20,  (int32_t)1, tmp1);
ClearMemSecret2( (int32_t)20,  (int32_t)1, tmp2);

uint64_t* tmp6 = make_array<uint64_t>( (int32_t)20,  (int32_t)1);
Relu2( (int32_t)20,  (int32_t)1, tmp3, tmp6,  (int32_t)0, 0);
ClearMemSecret2( (int32_t)20,  (int32_t)1, tmp3);
...
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)20; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)1; i1++){
tmp9 = SecretAdd(tmp9, Arr2DIdxRowM(tmp6, (int32_t)20, (int32_t)1,i0,i1));
}
}
...
Arr1DIdxRowM(tmp12, (int32_t)2560,tmp15) = Arr2DIdxRowM(tmp0, (int32_t)20, (int32_t)128,i2,i3);
Arr1DIdxRowM(tmp13, (int32_t)2560,tmp15) = Arr2DIdxRowM(tmp6, (int32_t)20, (int32_t)1,i2, (int32_t)0);
}
}
...
for (uint32_t i3 =  (int32_t)0; i3 <  (int32_t)128; i3++){
tmp15 = (( (int32_t)0 + (i2 *  (int32_t)128)) + (i3 *  (int32_t)1));
Arr2DIdxRowM(tmp11, (int32_t)20, (int32_t)128,i2,i3) = Arr1DIdxRowM(tmp14, (int32_t)2560,tmp15);
}
}
...
tmp19 = SecretAdd(tmp19, Arr2DIdxRowM(tmp11, (int32_t)20, (int32_t)128,i5,i4));
}
