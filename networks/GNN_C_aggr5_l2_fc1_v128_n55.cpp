...
uint64_t* tmp0 = make_array<uint64_t>( (int32_t)55,  (int32_t)128);
/* Variable to read the clear value corresponding to the input variable tmp0 at (9027,1-9027,39) */
uint64_t __tmp_in_tmp0;
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)55; i0++){
for (uint32_t i1 =  (uint32_t)0; i1 <  (int32_t)128; i1++){
if ((party == SERVER)) {
__tmp_in_tmp0 = 2;
}
Arr2DIdxRowM(tmp0, (int32_t)55, (int32_t)128,i0,i1) = (party == SERVER) ? __tmp_in_tmp0 : 0;
}
}

uint64_t* tmp1 = make_array<uint64_t>( (int32_t)55,  (int32_t)128);
...
Arr2DIdxRowM(tmp1, (int32_t)55, (int32_t)128,i0,i1) = (party == SERVER) ? __tmp_in_tmp1 : 0;
}
}

uint64_t* tmp2 = make_array<uint64_t>( (int32_t)55,  (int32_t)128);
...
Arr2DIdxRowM(tmp2, (int32_t)55, (int32_t)128,i0,i1) = (party == SERVER) ? __tmp_in_tmp2 : 0;
}
}

uint64_t* tmp3 = make_array<uint64_t>( (int32_t)55,  (int32_t)128);
...
Arr2DIdxRowM(tmp3, (int32_t)55, (int32_t)128,i0,i1) = (party == SERVER) ? __tmp_in_tmp3 : 0;
}
}
StartComputation();

uint64_t* tmp4 = make_array<uint64_t>( (int32_t)55,  (int32_t)128);

uint64_t* tmp5 = make_array<uint64_t>( (int32_t)7040);

uint64_t* tmp6 = make_array<uint64_t>( (int32_t)7040);

uint64_t* tmp7 = make_array<uint64_t>( (int32_t)7040);

int32_t tmp8;
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)55; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
tmp8 = (( (int32_t)0 + (i0 *  (int32_t)128)) + (i1 *  (int32_t)1));
Arr1DIdxRowM(tmp5, (int32_t)7040,tmp8) = Arr2DIdxRowM(tmp0, (int32_t)55, (int32_t)128,i0,i1);
Arr1DIdxRowM(tmp6, (int32_t)7040,tmp8) = Arr2DIdxRowM(tmp2, (int32_t)55, (int32_t)128,i0,i1);
}
}
ElemWiseActModelVectorMult( (int32_t)7040, tmp5, tmp6, tmp7);
ClearMemSecret1( (int32_t)7040, tmp5);
ClearMemSecret1( (int32_t)7040, tmp6);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)55; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
tmp8 = (( (int32_t)0 + (i0 *  (int32_t)128)) + (i1 *  (int32_t)1));
Arr2DIdxRowM(tmp4, (int32_t)55, (int32_t)128,i0,i1) = Arr1DIdxRowM(tmp7, (int32_t)7040,tmp8);
}
}
ClearMemSecret1( (int32_t)7040, tmp7);
ClearMemSecret2( (int32_t)55,  (int32_t)128, tmp0);
ClearMemSecret2( (int32_t)55,  (int32_t)128, tmp2);
...
for (uint32_t i3 =  (int32_t)0; i3 <  (int32_t)55; i3++){
tmp12 = SecretAdd(tmp12, Arr2DIdxRowM(tmp4, (int32_t)55, (int32_t)128,i3,i2));
}
Arr1DIdxRowM(tmp13, (int32_t)128,i2) = tmp12;
}
ClearMemSecret2( (int32_t)55,  (int32_t)128, tmp4);

uint64_t* tmp15 = make_array<uint64_t>( (int32_t)55,  (int32_t)128);

uint64_t* tmp16 = make_array<uint64_t>( (int32_t)7040);

uint64_t* tmp17 = make_array<uint64_t>( (int32_t)7040);

uint64_t* tmp18 = make_array<uint64_t>( (int32_t)7040);

int32_t tmp19;
for (uint32_t i4 =  (int32_t)0; i4 <  (int32_t)55; i4++){
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)128; i5++){
tmp19 = (( (int32_t)0 + (i4 *  (int32_t)128)) + (i5 *  (int32_t)1));
Arr1DIdxRowM(tmp16, (int32_t)7040,tmp19) = Arr2DIdxRowM(tmp1, (int32_t)55, (int32_t)128,i4,i5);
Arr1DIdxRowM(tmp17, (int32_t)7040,tmp19) = Arr2DIdxRowM(tmp3, (int32_t)55, (int32_t)128,i4,i5);
}
}
ElemWiseActModelVectorMult( (int32_t)7040, tmp16, tmp17, tmp18);
ClearMemSecret1( (int32_t)7040, tmp16);
ClearMemSecret1( (int32_t)7040, tmp17);
for (uint32_t i4 =  (int32_t)0; i4 <  (int32_t)55; i4++){
for (uint32_t i5 =  (int32_t)0; i5 <  (int32_t)128; i5++){
tmp19 = (( (int32_t)0 + (i4 *  (int32_t)128)) + (i5 *  (int32_t)1));
Arr2DIdxRowM(tmp15, (int32_t)55, (int32_t)128,i4,i5) = Arr1DIdxRowM(tmp18, (int32_t)7040,tmp19);
}
}
ClearMemSecret1( (int32_t)7040, tmp18);
ClearMemSecret2( (int32_t)55,  (int32_t)128, tmp1);
ClearMemSecret2( (int32_t)55,  (int32_t)128, tmp3);
...
for (uint32_t i7 =  (int32_t)0; i7 <  (int32_t)55; i7++){
tmp23 = SecretAdd(tmp23, Arr2DIdxRowM(tmp15, (int32_t)55, (int32_t)128,i7,i6));
}
Arr1DIdxRowM(tmp24, (int32_t)128,i6) = tmp23;
}
ClearMemSecret2( (int32_t)55,  (int32_t)128, tmp15);
ScaleDown1( (int32_t)128, tmp24,  (int32_t)12);
EndComputation();
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)128; i0++){
cout << (funcReconstruct2PCCons(Arr1DIdxRowM(tmp24, (int32_t)128,i0), 2)) << endl;
}
}
