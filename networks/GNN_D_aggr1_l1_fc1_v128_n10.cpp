...
uint64_t* tmp2 = make_array<uint64_t>( (int32_t)128,  (int32_t)128);
...
Arr2DIdxRowM(tmp2, (int32_t)128, (int32_t)128,i0,i1) = (party == SERVER) ? __tmp_in_tmp2 : 0;
}
}
...
int32_t tmp4 =  (int32_t)0;

uint64_t tmp5;

uint64_t* tmp6 = make_array<uint64_t>( (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)128; i0++){
tmp5 = funcSSCons( (int64_t)0);
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)10; i1++){
tmp5 = SecretAdd(tmp5, Arr2DIdxRowM(tmp1, (int32_t)10, (int32_t)128,i1,i0));
}
Arr1DIdxRowM(tmp6, (int32_t)128,i0) = tmp5;
}
...
Arr2DIdxRowM(tmp9, (int32_t)1, (int32_t)128,i3,i4) = Arr1DIdxRowM(tmp6, (int32_t)128,i2);
i2 = (i2 +  (int64_t)1);
}
}
...
Arr2DIdxRowM(tmp11, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp9, (int32_t)1, (int32_t)128,i0,i1), Arr1DIdxRowM(tmp0, (int32_t)128,i1));
}
}
...
MatMul2D( (int32_t)1,  (int32_t)128,  (int32_t)128, tmp11, tmp2, tmp14, 0);
ClearMemSecret2( (int32_t)128,  (int32_t)128, tmp2);
ClearMemSecret2( (int32_t)1,  (int32_t)128, tmp11);
ScaleUp2( (int32_t)1,  (int32_t)128, tmp3,  (int32_t)12);

uint64_t* tmp17 = make_array<uint64_t>( (int32_t)1,  (int32_t)128);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (int32_t)0; i1 <  (int32_t)128; i1++){
Arr2DIdxRowM(tmp17, (int32_t)1, (int32_t)128,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp14, (int32_t)1, (int32_t)128,i0,i1), Arr2DIdxRowM(tmp3, (int32_t)1, (int32_t)128,i0,i1));
}
}
